        ...
        },
        {
            ...
            questions: [
                ...
                },
                {
                    id: "cm18q100",
                    src: "WATE813-00177",
                    text: "In the classical Streeter-Phelps model, L_0 is initial ultimate BOD and D_0 is initial oxygen deficit. Positive k_d and k_r are base-10 deoxygenation and reaeration constants, with k_r unequal to k_d. Let \\(F(t)=10^{-k_dt}-10^{-k_rt}\\). Which expression gives the oxygen deficit D_t?",
                    options: [
                        { key: "a", text: "\\(D_t=\\dfrac{k_dL_0F(t)}{k_r-k_d}\\)<br>\\(\\quad+D_0\\,10^{-k_rt}\\)" },
                        { key: "b", text: "\\(D_t=\\dfrac{k_rL_0F(t)}{k_r-k_d}\\)<br>\\(\\quad+D_0\\,10^{-k_rt}\\)" },
                        { key: "c", text: "\\(D_t=\\dfrac{k_dL_0F(t)}{k_r-k_d}\\)<br>\\(\\quad+D_0\\,10^{-k_dt}\\)" },
                        { key: "d", text: "\\(D_t=\\dfrac{k_dL_0F(t)}{k_r+k_d}\\)<br>\\(\\quad+D_0\\,10^{-k_rt}\\)" }
                    ],
                    answer: "a",
                    explanation: "Option A combines deficit generated by BOD decay with recovery of the initial deficit. The first term uses k_d in its numerator; the initial deficit decays at the reaeration rate k_r. The expression satisfies D(0) = D_0 and the classical oxygen-deficit balance. Both constants must use the stated base-10 convention and the same time units. Equal constants require a limiting form. The original identical choices have been replaced with four distinct expressions while retaining answer A."
                }
            ]
        }
    ]
