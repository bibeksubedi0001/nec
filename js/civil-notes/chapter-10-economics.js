    ...
    Object.assign(registry, {
        AALL1002: {
            ...
            blocks: [
                {
                    ...
                    html: "<p><strong>Syllabus extension.</strong> None of the nine assigned questions supplies a complete project cash-flow timeline. A cash flow records money received or paid at specified dates, not simply revenue earned or an accounting expense recognized. Choose the decision perspective, currency, price base and study period before applying a formula.</p><p>Take receipts as positive and payments as negative. The investment date is t = 0; an end-of-year convention places the following year's net receipt at t = 1. </p>",
                    moreHtml: "<p>Identify construction expenditure, operating receipts and expenses, replacements, working-capital commitments and recoveries, and terminal disposal proceeds or costs. A delay in collection changes present value even if the nominal invoice amount is unchanged.</p><p>Project cash flow before financing excludes loan drawdowns and debt service; equity cash flow includes the relevant financing flows. Use a discount rate consistent with that choice rather than deducting financing costs and then counting them again through an incompatible hurdle rate.</p><p><strong>Financial and social economic analysis are different.</strong> Owner receipts and payments do not automatically equal society's resource costs and benefits. Taxes, subsidies and charges can be transfers within a stated social boundary, while environmental or user effects may exist without cash receipts. Define the boundary and avoid counting a transfer or the same underlying benefit twice.</p>",
                    sources: []
                },
                {
                    id: "econ-time-value-single-payments",
                    title: "Move a single payment through time using a matching interest period",
                    html: "<p><strong>Syllabus extension.</strong> The bank does not provide a single-payment time-value exercise. Money available now can earn a return or avoid financing cost; therefore equal amounts at different dates are not generally equivalent. </p><p>Compounding gives <strong>F = P(1 + i)<sup>n</sup></strong>, so the factor F/P is (1 + i)<sup>n</sup>. Reversing the operation gives <strong>P = F/(1 + i)<sup>n</sup></strong>, with factor P/F = (1 + i)<sup>−n</sup>. </p><p><strong>Hypothetical example:</strong> Rs1,000 invested for three years at an effective annual 10%, with interest retained, becomes 1000 × 1.1<sup>3</sup> = <strong>Rs1,331</strong>. Discounting Rs1,331 by that same factor returns Rs1,000. Simple interest on principal alone would instead produce 1000(1 + 0.10 × 3) = <strong>Rs1,300</strong>.</p><p>Interest and discounting are inverse time-value operations, not opposite opinions about profitability. At i = 0 both factors become one. Keep full precision in factors and round the final money amount, rather than rounding each year's interest before compounding.</p>",
                    moreHtml: "<p>Let P be present value, F the value n periods later and i the effective interest rate per period, expressed as a fraction.</p><p>The exponent counts the same periods to which i applies. Monthly cash flows cannot be discounted with an annual rate without a suitable conversion or explicit annual aggregation.</p>",
                    sources: []
                },
                {
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension.</strong> The bank gives no complete annual-equivalent example with both salvage and maintenance. Let C be initial capital cost, S the estimated net salvage receipt at the end of n years and i the consistent effective annual discount rate. Their present cost is C − S(P/F), so equivalent annual capital recovery is <strong>CR = C(A/P) − S(A/F)</strong>.</p><p>Using CRF = i + SFF gives two useful checks: <strong>CR = (C − S)CRF + iS = iC + (C − S)SFF</strong>. These equivalent expressions are not straight-line accounting depreciation. </p><p><strong>Hypothetical example:</strong> C = Rs10,000, S = Rs1,000, n = 5 years, i = 10% and end-year maintenance Rs400. CRF = 0.263797481 and SFF = 0.163797481. Capital recovery is <strong>Rs2,474.18/year</strong>, and total annual equivalent cost is <strong>Rs2,874.18/year</strong>, calculated before rounding. Straight-line depreciation for the same cost and residual assumptions would be only Rs1,800/year.</p>",
                    moreHtml: "<p>They include the time value of the capital tied up. Add annual operating or maintenance cost separately when calculating total equivalent annual cost.</p><p>Salvage must be placed at its actual date and net of relevant disposal costs. A negative terminal value represents a liability rather than a receipt. None of these hypothetical prices, lives or rates is a Nepal-prescribed allowance.</p>",
                    sources: []
                },
                {
                    id: "econ-three-year-npv-worked",
                    title: "A complete three-year NPV calculation with a stated time origin",
                    html: "<p><strong>Syllabus extension — the entire example is hypothetical.</strong> No assigned question gives an NPV timeline. Pay Rs120,000 at t = 0 and receive net operating cash of Rs50,000 at each year-end for three years. Assume no taxes, financing flows, further investment or terminal proceeds. All amounts are constant-price rupees and the effective real annual MARR is 10%.</p><p>Net present value is <strong>NPV(i) = Σ CF<sub>t</sub>/(1 + i)<sup>t</sup></strong>, including t = 0. The initial payment is not discounted another year. The following money values are displayed to two decimals, but totals use unrounded calculations.</p><table><thead><tr><th scope='col'>Year</th><th scope='col'>Net CF, Rs</th><th scope='col'>Present value, Rs</th><th scope='col'>Cumulative PV, Rs</th></tr></thead><tbody><tr><th scope='row'>0</th><td>−120,000</td><td>−120,000.00</td><td>−120,000.00</td></tr><tr><th scope='row'>1</th><td>50,000</td><td>45,454.55</td><td>−74,545.45</td></tr><tr><th scope='row'>2</th><td>50,000</td><td>41,322.31</td><td>−33,223.14</td></tr><tr><th scope='row'>3</th><td>50,000</td><td>37,565.74</td><td>4,342.60</td></tr></tbody></table><p>Thus <strong>NPV = −120000 + 50000(2.486851991) = Rs4,342.60</strong>. Positive NPV means the modelled receipts recover investment and the stipulated time-value requirement, with this additional present-worth surplus. It is not total accounting profit or cash held in a bank account at year three.</p>",
                    moreHtml: "<p>For an independent discretionary project, positive NPV supports acceptance on the quantified assumptions. Feasibility, excluded effects and competing uses of resources still require review. Zero NPV means exactly meeting the selected hurdle, not receiving no return.</p>",
                    sources: []
                },
                {
                    id: "econ-discounted-payback-worked",
                    title: "Discounted payback: distinguish a year-end result from interpolation",
                    html: "<p><strong>Syllabus extension — hypothetical continuation of the three-year example.</strong> The bank supplies no discounted-payback dataset. Retain Rs120,000 invested now, Rs50,000 received at each of three year-ends and effective real annual discounting at 10%. Discounted payback is the first time cumulative discounted receipts recover the initial outlay.</p><p>After year two, the unrecovered present amount is <strong>Rs33,223.1404959</strong>. The year-three receipt has present value <strong>Rs37,565.7400451</strong>. Under the stated <strong>strict year-end payment dates, recovery first occurs at year 3</strong>, because no receipt is available earlier in that year.</p><p>A common fractional estimate spreads the year-three discounted recovery evenly through the year: <strong>DPP ≈ 2 + 33223.1404959/37565.7400451 = 2.8844 years</strong>. This is an explicitly added interpolation assumption, not the exact payback date of the original lump-sum timeline or an exact continuous-discounting calculation.</p><p>With similarly interpolated undiscounted receipts, simple payback would be 120000/50000 = 2.4 years. Discounting delays recovery here because later receipts are worth less at the initial date. </p>",
                    moreHtml: "<p>If cumulative discounted cash never reaches zero during the study period, report no discounted payback within that period. Payback ignores later gains and liabilities after recovery and therefore cannot replace NPV for comparing whole-life economic value.</p>",
                    sources: []
                },
                {
                    id: "econ-irr-solution-and-marr-check",
                    title: "Solve IRR as the rate that makes the same cash flow's NPV zero",
                    html: "<p><strong>Syllabus extension — hypothetical continuation.</strong> The assigned bank gives no IRR calculation. For the same initial Rs120,000 payment and three end-year Rs50,000 receipts, internal rate of return r satisfies <strong>0 = −120000 + 50000/(1 + r) + 50000/(1 + r)<sup>2</sup> + 50000/(1 + r)<sup>3</sup></strong>. A rate is a fraction in the equation, not its percentage number.</p><p>At r = 0.12, NPV is <strong>+Rs91.5634</strong>; at r = 0.13 it is <strong>−Rs1,942.3701</strong>. Therefore a root lies between 12% and 13%. Linear interpolation gives about 12.0450%, but the NPV curve is not exactly straight. Iteratively narrowing the bracket gives <strong>r = 0.120443983, or IRR ≈ 12.0444%</strong>.</p><p>This conventional pattern has an initial outflow followed only by positive receipts. Its NPV decreases as the discount rate increases, so the relevant root is unique. Since its IRR exceeds the hypothetical 10% real MARR, it also has positive NPV at that MARR, consistent with the worked NPV result.</p>",
                    moreHtml: "<p>IRR is calculated from the cash flow, whereas MARR is the selected acceptance requirement. They are not names for the same input. Compare them on the same period, price and tax basis; a monthly or after-tax IRR cannot be compared directly with an incompatible annual or before-tax hurdle.</p>",
                    sources: []
                },
                {
                    id: "econ-multiple-irr-and-npv-profile",
                    title: "A cash flow can have more than one IRR, so inspect the NPV profile",
                    html: "<p><strong>Syllabus extension — hypothetical nonconventional cash flow.</strong> The bank has no multiple-IRR example. Consider −Rs100 now, +Rs230 after one year and −Rs132 after two years, perhaps representing a terminal liability. There are two changes of sign, so the simple conventional-investment acceptance rule cannot be assumed.</p><p>The root equation is <strong>−100 + 230/(1 + r) − 132/(1 + r)<sup>2</sup> = 0</strong>. Multiplying by (1 + r)<sup>2</sup> and setting x = 1 + r gives <strong>100x<sup>2</sup> − 230x + 132 = 0</strong>. Its roots are x = 1.1 and 1.2, producing <strong>IRRs of 10% and 20%</strong>.</p><p>At a hypothetical 15% MARR, NPV is <strong>+Rs0.189036</strong>; at 25% it is <strong>−Rs0.48</strong>. Reporting only the larger IRR conceals the non-monotonic NPV behaviour and can mislead an acceptance decision. Evaluate NPV at the appropriate hurdle instead of selecting whichever root looks favourable.</p>",
                    moreHtml: "<p>Multiple sign changes permit but do not guarantee multiple economically relevant roots; some patterns have no useful positive IRR. A spreadsheet's starting guess can locate one root and miss another. Check the dates, signs and NPV profile, especially when rehabilitation, decommissioning or other late outflows occur. IRR ranking is also unreliable for mutually exclusive alternatives of different scale or timing.</p>",
                    sources: []
                },
                {
                    id: "econ-marr-and-incremental-alternatives",
                    title: "MARR is a decision requirement; compare the extra investment incrementally",
                    html: "<p><strong>Syllabus extension.</strong> The bank's maximum-B/C item does not supply a MARR or competing cash-flow timelines. The minimum attractive rate of return is the hurdle selected for the decision, reflecting the relevant opportunity cost and analysis basis. </p><p>For alternatives A and B, form <strong>ΔCF<sub>t</sub> = CF<sub>B,t</sub> − CF<sub>A,t</sub></strong>. At the common MARR, <strong>ΔNPV = NPV<sub>B</sub> − NPV<sub>A</sub></strong>. A positive increment supports B over A on the quantified basis. </p>",
                    moreHtml: "<p>It is not automatically the bank lending rate, the project's IRR or a legally prescribed universal percentage.</p><p>For independent projects without a binding capital constraint, each positive-NPV opportunity may be considered. Mutually exclusive alternatives cannot all be implemented: compare their complete cash flows over a common service basis and study period. Include the feasible do-minimum alternative where appropriate. A mandatory service need may require choosing the least-cost feasible option rather than rejecting every option because none earns cash revenue.</p><p>If the incremental pattern is conventional, its IRR may also be compared with MARR; otherwise use incremental NPV directly.</p><p>Ranking individual IRRs or ratios ignores scale and can reject a worthwhile additional investment. Capital rationing, incompatible project bundles and different constraints require their own selection analysis. State those constraints rather than disguising them as a general highest-ratio rule.</p>",
                    sources: []
                },
                {
                    ...
                    html: "<p>For a defined perspective and common discount basis, <strong>B/C = present value of benefits / present value of costs</strong>. With positive cost denominator, B/C above one corresponds to positive net present benefit for that particular option. It does not establish that the option is best among mutually exclusive investments.</p><table><thead><tr><th scope='col'>Option</th><th scope='col'>PV cost</th><th scope='col'>PV benefit</th><th scope='col'>B/C</th><th scope='col'>Net PV</th></tr></thead><tbody><tr><th scope='row'>A</th><td>100</td><td>150</td><td>1.50</td><td>50</td></tr><tr><th scope='row'>B</th><td>200</td><td>280</td><td>1.40</td><td>80</td></tr></tbody></table><p>B has the lower individual ratio but the higher net benefit. Its extra cost is 100 and extra benefit 130, so <strong>incremental B/C = 1.30</strong> and <strong>incremental net PV = 30</strong>. Without another binding constraint, the extra investment is justified and B is preferred.</p>",
                    moreHtml: "<p><strong>Syllabus extension — hypothetical counterexample:</strong> the linked lining question supplies no alternative data. Suppose A and B are feasible, mutually exclusive designs over the same horizon. The following are already-discounted values in Rs thousands at the same selected MARR.</p><p>The bank's maximum-B/C statement can express a simplified efficiency idea, but is not a universal alternative-selection rule. Define whether savings are benefits or reductions in cost consistently; moving the same item between numerator and denominator can change a ratio while leaving net benefit unchanged. Social resource benefits and owner cash receipts must not be mixed.</p>",
                ...
                },
                {
                    ...
                    html: "<p>The bank states Rs40/m<sup>2</sup> initial lining cost, water saving 3 cumecs per million m<sup>2</sup>, crop value Rs300,000 per cumec, life 40 years, maintenance 12 paisa/m<sup>2</sup> and annual interest 6%. It does <strong>not specify the crop-value period or explicitly date maintenance</strong>. A cumec is a flow rate, not an annual water volume.</p><p><strong>Conditional annual interpretation:</strong> if Rs300,000 is benefit per cumec per year and maintenance is annual, the stated benefit per lining area is <strong>B = (3/1000000) × 300000 = Rs0.90/m<sup>2</sup>/year</strong>. This annual meaning is an assumption, not information recovered from the stem.</p><p>With an additional <strong>hypothetical zero-salvage assumption</strong>, CRF at i = 0.06, n = 40 is <strong>0.0664615359</strong>. Annualized cost is <strong>40 × CRF + 0.12 = Rs2.77846144/m<sup>2</sup>/year</strong>. Hence <strong>B/C = 0.90/2.77846144 = 0.323920</strong>, not the stored 1.2. None of the offered ratios matches this conditional calculation.</p><p>For uniform lined perimeter 20 m and length ℓ, lining area is 20ℓ m<sup>2</sup>. Multiplying both benefit and cost by 20ℓ cancels it from the ratio; an invented canal length cannot repair the mismatch. </p>",
                    moreHtml: "<p>A seasonal crop value, different maintenance period, nonzero salvage or additional cultivation costs needs an explicit revised cash flow. Preserve the bank and report the unresolved interpretation instead of choosing a wrong nearest option.</p>",
                ...
                },
                {
                    ...
                    html: "<p>Life-cycle cost analysis compares the discounted costs of technically feasible alternatives providing a comparable service. A cheaper initial pavement can be more expensive after maintenance, rehabilitation and work-zone effects are included. A cost-only comparison is insufficient if alternatives deliver materially different benefits.</p><p><strong>Syllabus extension:</strong> no assigned LCCA item supplies a dated cost schedule. With positive costs C<sub>t</sub> and an end-horizon residual receipt R<sub>N</sub>, one consistent expression is <strong>LCC = Σ C<sub>t</sub>/(1 + i)<sup>t</sup> − R<sub>N</sub>/(1 + i)<sup>N</sup></strong>. </p>",
                    moreHtml: "<p>The inspected FHWA explanation first identifies alternative strategies, then their construction, maintenance and rehabilitation activities and timing, and then estimates activity costs. Agency and relevant user costs form an expenditure stream for each alternative. Discount those streams, compare results and revisit assumptions or strategies where needed.</p><p>Thus cost estimation follows strategy development in the broad sequence, but <strong>activity identification and timing intervene</strong>. The bank's shortened next-step wording should not be memorized as a universal process that jumps directly from a design label to a meaningful cost total. Estimation and design also inform each other iteratively.</p><p>State the price base, analysis horizon, residual basis and included user costs. The FHWA source is foreign methodological guidance, not a Nepal discount-rate requirement or authority to treat user costs as contractor cash expenditure.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>Let C be recognized asset cost, S estimated residual value and n useful life in years. Under straight-line allocation with unchanged estimates, <strong>annual depreciation D = (C − S)/n</strong>. After t full years, accumulated depreciation is tD and simplified <strong>book value BV<sub>t</sub> = C − tD</strong>. The bank's definition assumes a cost model without additional revaluation or impairment adjustments.</p><p><strong>Syllabus extension — hypothetical carrying-value example:</strong> the formula and definition questions give no numerical schedule. Take C = Rs10,000, S = Rs1,000 and n = 5 years. Then D = <strong>Rs1,800/year</strong>, book value after year one is <strong>Rs8,200</strong>, after year two <strong>Rs6,400</strong>, and after year five <strong>Rs1,000</strong>. The residual is not depreciated under these stated assumptions.</p>",
                    moreHtml: "<p>Book value records an accounting carrying amount; market value is what a relevant transaction or valuation would establish. They need not coincide. Residual or salvage is an estimate at the end of the chosen service life, not automatically the current selling price.</p><p>Depreciation expense is <strong>not a fresh cash payment each year</strong>. Initial asset purchase is a cash outflow; subsequent allocation avoids charging that entire cost as an annual operating expense repeatedly. Tax depreciation may follow a different statutory basis and affects cash only through the tax consequences actually realized.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension — hypothetical comparison, not extra bank data.</strong> Reuse C = Rs10,000, S = Rs1,000 and n = 5 years. For the sinking-fund convention, assume a 10% effective annual fund return and equal end-year deposits. The deposit is <strong>A = 9000(A/F, 10%, 5) = Rs1,474.177327/year</strong>.</p><p>The accumulated fund is <strong>F<sub>t</sub> = A[(1.1)<sup>t</sup> − 1]/0.10</strong>. If the valuation convention takes that accumulation as accumulated depreciation, <strong>BV<sub>t</sub> = C − F<sub>t</sub></strong>. Year two's fund is Rs3,095.772387; its increase is Rs1,621.595060, greater than the deposit because the first deposit earns interest.</p><table><thead><tr><th scope='col'>Year</th><th scope='col'>Straight-line BV, Rs</th><th scope='col'>Constant-% BV, Rs</th><th scope='col'>Sinking BV, Rs</th></tr></thead><tbody><tr><th scope='row'>0</th><td>10,000.00</td><td>10,000.00</td><td>10,000.00</td></tr><tr><th scope='row'>1</th><td>8,200.00</td><td>6,309.57</td><td>8,525.82</td></tr><tr><th scope='row'>2</th><td>6,400.00</td><td>3,981.07</td><td>6,904.23</td></tr><tr><th scope='row'>3</th><td>4,600.00</td><td>2,511.89</td><td>5,120.47</td></tr><tr><th scope='row'>4</th><td>2,800.00</td><td>1,584.89</td><td>3,158.34</td></tr><tr><th scope='row'>5</th><td>1,000.00</td><td>1,000.00</td><td>1,000.00</td></tr></tbody></table><p>Constant percentage uses the calibrated 36.904266% rate, not the fund's 10%. All methods reach the stipulated residual, but their intermediate values differ. The sinking fund reaches Rs9,000 at year five only if the hypothetical deposits and returns actually occur. </p>",
                    moreHtml: "<p>A book-value schedule alone does not establish that cash has been invested. This valuation convention is not asserted as Nepal's statutory tax method or a mandatory financial-reporting policy.</p>",
                    sources: [
            ...
            cautions: [
                ...
                {
                    "id": "check-irri951-00161",
                    "status": "review",
                    "prompt": "The most economical type of lining is the one which shows ______.",
                ...
                {
                    "id": "check-tran808-00283",
                    "status": "review",
                    "prompt": "Which method is used to determine the most cost-effective design and construction procedure?",
                    "html": "<p><strong>Life-cycle cost analysis compares alternatives providing comparable service.</strong> Define activities and timing before estimating and discounting costs. Agency expenditures and user costs are separate components, not interchangeable accounting totals.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00283",
                            "set": 26,
                ...
                {
                    "id": "check-tran808-00285",
                    "status": "review",
                    "prompt": "What step comes after the initial strategy is decided in the life cycle cost analysis method?",
                    "html": "<p><strong>LCCA scope and sequence:</strong> cost comparison assumes comparable service. </p><p>The inspected FHWA workflow identifies activities and their timing after alternative strategies and before cost estimation. </p><p>The bank's broad next-step answer does not remove that intermediate work or make one abbreviated sequence universal. </p><p>Separate agency cash expenditures from user costs.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00285",
                            "set": 27,
                ...
                {
                    "id": "check-basi674-00405",
                    "status": "review",
                    "prompt": "Which of the following is the most accurate method for calculating obsolescence?",
                ...
                {
                    "id": "check-basi674-00408",
                    "status": "review",
                    "prompt": "A building has been purchased by a person at a cost of Rs. 25000. The useful life of the building is 40 years and the scrap value of the building is Rs. 3000. Calculate the annual sinking fund (Rs.) at the rate of 5% interest.",
                ...
                {
                    "id": "check-basi674-00409",
                    "status": "review",
                    "prompt": "Deerepitude is a type of",
                ...
                {
                    "id": "check-basi674-00411",
                    "status": "review",
                    "prompt": "Using straight line method annual",
                    "html": "<p><strong>Allocation versus value and cash:</strong> straight-line annual depreciation is (cost − residual)/life under the stated allocation model. </p><p>The annual expense is not another payment of the original capital cost, and it is not automatically the Nepal tax deduction.</p>",
                    "sources": [
                        {
                            "id": "BASI674-00411",
                            "set": 32,
                ...
                {
                    "id": "check-basi674-00414",
                    "status": "review",
                    "prompt": "The value of the property during its useful life based on subtraction of original cost and depreciation etc. is known",
                    "html": "<p>Simplified book value is cost less accumulated depreciation, not automatically current market value. </p>",
                    "sources": [
                        {
                            "id": "BASI674-00414",
                            "set": 32,
