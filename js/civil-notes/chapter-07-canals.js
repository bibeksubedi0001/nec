(function () {
    ...
    Object.assign(registry, {
        ACiE0702: {
            ...
            blocks: [
                {
                    ...
                    html: "<p>A canal network conveys water from an intake through progressively smaller distribution channels to the fields. A typical hierarchy is main canal, branch canal, distributary, minor and watercourse, although local naming and administrative boundaries vary. Identify where water enters, where it is divided and which land each reach serves before assigning a label.</p><table><thead><tr><th scope='col'>Functional description</th><th scope='col'>Meaning and limitation</th></tr></thead><tbody><tr><th scope='row'>Feeder canal</th><td>Primarily supplies another canal, reservoir or distribution system; direct irrigation is not its defining function.</td></tr><tr><th scope='row'>Carrier canal</th><td>Both supplies downstream canals and serves irrigation along its course.</td></tr><tr><th scope='row'>Watercourse or field channel</th><td>Carries irrigation water from an outlet towards individual fields. Farmer maintenance does not remove it from the irrigation system.</td></tr><tr><th scope='row'>Navigation canal</th><td>Provides a navigable waterway. Relatively small current velocities generally assist vessel operation; required depth, bank protection and operating controls remain separate considerations.</td></tr></tbody></table>",
                    moreHtml: "<p>FAO's irrigation-system description explicitly includes field ditches in distribution. Responsibility for maintaining them may lie with farmers or a water-user organization under the applicable arrangements, rather than with the agency maintaining the main canal. <strong>Ownership, maintenance responsibility and hydraulic purpose are different classifications.</strong></p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>A canal may simultaneously be a lined carrier canal, follow a contour alignment and operate under a perennial supply scheme. These terms answer different questions. Do not infer the material, route, ownership or actual annual delivery schedule from one classification alone.</p><table><thead><tr><th scope='col'>Term</th><th scope='col'>Useful interpretation</th></tr></thead><tbody><tr><th scope='row'>Perennial supply</th><td>A system intended to obtain a sustained or regulated supply rather than only high-stage flood diversions. Actual availability still depends on the source, allocations, storage and operating schedule.</td></tr><tr><th scope='row'>Inundation canal</th><td>The conventional textbook arrangement takes water when river stage is sufficiently high, without permanent diversion headworks maintaining the required head. Ancillary controls do not by themselves make the source perennial.</td></tr><tr><th scope='row'>Permanent canal</th><td>In the bank's usual contrast, a developed system with permanent regulation and distribution works. Permanent infrastructure is not a promise of uninterrupted year-round flow.</td></tr><tr><th scope='row'>Productive or protective</th><td>Historical economic and service-purpose labels: revenue recovery under an identified appraisal convention versus protection against agricultural scarcity. They do not describe channel geometry.</td></tr></tbody></table>",
                    moreHtml: "<p>Ice- or glacier-fed rivers can contribute sustained flows, but melt, rainfall and baseflow vary seasonally. Neither that source label nor the mere presence or absence of a regulator proves that every monthly irrigation requirement can be met. Similarly, covering running costs alone is not a universal economic definition of a productive project; the chosen convention may include capital-related charges.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>Alignment affects the number of natural drainage paths intercepted, the land served and the difference between available ground fall and acceptable canal fall. The following are terrain-based tendencies, not guarantees applicable to every route.</p><table><thead><tr><th scope='col'>Alignment</th><th scope='col'>Drainage and longitudinal-grade implications</th></tr></thead><tbody><tr><th scope='row'>Ridge</th><td>Ideally separates catchments and avoids their drains. Departures from the divide, saddles and local works still need examination.</td></tr><tr><th scope='row'>Contour</th><td>Tracks the hillside contour pattern while retaining the necessary canal grade; it is not an exact level contour. Downslope streams commonly cross its route, often creating several cross-drainage sites.</td></tr><tr><th scope='row'>Side-slope</th><td>Runs approximately down the general slope, crossing contours and potentially running parallel to natural drainage. Cross-drainage works may be avoided where that geometry holds, while excess ground fall may require controlled drops.</td></tr></tbody></table>",
                    moreHtml: "<p>The crossing type follows relative canal and drain levels, flood conditions, clearance and hydraulic losses. An <strong>aqueduct</strong> carries canal water above a drain; in a siphon aqueduct the drain passes below under pressure. An <strong>inverted canal siphon</strong> carries canal flow through a depressed pressure conduit beneath an obstruction. These arrangements are not synonyms, and a contour alignment does not automatically select one of them.</p><p>FAO describes separate open flumes, culverts and inverted siphons because their hydraulic arrangements differ. A preliminary count of crossings is useful for route comparison, but final selection needs the surveyed levels and relevant canal and drainage discharges.</p>",
                    sources: [
                        { id: "IRRI951-00138", set: 14, question: 72 },
                ...
                },
                {
                    ...
                    html: "<p>For a symmetrical trapezoid, define b as internal bed width, y as vertical water depth and <strong>z as horizontal distance per unit vertical rise</strong>. Thus 1.5:1 H:V means z = 1.5. Measure dimensions at the water-facing surface of any lining. The longitudinal bed slope is a different quantity from z.</p><table><thead><tr><th scope='col'>Quantity</th><th scope='col'>Expression and SI unit</th></tr></thead><tbody><tr><th scope='row'>Flow area</th><td>A = y(b + zy), in m<sup>2</sup></td></tr><tr><th scope='row'>Wetted perimeter</th><td>P = b + 2y√(1 + z<sup>2</sup>), in m; the free surface is excluded.</td></tr><tr><th scope='row'>Top water width</th><td>T = b + 2zy, in m</td></tr><tr><th scope='row'>Hydraulic radius</th><td>R = A/P, in m; used in resistance equations.</td></tr><tr><th scope='row'>Hydraulic depth</th><td>D<sub>h</sub> = A/T, in m; distinct from R and generally from y.</td></tr><tr><th scope='row'>Continuity</th><td>Q = AV, with mean V in m/s and Q in m<sup>3</sup>/s.</td></tr></tbody></table><p><em>Supplementary geometry example:</em> b = 4 m, y = 2 m and z = 1.5 give A = <strong>14 m<sup>2</sup></strong>, P ≈ <strong>11.211 m</strong> and T = <strong>10 m</strong>. Consequently R ≈ <strong>1.249 m</strong> and D<sub>h</sub> = <strong>1.400 m</strong>, neither equal to the 2 m water depth.</p>",
                    moreHtml: "<p>Freeboard lies above the specified design water level. It is not normally included in A or P when calculating capacity at that level. A quoted total depth must therefore be separated into water depth and the stated allowance before applying Manning's equation.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension: none of these 52 assigned records directly supplies a Kennedy calculation.</strong> The following method and illustration cover the explicitly listed official syllabus topic without attaching an invented bank citation.</p><p>In the customary metre-second empirical form, <strong>V<sub>K</sub> = 0.55m<sub>K</sub>y<sup>0.64</sup></strong>, where V<sub>K</sub> is the adopted non-silting/non-scouring mean velocity in m/s, y is water depth in metres and m<sub>K</sub> is the dimensionless critical-velocity ratio. Kennedy related sediment suspension to bed-generated turbulence. The multiplier represents sediment-related adjustment from the reference relation; it is neither Manning's n nor Lacey's f.</p><p>The word critical here does <strong>not</strong> mean the open-channel critical-flow condition associated with Froude number one. Nor does the equation alone provide bed width and longitudinal slope. For trial y and an independently justified m<sub>K</sub>, calculate V<sub>K</sub>, then A = Q/V<sub>K</sub>. At a selected stable side slope z, b = A/y − zy; reject a nonpositive width. Obtain R from the actual geometry and reconcile the required friction slope with a suitable resistance relation and the available profile.</p><p><em>Supplementary illustration, not bank data:</em> y = 1 m, m<sub>K</sub> = 1 and Q = 1.10 m<sup>3</sup>/s give V<sub>K</sub> = <strong>0.55 m/s</strong> and A = <strong>2.00 m<sup>2</sup></strong>. Choosing z = 1 gives b = <strong>1.00 m</strong>. </p>",
                    moreHtml: "<p>A justified roughness, slope, sediment assessment and bank-stability check are still needed. The empirical velocity relation is not a complete canal design.</p>",
                    sources: []
                },
                {
                    id: "canal-lacey-silt-factor-and-size",
                    title: "Lacey's factor needs a defined sediment size and unit convention",
                    html: "<p>The bank uses <strong>f = 1.76√d<sub>mm</sub></strong>, where d<sub>mm</sub> is the numerical value of the representative grain diameter in millimetres. Equivalently, write f = 1.76√[d/(1 mm)] to make the normalization explicit. Establish which representative size the selected correlation requires; an effective size D<sub>10</sub>, a median and a mean cannot silently be interchanged.</p><table><thead><tr><th scope='col'>Representative diameter used in this relation</th><th scope='col'>Calculated f</th></tr></thead><tbody><tr><th scope='row'>0.35 mm, supplied bank data</th><td>1.76√0.35 ≈ 1.041230</td></tr><tr><th scope='row'>1.00 mm, supplied bank data</th><td>1.760000</td></tr><tr><th scope='row'>Reference f = 1, inverse calculation</th><td>d = (1/1.76)<sup>2</sup> ≈ 0.322831 mm</td></tr></tbody></table><p>The historical word silt in the factor's name does not classify a particle as geotechnical silt. The correct f = 1.76 result for 1 mm therefore does not make that diameter the conventional f = 1 reference material or establish a modern soil-classification boundary.</p>",
                    moreHtml: "<p>Lacey's f is an <strong>empirically calibrated sediment parameter</strong>. Although tabulated as a bare numerical factor in this convention, it is not a universal dimensionless physical invariant independent of the adopted empirical units and calibration. The constants must change if the underlying numerical unit convention changes. It is also not sediment concentration, Manning roughness or a Darcy friction factor.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>The following are the specific rounded empirical forms used to check the supplied bank calculations. Use <strong>Q in m<sup>3</sup>/s</strong>, f from the stated millimetre convention, P in metres, V in m/s and dimensionless longitudinal slope S. They are not unit-free identities or automatic design rules for lined and non-alluvial channels.</p><table><thead><tr><th scope='col'>Estimated quantity</th><th scope='col'>Bank formula</th></tr></thead><tbody><tr><th scope='row'>Regime wetted perimeter</th><td>P = 4.75√Q</td></tr><tr><th scope='row'>Regime mean velocity</th><td>V = (Qf<sup>2</sup>/140)<sup>1/6</sup></td></tr><tr><th scope='row'>Regime longitudinal slope</th><td>S = f<sup>5/3</sup> / (3340Q<sup>1/6</sup>)</td></tr></tbody></table><p>An additional commonly used rounded estimate, <strong>R ≈ 0.47(Q/f)<sup>1/3</sup></strong>, supplies useful syllabus context; it is not explicitly worked in these 52 records. The archived unlined-canal standard discusses regime radius and perimeter estimates, but damaged OCR exponents are not used to redefine the clearly stated bank formula forms above.</p><p>Choose a consistent design procedure, then enforce <strong>Q = AV, R = A/P</strong> and the actual section geometry. For example, using estimated V and P gives A = Q/V and the corresponding geometric R = A/P. </p>",
                    moreHtml: "<p>Do not additionally force a separately rounded R estimate, every velocity relation and every perimeter relation to hold exactly: rounding and empirical fitting can make the system overdetermined.</p><p>Side slopes require independent stability justification. A small discrepancy between rounded empirical estimates is not permission to alter sediment size or mix coefficients merely to reproduce an answer option.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>When the known flow quantity is discharge per unit width, use <strong>q in m<sup>3</sup>/s per metre</strong>, equivalently m<sup>2</sup>/s, rather than total Q. The bank's normal-scour estimate is <strong>d<sub>n</sub> = 1.35(q<sup>2</sup>/f)<sup>1/3</sup></strong>, with its stated empirical metre-second convention.</p><p>For the supplied q = 3 and f = 1.2, q<sup>2</sup>/f = 7.5 and d<sub>n</sub> = 1.35 × 7.5<sup>1/3</sup> = <strong>2.642536 m</strong>. This agrees with 2.64 m. </p><p>The other bank calculation uses P = 4.75√Q. <strong>Only if the intended discharge is 3600 m<sup>3</sup>/s</strong>, √Q = 60 and P = <strong>285 m</strong>. </p><p>P is a <strong>wetted perimeter</strong>, not universally the actual bridge opening or canal bed width. In a very wide alluvial section, a perimeter-based estimate may approximate a preliminary waterway width. Bridge approval additionally needs flood hydraulics, afflux, obstructions, local scour, foundation and other design checks. The 285 m arithmetic does not supply those checks.</p>",
                    moreHtml: "<p>Interpret it as depth <strong>from the relevant water surface to the estimated scoured bed</strong>, not extra erosion below an unspecified existing bed. Existing bed and water-level datums are needed to find additional lowering. Local scour at bends, piers or constrictions needs separate assessment; no local amplification factor is implied here.</p><p>The printed ounces is not a usable discharge unit. Even fluid ounces would require an identified volume convention and a time basis; they cannot be silently read as cumecs.</p>",
                    sources: [
                        { id: "IRRI951-00035", set: 5, question: 69 },
                ...
                },
                {
                    ...
                    html: "<p>For a small-slope, steady uniform reach of length L, the downslope water-weight component is approximately γALS<sub>0</sub>. Balancing it against the integrated boundary resistance gives <strong>τ<sub>avg</sub>PL = γALS<sub>0</sub></strong>, neglecting surface wind shear. Therefore <strong>τ<sub>avg</sub> = γRS<sub>f</sub></strong>, with S<sub>f</sub> = S<sub>0</sub> for this uniform reach and R = A/P.</p><p>This is an average over the wetted boundary. <strong>Uniform flow does not imply uniform stress on the bed and banks.</strong> Section shape and sidewall effects alter the distribution; bends and local disturbances can increase particular demands. For a sufficiently wide channel, the bed approximation becomes <strong>τ<sub>bed</sub> ≈ γyS<sub>0</sub></strong>. Substituting y for R without the wide-channel assumption is not generally valid.</p><p><strong>Actual bank data:</strong> y = 2.0 m, S<sub>0</sub> = 1/10000 and γ = 9810 N/m<sup>3</sup> give τ<sub>bed</sub> ≈ 9810 × 2 × 0.0001 = <strong>1.962 N/m<sup>2</sup></strong>, or 1.962 Pa. This is approximately <strong>0.200 kgf/m<sup>2</sup></strong>, using about 9.81 N per kgf. It is not 1.962 kg/m<sup>2</sup>; mass per area is not stress.</p>",
                    moreHtml: "<p>At the stipulated limiting slope, this is the implied limiting bed demand in the wide-channel model. To establish a permissible material stress independently, obtain appropriate erosion-resistance data and safety allowances. Silt-free water does not make the soil erosion-proof or provide the missing soil-property tests.</p>",
                ...
                },
                {
                    ...
                    html: "<p>A loose grain on an inclined bank already experiences a downslope component of its submerged weight. Part of its frictional resistance is therefore committed to resisting gravity before flowing water adds a tractive demand. This is why the permissible hydraulic stress on a granular side slope is lower than for the corresponding horizontal bed material.</p><p>For the idealized noncohesive-grain model, <strong>K<sub>τ</sub> = τ<sub>allow,side</sub>/τ<sub>allow,level bed</sub> = √[1 − sin<sup>2</sup>θ/sin<sup>2</sup>φ]</strong>. Here θ is the bank angle measured from horizontal and φ is the angle of repose used by the model. The square-root expression requires θ &lt; φ for positive remaining resistance.</p><p>Using the supplied θ = 30° and φ = 36°, sin<sup>2</sup>θ = 0.25 and sin<sup>2</sup>φ ≈ 0.3454915. Hence <strong>K<sub>τ</sub> = 0.525731</strong>, agreeing with the current rounded value 0.53. The limiting cases are informative: K<sub>τ</sub> = 1 on a level surface and tends to zero as θ approaches φ.</p>",
                    moreHtml: "<p>This is an <strong>allowable-stress ratio, not the ratio of actual applied wall and bed stresses</strong>. Determine applied side and bed stresses separately and compare each with its appropriate resistance. The formula contains no cohesion, vegetation, armouring or lining-strength term; it must not be applied unchanged to cohesive banks or structural linings.</p>",
                ...
                },
                {
                    ...
                    html: "<p>Hydraulic economy minimizes wetted perimeter for a required flow area, thereby maximizing R when roughness and slope are fixed. It is a geometric optimization, not automatically the minimum cost of excavation, lining, land, maintenance and bank stabilization.</p><p>At fixed area A and side slope z, substitute b = A/y − zy into the perimeter: <strong>P = A/y + [2√(1 + z<sup>2</sup>) − z]y</strong>. Setting its derivative with respect to y to zero gives A = [2√(1 + z<sup>2</sup>) − z]y<sup>2</sup>. Consequently the best trapezoid <strong>for that fixed z</strong> has <strong>b = 2y[√(1 + z<sup>2</sup>) − z]</strong> and <strong>R = y/2</strong>.</p><p>Only if z is also free to vary does minimizing 2√(1 + z<sup>2</sup>) − z give <strong>z = 1/√3</strong>. The sides then make 60° with the horizontal and the section is a half-regular-hexagon. The bank's assumed <strong>z = 1.5 is not that half-hexagon</strong>, although a best section can still be calculated with z held at 1.5.</p>",
                    moreHtml: "<p>In practice, soil stability, lining support and available land often fix or constrain z before hydraulic sizing. Do not steepen an unsupported soil bank merely to attain the unconstrained mathematical optimum.</p>",
                ...
                },
                {
                    ...
                    html: "<p>Use the actual supplied Q = <strong>400 m<sup>3</sup>/s</strong>, z = <strong>1</strong>, n = <strong>0.012</strong>, S<sub>f</sub> = <strong>1/6000</strong> under uniform flow, and the problem's velocity limit of <strong>3 m/s</strong>. Continuity alone requires A ≥ Q/3 = <strong>133.333333 m<sup>2</sup></strong>. That is necessary but not sufficient: the same section must also convey Q under the stated resistance and slope.</p><table><thead><tr><th scope='col'>Offered b; assumed water y, in m</th><th scope='col'>A = y(b + y), m<sup>2</sup></th><th scope='col'>Necessary area check</th></tr></thead><tbody><tr><th scope='row'>15.0; 6.30</th><td>134.1900</td><td>Passes area alone; Manning capacity is only about 369 m<sup>3</sup>/s.</td></tr><tr><th scope='row'>14.2; 6.28</th><td>128.6144</td><td>Insufficient at the 3 m/s cap.</td></tr><tr><th scope='row'>14.0; 6.50</th><td>133.2500</td><td>Still below 133.333333.</td></tr><tr><th scope='row'>14.4; 6.25</th><td>129.0625</td><td>Insufficient at the 3 m/s cap.</td></tr></tbody></table><p>For the keyed b = 14.2 m, y = 6.28 m pair, calculate P = 14.2 + 2 × 6.28√2 and R = 128.6144/P. Manning gives <strong>V = 2.721712 m/s</strong> and <strong>Q = 350.051352 m<sup>3</sup>/s</strong>. Forcing 400 through its area would instead require <strong>3.110072 m/s</strong>, above the cap. Thus <strong>none of the four options satisfies all the supplied conditions</strong>.</p><p><em>Conditional alternative, not selection of an offered option:</em> holding b = 14.2 m and solving the Manning discharge equation for y gives <strong>y = 6.759075 m</strong> and <strong>V = 2.823584 m/s</strong>, with freeboard specified separately. The velocity limit is an inequality, not an instruction to force V = 3 or a criterion that uniquely fixes b and y.</p><p>This alternative is only a hydraulic example under the question's 3 m/s limit. Its velocity exceeds the separately cited 2.7 m/s concrete guidance; if that guidance governs the project, further redesign is required. Neither the example nor the failed options establish lining or bank safety.</p>",
                    moreHtml: "<p>For a generous upper-bound check, temporarily treat each offered <em>total</em> depth as entirely water depth. Any positive freeboard would reduce the available flow area and Manning capacity further.</p>",
                ...
                },
                {
                    ...
                    html: "<p>A design value of n needs a surface finish, condition, alignment and operating context. Smooth new concrete, rough formed concrete and an aged repaired lining need not have the same resistance. Sediment deposits, weeds, joints and irregularities can change the effective value, and bends introduce additional losses.</p><table><thead><tr><th scope='col'>Evidence or assumption</th><th scope='col'>n and its qualification</th></tr></thead><tbody><tr><th scope='row'>Supplied bank working range</th><td>0.012–0.015; the two numerical design examples separately stipulate 0.012 and 0.015. These are calculation inputs, not proof of every as-built surface.</td></tr><tr><th scope='row'>USBR Water Measurement Manual §2.16</th><td>Concrete examples span 0.011–0.016 as finish becomes rougher. The discussion also cautions against inappropriate use of normal-flow predictions.</td></tr><tr><th scope='row'>IS 10430:2000 Table 1</th><td>0.015–0.018 for concrete with trowel/float finish in the table for straight alignment; the table's condition and ageing notes also matter.</td></tr></tbody></table><p><strong>IS 10430:2000 §8.8.5</strong> lists <strong>2.7 m/s for cement-concrete lining as design guidance</strong>. It is not a universal safe velocity for every concrete, joint, subgrade, bend or sediment load. Select and check the actual material and specification; abrasion, local hydraulic effects and long-term condition may impose other constraints.</p>",
                    moreHtml: "<p>The differences are not resolved by declaring one universal cast-in-situ number. Match the specified or observed surface to the selected reference, use suitable operating-condition allowances and check sensitivity to deterioration. Do not silently replace a supplied example's n to defend an answer option.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>Compare rigid concrete, brick/tile, precast units, stone, soil-cement and protected flexible membranes against the actual seepage, hydraulic, subgrade and maintenance requirements. Availability, transport, access, construction quality, repair interruptions and whole-life cost can matter as much as initial material price. Bed width is only one input.</p><p>The bank's <strong>3 m and 8 m width statements do not establish blanket bans or prerequisites for in-situ concrete</strong>. A small canal can use it where the complete design and economics justify it. The archived IS 10430 selection discussion requires site-specific comparison rather than selection by one width alone.</p><p><strong>Hydraulic efficiency can deteriorate with time.</strong> IS 10430:2000 §4.1.2 recognizes increasing roughness as lining deteriorates. Its §5.1.4 discusses the relative ease of repair or replacement of unit linings, while §4.1.3 gives cement concrete and stone masonry a generally better abrasion-resistance assessment than brick tile. Those observations do not prove that every concrete mix outperforms every tile or that any lining will polish itself into improved efficiency.</p><p>For soil-cement, the bank's <strong>2–8% cement figure is not a universal recipe</strong>. Establish the treatment type, soil grading and chemistry, cement properties, intended mass basis, compaction and required permeability and durability performance. An appropriate dosage must be justified by testing and specification, not transferred unchanged between unlike soils or lining systems.</p>",
                    moreHtml: "<p>A membrane in a stable bed combined with rigid side lining can be one option, but stability must be demonstrated. A seepage barrier is not automatically a scour-resistant exposed surface. Cover stability, puncture resistance, joints, transitions, uplift and access for repairs all affect the suitability of a membrane or combination lining.</p>",
                    sources: [
            ...
            cautions: [
                {
                    "id": "check-irri951-00021",
                    "status": "review",
                    "prompt": "Which type of canal does not need cross drainage structures?",
                    "html": "<p><strong>An ideal ridge alignment avoids natural drain crossings.</strong> That is a terrain model, not a guarantee for every real route. Surveyed drains, saddles, structures and command levels determine the required works.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00021",
                            "set": 1,
                ...
                {
                    "id": "check-irri951-00018",
                    "status": "review",
                    "prompt": "Due to lined channel section",
                    "html": "<p><strong>Greater delivery is not automatic enlargement of GCA:</strong> reduced losses may allow more land to be irrigated within feasible command, while lower n increases capacity only with the other hydraulic conditions held appropriately. </p><p>Lining does not automatically increase section area, eliminate seepage or redraw the command boundary. </p><p>Separate increased conveyance, water saving and actual area served.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00018",
                            "set": 3,
                ...
                {
                    "id": "check-irri951-00020",
                    "status": "review",
                    "prompt": "Aggrading channel is",
                    "html": "<p><strong>Regime is dynamic balance, not no grain motion:</strong> aggradation means silting and bed rise, not the printed sitting. </p>",
                    "sources": [
                        {
                            "id": "IRRI951-00020",
                            "set": 3,
                ...
                {
                    "id": "check-irri951-00025",
                    "status": "review",
                    "prompt": "Which canal is not considered to be used for irrigation?",
                    "html": "<p><strong>A watercourse is an irrigation channel:</strong> it takes water towards the fields even when farmers maintain it. </p>",
                    "sources": [
                        {
                            "id": "IRRI951-00025",
                            "set": 4,
                ...
                {
                    "id": "check-irri951-00029",
                    "status": "review",
                    "prompt": "Which of the following conditions is NOT applicable to a true regime?",
                    "html": "<p>The regime item similarly means silt grade and charge, not silk. </p>",
                    "sources": [
                        {
                            "id": "IRRI951-00029",
                            "set": 4,
                ...
                {
                    "id": "check-irri951-00035",
                    "status": "review",
                    "prompt": "The waterway for a bridge on the river in alluvial plain having a dominant discharge of 3600 ounces should be",
                ...
                {
                    "id": "check-irri951-00038",
                    "status": "review",
                    "prompt": "Lacey scour depth for a stream carrying a discharge of 3 cumecs per meter width having a silt factor 1.2 is",
                ...
                {
                    "id": "check-irri951-00039",
                    "status": "review",
                    "prompt": "If D10 of particle is 2mm with discharge of 2m3/s then longitudinal slope is",
                ...
                {
                    "id": "check-irri951-00040",
                    "status": "review",
                    "prompt": "If Q = 5m³/s and the mean size of sediments is 0.5mm then what is the velocity using Lacey’s formula?",
                ...
                {
                    "id": "check-irri951-00043",
                    "status": "review",
                    "prompt": "What is the value of f if d=1mm?",
                    "html": "<p><strong>Lacey's stated calibration gives f = 1.76 for d = 1 mm.</strong> The conventional f = 1 reference corresponds to about 0.3228 mm, not 1 mm. Diameter units are part of the empirical formula.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00043",
                            "set": 5,
                ...
                {
                    "id": "check-irri951-00044",
                    "status": "review",
                    "prompt": "Lacey silt factor for 0.35 mm diameter particles",
                    "html": "<p><strong>Correct factors, misleading standard-silt label:</strong> f = 1.76 for 1 mm and f ≈ 1.041230 for 0.35 mm are correct in the stated calibration. </p><p>The conventional f = 1 reference corresponds to about 0.322831 mm, not 1 mm. </p><p>The historical parameter name is neither a geotechnical soil classification nor a universal unit-independent physical factor.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00044",
                            "set": 5,
                ...
                {
                    "id": "check-irri951-00045",
                    "status": "review",
                    "prompt": "The tractive force ratio for regime canal with angle of repose 36° and side slope 30° is",
                ...
                {
                    "id": "check-irri951-00127",
                    "status": "review",
                    "prompt": "On flatlands what type of canal alignment is used?",
                    "html": "<p><strong>Flat terrain does not uniquely fix canal alignment.</strong> Command levels, drainage, settlements and route geometry control the choice. Textbook ridge, contour and side-slope tendencies need the actual terrain model.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00127",
                            "set": 13,
                ...
                {
                    "id": "check-irri951-00131",
                    "status": "review",
                    "prompt": "Design a lined canal carrying a discharge of 20 cumecs. The slope is 1 in 7000. Assume suitable values for side slopes and lining.[Given rugosity coefficient as 0.015]",
                ...
                {
                    "id": "check-irri951-00132",
                    "status": "review",
                    "prompt": "Design a lined canal to carry a discharge of 400 cumecs and slope is 1 in 6000. Take side slopes as 1 : 1 and rugosity constant as 0.012. Assume limiting velocity as 3 m/sec.",
                ...
                {
                    "id": "check-irri951-00133",
                    "status": "review",
                    "prompt": "Depending on what factor does the lining of a canal can increase the capacity of the canal?",
                    "html": "<p>Lining does not automatically increase section area, eliminate seepage or redraw the command boundary. </p>",
                    "sources": [
                        {
                            "id": "IRRI951-00133",
                            "set": 13,
                ...
                {
                    "id": "check-irri951-00134",
                    "status": "review",
                    "prompt": "Mathematically, depending on what factor we can say velocity increases the capacity of the canal?",
                    "html": "<p><strong>Greater delivery is not automatic enlargement of GCA:</strong> reduced losses may allow more land to be irrigated within feasible command, while lower n increases capacity only with the other hydraulic conditions held appropriately. </p>",
                    "sources": [
                        {
                            "id": "IRRI951-00134",
                            "set": 13,
                ...
                {
                    "id": "check-irri951-00138",
                    "status": "review",
                    "prompt": "Which of the following combination is not correct?",
                    "html": "<p>This reconciles the bank's inconsistent side-slope explanations without claiming that all irrigation canals follow ridges or that every contour route must have a particular number of crossings. </p>",
                    "sources": [
                        {
                            "id": "IRRI951-00138",
                            "set": 14,
                ...
                {
                    "id": "check-irri951-00139",
                    "status": "review",
                    "prompt": "Which canal is not provided with any headworks for diversion of river water?",
                    "html": "<p><strong>Source and infrastructure labels do not guarantee annual supply:</strong> inundation describes the conventional high-river-stage diversion arrangement, while permanent works and perennial supply answer different questions. </p>",
                    "sources": [
                        {
                            "id": "IRRI951-00139",
                            "set": 14,
                ...
                {
                    "id": "check-irri951-00141",
                    "status": "review",
                    "prompt": "Which one is well traded and is provided with permanent regulation and distribution works?",
                    "html": "<p><strong>Source and infrastructure labels do not guarantee annual supply:</strong> inundation describes the conventional high-river-stage diversion arrangement, while permanent works and perennial supply answer different questions. </p>",
                    "sources": [
                        {
                            "id": "IRRI951-00141",
                ...
                {
                    "id": "check-irri951-00145",
                    "status": "review",
                    "prompt": "Which type of canal is most useful in NMF areas?",
                ...
                {
                    "id": "check-irri951-00146",
                    "status": "review",
                    "prompt": "What type of canal necessitates construction of cross drainage works more than any other types?",
                    "html": "<p><strong>Contour routes commonly intersect natural drainage.</strong> A side-slope route may run parallel to it, while an ideal ridge avoids crossings. Actual surveyed geometry, not the route label alone, determines the number and type of cross-drainage works.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00146",
                            "set": 15,
                ...
                {
                    "id": "check-irri951-00147",
                    "status": "review",
                    "prompt": "Which type of canal is the farmer’s responsibility?",
                    "html": "<p><strong>A watercourse is an irrigation channel:</strong> it takes water towards the fields even when farmers maintain it. </p><p>The bank's exclusion of watercourses confuses administrative responsibility with use. </p><p>The separate farmer-responsibility item is a conventional management description, not evidence that field channels lie outside irrigation.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00147",
                            "set": 15,
                ...
                {
                    "id": "check-irri951-00148",
                    "status": "review",
                    "prompt": "Which type of canal need syphons?",
                ...
                {
                    "id": "check-irri951-00149",
                    "status": "review",
                    "prompt": "If a looping is present in the ridge line they how can that area be irrigated with?",
                ...
                {
                    "id": "check-irri951-00160",
                    "status": "review",
                    "prompt": "What is the safe limiting velocity for cement concrete lining?",
                ...
                {
                    "id": "check-irri951-00162",
                    "status": "review",
                    "prompt": "Which of the following guideline is not recommended for the choice of lining when the bed width of the canal is up to 3 m?",
                    "html": "<p><strong>Width alone does not select the lining:</strong> a bed width up to 3 m is not a blanket prohibition on in-situ concrete, and width greater than 8 m is not an established universal prerequisite. </p><p>The source-specific thresholds lack an identified applicable specification.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00162",
                            "set": 16,
                ...
                {
                    "id": "check-irri951-00163",
                    "status": "review",
                    "prompt": "Which of the following is not a cause for the hydrostatic pressure on the lining?",
                ...
                {
                    "id": "check-irri951-00164",
                    "status": "review",
                    "prompt": "Pressure relief valves may help in ______.",
                    "html": "<p><strong>Relief and drain orientation are conditional:</strong> valves require suitable hydraulic conditions, serviceability and filtered entry to avoid piping; an unusable or submerged outfall can defeat the intended drainage. </p><p>No full drainage layout or capacity is supplied.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00164",
                            "set": 16,
                ...
                {
                    "id": "check-irri951-00165",
                    "status": "review",
                    "prompt": "Pipe drains run ______.",
                    "html": "<p>Longitudinal collectors may receive transverse or side-slope laterals, so the longitudinal description does not apply to every pipe. </p><p>No full drainage layout or capacity is supplied.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00165",
                            "set": 16,
                ...
                {
                    "id": "check-irri951-00166",
                    "status": "review",
                    "prompt": "Which of the following statement is wrong about the requirement of good lining?",
                ...
                {
                    "id": "check-irri951-00167",
                    "status": "review",
                    "prompt": "Which type of lining is adopted when the channels have become stable and no danger’s scouring is expected?",
                    "html": "<p><strong>Width alone does not select the lining:</strong> a bed width up to 3 m is not a blanket prohibition on in-situ concrete, and width greater than 8 m is not an established universal prerequisite. </p><p>A membrane bed with rigid sides is a conditional option for suitably stable and protected conditions, not proof that scour, puncture, uplift and joint checks can be omitted. </p><p>The source-specific thresholds lack an identified applicable specification.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00167",
                            "set": 16,
                ...
                {
                    "id": "check-irri951-00171",
                    "status": "review",
                    "prompt": "What cause is prime responsible for the heavy movement of water from main canal to branch canal?",
                    "html": "<p><strong>Do not reduce an offtake to one slope or one head drop:</strong> branch flow depends on available head, gates, section, submergence and losses, not simply a steeper branch bed. </p><p>Establish actual water and energy levels over the operating range.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00171",
                            "set": 17,
                ...
                {
                    "id": "check-irri951-00172",
                    "status": "review",
                    "prompt": "Lacey’s regime theory is valid for",
                    "html": "<p>Lacey's ideal also needs adjustable alluvial bed and banks; the label unlined alone is insufficient, and varying sediment or water discharge can disturb the balance.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00172",
                            "set": 17,
                ...
                {
                    "id": "check-irri951-00175",
                    "status": "review",
                    "prompt": "What is the range of value of Manning’s coefficient for straight alignment for cast in-situ concrete lining?",
                ...
                {
                    "id": "check-irri951-00176",
                    "status": "review",
                    "prompt": "Which of the following statement is wrong?",
                ...
                {
                    "id": "check-irri951-00177",
                    "status": "review",
                    "prompt": "In soil-cement lining the Portland cement is added to the soil up to the extent of ______",
                ...
                {
                    "id": "check-irri951-00252",
                    "status": "review",
                    "prompt": "Which type of canal requires cross drainage works",
                    "html": "<p><strong>Contour routes commonly intersect natural drainage.</strong> A side-slope route may run parallel to it, while an ideal ridge avoids crossings. Actual surveyed geometry, not the route label alone, determines the number and type of cross-drainage works.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00252",
                ...
                {
                    "id": "check-irri951-00254",
                    "status": "review",
                    "prompt": "Cross drainage works can be avoided in",
                    "html": "<p><strong>An ideal ridge alignment avoids natural drain crossings.</strong> That is a terrain model, not a guarantee for every real route. Surveyed drains, saddles, structures and command levels determine the required works.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00254",
                ...
                {
                    "id": "check-irri951-00255",
                    "status": "review",
                    "prompt": "Cross drainage works can’t be avoided in",
                    "html": "<p><strong>Contour routes commonly intersect natural drainage.</strong> A side-slope route may run parallel to it, while an ideal ridge avoids crossings. Actual surveyed geometry, not the route label alone, determines the number and type of cross-drainage works.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00255",
                ...
                {
                    "id": "check-irri951-00256",
                    "status": "review",
                    "prompt": "Canals taken off from ice fed rivers are",
                    "html": "<p><strong>Ice-fed rivers still vary through time.</strong> Snow and glacier melt, rainfall and seasonal storage affect discharge. A perennial source does not guarantee a constant flow or unlimited irrigation supply.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00256",
                            "set": 25,
                ...
                {
                    "id": "check-irri951-00257",
                    "status": "review",
                    "prompt": "Canals taken off from rivers with or without regulators are",
                    "html": "<p>The phrase with or without regulators does not by itself establish permanent, perennial or non-perennial classification, and an explanation that assumes permanent headworks does not repair that omission.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00257",
                            "set": 25,
                ...
                {
                    "id": "check-irri951-00260",
                    "status": "review",
                    "prompt": "F.S.L. of a canal at its head with respect to parent channel is kept",
                    "html": "<p>The 15 cm difference is not a verified universal head-loss requirement. </p><p>Establish actual water and energy levels over the operating range.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00260",
                            "set": 25,
                ...
                {
                    "id": "check-basi674-00377",
                    "status": "review",
                    "prompt": "Pick up the correct statement from the following.",
                    "html": "<p><strong>Level conditions and earthwork notation matter:</strong> mixed cutting/filling requires the bed below NSL as well as FSL above NSL. </p><p>Use Bd<sub>c</sub> + z<sub>c</sub>d<sub>c</sub><sup>2</sup> with one consistently defined cutting depth, not an undefined capital D or an automatic substitution of flow depth. </p><p>The bank's 2d/3d berm guidance needs a specified configuration and reference; it is not a universal selection rule. </p>",
                    "sources": [
                        {
                            "id": "BASI674-00377",
                            "set": 29,
                ...
                {
                    "id": "check-hydr626-00268",
                    "status": "review",
                    "prompt": "A wide unlined channel carrying silt-free water has a depth of 2.0 m. The maximum slope that can be given to a channel is 1 in 10,000. Calculate the maximum tractive stress permissible on the bed to prevent scouring:",
                ...
                {
                    "id": "check-irri951-00324",
                    "status": "review",
                    "prompt": "Finally formed berms in canals are provided for",
                    "html": "<p>The bank's 2d/3d berm guidance needs a specified configuration and reference; it is not a universal selection rule. </p><p>Berm benefits also depend on actual position, stability and seepage or erosion detailing.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00324",
                            "set": 31,
                ...
                {
                    "id": "check-irri951-00331",
                    "status": "review",
                    "prompt": "Irrigation canals are generally aligned along",
                    "html": "<p><strong>River-training or canal works need surveyed geometry and water levels.</strong> Their suitability depends on the actual alignment, river behaviour and design flow, not a universal count or route label.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00331",
                            "set": 31,
