        ...
        ACiE0603: {
            ...
            blocks: [
                {
                    ...
                    title: "Treatment sequence and barrier selection",
                    html: "<p><strong>Conventional surface-water sequence:</strong> screening → rapid coagulant mixing → slow flocculation → sedimentation → filtration → disinfection. Screens intercept debris; rapid mixing distributes coagulant to destabilise particles; slow mixing grows flocs. Settling reduces filter solids loading, filtration captures remaining particles, and disinfection inactivates targeted microorganisms. Clear-looking water is not necessarily safe.</p><p><strong>Choose barriers for the source.</strong> Suitable waters may use direct filtration without sedimentation; groundwater may need different chemical treatment. Ordinary settling does not remove dissolved hardness, volatile gases or dissolved organics. Coagulation, flocculation and sedimentation do not guarantee complete suspended-solids removal.</p>",
                    moreHtml: "<p>Check source variability, treatment objectives, treatability, hydraulic continuity, residuals disposal, operator capability and failure response. Sample between barriers to distinguish poor coagulation, filter breakthrough and inadequate disinfection contact. The cited questions establish the conventional order; a complete plant design still needs source-specific evidence, including which barriers must remain in service during failures.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>A bar screen protects pumps and downstream units from sticks, leaves and other large debris. Its clear spacing must match the material to be intercepted and the equipment being protected. The bank's 50 mm coarse-screen opening is a teaching value, not a universal definition of coarse screening or a Nepal specification.</p><p>For a simplified rack whose areas are measured normal to the approach flow, clear opening b and bar thickness t give an open-area fraction <strong>φ = b/(b + t)</strong>. If the gross submerged frontal area is A, the clean opening velocity is <strong>v<sub>o</sub> = Q/(φA)</strong>. Q is m<sup>3</sup>/s, A is m<sup>2</sup>, and velocity is m/s. Inclination, supports and frame obstruction require their actual projected geometry.</p><p><strong>Hypothetical example:</strong> Q = 0.12 m<sup>3</sup>/s, A = 0.40 m<sup>2</sup>, b = 50 mm and t = 10 mm give φ = 0.8333, net area 0.3333 m<sup>2</sup> and v<sub>o</sub> = <strong>0.36 m/s</strong>. Blocking half that opening area raises velocity to <strong>0.72 m/s</strong> at unchanged flow.</p>",
                    moreHtml: "<p>Obstruction also increases headloss and upstream level; a loss coefficient must describe the particular rack and blockage condition. Design includes cleaning access, redundancy and safe containment of screenings, rather than assuming the initial clean-screen calculation remains valid. Screening does not remove dissolved contaminants or provide disinfection.</p>",
                ...
                },
                {
                    ...
                    html: "<p><strong>Plain sedimentation</strong> means gravity separation without deliberate coagulant addition. It does not mean that every particle must remain discrete: natural aggregation can occur. Conversely, the presence of gravity settling alone does not prove that a coagulant was used. Clarification describes the production of clearer supernatant and can include different settling arrangements.</p><table><thead><tr><th scope='col'>Settling regime</th><th scope='col'>Physical behaviour</th></tr></thead><tbody><tr><th scope='row'>Type I, discrete</th><td>Dilute, essentially noninteracting particles retain approximately constant size and settling velocity.</td></tr><tr><th scope='row'>Type II, flocculent</th><td>Particles aggregate during descent; size and settling velocity change with time and depth.</td></tr><tr><th scope='row'>Zone or hindered</th><td>Concentrated particles interact and can settle with an identifiable interface.</td></tr><tr><th scope='row'>Compression</th><td>Particles form a supporting network; further consolidation expels water from the solids layer.</td></tr></tbody></table>",
                    moreHtml: "<p>The discrete-particle overflow-rate model is useful for understanding clarification, but it cannot automatically predict a chemically formed floc's removal. Flocculent settling needs treatability or settling-column evidence; concentrated sludge also requires solids-flux and storage considerations.</p><p>First identify whether the task concerns individual particles, an evolving floc suspension or a sludge blanket. Then choose the model and measurements. This avoids using a single Stokes velocity for all material in a clarifier or calling every gravity-separation operation sedimentation with coagulant.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>For a small sphere settling at terminal velocity, submerged weight equals drag. Submerged weight is <strong>(ρ<sub>s</sub> − ρ)gπd<sup>3</sup>/6</strong>; creeping-flow drag is <strong>3πμdv<sub>s</sub></strong>. Equating them gives <strong>v<sub>s</sub> = (ρ<sub>s</sub> − ρ)gd<sup>2</sup>/(18μ) = g(s − 1)d<sup>2</sup>/(18ν)</strong>, where s = ρ<sub>s</sub>/ρ and ν = μ/ρ.</p>" +
                        ...
                        "<p><strong>Corrected option:</strong> Model 27 Q91 now offers 0.03597 cm/s instead of 0.36 cm/s. Do not adjust inputs to fit a distractor. Aggregating flocs, irregular grains and interacting sludge may require another settling model.</p>",
                ...
                },
                {
                    ...
                    html: "<p>Three useful basin quantities have different denominators: <strong>surface loading Q/A<sub>plan</sub></strong>, <strong>nominal detention V/Q</strong>, and <strong>horizontal velocity Q/A<sub>flow</sub></strong>. The plan area is not the cross-sectional flow area. Volume includes the effective water space, not an assumed allowance already occupied by sludge or inactive zones.</p><p><strong>Hypothetical example; these dimensions and flows are not bank givens.</strong> Let Q = 7200 m<sup>3</sup>/day = 300 m<sup>3</sup>/h, L = 30 m, B = 10 m and H = 3 m. The following values describe a uniform-flow idealisation.</p><table><thead><tr><th scope='col'>Quantity</th><th scope='col'>Calculation</th></tr></thead><tbody><tr><th scope='row'>Surface loading</th><td>300/(30 × 10) = 1.0 m/h</td></tr><tr><th scope='row'>Nominal detention</th><td>(30 × 10 × 3)/300 = 3.0 h</td></tr><tr><th scope='row'>Horizontal velocity</th><td>300/(10 × 3) = 10 m/h = 0.002778 m/s</td></tr></tbody></table><p>A hypothetical discrete class settling at 0.5 m/h has ideal removal 0.5/1.0 = <strong>50%</strong>. Doubling Q without changing the basin raises surface loading to 2 m/h, halves detention to 1.5 h and reduces this class's ideal removal to <strong>25%</strong>.</p>",
                    moreHtml: "<p>Actual detention is distributed, not identical for every parcel. Inlet jets, dead zones and density currents can make early breakthrough much faster than V/Q. Sizing must therefore examine peak operating flow, parallel-unit availability and hydraulic layout, not only the average-flow arithmetic.</p>",
                ...
                },
                {
                    ...
                    html: "<p>Aluminium and iron salts can both generate hydroxide precipitates and remove destabilised particles or associated organic colour. Their useful pH windows, alkalinity consumption, residual-metal behaviour, sludge characteristics and cost differ. The preferred reagent is the one that achieves the specified performance with manageable operation for the actual water.</p><p>An iron floc may settle differently from an alum floc, but <strong>floc density, settling speed and total floc quantity are not synonyms</strong>. Total sludge depends on reagent dose, precipitation chemistry and captured solids. A claim that iron necessarily produces less floc, or always permits shorter sedimentation, cannot be deduced from the reagent name.</p>",
                    moreHtml: "<p>Alum can remove some taste- and odour-associated material when it is particulate or linked to removable organic matter. This does not establish removal of every dissolved odour compound, nor easy dewatering of every alum sludge. Compare clarified-water quality, filter loading and sludge treatment together.</p><p>Surfactants can stabilise foam and emulsified oil and alter flocculation or surface scum. Greasy accumulation nevertheless warrants source investigation rather than identification of one universal cause. Characterise oil, detergent and organic loading, assess whether source control or pretreatment is needed, and confirm performance by testing. Increasing coagulant dose without understanding the interference can increase residuals without solving the problem.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>Rapid mixing distributes coagulant and promotes its initial contact with particles. Flocculation follows with gentler mixing so particles collide without excessive breakup. A motor speed alone does not describe the mixing intensity: impeller geometry, liquid properties, baffling and power transfer also matter.</p><p>The conventional mean velocity-gradient parameter is <strong>G = √[P/(μV)]</strong>, where P is power actually dissipated in the water in watts, μ is dynamic viscosity in Pa·s and V is the mixed water volume in m<sup>3</sup>. Since P/(μV) has units s<sup>−2</sup>, G has units <strong>s<sup>−1</sup></strong>. It is an energy-based measure of shear, not a longitudinal water speed or a literal uniform gradient everywhere.</p><p><strong>Hypothetical example:</strong> P = 100 W, μ = 0.001 Pa·s and V = 40 m<sup>3</sup> give G = √(100/0.04) = <strong>50 s<sup>−1</sup></strong>. If only 60% of motor input reaches the water, the corresponding input is 100/0.60 = <strong>166.7 W</strong>; substituting that input directly for P would overstate G.</p>",
                    moreHtml: "<p>Cold water changes viscosity, while local high-shear regions can damage floc even when average G appears suitable. The parameter helps compare mixing designs but cannot replace tests of floc formation, hydraulic distribution and particle survival during transfer to the next unit.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>A slow sand filter operates at a low hydraulic loading through fine sand. A biologically active surface region, often called the schmutzdecke, and processes deeper in the bed contribute to particle and microbial removal. A newly prepared or disturbed bed does not instantly have the performance of a mature filter.</p><p><strong>WHO 2022 Annex A5.1.4, printed page 542</strong>, describes typical loading of <strong>0.1–0.3 m/h</strong>, effective sand size <strong>0.15–0.3 mm</strong> and sand depth <strong>0.5–1.5 m</strong>. These are guidance ranges, not normative Nepal dimensions. The bank's 100–200 L/(m<sup>2</sup>·h) equals 0.1–0.2 m/h; its 0.9–1.1 m depth and 0.20–0.35 mm effective size are other teaching intervals, not proof of universal requirements.</p><p>High incoming solids can shorten runs rapidly, so source protection, presettling or roughing filtration may be important. Turbidity is measured optically in NTU, whereas suspended-solids concentration is a mass per volume. The bank's 60 mg/L turbidity threshold cannot be converted into a universal NTU limit.</p>",
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension:</strong> the assigned bank does not supply a complete headloss, backwash or filter-run dataset. In a clean saturated bed, a simplified Darcy representation is <strong>Δh = vL/K</strong>, with hydraulic conductivity K in m/s, filtration velocity v in m/s and media depth L in metres. Deposits alter effective permeability and flow distribution, so a fixed clean-bed K cannot predict an entire run.</p><p>Backwashing removes retained solids and restores hydraulic performance. Bed expansion depends on media size, density and water temperature; air scour, where designed, changes the cleaning system further. Wash rates, sequencing and restart procedures must therefore be specific to the installed equipment, not copied from an unrelated filter.</p>",
                    moreHtml: "<p>Two distinct limits can end a run: excessive headloss or unacceptable effluent quality. Turbidity breakthrough may occur before the terminal headloss, while local deposits and cracks can produce uneven flow. A timer alone does not demonstrate that a filter remains effective.</p><p>Calculate wash-water volume from actual wash flow and duration, account for beds unavailable during washing, and verify post-wash effluent before normal return to service. Wash-water recycling can concentrate particles, organisms or chemicals at the head of the plant; residuals treatment and controlled recycle are part of the process mass balance, not free extra capacity.</p>",
                    sources: []
                },
                {
                ...
                },
                {
                    ...
                    html: "<p>Free chlorine in typical treated water includes hypochlorous acid and hypochlorite ion, related by <strong>HOCl ⇌ H<sup>+</sup> + OCl<sup>−</sup></strong>. HOCl is generally the more effective disinfecting form. Increasing pH shifts the equilibrium towards OCl<sup>−</sup>, so otherwise comparable free-chlorine disinfection becomes less effective.</p><p>The HOCl fraction is approximately <strong>1/[1 + 10<sup>pH − pK<sub>a</sub></sup>]</strong>. <strong>Hypothetical equilibrium illustration:</strong> take pK<sub>a</sub> = 7.5 as an illustrative temperature-dependent value. At pH 6.5, the fraction is 1/1.1 = <strong>90.9%</strong>; at pH 8.5 it is 1/11 = <strong>9.09%</strong>. These are species fractions, not percentages of organisms killed.</p><p>Do not lower pH indiscriminately: corrosion and final water-quality requirements also matter. Neither maximum efficiency exactly at pH 7 nor instantaneous E. coli destruction at pH 9.5 is a universal rule. Required contact and organism-specific validation remain necessary.</p>",
                    moreHtml: "<p>Hypochlorite products tend to add alkalinity, whereas chlorine gas can lower pH through its aqueous reactions. Actual pH change depends on dose, formulation, buffering and starting chemistry. A product's name alone does not establish a measurable increase in every water or an intrinsically inferior disinfecting performance at the same final free chlorine and pH.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    moreHtml: "<p>Manganese oxidation can be much slower under conditions adequate for iron. Aeration alone is therefore not a guaranteed manganese-removal method. Depending on the water, treatment may use a suitable oxidant, catalytic media, adsorption/oxidation or biological filtration. Oxidant dose and contact need treatability evidence; precipitate capture and filter washing remain essential.</p><p>Chloramine is comparatively weak for rapid iron and manganese oxidation. Its persistence can be useful for distribution disinfection, but that does not make it interchangeable with ozone, chlorine dioxide or permanganate for metal treatment. Each stronger oxidant also brings operating and by-product constraints.</p><p><strong>Sequestration</strong> keeps metals dispersed or complexed to reduce visible deposition; it does not physically remove their mass. Verify total and relevant dissolved concentrations rather than judging success only by absence of staining. Manganese greensand or other catalytic media require their specified operating conditions, and ordinary activated carbon cannot be credited with guaranteed manganese removal simply because it adsorbs organic compounds.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>Apparent colour includes suspended material; true colour is assessed after an appropriate particle-removal preparation. Settling and filtration may improve apparent colour while leaving dissolved organic colour. Coagulation can remove suitable organic fractions, carbon can adsorb selected dissolved compounds, and oxidation can transform particular colour or odour producers.</p><p>Volatile hydrogen sulfide may respond to aeration; nonvolatile compounds do not follow the same gas-transfer mechanism. Oxidation is not universally the best odour treatment: effectiveness and by-products depend on the compound, oxidant, dose and contact conditions. Oxidising a compound does not automatically mineralise it or improve every sensory characteristic.</p>",
                    moreHtml: "<p>Algal and cyanobacterial problems also require source investigation. Nutrient control, intake management and removal of intact cells can be relevant. Killing or lysing cells may release intracellular taste-and-odour compounds or toxins, so disappearance of a visible bloom does not establish safer water.</p><p>Copper sulfate is a historically used algicide, explaining the bank's identification question, but this is not a dosing recommendation or a universal preferred solution. Aquatic toxicity, residual copper, source ecology and toxin-release risk must be assessed by qualified operators under the applicable permissions. Treatment choices should be verified against actual target compounds and final water quality, with source prevention considered alongside plant-based removal.</p>",
                    sources: [
            ...
            cautions: [
                ...
                },
                {
                    ...
                    "status": "review",
                    "prompt": "When temporary hard water is boiled, one of the substances formed is",
                    "html": "<p><strong>More than one product can be correct.</strong> Boiling calcium bicarbonate forms CaCO<sub>3</sub>, CO<sub>2</sub> and water. If carbonate and carbon dioxide are separate choices, asking for one substance formed does not establish a unique answer.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00274",
                            "set": 27,
                ...
                },
                {
                    ...
                    "status": "review",
                    "prompt": "Consider the following statements regarding sand as filter material. i. It should be free from clay or silt ii. Organic matter should be present in the sand, iii. It should be nonuniform. Which of the above statement is/are correct?",
