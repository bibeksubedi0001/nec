        ...
        ACiE0602: {
            ...
            blocks: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension:</strong> the bank does not provide an intake-type comparison or construction design. Type names describe arrangements; selection follows source behaviour, hydraulic levels, quality and maintainability.</p><table><thead><tr><th scope='col'>Arrangement</th><th scope='col'>Use and construction consideration</th></tr></thead><tbody><tr><th scope='row'>River-bank intake or collection well</th><td>An entry and connecting conduit convey water to a protected chamber or pumping well. Sediment entry, flood access, bank stability and isolation need explicit provision.</td></tr><tr><th scope='row'>Submerged intake</th><td>A screened entry away from shore can reach suitable depth. Underwater inspection, debris removal, pipe protection and anchorage become important.</td></tr><tr><th scope='row'>Lake/reservoir tower</th><td>Multiple inlet levels can permit selective withdrawal. A wet tower contains the collection water; a dry-access arrangement houses accessible controls around separate conduits.</td></tr><tr><th scope='row'>Floating intake</th><td>Moves with water level, but needs stable mooring, flexible connections and protection from debris, waves and low-water grounding.</td></tr></tbody></table>",
                    moreHtml: "<p>A spring collection chamber or protected well head is another abstraction arrangement, not proof of an inherently safe source. Prevent dirty surface drainage or animals from bypassing the intended collection path.</p><p>Construction planning addresses temporary diversion or dewatering, stable excavation, foundations, watertight interfaces, safe access and the protection of raw water from construction pollution. Screens, valves and removable components need space for maintenance. Check flotation, scour and flood actions before choosing the foundation and anchorage; merely specifying concrete or a tower does not establish stability or an acceptable ecological footprint.</p>",
                    sources: []
                },
                {
                ...
                },
                {
                    ...
                    html: "<p>A material name alone does not establish a pipe's allowable pressure, service life or suitability for drinking water. Specify the applicable product standard, dimensions, pressure class, temperature basis, joint system, lining or coating, installation and potable-water compatibility.</p><table><thead><tr><th scope='col'>Material family</th><th scope='col'>Selection considerations</th></tr></thead><tbody><tr><th scope='row'>Ductile iron</th><td>Robust pressure-pipe option; lining, external corrosion protection, joint restraint and handling still matter.</td></tr><tr><th scope='row'>Steel</th><td>Useful for fabricated pressure mains and crossings; corrosion protection, weld quality, wall stability and anchorage govern performance.</td></tr><tr><th scope='row'>uPVC and polyethylene</th><td>Lightweight corrosion-resistant options; pressure rating, temperature, long-term loading, joint quality and supported installation remain essential.</td></tr><tr><th scope='row'>Concrete pressure products</th><td>Suitability depends on the specific reinforced or prestressed product and joint design, not the word concrete alone.</td></tr><tr><th scope='row'>Galvanised steel service pipe</th><td>Historically called GI; zinc protection is not permanent immunity to corrosion, deposits or reduced bore.</td></tr></tbody></table><p>The bank's GI residential-service answer describes a conventional practice, not a universal requirement or a reason to install lead service pipes. Local approved materials and water compatibility must govern selection.</p>",
                    moreHtml: "<p>Compare rated operating and test conditions with maximum static pressure, operating pressure and assessed transients. Do not assume a nominal class number can be read directly as MPa without its standard, or that a short proof test establishes a lifetime operating rating. The weakest compatible component may be a fitting, valve or joint rather than the straight pipe.</p>",
                ...
                },
                {
                    ...
                    html: "<p>A <strong>scour, washout or blow-off valve</strong> provides a controlled discharge for draining or flushing a main. Low points are common locations because water and deposited solids can collect there; dead ends can also need flushing. The location must actually permit the isolated section to drain or develop the required flushing flow.</p><p>Not every geometric depression automatically requires an identical valve. Pipe profile, isolation boundaries, sediment risk, outfall levels, available pressure and safe disposal determine the arrangement and size. A washout connected carelessly to a drain can create a contamination pathway; the receiving environment and water quality of the discharge also need consideration.</p>",
                    moreHtml: "<p>Air can accumulate at summits and restrict the effective flow area or disturb operation. Air-release devices remove accumulated air under pressure; air/vacuum devices admit or exhaust larger air volumes during filling, emptying or other specified conditions. Combination devices serve both functions when correctly selected. High points are important, but the complete profile and operating scenarios determine locations and capacity.</p><p>Air control, pressure relief and scour are not interchangeable duties. A small air-release valve is not necessarily sized to protect a rapidly draining main from vacuum, and admitting or expelling air can interact with transients. Check filling and shutdown procedures and obtain suitable device characteristics rather than assuming that a symbol at every summit provides complete surge protection.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>A service or distribution reservoir stores treated water between its production or transmission system and consumers. It absorbs the difference between the inflow schedule and variable demand, allowing treatment or pumping to operate more uniformly where the available storage and control strategy permit. This is the <strong>balancing</strong> function, not merely a large emergency water reserve.</p><p>An elevated tank or suitably located ground-level reservoir can provide gravity pressure according to its water level and distribution losses. A low-level ground tank may instead require downstream pumping. Tank level varies during operation, so check service pressure at the minimum operating level and maximum static pressure at the high level, not only at a convenient mean elevation.</p>",
                    moreHtml: "<p>Storage can also support fire or emergency provision and improve operating flexibility, but those purposes require separate quantities and rules for preserving usable reserves. A source impounding reservoir stores raw water over a potentially different time scale; a detention reservoir normally attenuates a flow event. The term reservoir alone does not establish the contents or function.</p><p>Location also affects access, foundation conditions, seismic and slope exposure, land, security and water quality. Provide maintainable compartments or another continuity strategy where justified. More volume is not automatically better: poor turnover and mixing can degrade quality. Uniform plant operation is possible only if cumulative inflow and outflow can be reconciled within the actual operating storage range.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension; all rates and times in this example are hypothetical.</strong> The assigned bank gives no balancing table. Assume constant inflow <strong>10 m<sup>3</sup>/hour</strong> for 24 hours. Demand rates in six successive four-hour periods are <strong>4, 16, 12, 8, 14 and 6 m<sup>3</sup>/hour</strong>. Both daily inflow and demand equal 240 m<sup>3</sup>.</p><p>Each period supplies 40 m<sup>3</sup>. Subtract the period's demand volume, not its hourly rate. The signed period changes are <strong>+24, −24, −8, +8, −16 and +16 m<sup>3</sup></strong>. The table uses B(0) = 0 and an initial usable storage of 16 m<sup>3</sup>.</p><table><thead><tr><th scope='col'>End hour</th><th scope='col'>Period demand, m<sup>3</sup></th><th scope='col'>Cumulative B, m<sup>3</sup></th><th scope='col'>Usable S, m<sup>3</sup></th></tr></thead><tbody><tr><th scope='row'>0</th><td>Not applicable</td><td>0</td><td>16</td></tr><tr><th scope='row'>4</th><td>16</td><td>24</td><td>40</td></tr><tr><th scope='row'>8</th><td>64</td><td>0</td><td>16</td></tr><tr><th scope='row'>12</th><td>48</td><td>−8</td><td>8</td></tr><tr><th scope='row'>16</th><td>32</td><td>0</td><td>16</td></tr><tr><th scope='row'>20</th><td>56</td><td>−16</td><td>0</td></tr><tr><th scope='row'>24</th><td>24</td><td>0</td><td>16</td></tr></tbody></table><p>The maximum B is 24 and minimum is −16, giving <strong>C<sub>b</sub> = 24 − (−16) = 40 m<sup>3</sup></strong>. S returns to its initial value, so this ideal cycle repeats. Starting empty at hour zero would fail later despite equal daily totals.</p>",
                ...
                },
                {
                    ...
                    html: "<p>Breakdown storage sustains an agreed service level during a credible interruption. Its basis includes outage duration, demand, remaining inflow, repair access, redundancy and failure consequences. Apply <strong>dS/dt = I<sub>available</sub> − D</strong> with the actual initial usable storage, capacity ceiling and operating policy. For zero inflow and constant demand D over duration T, <strong>V<sub>outage</sub> = DT</strong>. Variable schedules require a cumulative balance that accounts for replenishment; summing only positive interval deficits is not necessarily the exact storage requirement.</p><p><em>Added hypothetical scenario:</em> maintaining 10 m<sup>3</sup>/hour for six hours with no inflow requires <strong>60 m<sup>3</sup></strong>. If a design explicitly preserves that reserve below an independent 40-m<sup>3</sup> balancing band, the two require <strong>100 m<sup>3</sup> usable storage</strong> before other allowances. That addition is conditional; overlapping fire/outage scenarios and shared storage must be treated consistently rather than counted twice.</p><p>The bank's claim that breakdown reserve is generally no more than <strong>25% of total storage</strong> has no verified universal basis here. Even a stipulated percentage needs its denominator. <em>A separate hypothetical percentage exercise:</em> if B = 40 m<sup>3</sup> is all non-reserve usable storage and reserve is 25% of total T, then T = 40 + 0.25T, giving <strong>T = 53.3333 m<sup>3</sup></strong> and reserve 13.3333 m<sup>3</sup>. This is an alternative assumption, not the six-hour scenario.</p>",
                    moreHtml: "<p>Dead storage and freeboard are not available emergency supply. Excessive residence time needs turnover and mixing control, but that concern does not establish a universal reserve cap. Record the scenario, protected operating levels and replenishment plan before selecting capacity.</p>",
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension; this entire branch network is hypothetical.</strong> The bank gives no elevations, pipe resistances or nodal withdrawals. Assume a reservoir with H = 100 m feeds junction A, which has no withdrawal. A supplies B at 4 L/s and C at 6 L/s. Steady continuity requires the reservoir–A flow to be <strong>10 L/s</strong>.</p><p>Adopt a simple positive-flow model h = rQ<sup>2</sup>, with Q numerically in L/s and r in m/(L/s)<sup>2</sup>. Let r be 0.05 for the common pipe, 0.50 for A–B and 0.25 for A–C. The losses are respectively <strong>5, 8 and 9 m</strong>. Consequently H<sub>A</sub> = 95 m, H<sub>B</sub> = 87 m and H<sub>C</sub> = 86 m.</p><table><thead><tr><th scope='col'>Node</th><th scope='col'>H, m</th><th scope='col'>Elevation z, m</th><th scope='col'>Pressure head H − z, m</th></tr></thead><tbody><tr><th scope='row'>A</th><td>95</td><td>80</td><td>15</td></tr><tr><th scope='row'>B</th><td>87</td><td>75</td><td>12</td></tr><tr><th scope='row'>C</th><td>86</td><td>70</td><td>16</td></tr></tbody></table>",
                    moreHtml: "<p>Although C has the lowest hydraulic head, <strong>B has the lowest pressure head</strong>. Searching only for the lowest H or longest branch can therefore miss the critical service location. Walk each source-to-node path and use a common elevation datum.</p><p>This model assumes fixed delivered demands, negligible nodal velocity heads and the stated resistances. It supplies no minimum-pressure standard. Check maximum-day/peak and isolation scenarios, and use pressure-dependent delivery if a fixed-demand solution becomes physically impossible. A friction calculation is not permission to supply full demand at negative pressure.</p>",
                    sources: []
                },
                {
            ...
            cautions: [
                {
                    "id": "check-wate813-00284",
                    "status": "review",
                    "prompt": "From high level water resource, the water supply system used in termed as",
                ...
                {
                    "id": "check-wate813-00021",
                    "status": "review",
                    "prompt": "What type of fitting is used to connect pipes of different diameter?",
                ...
                {
                    "id": "check-wate813-00022",
                    "status": "review",
                    "prompt": "Which of the following is the use of Altitude valves?",
                    "html": "<p><strong>Altitude means level control, not simply delivering water to a tank.</strong> </p><p>The device's sensing and set-point logic controls tank inflow. </p>",
                    "sources": [
                        {
                            "id": "WATE813-00022",
                            "set": 4,
                ...
                {
                    "id": "check-wate813-00025",
                    "status": "review",
                    "prompt": "In the water-supply distribution network, the dead-end system is not favored because?",
                    "html": "<p><strong>Network layout answers are tendencies, not guarantees.</strong> </p><p>A simple dead-end tree loses downstream supply when isolated, but low terminal pressure and poor residual retention can also be disadvantages. </p>",
                    "sources": [
                        {
                            "id": "WATE813-00025",
                            "set": 4,
                ...
                {
                    "id": "check-wate813-00027",
                    "status": "review",
                    "prompt": "Which of the following pipe fitting provide a deviation of 90° in the pipework system?",
                ...
                {
                    "id": "check-wate813-00028",
                    "status": "review",
                    "prompt": "Which distribution is used in irregularly developed old city",
                    "html": "<p><strong>Irregular streets favour, but do not force, a branch layout.</strong> Existing pipes, supply points, pressure, reliability and cost determine the actual network. The city description alone does not prove the least-cost arrangement.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00028",
                            "set": 4,
                ...
                {
                    "id": "check-wate813-00029",
                    "status": "review",
                    "prompt": "Which pipe is strong in resisting inside stress but weak when stressed from outside?",
                ...
                {
                    "id": "check-wate813-00030",
                    "status": "review",
                    "prompt": "Scour valves are provided",
                    "html": "<p><strong>Low-point scour placement is functional, not an automatic valve at every depression.</strong> </p><p>Drainability, isolated sections, sediment risk and a safe outfall determine provision. </p><p>Air devices are selected from the profile and operating conditions; an air-release symbol at a summit is not proof of adequate vacuum or surge protection.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00030",
                            "set": 4,
                ...
                {
                    "id": "check-wate813-00031",
                    "status": "review",
                    "prompt": "The reserve of water for breakdown period is generally not more than ….. of total storage.",
                ...
                {
                    "id": "check-hydr626-00113",
                    "status": "review",
                    "prompt": "Which reservoir is helpful in permitting the pumps or the water treatment plants to work at a uniform rate?",
                    "html": "<p><strong>Uniform production requires enough usable balancing storage.</strong> </p><p>A distribution reservoir can absorb demand variation, but its presence alone does not guarantee constant-rate pumping or treatment. </p>",
                    "sources": [
                        {
                            "id": "HYDR626-00113",
                            "set": 13,
                ...
                {
                    "id": "check-basi674-00295",
                    "status": "review",
                    "prompt": "According to National Building Code, the hydrants in water mains is provided at minimum interval of",
                ...
                {
                    "id": "check-wate813-00278",
                    "status": "review",
                    "prompt": "What should you do when spindle of cock continuously slip down and tap does close?",
                ...
                {
                    "id": "check-wate813-00279",
                    "status": "review",
                    "prompt": "Foot valve is at bottom of...",
                ...
                {
                    "id": "check-wate813-00280",
                    "status": "review",
                    "prompt": "Which of the following joint is called run lead joint?",
                ...
                {
                    "id": "check-wate813-00282",
                    "status": "review",
                    "prompt": "The suitable layout for a water supply distribution system, for a city of roads of rectangular pattern is",
                    "html": "<p><strong>Network layout answers are tendencies, not guarantees.</strong> </p><p>Irregular streets do not force one layout or prove least cost. </p><p>Grids provide possible alternative routes, not guaranteed circulation, continuous supply or safe water quality.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00282",
                            "set": 28,
                ...
                {
                    "id": "check-wate813-00283",
                    "status": "review",
                    "prompt": "The purpose of providing a balancing reservoir in a water supply distribution system is",
                    "html": "<p>Cumulative inflow and outflow must fit within the operating band, with appropriate controls and a sustainable volume balance.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00283",
                            "set": 28,
                ...
                {
                    "id": "check-wate813-00285",
                    "status": "review",
                    "prompt": "The equation used commonly for the design of distribution system for water supply is designed by",
                ...
                {
                    "id": "check-wate813-00286",
                    "status": "review",
                    "prompt": "For water supply to residences, the service are provided by",
                ...
                {
                    "id": "check-wate813-00287",
                    "status": "review",
                    "prompt": "The method which is most widely used for analyzing and designing the pipes of all types of complex water distribution network is",
                ...
                {
                    "id": "check-wate813-00288",
                    "status": "review",
                    "prompt": "Which of the following is known as Shut off valve?",
                ...
                {
                    "id": "check-wate813-00289",
                    "status": "review",
                    "prompt": "The spacing between the Stoice valves is ...",
                ...
                {
                    "id": "check-wate813-00290",
                    "status": "review",
                    "prompt": "The Gate valves are made of ... with brass mountings.",
                ...
                {
                    "id": "check-wate813-00291",
                    "status": "review",
                    "prompt": "Which of the following is known as washout valve?",
                    "html": "<p><strong>A washout or scour valve drains or flushes a pipeline section.</strong> Low-point provision depends on drainability, isolation and a safe outfall; it is not automatically required at every small depression.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00291",
                            "set": 29,
                ...
                {
                    "id": "check-wate813-00292",
                    "status": "review",
                    "prompt": "The valve which is preferred in elevated tanks and stand pipes is",
                    "html": "<p>The device's sensing and set-point logic controls tank inflow. </p><p>It is not interchangeable with a check, scour or pressure-relief valve, and it does not remove the need to assess overflow and failure conditions.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00292",
                            "set": 29,
                ...
                {
                    "id": "check-wate813-00293",
                    "status": "review",
                    "prompt": "Which of the following is also known as a check valve?",
                ...
                {
                    "id": "check-wate813-00329",
                    "status": "review",
                    "prompt": "At which location in a water pipeline is a blow-off valve (scour valve) typically situated?",
                    "html": "<p><strong>Low-point scour placement is functional, not an automatic valve at every depression.</strong> </p><p>Drainability, isolated sections, sediment risk and a safe outfall determine provision. </p>",
                    "sources": [
                        {
                            "id": "WATE813-00329",
                            "set": 32,
