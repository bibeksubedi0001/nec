(function () {
    ...
    Object.assign(registry, {
        ACiE0804: {
            ...
            blocks: [
                {
                    ...
                    html: "<p><strong>Official 8.4 scope:</strong> components of a typical ROR plant; design of intake; methods of bed and suspended load handling; design of settling basin (practice and concentration approach), estimation of sediment volume in settling basin, flushing of deposited sediment, estimation of flushing frequency for sediments.</p><table><thead><tr><th scope='col'>Part of the scheme</th><th scope='col'>Function and boundary</th></tr></thead><tbody><tr><th scope='row'>River headworks</th><td>Weir or barrage, intake, under-sluices and associated protection control admission and river passage. A fish pass may provide a separate ecological route.</td></tr><tr><th scope='row'>Sediment treatment</th><td>A gravel trap and settling basin remove selected particulate material from diverted water. They belong to the scheme's sediment-control system; their exact site location varies.</td></tr><tr><th scope='row'>Conveyance and generation</th><td>Headrace, forebay or suitable surge connection, penstock, turbine in the powerhouse, and tailrace convey water, extract energy and return water downstream.</td></tr></tbody></table>",
                    moreHtml: "<p>A <strong>run-of-river plant</strong> uses river flow with little seasonal regulation compared with a storage scheme. A diversion pond or limited pondage may still exist: ROR does not mean zero stored water. The diversion structure raises or controls the water level for abstraction; it does not increase the river's water supply.</p><p>For an illustrative open-headrace arrangement, trace the diverted stream from <strong>intake to gravel trap, settling basin, headrace, forebay, penstock, turbine and tailrace</strong>. This is a typical route, not a mandatory arrangement for every project. An under-sluice returns river water downstream without sending it through the turbine. A flushing outlet branches from a sediment-control structure. A surge tank, where needed in a pressure-waterway layout, is generally a connected branch rather than a vessel through which every litre must pass.</p><p>Thus a powerhouse is a component of the <em>whole ROR plant</em>, not an intake-side headworks component. The bank's two component questions use different boundaries. The notes retain those questions as references while teaching the physical connections, not merely memorizing lists.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>Describe an intake by <strong>where the opening is, how water approaches it, and whether the opening is submerged at the operating stage</strong>. These are different attributes. An opening on a riverbank can be submerged; being below the water surface does not by itself put an intake on the river bed.</p><table><thead><tr><th scope='col'>Description</th><th scope='col'>Physical meaning</th></tr></thead><tbody><tr><th scope='row'>Side or lateral intake</th><td>Water turns from the river into an opening along its side; approach currents and sediment-rich near-bed flow need attention.</td></tr><tr><th scope='row'>Frontal intake</th><td>The entrance faces the approaching flow. Alignment affects entry losses and direct exposure to transported material.</td></tr><tr><th scope='row'>Bottom intake</th><td>Water is collected through a bed-level or weir-rack arrangement; the Tyrolean example has a specific through-rack water route.</td></tr><tr><th scope='row'>Submerged intake</th><td>The opening is below the relevant water surface. A bed-mounted intake is one possible construction, not the definition of all submerged intakes.</td></tr></tbody></table>",
                    moreHtml: "<p>The concave, outer bank of a simple river bend often offers a deeper approach and less coarse deposition than the convex inner bank. The bend's secondary circulation can move near-bed sediment towards the inner bank, while high outer-bank velocities maintain depth. This explains the conventional bank answer without reducing the process to centrifugal force alone.</p><p>The same outer bank may suffer severe erosion. Select the site using river surveys, bank and foundation stability, changing thalweg position, flood approach, sediment pathways, possible outfall contamination and construction access. A protected straight reach may be preferable to an unstable bend. Neither concavity nor submergence guarantees clean water.</p><p>A submerged opening must retain adequate submergence at the <em>minimum operating stage</em>, while remaining clear of expected deposition. Floating material may be less directly exposed to a deep opening, but submerged debris, ice processes, blockage and difficult inspection remain possible. The bank's all-stages and damage-immunity claims are not general design facts.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>For steady operation of the diverted-water system, a useful balance is <strong>Q<sub>intake</sub> = Q<sub>turbine</sub> + Q<sub>flush,through</sub> + Q<sub>loss</sub></strong>. Q<sub>flush,through</sub> is flushing water that actually passes through this intake before leaving a gravel trap or settling basin. Add any other nonoverlapping abstraction explicitly. During filling or drawdown, also include the rate of change of water stored within the selected boundary.</p><p><strong>Added water-budget example, not bank givens:</strong> if generation needs 10.0 m<sup>3</sup>/s, downstream basin flushing needs 0.8 m<sup>3</sup>/s through the intake, and conveyance losses are 0.2 m<sup>3</sup>/s, the simultaneous intake requirement is <strong>11.0 m<sup>3</sup>/s</strong>. A separate 2.0 m<sup>3</sup>/s river under-sluice does not make that intake requirement 13.0; the river must nevertheless supply both routes and any other required releases, without double-counting a release already included in them.</p><p>The bank's <strong>100–120% of turbine discharge means 0–20% extra</strong>, since the extra fraction is Q<sub>intake</sub>/Q<sub>turbine</sub> − 1. An allowance of <strong>10–20% extra</strong> instead gives <strong>110–120% of turbine discharge</strong>. Neither expression is the same as designing the whole intake for only 10–20% of turbine demand.</p><p>The reviewed <strong>AEPC first update 2014</strong> discusses an allowance for the relevant <em>conveyance system</em> within its micro/pico-hydro scope up to <strong>100 kW</strong>. It is not a universal intake-sizing rule for all ROR plants and does not replace the actual flushing-water path, losses, operating head and available river flow.</p>",
                    moreHtml: "<p>A river under-sluice may take water directly from the upstream pond and discharge to the river without passing through the intake. That flow belongs in the <strong>river availability and headworks balance</strong>, but not automatically in intake discharge. Likewise, intermittent flushing may occur with reduced turbine demand rather than with full turbine demand and the largest flushing flow simultaneously. Design each genuine operating case and size each passage for the case that governs it.</p>",
                ...
                },
                {
                    ...
                    html: "<p>For headworks sediment handling, distinguish <strong>particulate transport</strong> from dissolved material, and distinguish a particle's <strong>size</strong> from its <strong>mode of transport</strong>. A grain can move near the bed under one flow condition and become suspended under another. Coarse does not mean bed load in every case, and suspended does not mean exclusively very fine silt.</p><table><thead><tr><th scope='col'>Material or transport mode</th><th scope='col'>Meaning</th><th scope='col'>Headworks implication</th></tr></thead><tbody><tr><th scope='row'>Bed load</th><td>Particles move by rolling, sliding or short hops near the bed.</td><td>Approach alignment, raised admission and appropriate low-level bypass or scouring routes can reduce entry.</td></tr><tr><th scope='row'>Suspended sediment</th><td>Particles are carried within the water column, with turbulence opposing their tendency to fall.</td><td>Selected classes can deposit when residence time and settling conditions are adequate.</td></tr><tr><th scope='row'>Dissolved load</th><td>Solutes are present at molecular or ionic scale rather than as the discrete grains being settled.</td><td>Ordinary desilting does not remove them by gravity settling.</td></tr></tbody></table>",
                    moreHtml: "<p>The bank's threefold bed–suspended–dissolved list is a broad description of river-borne material. In hydraulic sediment-transport design, bed and suspended loads refer to <em>particulate</em> loads. Do not include dissolved mass in a basin's settleable concentration merely to match that broader terminology.</p><p>A settling basin targets <strong>settleable suspended grain classes</strong>, including relatively coarse suspended sand where present. Some fine or cohesive particles may remain in suspension. Define the inlet size distribution, settling velocities, mineral hardness and desired class-specific removal; one total concentration does not reveal the abrasive risk or the fraction that can settle.</p><p>Graded performance uses incoming <em>mass fractions</em>, not numbers of particles. A few large grains can carry more mass than many small ones. This distinction becomes essential when converting different class efficiencies into an overall deposited mass and an outlet concentration.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>Sediment control is a sequence of interventions, not one device that makes river water sediment-free. First reduce avoidable sediment supply where practical, then limit entry into the diverted stream, then remove selected material that has entered, and finally evacuate deposits without creating an unacceptable downstream problem.</p><table><thead><tr><th scope='col'>Stage</th><th scope='col'>Purpose and limitation</th></tr></thead><tbody><tr><th scope='row'>Catchment management</th><td>Erosion control and suitable land management can reduce sediment delivery. They do not eliminate natural erosion, bank failures or every extreme-event sediment pulse.</td></tr><tr><th scope='row'>Exclusion before abstraction</th><td>Intake alignment, sill arrangement and suitable river sediment bypass or excluder passages keep part of the sediment-rich flow out of the intake.</td></tr><tr><th scope='row'>Extraction after entry</th><td>An ejector or extractor removes a sediment-rich portion of the diverted flow. Its interception occurs downstream of admission even if its final outfall returns to the river.</td></tr><tr><th scope='row'>Trapping and removal</th><td>Gravel traps and settling basins deposit selected sizes; flushing or mechanical removal is then needed to restore their function.</td></tr></tbody></table>",
                    moreHtml: "<p>Where both are provided, the usual diverted-water sequence is <strong>gravel trap before settling basin</strong>. The gravel trap intercepts relatively coarse material early, reducing blockage and storage demand in the finer-sediment basin. The downstream settling basin can then be proportioned for its actual incoming suspended load rather than for the unmodified river mixture.</p><p>Provide a workable flushing or cleaning arrangement for each trap. A trap that rapidly fills and then passes its deposit downstream has not achieved sustained protection. Conversely, an oversized trap with an outlet too high to remove the deposit may have considerable nominal volume but poor operational performance.</p><p>Measure or estimate concentration and grading at the <em>entrance of the structure being designed</em>. Substituting river concentration after upstream exclusion, dilution or removal has changed the stream can give the wrong basin loading. Reservoir dredging is one general sediment-management method mentioned by the bank; it is not a mandatory routine operation for every ROR intake.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>A settling basin changes the flow distribution so that selected particles have time to reach a collecting surface. Its zoning describes <strong>engineering functions</strong>, not separate laws of gravity. Particles can begin falling in the inlet or transition; the principal settling zone is where useful removal is deliberately provided and assessed.</p><table><thead><tr><th scope='col'>Zone</th><th scope='col'>Design role</th></tr></thead><tbody><tr><th scope='row'>Inlet and inlet transition</th><td>Expand or redistribute the approach flow across the basin without a concentrated jet, severe separation or short-circuiting.</td></tr><tr><th scope='row'>Main settling zone</th><td>Provide the active width, length and depth used in the removal model. In conventional long basins this is usually the largest length.</td></tr><tr><th scope='row'>Outlet zone</th><td>Collect the clarified flow without drawing a fast path through the basin or re-entraining the deposited layer.</td></tr><tr><th scope='row'>Deposit-storage and collection region</th><td>Accommodate sediment below the required working flow section and connect it to a flushing or cleaning route.</td></tr></tbody></table>",
                    moreHtml: "<p>The inlet zone commonly <em>contains</em> the inlet transition. Offering inlet zone and transition zone as mutually exclusive choices is ambiguous unless a particular diagram defines them. Likewise, largest settling-zone length is a conventional layout characteristic, not a prescribed fraction of every basin's total length. Do not count the full civil footprint as active settling area without justifying the hydraulic contribution of its transitions.</p><p>Slow, orderly bulk flow is desirable, but a large full-scale basin can have a high Reynolds number even at modest velocity. Low velocity is not proof of laminar flow, and the bank supplies no hydraulic length or viscosity with which to establish its regime. Avoid strong eddies and resuspension rather than assuming that all turbulence can be eliminated.</p><p>The particle Reynolds number used for a settling-velocity law is a different quantity. An individual tiny grain can satisfy Stokes conditions in a basin whose bulk flow is turbulent. The ideal models developed below deliberately simplify that flow; their assumptions must not be confused with a claim that the whole basin is laminar.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><em>Source-free syllabus extension: no assigned question provides the grain and fluid data needed for a settling-velocity calculation.</em> For an isolated spherical grain of diameter d and density ρ<sub>s</sub> in a fluid of density ρ, the downward submerged weight is <strong>(ρ<sub>s</sub> − ρ)gπd<sup>3</sup>/6</strong>. At terminal settling velocity w<sub>s</sub>, this balances upward drag.</p><p>In creeping flow around the particle, drag is 3πμd w<sub>s</sub>, where μ is dynamic viscosity. Equating forces and cancelling πd gives <strong>w<sub>s</sub> = (ρ<sub>s</sub> − ρ)gd<sup>2</sup>/(18μ)</strong>. With kinematic viscosity ν = μ/ρ, the same result is <strong>w<sub>s</sub> = (ρ<sub>s</sub>/ρ − 1)gd<sup>2</sup>/(18ν)</strong>. Use d in m, g in m/s<sup>2</sup> and ν in m<sup>2</sup>/s to obtain w<sub>s</sub> in m/s.</p><p>Check <strong>Re<sub>p</sub> = w<sub>s</sub>d/ν ≪ 1</strong> after calculating the trial velocity. This is a particle-scale condition, not a requirement that the entire basin have laminar flow. At larger Re<sub>p</sub>, use an appropriate drag relation or measured settling velocity; the d<sup>2</sup> dependence is no longer generally valid.</p><p><strong>Added particle example:</strong> assume d = 0.020 mm = 2 × 10<sup>−5</sup> m, ρ<sub>s</sub> = 2650 kg/m<sup>3</sup>, ρ = 1000 kg/m<sup>3</sup>, ν = 10<sup>−6</sup> m<sup>2</sup>/s and g = 9.81 m/s<sup>2</sup>. Stokes gives <strong>w<sub>s</sub> = 0.0003597 m/s</strong>; Re<sub>p</sub> = <strong>0.007194</strong>, consistent with creeping particle flow under the other assumptions.</p><p>Increasing that diameter tenfold would produce a <em>Stokes trial</em> of 0.03597 m/s and Re<sub>p</sub> = 7.194. The failed Reynolds-number check means this trial is <strong>not an accepted settling velocity</strong>. </p>",
                    moreHtml: "<p>Non-spherical grains, flocculation, cohesive fines, hindered settling at higher concentrations and bed resuspension require additional treatment. The illustrative diameter is not a prescribed hydropower removal cutoff.</p>",
                    sources: []
                },
                {
                    id: "ideal-trajectory-capture",
                    title: "Trajectory extension: residence time, fall distance and ideal capture",
                    html: "<p><em>Source-free syllabus extension: the bank supplies no complete ideal-trajectory basin example.</em> Consider a rectangular active settling zone of width B, length L and clear working depth h, all in metres. Assume steady Q, uniform horizontal velocity <strong>u = Q/(Bh)</strong>, dilute discrete particles with constant positive w<sub>s</sub>, a horizontal collecting floor, no vertical remixing, no short-circuiting and no resuspension.</p><p>A particle spends <strong>t<sub>r</sub> = L/u</strong> in the zone and falls a distance w<sub>s</sub>t<sub>r</sub>. A particle entering at height z above the floor is captured if z ≤ w<sub>s</sub>t<sub>r</sub>. The most demanding starting height is z = h, so complete ideal capture of this class requires L/u ≥ h/w<sub>s</sub>.</p><p>Substituting continuity gives <strong>w<sub>s</sub>BL/Q ≥ 1</strong>, or <strong>w<sub>s</sub> ≥ q<sub>o</sub> = Q/(BL)</strong>. The surface loading q<sub>o</sub> has units m/s and uses the <em>horizontal active plan area</em>. </p><p>Now assume the class enters uniformly over all heights from 0 to h. The fraction of its incoming mass starting low enough to settle is the captured height divided by h. Hence <strong>η = min(w<sub>s</sub>t<sub>r</sub>/h, 1) = min(w<sub>s</sub>BL/Q, 1)</strong>. If entrance concentration or velocity varies with height, that simple uniform-height fraction is no longer automatically valid.</p><p>For a target fraction η<sub>target</sub> between zero and one, the ideal minimum area for this single class is η<sub>target</sub>Q/w<sub>s</sub>. The complete-capture threshold is Q/w<sub>s</sub>. These are theoretical results under the stated trajectory model, not guaranteed field efficiencies.</p>",
                    moreHtml: "<p>It is not Q/(Bh), which is the horizontal flow velocity, and it is not Q/(BLh), which has inverse-time units.</p><p>Depth cancels because increasing h both lengthens the settling distance and reduces u at fixed Q and B. It still affects turbulence, bed shear, inlet/outlet behaviour, sediment-storage clearance and construction. Removing depth from the entire practical design would therefore be a serious misuse of the cancellation.</p>",
                    sources: []
                },
                {
                    id: "depth-mixed-concentration-model",
                    title: "Concentration extension: derive a depth-mixed plug-flow model",
                    html: "<p><em>Source-free syllabus extension for the explicitly required concentration approach.</em> The following is <strong>one specified concentration model, not a universal settling law or an asserted code formula</strong>. </p><p>Use the model assumption that the effective concentration at the collecting surface equals the section mean, so deposition flux is <strong>w<sub>s</sub>C</strong>, in kg/(m<sup>2</sup> s). Across a short slice dx, incoming minus outgoing suspended mass rate equals deposition onto plan area B dx: Q[C(x) − C(x + dx)] = B dx w<sub>s</sub>C(x). Dividing by dx and taking the limit gives <strong>Q dC/dx = −B w<sub>s</sub>C</strong>.</p><p>Separate variables: dC/C = −(B w<sub>s</sub>/Q) dx. Integrating from C<sub>in</sub> at x = 0 to C<sub>out</sub> at x = L gives <strong>ln(C<sub>out</sub>/C<sub>in</sub>) = −w<sub>s</sub>BL/Q</strong>. Thus <strong>C<sub>out</sub>/C<sub>in</sub> = exp(−w<sub>s</sub>BL/Q)</strong> and, for equal inlet and outlet water discharge, <strong>η = 1 − exp(−w<sub>s</sub>BL/Q)</strong>.</p><p>For a specified positive outlet concentration below the inlet concentration, solve <strong>L = [Q/(B w<sub>s</sub>)] ln(C<sub>in</sub>/C<sub>out</sub>)</strong>. Equivalently, BL = −(Q/w<sub>s</sub>) ln(1 − η<sub>target</sub>). In this model, exactly zero outlet concentration or exactly 100% removal is approached only as the loading ratio tends to infinity.</p>",
                    moreHtml: "<p>Assume steady longitudinal plug flow, constant Q and B, and concentration C(x) that is continuously mixed across the depth and width at each longitudinal position. There is no longitudinal dispersion, short-circuiting, resuspension, flocculation or change in particle settling velocity.</p><p><strong>The mixing assumption differs from the trajectory model.</strong> Here depth mixing continually redistributes remaining suspended particles; in the ideal trajectory derivation each particle simply falls without vertical remixing. Longitudinal plug flow does not mean an absence of depth mixing. Do not combine the no-remixing assumption with the exponential result, or call either prediction measured performance without hydraulic evidence.</p>",
                    sources: []
                },
                {
                ...
                },
                {
                    ...
                    html: "<p><em>Source-free syllabus extension with an added sediment-mixture example.</em> Let f<sub>i</sub> be the incoming particulate <strong>mass fraction</strong> of class i, so Σf<sub>i</sub> = 1, and let η<sub>i</sub> be its predicted capture fraction under one consistent model. Then <strong>η<sub>overall</sub> = Σf<sub>i</sub>η<sub>i</sub></strong>. Equal weighting of class efficiencies is justified only when their incoming masses are equal.</p><p><strong>Added mixture:</strong> use Q = 2 m<sup>3</sup>/s and active area BL = 100 m<sup>2</sup>, giving q<sub>o</sub> = 0.020 m/s. Assume three noncohesive classes with the following invented mass fractions and supplied settling velocities. Apply each model separately; the two efficiency values in each row are alternatives, not quantities to average together.</p><table><thead><tr><th scope='col'>Class</th><th scope='col'>f<sub>i</sub></th><th scope='col'>w<sub>s,i</sub>, m/s</th><th scope='col'>η<sub>i</sub>: trajectory / mixed</th></tr></thead><tbody><tr><th scope='row'>Faster settling</th><td>0.20</td><td>0.040</td><td>1.0000 / 0.8647</td></tr><tr><th scope='row'>Intermediate</th><td>0.50</td><td>0.020</td><td>1.0000 / 0.6321</td></tr><tr><th scope='row'>Slower settling</th><td>0.30</td><td>0.005</td><td>0.2500 / 0.2212</td></tr></tbody></table><p>The trajectory total is 0.20(1) + 0.50(1) + 0.30(0.25) = <strong>0.775, or 77.5%</strong>. Its escaping mass fraction is 0.225, entirely from the slower class. Using the unrounded mixed-model efficiencies instead gives <strong>η<sub>overall</sub> ≈ 0.55535, or 55.5%</strong>.</p><p>With an additional illustrative C<sub>in</sub> = 0.40 kg/m<sup>3</sup> and equal inlet/outlet water flow, <strong>C<sub>out</sub> = C<sub>in</sub>(1 − η<sub>overall</sub>)</strong>. The trajectory prediction is <strong>0.090 kg/m<sup>3</sup></strong>; the mixed prediction is about <strong>0.178 kg/m<sup>3</sup></strong>. An illustrative outlet goal of 0.10 kg/m<sup>3</sup> requires η ≥ 75%, so only the first of these model predictions meets it.</p>",
                    moreHtml: "<p>Class-specific protection targets still matter even when a total-concentration goal is met. Changes in flow, grading or mineral hardness can change turbine exposure. Use grading at the basin inlet after the gravel trap, and keep dissolved mass outside this particulate balance.</p>",
                    sources: []
                },
                {
                ...
                },
                {
                    ...
                    html: "<p>Deposited dry sediment mass occupies both solid-grain volume and a bulk deposit containing voids. Let <strong>V<sub>bulk</sub> = V<sub>solid</sub> + V<sub>void</sub></strong>, porosity <strong>n = V<sub>void</sub>/V<sub>bulk</sub></strong>, and grain density ρ<sub>s</sub> = M<sub>dry</sub>/V<sub>solid</sub>. Then V<sub>solid</sub> = (1 − n)V<sub>bulk</sub>.</p><p>It follows that <strong>ρ<sub>dry,bulk</sub> = M<sub>dry</sub>/V<sub>bulk</sub> = (1 − n)ρ<sub>s</sub></strong> and <strong>V<sub>bulk</sub> = M<sub>dep</sub>/ρ<sub>dry,bulk</sub></strong>, with M<sub>dep</sub> expressed as dry deposited mass. By contrast, <strong>V<sub>solid</sub> = M<sub>dep</sub>/ρ<sub>s</sub></strong> excludes void space. For physical voids, dry bulk density cannot exceed the density of the solid grains.</p><p>Void ratio is <strong>e = V<sub>void</sub>/V<sub>solid</sub> = n/(1 − n)</strong>, so <strong>ρ<sub>dry,bulk</sub> = ρ<sub>s</sub>/(1 + e)</strong>. A bulk-volume/solid-volume multiplier is <strong>k<sub>v</sub> = 1 + e = 1/(1 − n) ≥ 1</strong>. It multiplies solid volume, or divides particle density; it does not multiply particle density to produce a larger dry bulk density.</p><p>The words <strong>packing factor</strong> alone are insufficient. A solid-volume fraction V<sub>solid</sub>/V<sub>bulk</sub> must not exceed one, whereas the inverse volume multiplier is at least one. A factor relating two measured bulk-density states would need both states defined. These conventions cannot be exchanged merely to reproduce an answer option.</p><p>For a saturated deposit, wet bulk density is approximately <strong>(1 − n)ρ<sub>s</sub> + nρ<sub>w</sub></strong>, including pore-water mass. Dividing <em>dry sediment mass</em> by this wet density incorrectly counts water as sediment mass. </p>",
                    moreHtml: "<p>Use dry bulk density for dry-mass storage calculations, and measure or justify how packing changes with grading, deposition and consolidation. Working water volume, allowable sediment volume and total basin volume are also distinct quantities.</p>",
                ...
                },
                {
                    ...
                    html: "<p><strong>Actual bank data, HYDR626-00266, Model 29 Q63:</strong> Q = 25 m<sup>3</sup>/s, C = 5 kg/m<sup>3</sup>, duration 10 days, stated silt density 2400 kg/m<sup>3</sup>, and an undefined packing factor of 1.2. The stored key is <strong>D, 37,500 m<sup>3</sup></strong>. These notes do not alter it.</p><p>First compute the unambiguous incoming quantity: <strong>T = 10 × 24 × 3600 = 864,000 s</strong>; Q C = <strong>125 kg/s</strong>; hence <strong>M<sub>in</sub> = 108,000,000 kg</strong>. If capture is a constant η and no deposit is removed during the interval, added deposited mass is <strong>108,000,000η kg</strong>. The numerical alternatives below explicitly assume <strong>η = 1</strong>; complete capture is not supplied by the stem.</p><table><thead><tr><th scope='col'>Interpretation of density and factor</th><th scope='col'>Consequence at complete capture</th></tr></thead><tbody><tr><th scope='row'>2400 is particle density alone</th><td>Solid-grain volume is 108,000,000/2400 = <strong>45,000 m<sup>3</sup></strong>. Bulk deposit volume still needs a void-space definition.</td></tr><tr><th scope='row'>2400 is particle density; 1.2 is V<sub>bulk</sub>/V<sub>solid</sub></th><td>V<sub>bulk</sub> = 1.2 × 45,000 = <strong>54,000 m<sup>3</sup></strong>. Here e = 0.2, n = 1/6 and dry bulk density = 2000 kg/m<sup>3</sup>.</td></tr><tr><th scope='row'>2400 is already dry bulk density</th><td>V<sub>bulk</sub> = <strong>45,000 m<sup>3</sup></strong>. Do not apply an additional undefined packing adjustment to a density that already includes its void state.</td></tr></tbody></table><p>The stored explanation instead calls 2400 the particle density and multiplies it by 1.2 to obtain <strong>2880 kg/m<sup>3</sup></strong> as dry bulk density. This implies <strong>n = 1 − 2880/2400 = −0.20</strong> and <strong>e = 2400/2880 − 1 = −1/6</strong>. Negative void space is impossible. At full capture, its resulting 37,500 m<sup>3</sup> is smaller than the 45,000 m<sup>3</sup> occupied by the solid grains themselves.</p><p><strong>Do not simply replace D with A, 45,000.</strong> That number is solid volume under one interpretation and bulk volume under another. A 1.2 bulk-volume multiplier gives 54,000, which is not offered. </p>",
                    moreHtml: "<p>Capture efficiency and density/factor definitions remain missing or contradictory; choosing an unstated efficiency to fit an option would not repair the explanation. No unique corrected bulk-volume option is asserted.</p>",
                    sources: [{ id: "HYDR626-00266", set: 29, question: 63 }]
                },
                {
                    id: "flushing-arrangements-and-bieri",
                    title: "Flushing arrangements and the meaning of continuous operation in Bieri",
                    html: "<p>Sediment removal can be arranged so that a basin is cleaned intermittently, sediment is purged while water delivery continues, or separate bays alternate between settling and cleaning. Distinguish the <strong>continuity of plant production</strong> from the <strong>timing and location of sediment-outlet operation</strong>.</p><table><thead><tr><th scope='col'>Operating arrangement</th><th scope='col'>What must be checked</th></tr></thead><tbody><tr><th scope='row'>Intermittent chamber flushing</th><td>A deposit accumulates to a chosen limit, then the chamber is isolated or operated in a flushing mode. Generation may stop or use another available route.</td></tr><tr><th scope='row'>Sediment removal during water delivery</th><td>A controlled purge removes collected sediment while useful flow continues. Water supply, flushing head and separation of the sediment-rich outlet from the power outlet must be adequate.</td></tr><tr><th scope='row'>Parallel-bay operation</th><td>Other bays remain available while one is cleaned. Their reduced total active area must still meet the permitted discharge and sediment duty.</td></tr></tbody></table>",
                    moreHtml: "<p>The bank's <strong>BEIRI</strong> spelling is read here as <strong>Bieri</strong>. Its intended contrast is a basin arrangement that permits <strong>continued plant production while flushing</strong>, rather than requiring routine complete shutdown for every sediment-removal operation. Continued production remains conditional on sufficient water and the functioning operating arrangement.</p><p>That description does <strong>not</strong> mean every flushing opening is permanently fully open or that each location flushes at every instant. Local or sequential operation can coexist with continuing overall water delivery. The actual mechanism, gate sequence and control logic require the design and operating documentation of the particular installation.</p><p><strong>Unverified particulars:</strong> the supplied research did not establish the claimed Middle Marsyangdi installation or the claimed specific level/turbidity sensors from inspected primary material. They are not presented here as verified project facts or universal Bieri features. The source key's operational intent can be explained without endorsing those additional assertions.</p>",
            ...
            cautions: [
                {
                    "id": "check-hydr626-00238",
                    "status": "review",
                    "prompt": "Which component of a hydropower plant is responsible for filtering debris from the water before it enters the turbine?",
                    "html": "<p><strong>Trash racks intercept suitable debris before machinery.</strong> They do not remove every fine abrasive particle. Bar spacing, blockage, headloss and cleaning must match the protected intake and equipment.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00238",
                            "set": 1,
                ...
                {
                    "id": "check-hydr626-00034",
                    "status": "review",
                    "prompt": "For BEIRI settling basin which of the following statement is false?",
                ...
                {
                    "id": "check-hydr626-00035",
                    "status": "review",
                    "prompt": "Submerged intake is located at.",
                ...
                {
                    "id": "check-hydr626-00036",
                    "status": "review",
                    "prompt": "Which of the following is incorrect for settling basin?",
                ...
                {
                    "id": "check-hydr626-00129",
                    "status": "review",
                    "prompt": "To avoid the possible damage to the wicket gates and turbine runners",
                    "html": "<p><strong>Trash racks intercept debris that could damage machinery.</strong> A rack-and-trolley installation still uses the same rack protection principle, so those choices may overlap. Fine abrasive sediment can pass through and needs separate handling.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00129",
                            "set": 15,
                ...
                {
                    "id": "check-hydr626-00215",
                    "status": "review",
                    "prompt": "River intake is usually situated on",
                ...
                {
                    "id": "check-hydr626-00218",
                    "status": "review",
                    "prompt": "Which of the following is NOT a factor that affects the design of an intake structure?",
                ...
                {
                    "id": "check-hydr626-00220",
                    "status": "review",
                    "prompt": "Trash racks are built for:",
                    "html": "<p><strong>Trash racks intercept suitable debris before machinery.</strong> They do not remove every fine abrasive particle. Bar spacing, blockage, headloss and cleaning must match the protected intake and equipment.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00220",
                ...
                {
                    "id": "check-hydr626-00251",
                    "status": "review",
                    "prompt": "By constructing which structure we can help the fish in their migration?",
                    "html": "<p><strong>Bank check: objectives need operating conditions.</strong> </p><p>HYDR626-00251 correctly identifies a fish ladder's purpose, but successful passage needs species-appropriate hydraulics and water supply. </p><p>An ordinary scouring sluice or trash rack is not automatically a safe fishway or fish screen.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00251",
                            "set": 27,
                ...
                {
                    "id": "check-hydr626-00254",
                    "status": "review",
                    "prompt": "What are the types of sediment load?",
                    "html": "<p><strong>Bank check: separate solutes, grain size and transport mode.</strong> </p><p>HYDR626-00254's dissolved load belongs to a broad river-material classification; it is not particulate material removed by ordinary settling. </p><p>The design target is specified settleable suspended classes, not necessarily only fines and not every suspended particle.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00254",
                            "set": 28,
                ...
                {
                    "id": "check-hydr626-00257",
                    "status": "review",
                    "prompt": "Settling basin is located in the canal at",
                    "html": "<p><strong>Coarse removal normally precedes finer settling where both are needed.</strong> A gravel trap can protect a downstream settling basin. Actual sediment grading, layout and maintenance determine which structures are appropriate.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00257",
                            "set": 28,
                ...
                {
                    "id": "check-hydr626-00258",
                    "status": "review",
                    "prompt": "The settling basin are designed to settle",
                    "html": "<p><strong>Bank check: separate solutes, grain size and transport mode.</strong> </p><p>In HYDR626-00258, coarse and suspended are not mutually exclusive: coarse suspended sand can settle too. </p><p>The design target is specified settleable suspended classes, not necessarily only fines and not every suspended particle.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00258",
                            "set": 28,
                ...
                {
                    "id": "check-hydr626-00259",
                    "status": "review",
                    "prompt": "Which of the following design criteria are important for design of settling basin",
                ...
                {
                    "id": "check-hydr626-00260",
                    "status": "review",
                    "prompt": "In which zone of settling basin, the transitions from canal to settling zone occurs",
                    "html": "<p><strong>Bank check: functional zones are not sharp settling boundaries.</strong> </p><p>HYDR626-00260's inlet commonly includes its transition, so the two labels need a diagram to be exclusive. </p>",
                    "sources": [
                        {
                            "id": "HYDR626-00260",
                            "set": 28,
                ...
                {
                    "id": "check-hydr626-00261",
                    "status": "review",
                    "prompt": "In which range the gradual expansion of inlet gives smooth transition in settling basin",
                ...
                {
                    "id": "check-hydr626-00262",
                    "status": "review",
                    "prompt": "In which zone of settling basin the suspended particles starts to settle down",
                    "html": "<p><strong>Bank check: functional zones are not sharp settling boundaries.</strong> </p><p>HYDR626-00262 should identify the main intended removal region, not claim particles only start falling there. </p>",
                    "sources": [
                        {
                            "id": "HYDR626-00262",
                            "set": 29,
                ...
                {
                    "id": "check-hydr626-00263",
                    "status": "review",
                    "prompt": "Which zone is larger in length in settling basin?",
                    "html": "<p><strong>Bank check: functional zones are not sharp settling boundaries.</strong> </p><p>HYDR626-00263's long settling zone is typical of a conventional layout, not a universal proportion or permission to count all transition area as active settling area.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00263",
                            "set": 29,
                ...
                {
                    "id": "check-hydr626-00264",
                    "status": "review",
                    "prompt": "If G is the discharge in m³/sec, T is sediment emptying frequency in seconds and C is sediment concentration kg/m³ then sediment load can be computed from",
                ...
                {
                    "id": "check-hydr626-00265",
                    "status": "review",
                    "prompt": "The methods which are adopted in sediment handling are",
                    "html": "<p><strong>Bank check: sediment management reduces and redistributes a load.</strong> </p><p>HYDR626-00265's watershed measures reduce sediment supply rather than eliminating it. </p><p>Exclusion, deposition and removal are different stages, each with its own capacity and maintenance requirements.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00265",
                            "set": 29,
                ...
                {
                    "id": "check-hydr626-00266",
                    "status": "review",
                    "prompt": "What is the volume of silt accumulated in a period of 10 days if the sediment concentration of the flow is 5kg/m³ for a discharge of 25 cumecs and silt density of 2400kg/m³ and a packing factor of 1.2",
                ...
                {
                    "id": "check-hydr626-00269",
                    "status": "review",
                    "prompt": "Which of the following is component of ROR plant",
                    "html": "<p><strong>Bank check: plant and headworks use different boundaries.</strong> </p><p>HYDR626-00269 includes the powerhouse as part of the complete ROR plant. </p>",
                    "sources": [
                        {
                            "id": "HYDR626-00269",
                            "set": 29,
                ...
                {
                    "id": "check-hydr626-00270",
                    "status": "review",
                    "prompt": "Which of the following is the component of ROR head work",
                    "html": "<p>HYDR626-00270 lists intake-side river headworks. </p><p>An under-sluice and basin flushing outlet are branches, not compulsory series elements before the turbine; ROR also does not forbid limited diversion pondage.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00270",
                            "set": 29,
                ...
                {
                    "id": "check-hydr626-00271",
                    "status": "review",
                    "prompt": "Bottom intake is suitable for project having",
                    "html": "<p><strong>Bank check: correct the explained route, not the stored question.</strong> </p><p>In HYDR626-00271, diverted water passes <strong>through</strong> the Tyrolean rack into its collector; excluded coarse bed load travels <strong>over</strong> the rack downstream, not underneath into that collector. </p><p>Flat-reach limitations and steep-reach suitability require the actual sediment and hydraulic setting.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00271",
                            "set": 30,
                ...
                {
                    "id": "check-hydr626-00272",
                    "status": "review",
                    "prompt": "Bottom intake is not suitable for project having",
                    "html": "<p><strong>Bank check: correct the explained route, not the stored question.</strong> </p><p>HYDR626-00272's malformed numerical option supplies no 10% gradient threshold. </p>",
                    "sources": [
                        {
                            "id": "HYDR626-00272",
                            "set": 30,
                ...
                {
                    "id": "check-hydr626-00273",
                    "status": "review",
                    "prompt": "Which of the following are feature ideal headworks",
                    "html": "<p><strong>Bank check: objectives need operating conditions.</strong> </p><p>HYDR626-00273's reliable supply, economy and debris/ice protection are design aims, not guarantees of zero maintenance or damage. </p>",
                    "sources": [
                        {
                            "id": "HYDR626-00273",
                            "set": 30,
                ...
                {
                    "id": "check-hydr626-00275",
                    "status": "review",
                    "prompt": "Undersluice is constructed",
                ...
                {
                    "id": "check-hydr626-00276",
                    "status": "review",
                    "prompt": "Design discharge of intake will be taken",
