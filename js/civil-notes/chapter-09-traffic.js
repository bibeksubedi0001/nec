(function () {
    ...
    Object.assign(registry, {
        ACiE0904: {
            code: "ACiE0904",
            questionCount: 66,
            formulaSheet: "<table><thead><tr><th scope='col'>Quantity</th><th scope='col'>Relation and basis</th></tr></thead><tbody><tr><th scope='row'>Reaction and braking</th><td>d<sub>r</sub> = vt<sub>r</sub>; d<sub>b</sub> = v<sup>2</sup>/(2a).</td></tr><tr><th scope='row'>Flow relation</th><td>q = N/T; density k = N/L; q = kV<sub>s</sub>.</td></tr><tr><th scope='row'>PCU stream</th><td>N<sub>PCU</sub> = ΣE<sub>i</sub>N<sub>i</sub>.</td></tr><tr><th scope='row'>Peak-hour factor</th><td>PHF = N<sub>h</sub>/(4N<sub>15,max</sub>); 0.25 ≤ PHF ≤ 1.</td></tr><tr><th scope='row'>Mean speeds</th><td>V<sub>t</sub> = Σn<sub>i</sub>v<sub>i</sub>/Σn<sub>i</sub>; V<sub>s</sub> = Σn<sub>i</sub>/Σ(n<sub>i</sub>/v<sub>i</sub>); V<sub>t</sub> = V<sub>s</sub> + σ<sub>s</sub><sup>2</sup>/V<sub>s</sub>.</td></tr><tr><th scope='row'>Greenshields</th><td>V = V<sub>f</sub>(1 − k/k<sub>j</sub>); k<sub>c</sub> = k<sub>j</sub>/2; q<sub>max</sub> = V<sub>f</sub>k<sub>j</sub>/4.</td></tr><tr><th scope='row'>Signals</th><td>Effective green g = G + a + r − (l<sub>1</sub> + l<sub>2</sub>); Σg<sub>i</sub> = C − L; capacity c = s(g/C).</td></tr><tr><th scope='row'>Webster cycle</th><td>C<sub>0</sub> = (1.5L + 5)/(1 − Y), y = q/s.</td></tr><tr><th scope='row'>Roundabout radius</th><td>e + f = V<sup>2</sup>/(127R).</td></tr><tr><th scope='row'>Crash rate</th><td>R = 10<sup>6</sup>A/(AADT·D·L<sub>km</sub>) per million vehicle-km.</td></tr></tbody></table>",
            blocks: [
                {
                    id: "traffic-purpose-studies-and-taxonomies",
                    title: "Traffic engineering starts with a problem, evidence and road users",
                    html: "<p><strong>Traffic engineering applies engineering analysis to the safe, efficient and convenient movement of people and goods.</strong> Its subject is not simply fast vehicles. Access, pedestrian movement, freight, public transport, delay, reliability and the number and severity of crashes all matter. A proposal that increases vehicle speed while making crossings dangerous has not automatically improved the transport system.</p><p>The official ACiE0904 scope includes human and vehicle characteristics, operations, regulation and controls, traffic studies, intersections, signals, night visibility and safety. A useful study sequence is to define the problem and observation boundary, collect appropriate evidence, analyse alternatives, and evaluate their effects. Data collection is foundational, and volume counts often support later studies, but a specific crash or accessibility problem need not begin with a volume survey.</p><table><thead><tr><th scope='col'>Study</th><th scope='col'>Question answered</th></tr></thead><tbody><tr><th scope='row'>Volume and classification</th><td>How many users or vehicles pass, in which movements and periods?</td></tr><tr><th scope='row'>Speed and travel time</th><td>How fast do users move, and where does travel time accumulate?</td></tr><tr><th scope='row'>Origin–destination</th><td>Where do trips begin and end, and what connections do they require?</td></tr><tr><th scope='row'>Capacity and flow</th><td>How does demand interact with available service, queues and bottlenecks?</td></tr><tr><th scope='row'>Parking and crashes</th><td>How are spaces used, and what safety patterns warrant investigation?</td></tr></tbody></table><p><small>Evidence boundary: links identify the 66 assigned bank records, not endorsement of every stored key or explanation.  All invented datasets are labelled syllabus extensions with empty bank-source lists. These are educational analyses and document comparisons, not approved designs, current-law certification, instructions to operate traffic controls, or field implementation plans.</small></p>",
                    moreHtml: "<p>The human–vehicle–roadway grouping is a useful three-part model. The bank also lists seven departmental categories: characteristics, studies and analysis, operations, planning and analysis, design, administration and research. These are <strong>classification conventions, not universal counts</strong>. Inventories, administrative and economic studies can support the same project; dynamic traffic analysis is not invalid merely because one textbook groups studies differently. Models are used in volume, parking and crash analysis, not exclusively in one study category.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><em>Syllabus extension: human characteristics beyond the assigned classification questions.</em> The bank supplies no complete human-response experiment. The following comparison is hypothetical, not a recovered question or a prescribed reaction-time standard.</p><ul><li><strong>Vision:</strong> acuity, peripheral detection, contrast sensitivity and adaptation affect whether an object is noticed and identified. Seeing a bright lamp is not the same as recognising a pedestrian beside it.</li><li><strong>Information load:</strong> a legible sign can still be ineffective if several competing messages arrive too late for a decision. Consistent layouts reduce unnecessary interpretation.</li><li><strong>Movement ability:</strong> walking speed, balance, wheelchair use and sensory limitations affect access and crossing needs. An average user does not represent every user.</li><li><strong>Expectation:</strong> an unexpected lane termination or ambiguous priority can demand more decision time than a familiar, predictable situation.</li></ul><p>Reaction travel follows <strong>d<sub>r</sub> = vt<sub>r</sub></strong> with v in m/s and t<sub>r</sub> in seconds. For an <strong>invented comparison</strong>, a vehicle continues at 36 km/h, or 10 m/s, before braking. Assumed response times of 1.5 s and 2.5 s give 15 m and 25 m of reaction travel. The extra second consumes 10 m before braking begins; these distances are not total stopping distances.</p>",
                    moreHtml: "<p><strong>A road user must detect information, understand it, decide and act.</strong> PIEV is a traditional mnemonic for perception, intellection, emotion and volition. It is a teaching framework rather than a sequence of separately fixed biological timers. Familiarity, expectation, distraction, fatigue, impairment, age and the complexity of the decision affect response. A design reaction-time assumption is neither a biological maximum nor a guarantee that everyone responds within it.</p><p>Planning implications include understandable junctions, adequate visibility, manageable approach speeds, accessible crossings and consistent guidance. Education helps explain a system, but it cannot compensate for every misleading layout or remove the need to accommodate human error.</p>",
                    sources: []
                },
                {
                    id: "traffic-vehicle-characteristics",
                    title: "Dimensions, swept paths and performance describe different vehicle effects",
                    html: "<p><em>Syllabus extension: vehicular characteristics and their planning consequences.</em> No assigned question supplies a complete design-vehicle envelope, swept-path analysis or braking dataset. Dimensions and performance limits must come from the applicable vehicle and road-design basis, not from an unrelated bank item.</p><table><thead><tr><th scope='col'>Characteristic</th><th scope='col'>Why it matters</th></tr></thead><tbody><tr><th scope='row'>Width, height and length</th><td>Influence lateral space, overhead clearance, storage length and obstruction of sight lines. A design envelope is not a statement of every current legal limit.</td></tr><tr><th scope='row'>Wheelbase and overhang</th><td>Wheelbase is axle-centre spacing, not overall length. Rear-wheel off-tracking and body overhang affect the swept envelope through a turn.</td></tr><tr><th scope='row'>Articulation</th><td>A tractor–trailer combination follows different paths from a rigid vehicle of similar overall length.</td></tr><tr><th scope='row'>Acceleration and climbing</th><td>Power-to-mass ratio, loading and gradients influence discharge, merging and speed differences.</td></tr><tr><th scope='row'>Braking and stability</th><td>Tyres, brakes, surface friction, wetness, loading and gradient affect deceleration and control.</td></tr></tbody></table><p>For a simplified level-road motion model with constant positive deceleration magnitude a, <strong>d<sub>b</sub> = v<sup>2</sup>/(2a)</strong>. An <strong>invented mechanics example</strong> uses a = 4 m/s<sup>2</sup>: braking from 10 m/s requires 12.5 m, while braking from 20 m/s requires 50 m. Doubling speed quadruples braking distance in this model. Reaction travel is additional; the assumed deceleration is not a recommended field value.</p>",
                    moreHtml: "<p>A bus may carry many people while occupying more road space than a car; counting vehicles alone misses that distinction. A truck's effect on traffic operations also differs from its effect on pavement damage. Neither a passenger-car equivalent nor gross vehicle length supplies an axle-load spectrum. Planning therefore considers person movement, operational space, dynamic performance and structural loading separately.</p>",
                    sources: []
                },
                {
                    id: "traffic-vulnerable-users-and-regulation",
                    title: "Regulation and the three Es serve all road users",
                    html: "<p><strong>Vehicular and pedestrian traffic are both part of road traffic.</strong> Bicycles belong within vehicular traffic even though their users, like motorcyclists and pedestrians, have little external protection. Pedestrians are the most vulnerable choice among the bank's offered categories; that answer must not erase other vulnerable users or imply identical risk for every pedestrian.</p><table><thead><tr><th scope='col'>Traditional E</th><th scope='col'>Contribution</th></tr></thead><tbody><tr><th scope='row'>Engineering</th><td>Road layout, visibility, separation, crossings and intelligible controls reduce opportunities for serious conflict.</td></tr><tr><th scope='row'>Education</th><td>Users learn the meaning of controls, shared responsibilities and the limitations of vehicles and human perception.</td></tr><tr><th scope='row'>Enforcement</th><td>Authorised institutions support compliance with applicable rules; a sign alone does not establish effective compliance.</td></tr></tbody></table>",
                    moreHtml: "<p>Traffic regulation concerns interacting subjects rather than a universal sequence of four implementation stages. <strong>Driver controls</strong> address competence and behaviour; <strong>vehicle controls</strong> address fitness and permitted characteristics; <strong>flow controls</strong> address movements, priority, speed and use of road space; broader administrative controls provide the institutional framework. The bank's driver-first order is a teaching convention, not a verified chronology of Nepal's legislation.</p><p>The <strong>engineering, education and enforcement</strong> mnemonic is useful but not an exhaustive modern safety framework. Safe vehicles, speed management, emergency response and evaluation also matter. Pedestrians are not obstructions to be removed from the analysis: walking links, public-transport access, crossing demand and accessibility belong in the design problem. Reducing exposure to high-energy conflicts is more meaningful than maximising vehicle speed without regard to injury consequences.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>The fundamental traffic-stream variables are flow, density and speed.</strong> Flow measures passage per time, density measures vehicles present per road length, and speed measures distance per time. PCU, the passenger car unit, is a unit of equivalent traffic, not a fourth independent stream variable and not itself the conversion factor.</p><p>A <strong>passenger-car-equivalency factor</strong> converts a vehicle class into equivalent passenger-car units under an adopted method. For classified counts N<sub>i</sub> and factors E<sub>i</sub>, the equivalent count is <strong>N<sub>PCU</sub> = ΣE<sub>i</sub>N<sub>i</sub></strong>. </p><table><thead><tr><th scope='col'>Quantity</th><th scope='col'>Purpose and unit</th></tr></thead><tbody><tr><th scope='row'>Vehicle count or flow</th><td>Actual vehicles or vehicles/h within the declared counting boundary.</td></tr><tr><th scope='row'>Equivalent operational flow</th><td>PCU/h, using a specified equivalency method.</td></tr><tr><th scope='row'>Person movement</th><td>Persons or persons/h; requires occupancy or direct person counts, not PCU alone.</td></tr><tr><th scope='row'>Pavement loading</th><td>Axle-load spectra or equivalent standard-axle repetitions under a pavement-damage model, not PCU.</td></tr></tbody></table>",
                    moreHtml: "<p>Dividing by an observation time in hours gives PCU/h. The factors depend on the analysis method and may depend on road width, gradients, traffic mix, vehicle performance and prevailing operation; a single timeless factor for every truck or motorcycle is not assumed.</p><p>Do not multiply a vehicle flow by an equivalency factor, leave density in actual vehicles/km, and then expect a mixed-unit flow–density identity to hold. Likewise, an AADT value containing all vehicles does not by itself reveal the commercial-vehicle count, directional axle distribution or pavement damage. Keep the measurement basis attached to every calculation.</p>",
                ...
                },
                {
                    ...
                    html: "<p><strong>Demand, observed flow, capacity and level of service are different quantities.</strong> Demand is the traffic seeking service. Observed flow is what passes the observation point. </p><ul><li><strong>Geometry:</strong> lane width and number, gradient, lateral clearance, alignment and junction layout affect movement.</li><li><strong>Traffic:</strong> composition, turning proportions, lane use, vehicle performance and driver behaviour affect service.</li><li><strong>Control:</strong> signal allocation, priority and permitted movements determine when conflicting streams can be served.</li><li><strong>Environment:</strong> weather, visibility, incidents, roadside activity and downstream blocking can change the prevailing conditions.</li></ul><p>For a signal lane group, <strong>c = s(g/C)</strong>: saturation flow s is multiplied by the effective-green fraction. This directly shows why a traffic control device can affect capacity. All four alternatives in the bank's capacity-factor question can influence capacity; the explanation's distinction between management and physical capacity does not justify excluding controls from the broadly worded question.</p><p>An uncontrolled or priority intersection depends on conflicting flows, available gaps, turning demand, geometry and behaviour. The bank's <strong>1200–1400 vehicles/h</strong> range is not a transferable capacity for every uncontrolled junction, and changing vehicles/h to PCU/h in the explanation does not repair the missing basis.</p>",
                    moreHtml: "<p>Capacity is an estimated maximum sustainable service rate for specified prevailing conditions and an analysis period; it is not a universal highest-safe-flow guarantee. A downstream bottleneck can suppress observed flow while demand and queues grow upstream.</p><p>Degree of saturation compares compatible demand and capacity, often as q/c. A value below one does not mean zero delay: vehicles can still wait during red or for an acceptable gap. Level of service describes an operating quality under a named facility-specific method; travel speed, delay and density play different roles for different facilities. Daily service volumes must not be relabelled as hourly per-lane capacities.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Parking studies examine available spaces and the demand to occupy them.</strong> An inventory records the location, number, restrictions, access and suitability of spaces. An occupancy survey records use. A full facility can conceal rejected demand, circulating search traffic or displaced parking; low occupancy can reflect price or access restrictions. Observed occupancy alone is therefore not total latent demand.</p><table><thead><tr><th scope='col'>Measure</th><th scope='col'>Definition</th></tr></thead><tbody><tr><th scope='row'>Accumulation A(t)</th><td>Vehicles present at a given instant; initial accumulation plus entries minus exits.</td></tr><tr><th scope='row'>Parking volume</th><td>Parking visits in a declared period. Repeated visits and distinct vehicles are different counts.</td></tr><tr><th scope='row'>Parking load</th><td>Integral of accumulation over time, in vehicle-hours when time is in hours.</td></tr><tr><th scope='row'>Occupancy or index</th><td>Occupied vehicle-hours divided by compatible available bay-hours, commonly expressed as a percentage.</td></tr><tr><th scope='row'>Turnover</th><td>Visits per bay during the stated period, or visits per bay-hour if expressly time-normalised.</td></tr></tbody></table>",
                    moreHtml: "<p><strong>On-street or kerb parking</strong> is classified by location beside the road. <strong>Off-street parking</strong> is provided in a separate lot, structure or similar facility away from the carriageway. Parallel, angled and right-angle parking describe orientation, not that location classification. Both parallel and angled arrangements can occur off-street; merely saying along the kerb does not necessarily mean parallel orientation.</p><p>Duration distributions distinguish short visits from long stays. Mean duration calculated as load divided by visits needs the same observation boundary or a complete compatible cohort. A stay beginning before the survey or ending after it is truncated unless its full duration is obtained separately.</p><p>Angled parking can fit more vehicles per metre of kerb but uses different depth and manoeuvring space. That is not proof of greater efficiency per square metre of total site area. Access, visibility, pedestrians, loading activity and reversing interactions remain part of the assessment.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><em>Syllabus extension: this is a wholly hypothetical, non-personal parking dataset.</em> Assume 20 usable bays remain available throughout a two-hour observation. There are 24 parking visits, all beginning and ending inside the window, no initial or final occupied bays, and a measured sum of complete stay durations of 16 vehicle-hours. No individual identifiers are needed.</p><p>Available space-time is <strong>20 × 2 = 40 bay-hours</strong>. Parking load is <strong>P = ∫A(t)dt = 16 vehicle-hours</strong>, equivalently the sum of those complete visits' durations. The mean accumulation is <strong>16/2 = 8 vehicles</strong>, but this average does not reveal peak accumulation or when spaces were unavailable.</p><table><thead><tr><th scope='col'>Measure</th><th scope='col'>Calculation and interpretation</th></tr></thead><tbody><tr><th scope='row'>Occupancy</th><td>100 × 16/40 = <strong>40%</strong> of available bay-hours occupied.</td></tr><tr><th scope='row'>Mean duration</th><td>16/24 h = <strong>40 minutes per visit</strong> for this complete cohort.</td></tr><tr><th scope='row'>Period turnover</th><td>24/20 = <strong>1.2 visits/bay over two hours</strong>.</td></tr><tr><th scope='row'>Time-normalised turnover</th><td>24/(20 × 2) = <strong>0.6 visits/(bay·hour)</strong>.</td></tr></tbody></table><p>These totals do not reveal the number of distinct vehicles, the number of people visiting, rejected demand or parking search time. A turnover of 1.2 is neither an occupancy percentage nor necessarily 1.2 per hour. The complete-cohort assumptions make this arithmetic valid; they are not claims about the missing data in any bank question.</p>",
                    moreHtml: "<p>The numerator and denominator must describe the same usable facility and period. If bays close partway through a survey, available bay-hours are summed over the varying supply rather than assumed constant. If the load includes carry-in vehicles but volume counts only new arrivals, load/volume is not the mean full duration of those arrivals.</p>",
                    sources: []
                },
                {
                    id: "traffic-crash-studies-and-diagrams",
                    title: "A collision diagram reveals patterns, not proof of a single cause",
                    html: "<p><strong>Crash studies examine the occurrence, severity and circumstances of collisions.</strong> The bank uses accident terminology; the engineering task is to understand preventable risk rather than assume every event was unavoidable. Useful records distinguish location, date, movement, crash type, severity, road condition, lighting and the relevant exposure. Aggregation should avoid unnecessary personal details.</p><ul><li><strong>Frequency:</strong> count events over an identified period and spatial boundary.</li><li><strong>Severity:</strong> distinguish outcome categories under the source's definitions; a total can conceal a change in serious injuries.</li><li><strong>Exposure:</strong> traffic volume and, for segments, distance travelled affect the opportunity for events. Raw counts alone are not comparable risk rates.</li><li><strong>Quality:</strong> missing reports, location errors, changing definitions and underreporting influence the apparent pattern.</li></ul>",
                    moreHtml: "<p>A <strong>collision diagram</strong> schematically places crash movements and types at a location. A cluster of similar turning or crossing events can suggest a conflict needing investigation. A <strong>condition diagram</strong> records features such as layout, controls, accesses, visibility obstructions and roadside conditions. The two diagrams answer complementary questions: what happened and what physical or operational circumstances were present.</p><p>A diagram cannot establish causation merely because several symbols are close together. Comparison sites, operational observations, road-user behaviour and physical evidence help distinguish hypotheses. Before-and-after evaluation should consider exposure changes, broader trends and <strong>regression to the mean</strong>: a site selected after an unusually bad period may improve partly through random fluctuation.</p><p>A blackspot designation requires the applicable authority's definition and screening method. No universal threshold such as a fixed number of crashes is invented here. The bank's record-of-occurrence answer captures the diagram's purpose, but its incomplete alternatives do not justify treating the diagram as a complete safety assessment.</p>",
                ...
                },
                {
                    ...
                    html: "<p><em>Syllabus extension: all crash counts, traffic volumes, lengths and periods below are invented.</em> They are not reports about a real road or people. The formulas use metric exposure units derived explicitly; a foreign reference's vehicle-mile convention is not silently relabelled vehicle-km.</p><p>For A crashes on a segment of length L<sub>km</sub>, with representative AADT over D days, <strong>R<sub>segment</sub> = 10<sup>6</sup>A/(AADT × D × L<sub>km</sub>)</strong>. The denominator is vehicle-km, giving <strong>crashes per million vehicle-km</strong>. AADT and crash coverage must include the same direction or directions and the same segment.</p><p>Assume 30 crashes, AADT = 10,000 vehicles/day, D = 1095 days and L = 2 km. Exposure is <strong>21,900,000 vehicle-km</strong>; <strong>R = 30/21.9 = 1.37 crashes per million vehicle-km</strong>, rounded. The explicitly assumed 1095 days must not replace actual elapsed days when a real study spans a leap day.</p><p>For an intersection, use total entering traffic over the matched study period: <strong>R<sub>intersection</sub> = 10<sup>6</sup>A/(AADT<sub>entering</sub> × D)</strong>. There is <strong>no segment-length multiplier</strong>. With 12 hypothetical crashes, 20,000 entering vehicles/day and 1095 days, exposure is 21,900,000 entering vehicles and the rate is <strong>12/21.9 = 0.548 crashes per million entering vehicles</strong>, rounded. This is not the same risk measure as the segment result.</p>",
                    moreHtml: "<p>Entering AADT sums the inbound approaches without adding the corresponding exits a second time. When exposure varies materially by day, year or subsegment, sum compatible traffic exposure rather than imposing a constant AADT. Keep crash severities, reporting definitions, dates and spatial limits consistent in comparisons.</p><p><strong>No zero denominator is allowed.</strong> Missing or zero exposure makes the normalised rate unavailable, not automatically zero or a usable infinite risk score. Zero crashes with positive exposure gives an observed zero rate, not proof of zero underlying risk. Low event counts require caution about uncertainty, even when arithmetic is exact.</p>",
                    sources: []
                },
                {
                    id: "traffic-intersection-and-interchange-conflicts",
                    title: "Grade separation removes crossings, not every interaction",
                    html: "<p><strong>At-grade intersections bring roads together on the same level.</strong> T, Y, crossroad, staggered and multi-leg configurations impose different movement and visibility problems. Channelisation uses lanes, islands or markings to organise paths; it can simplify decisions but does not automatically eliminate conflicts or justify higher speeds.</p><table><thead><tr><th scope='col'>Interaction</th><th scope='col'>Meaning</th></tr></thead><tbody><tr><th scope='row'>Crossing</th><td>Paths intersect across each other; pedestrian crossings must be considered as well as vehicle movements.</td></tr><tr><th scope='row'>Merging</th><td>Streams join and compete for a common downstream path.</td></tr><tr><th scope='row'>Diverging</th><td>A stream separates into different paths, with possible speed changes and lane-choice interactions.</td></tr><tr><th scope='row'>Weaving</th><td>Entering and leaving streams exchange relative positions over a common road length.</td></tr></tbody></table>",
                    moreHtml: "<p><strong>Grade separation</strong> carries the crossing roads at different levels. A crossing without connecting ramps is not necessarily an interchange; an <strong>interchange</strong> also provides traffic connections. Grade separation removes the main-road crossing interaction, while ramp merges, diverges, weaving and any at-grade ramp terminals still need assessment.</p><p>A diamond commonly has ramp-terminal junctions on the crossroad. A trumpet is commonly suited to a three-leg connection and is not inherently an at-grade-conflict layout. A full cloverleaf provides loop connections for the crossing turns but introduces weaving in its conventional arrangement. <strong>In Nepal's left-driving arrangement, conventional cloverleaf loops serve right turns</strong>; importing the US right-driving left-turn explanation reverses the movement.</p><p>Direct, semi-direct and indirect or loop describe <strong>ramp forms</strong>; cloverleaf describes the overall interchange arrangement. Selection depends on demand by movement, land, speed consistency, weaving, queue storage, pedestrian and cycle access, cost and surrounding connections. No layout is automatically conflict-free, highest-capacity or safest in all circumstances. The number of arms alone also does not equal the number of individual traffic movements or conflict points.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Signals allocate opportunities for conflicting movements in time.</strong> Appropriate phasing can reduce crossing and some turning conflicts and provide more orderly service, including pedestrian opportunities. </p><p>The bank associates <strong>amber</strong> with clearance time. More precisely, the yellow or amber change interval and an <strong>all-red clearance interval</strong> are distinct parts of signal timing. The inspected Nepal Traffic Signs Manual, August 1997, §E5.3 explains signal indications, but expressly does not provide a comprehensive phasing-design guide. Amber is not unrestricted permission to enter the junction; green is also subject to movement restrictions and conflicts allowed by the particular design.</p><p>One consistent accounting convention is <strong>g = G + a + r − (l<sub>1</sub> + l<sub>2</sub>)</strong>, where a is yellow, r is all-red, l<sub>1</sub> is startup loss and l<sub>2</sub> is clearance loss. All intervals use the same time unit. Clearance loss must include the unused clearance intervals under that convention: adding all-red and then forgetting to account for its unused time would create fictitious capacity.</p><p>For a simple sequence of non-overlapping critical phases, <strong>Σg<sub>i</sub> = C − L</strong>, where C is cycle length and L total lost time. Overlapping phases require their actual critical-path accounting rather than summing every lane group's green. These definitions support paper analysis only; site-specific pedestrian, clearance, controller and conflict checks are indispensable before any authorised implementation.</p>",
                    moreHtml: "<p>Stopping and queueing can increase rear-end crashes. Neither a safety improvement nor a rear-end increase is inevitable at every installation, and a permissive turning movement can retain conflicts even during green.</p><p>For analysis, <strong>displayed green G</strong> is the visible indication duration. <strong>Effective green g</strong> is an equivalent duration of service at the saturation discharge rate. Startup losses mean the first part of a queue's discharge is not at its settled saturation rate; some usable discharge can occur outside the displayed green. Therefore g and G need not be equal.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><em>Syllabus extension: all signal timings and flows in this block are hypothetical accounting inputs.</em> They are not bank givens, recommended clearance intervals, controller settings or a plan for a real intersection. Assume an otherwise unblocked lane group with a standing queue able to use its effective green.</p><p>Suppose saturation flow is <strong>s = 1800 PCU/h</strong>, effective green is <strong>g = 30 s</strong> and cycle length is <strong>C = 90 s</strong>. Since g/C is dimensionless, <strong>c = s(g/C) = 1800(30/90) = 600 PCU/h</strong>. Saturation flow describes service during effective green, not the group's average service throughout red and green together.</p><p>The same result follows by counting cycles. Effective discharge per cycle is <strong>1800 × 30/3600 = 15 PCU</strong>, and the hour contains <strong>3600/90 = 40 cycles</strong>. Hence <strong>15 × 40 = 600 PCU/h</strong>. Multiplying s by 30 without converting seconds to hours is dimensionally wrong; treating 15 PCU/cycle as an hourly capacity is also wrong.</p><p>For a <strong>separate illustrative time account</strong>, take displayed G = 30 s, a = 3 s, r = 1 s, startup loss l<sub>1</sub> = 2 s and clearance loss l<sub>2</sub> = 2 s. Under the stated accounting convention, <strong>g = 30 + 3 + 1 − 2 − 2 = 30 s</strong>. </p>",
                    moreHtml: "<p>The assumed clearance loss already includes unused clearance time, including the all-red in this example; it must not be added again. Equality of G and g here is a numerical coincidence, not their definition.</p><p>If demand exceeds the estimated service for a sustained period, unserved demand accumulates as a queue unless it diverts or is otherwise removed from the boundary. If downstream storage blocks the lane group, the nominal green fraction may not be usable. Lane-group saturation flow cannot be multiplied by the lane count again if it already includes those lanes. Actual timings require independent safety and facility-specific checks beyond this arithmetic.</p>",
                    sources: []
                },
                {
                ...
                },
                {
                    ...
                    html: "<p><strong>The inspected source is the Department of Roads Traffic Signs Manual, Volume 1, August 1997.</strong> Its government-hosted copy is evidence for that edition, not a new 2026 manual or proof that every provision remains current after all revisions. Sections D and E distinguish regulatory, warning and information functions; signs work through consistent meaning, visibility and recognition, not colour alone.</p><p><strong>Regulatory signs</strong> convey requirements or prohibitions and are mostly circular. Important distinctive forms are <strong>STOP: a red octagon with a white border</strong>, and <strong>Give Way: an inverted triangle with a red border and white background</strong>, confirmed in schedules A1 and A2. They are regulatory exceptions, not warning signs. Even the remaining regulatory schedule should not be described as exceptionlessly circular.</p><table><thead><tr><th scope='col'>Information example</th><th scope='col'>1997 background context</th></tr></thead><tbody><tr><th scope='row'>Parking place, C3</th><td>Blue, with white identifying detail.</td></tr><tr><th scope='row'>Place and local direction information</th><td>White is used for identified types and local-route contexts.</td></tr><tr><th scope='row'>National-route direction information</th><td>Green occurs in the specified direction-sign arrangements.</td></tr><tr><th scope='row'>Temporary diversion direction</th><td>Yellow with black information.</td></tr></tbody></table><p>Section E4.3 and the individual schedules establish that <strong>informatory backgrounds are not universally white</strong>. The full road-on/road-to matrix in Table 3 is not reproduced from its flattened text extraction. </p>",
                    moreHtml: "<p><strong>Most warning signs</strong> are upright triangles with a red border, white background and black hazard symbol. This is not the US yellow-diamond convention, and most does not mean every schedule item: chevrons, obstruction markers and some diversion signs use other forms. Supplementary plates qualify the main message rather than creating an unrelated instruction.</p><p>Classification requires the actual sign type and route context. Shape, symbol and contrast also support recognition where colour perception or viewing conditions are limited. This summary teaches recognition and source distinctions, not a complete installation specification.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><em>Syllabus extension: road-marking functions and optical behaviour have no dedicated assigned bank calculation.</em> The supporting source is the inspected DoR Traffic Signs Manual, August 1997, particularly §§E6, G2, H2 and I. This is an explanation of principles, not a road-marking work method or a claim of current dimensional compliance.</p><p>More reflected light in an unsuitable direction may create glare rather than useful recognition. Water can change the optical behaviour of a marking and its surroundings. Day/night condition assessment, legibility, skid resistance and compatibility with the intended sign or marking type therefore belong together. The 1997 manual's construction and maintenance details are not reproduced as instructions; the educational lesson is that visibility is a maintained performance, not just a colour chosen at installation.</p>",
                    moreHtml: "<p><strong>Transverse markings</strong> identify controls across a movement, such as stop and give-way lines. <strong>Longitudinal markings</strong> organise lanes, edges, restrictions and guidance along the direction of movement. Crossing markings, lane arrows and painted islands convey additional functions. A line's meaning depends on its prescribed pattern and context, not merely the fact that paint is present.</p><p>Markings provide a continuing message near the vehicle path and can complement an upright sign. They can also be hidden by queues, dirt, water or snow and worn by traffic. Clear dry-day appearance does not establish wet-night performance. Surface skid resistance is a separate requirement from optical brightness, especially for two-wheeled users and pedestrians.</p><p><strong>Retroreflection</strong> returns a significant part of incident light toward its source direction, allowing headlights and the nearby driver's eye to benefit. It is not identical to diffuse reflection from a pale surface or mirror-like specular reflection. Reflective sheeting, glass beads in markings and road studs perform differently with observation angle, approach geometry, contamination, ageing and wetness.</p>",
                    sources: []
                },
                {
                    id: "traffic-night-visibility-and-lighting",
                    title: "Night visibility depends on luminance, contrast, glare and wetness",
                    html: "<p><strong>Night visibility is the ability to detect and interpret a relevant target in its surroundings.</strong> Target size, position, observation time, contrast, driver vision, adaptation, weather and glare all matter. </p><table><thead><tr><th scope='col'>Quantity</th><th scope='col'>Meaning</th></tr></thead><tbody><tr><th scope='row'>Illuminance</th><td>Light incident per unit area, measured in <strong>lux</strong>, equivalent to lumen/m<sup>2</sup>.</td></tr><tr><th scope='row'>Luminance</th><td>Light leaving a surface toward the observer, measured in <strong>cd/m<sup>2</sup></strong>; depends on illumination, reflection and viewing geometry.</td></tr><tr><th scope='row'>Contrast</th><td>Difference between target and background appearance; a bright background may reveal a dark target but conceal a similarly bright one.</td></tr><tr><th scope='row'>Glare and uniformity</th><td>Excessive bright sources can reduce useful vision, while abrupt dark patches and nonuniformity complicate adaptation.</td></tr></tbody></table><p><strong>The bank's IRC lighting-pole clearance of 0.6 m from a raised kerb remains clause-unverified.</strong> DoR's 1997 §F3 instead gives 600 mm between <strong>any part of a sign</strong> and the <strong>outer shoulder edge</strong>, or carriageway edge without a shoulder. Equal numbers do not make these provisions equivalent. Neither value by itself establishes a safe clear zone or guarantees protection from vehicle impact.</p>",
                    moreHtml: "<p>Pavement reflectance is one factor rather than a complete safety measure. Ordinary light-coloured concrete often appears brighter than dark bituminous surfacing under comparable conditions, explaining the bank's conventional concrete answer, but this does not make every concrete road safer in every lighting condition.</p><p>Lighting assessment considers distribution, luminaire optics, spacing, mounting geometry, road layout, surroundings and maintenance. Existing electric poles can constrain a layout but do not determine an acceptable photometric result. Closer spacing alone cannot guarantee uniformity or glare control. Single-sided lighting can be economical for a suitable narrow road, but opposed, staggered or central arrangements must be compared on performance, obstacles and life-cycle cost rather than a universal cheapest-layout rule.</p><p>Wet surfaces can redistribute reflections and increase glare or reduce marking conspicuity. An assessment of pavement brightness alone misses the visibility of pedestrians at edges and crossings. Relevant target contrast and light reaching vertical objects may differ from the average light on the carriageway.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><em>Syllabus extension: safety-audit concepts and roadside-risk integration are not directly tested by the assigned 66 records.</em> The process below is general educational practice, not a transcription of Nepal's Road Safety Audit Manual. That manual's full procedure and any later revisions have not been verified for these notes.</p><ol><li><strong>Understand the proposal and users:</strong> consider how people actually approach, cross, turn, stop and access adjacent land, including vulnerable users and maintenance needs.</li><li><strong>Identify potential conflicts and consequences:</strong> examine visibility, speed consistency, misleading layouts, pedestrian continuity, roadside hazards and night or wet-weather conditions.</li><li><strong>Explain findings:</strong> describe the location, affected user and plausible risk mechanism rather than presenting an unexplained checklist score.</li><li><strong>Record responses and follow-up:</strong> the responsible design or road authority evaluates findings and records action or reasons for a different response. Audit does not replace its design responsibility.</li></ol><p>The inspected <strong>MoPIT/NRSC Road Safety Note 2, Designing Safer Side Drains, Final (Revised), June 2024</strong>, §4 connects drainage condition with roadside safety. Relevant concerns include shoulder drop-off, eroded slopes, protruding headwalls, blockages, bicycle-trapping grates and nontraversable drainage structures in roadside recovery space. A hydraulically adequate drain can still be a collision or pedestrian hazard; a shallow-looking drain is not automatically safe.</p><p>The 2024 note is explicitly revised, but that title alone does not prove that every 1996 provision was formally withdrawn. No universal drain depth, barrier layout, blackspot threshold or field-control procedure is supplied here. Real interventions require the applicable current documents, competent assessment and authorised design and implementation.</p>",
                    moreHtml: "<p><strong>A road-safety audit is a structured, independent examination of potential safety problems for all road users.</strong> It can identify risks during planning, design or pre-opening review before a crash pattern develops. Examination of an existing road's safety conditions is also valuable, although the responsible authority may distinguish audits from safety inspections. Neither is merely checking that dimensions match a standard.</p><p>Safety measures work as a system: manageable conflict speeds, understandable priority, accessible walking routes, suitable crossings, sound vehicle condition, maintained guidance and effective post-crash response. A warning sign cannot cure every deficient layout. Evaluation should test the intended safety mechanism and consider unintended effects, not just count installations.</p>",
                    sources: []
                }
            ],
            gaps: [
            ...
            cautions: [
                ...
                {
                    "id": "check-tran808-00262",
                    "status": "review",
                    "prompt": "Which of the following is not an objective of OD Studies?",
                    "html": "<p><strong>OD studies can include pedestrians and person trips.</strong> The general method is not limited to vehicle movements. A narrower vehicle-only survey must be stated before excluding pedestrian travel patterns.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00262",
                            "set": 1,
                ...
                {
                    "id": "check-tran808-00008",
                    "status": "review",
                    "prompt": "Enoscope is used to determine",
                ...
                {
                    "id": "check-tran808-00011",
                    "status": "review",
                    "prompt": "'Clearance time' is indicated by",
                    "html": "<p><strong>Amber and all-red are distinct, and signal crash effects are conditional.</strong> </p><p>Model 2, Q90's amber answer is conventional but incomplete as a clearance-time definition. </p>",
                    "sources": [
                        {
                            "id": "TRAN808-00011",
                            "set": 2,
                ...
                {
                    "id": "check-tran808-00013",
                    "status": "review",
                    "prompt": "What is the arithmetic average of the speeds of all vehicles passing a specific point on a roadway over a given period of time?",
                ...
                {
                    "id": "check-tran808-00016",
                    "status": "review",
                    "prompt": "An intersection that is provided for different levels of the road is called",
                    "html": "<p>Model 3, Q84 correctly identifies different-level roads as grade-separated, but ramps can retain interactions. </p>",
                    "sources": [
                        {
                            "id": "TRAN808-00016",
                            "set": 3,
                ...
                {
                    "id": "check-tran808-00022",
                    "status": "review",
                    "prompt": "Daily average traffic calculated based on 30 days' survey in 365 days is",
                    "html": "<p><strong>ADT and AADT require the stated estimation basis.</strong> </p><p>The unadjusted 30-day mean in Model 3, Q90 is ADT, as stored. </p><p>Short counts can nevertheless estimate AADT after justified adjustments. </p>",
                    "sources": [
                        {
                            "id": "TRAN808-00022",
                            "set": 3,
                ...
                {
                    "id": "check-tran808-00023",
                    "status": "review",
                    "prompt": "Which of the following is used for speed regulation?",
                    "html": "<p><strong>The 85th-percentile convention is not an automatic safety or legal rule.</strong> Observed speeds must be considered with geometry, access, pedestrians and crash risk. A claimed universal 98th-percentile design-speed rule is also unsupported.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00023",
                            "set": 4,
                ...
                {
                    "id": "check-tran808-00028",
                    "status": "review",
                    "prompt": "Calculate Round about radius for f = 0.36, e=0 and v=35kmph.",
                ...
                {
                    "id": "check-tran808-00052",
                    "status": "review",
                    "prompt": "What is the effect of using traffic signals?",
                    "html": "<p><strong>Signal crash effects are conditional.</strong> Signals can reduce some crossing or turning conflicts while increasing rear-end exposure. Permissive turns can retain conflicts; amber and all-red are different intervals, and amber is not unrestricted entry permission.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00052",
                            "set": 6,
                ...
                {
                    "id": "check-tran808-00055",
                    "status": "review",
                    "prompt": "For the movement of vehicles at an intersection of two roads, without any interference, the type of grade separator generally preferred to, is",
                    "html": "<p><strong>A cloverleaf is not interference-free.</strong> Grade separation removes direct crossing conflicts, but weaving, merging and diverging remain. A trumpet is also a grade-separated layout when designed as such.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00055",
                            "set": 6,
                ...
                {
                    "id": "check-tran808-00056",
                    "status": "review",
                    "prompt": "Which intersection has no conflict?",
                    "html": "<p><strong>A cloverleaf is not interference-free.</strong> Grade separation removes direct crossing conflicts, but weaving, merging and diverging remain. A trumpet is also a grade-separated layout when designed as such.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00056",
                ...
                {
                    "id": "check-tran808-00058",
                    "status": "review",
                    "prompt": "The normal flows on two approach roads at an intersection are respectively 500 pcu/h and 300 pcu/h. The corresponding saturation flow is 1600 pcu/h on each road. The total lost time per single cycle is 16 s. The optimum cycle time by Webster's method is?",
                    "html": "<p><strong>The stored Webster answers already reflect the correct arithmetic.</strong> </p><p>Model 7, Q82 gives Y = 500/1600 + 300/1600 = 0.5 and C = 58 s if the demands are separately served critical phases. </p><p>Effective green totals 42 s, with proportional portions 26.25 and 15.75 s, not automatically displayed greens. </p><p>Concurrent opposing movements must not be blindly summed. </p><p>Q86 gives C = 50 s for L = 10 s and Y = 0.6; the stem/options omit the time unit. </p><p>Neither exercise is an approved timing plan.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00058",
                            "set": 7,
                ...
                {
                    "id": "check-tran808-00059",
                    "status": "review",
                    "prompt": "Calculate the capacity of a rotary in PCU per hour for a weaving traffic proportion of 0.5, with a weaving section width of 12m, average entry width of 0.4m, and a weaving section length of 7.2m.",
                ...
                {
                    "id": "check-tran808-00060",
                    "status": "review",
                    "prompt": "The minimum weaving angle in the rotary section",
                ...
                {
                    "id": "check-tran808-00062",
                    "status": "review",
                    "prompt": "If total lost time is 10 for sum of proportion 0.6, then optimal cycle length?",
                    "html": "<p><strong>Webster arithmetic gives 50 seconds.</strong> With L = 10 s and Y = 0.6, C = (1.5L + 5)/(1 - Y) = 50 s. The source omits units; this theoretical result is not a complete signal timing plan.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00062",
                            "set": 7,
                ...
                {
                    "id": "check-tran808-00064",
                    "status": "review",
                    "prompt": "The minimum value of 15-minute peak hour factor on a section of a road is?",
                ...
                {
                    "id": "check-tran808-00070",
                    "status": "review",
                    "prompt": "Which of the following pavement is best for night visibility?",
                    "html": "<p><strong>Brighter pavement and closer lighting are not complete safety criteria.</strong> </p><p>Model 8, Q83's concrete choice is a conventional reflectance comparison. </p>",
                    "sources": [
                        {
                            "id": "TRAN808-00070",
                            "set": 8,
                ...
                {
                    "id": "check-tran808-00220",
                    "status": "review",
                    "prompt": "Which one of the following is not a common application of OD survey?",
                    "html": "<p><strong>OD data can support weaving analysis.</strong> Entry-to-exit movement information helps determine weaving proportions. Only an explicitly restricted survey scope could justify excluding that application.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00220",
                            "set": 21,
                ...
                {
                    "id": "check-tran808-00224",
                    "status": "review",
                    "prompt": "What is traffic engineering?",
                ...
                {
                    "id": "check-tran808-00227",
                    "status": "review",
                    "prompt": "What is the first stage in the function of the traffic engineering department?",
                    "html": "<p><strong>First-stage answers are contextual.</strong> </p><p>Model 22, Q80 stores collection of data, and Q81 stores traffic volume studies. </p><p>Data are foundational and counts often support other work, but problem definition and study objectives may precede collection. </p><p>A safety, parking or pedestrian investigation does not universally begin with a volume study.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00227",
                            "set": 22,
                ...
                {
                    "id": "check-tran808-00228",
                    "status": "review",
                    "prompt": "What is the first stage in traffic engineering studies?",
                    "html": "<p><strong>First-stage answers are contextual.</strong> </p><p>A safety, parking or pedestrian investigation does not universally begin with a volume study.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00228",
                            "set": 22,
                ...
                {
                    "id": "check-tran808-00229",
                    "status": "review",
                    "prompt": "The study of traffic engineering is divided into how many major categories?",
                    "html": "<p><strong>Taxonomy is not a universal numerical law.</strong> </p><p>Model 22, Q82 stores seven engineering categories; Q84 stores three elements; Q85 excludes dynamic studies. </p><p>Human–vehicle–roadway and HBW/HBO/NHB are useful groupings, but their counts depend on the classification. </p><p>An identified textbook taxonomy is needed to justify the exclusive wording; no replacement count is invented.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00229",
                            "set": 22,
                ...
                {
                    "id": "check-tran808-00231",
                    "status": "review",
                    "prompt": "In traffic engineering, the elements are classified into how many categories?",
                    "html": "<p><strong>Category count depends on the textbook taxonomy.</strong> Human, vehicle and roadway are a useful three-element model, but the source must identify the classification before its count is treated as exclusive.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00231",
                            "set": 22,
                ...
                {
                    "id": "check-tran808-00232",
                    "status": "review",
                    "prompt": "Which of the following is not a category of Traffic Studies?",
                    "html": "<p><strong>Taxonomy is not a universal numerical law.</strong> </p><p>Human–vehicle–roadway and HBW/HBO/NHB are useful groupings, but their counts depend on the classification. </p><p>Dynamic traffic analysis exists. </p><p>An identified textbook taxonomy is needed to justify the exclusive wording; no replacement count is invented.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00232",
                            "set": 22,
                ...
                {
                    "id": "check-tran808-00233",
                    "status": "review",
                    "prompt": "Which of the following is the traffic that is prepared based on 365 days of the year?",
                    "html": "<p>Model 22, Q86 correctly identifies AADT, but a complete calendar-year mean uses 365 or 366 days as applicable; missing observations cannot simply be treated as zero.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00233",
                            "set": 22,
                ...
                {
                    "id": "check-tran808-00234",
                    "status": "review",
                    "prompt": "Which of the following is the first phase of traffic regulation?",
                ...
                {
                    "id": "check-tran808-00237",
                    "status": "review",
                    "prompt": "Which of the following traffic study uses traffic models to analyze traffic?",
                ...
                {
                    "id": "check-tran808-00239",
                    "status": "review",
                    "prompt": "Which of the following traffic study determines total parking demand?",
                    "html": "<p><strong>Parking demand, location and orientation are different.</strong> </p><p>Model 23, Q80 correctly identifies parking studies, but observed occupancy is not all latent demand. </p><p>Quantitative load, duration and turnover need compatible periods and cohorts.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00239",
                            "set": 23,
                ...
                {
                    "id": "check-tran808-00240",
                    "status": "review",
                    "prompt": "What is the purpose of a Travel Time and Delay Study?",
                    "html": "<p>Model 23, Q81's quality-of-movement choice is a broad study objective; its other travel-time alternatives overlap with that purpose. </p><p>A formal LOS grade still requires a defined facility and method.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00240",
                            "set": 23,
                ...
                {
                    "id": "check-tran808-00242",
                    "status": "review",
                    "prompt": "Which of the following is not determined by traffic volume studies?",
                ...
                {
                    "id": "check-tran808-00243",
                    "status": "review",
                    "prompt": "Which of the following is not a parameter of traffic stream?",
                ...
                {
                    "id": "check-tran808-00244",
                    "status": "review",
                    "prompt": "Which of the following is not a way by which traffic volume data is presented?",
                ...
                {
                    "id": "check-tran808-00245",
                    "status": "review",
                    "prompt": "Which of the following does the thickness of lines represent in Traffic flow maps?",
                ...
                {
                    "id": "check-tran808-00246",
                    "status": "review",
                    "prompt": "Which of the following is not a factor affecting traffic capacity?",
                    "html": "<p><strong>Controls affect capacity, and no universal uncontrolled-junction range follows.</strong> </p><p>Model 23, Q87 excludes control devices, although c = s(g/C) directly demonstrates their effect; all four offered factors can matter. </p><p>Its explanation additionally switches to PCU/h. </p><p>These are not interchangeable units or a general junction capacity.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00246",
                            "set": 23,
                ...
                {
                    "id": "check-tran808-00247",
                    "status": "review",
                    "prompt": "Which of the following are the disadvantages of traffic signals?",
                    "html": "<p><strong>Signal crash effects are conditional.</strong> Signals can reduce some crossing or turning conflicts while increasing rear-end exposure. Permissive turns can retain conflicts; amber and all-red are different intervals, and amber is not unrestricted entry permission.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00247",
                ...
                {
                    "id": "check-tran808-00248",
                    "status": "review",
                    "prompt": "When are mail-back postcard surveys usually used?",
                ...
                {
                    "id": "check-tran808-00249",
                    "status": "review",
                    "prompt": "Which of the following is one of the uses of a collision diagram?",
                ...
                {
                    "id": "check-tran808-00250",
                    "status": "review",
                    "prompt": "Which of the following type of parking area exclusively allotted for parking at one distance away from the mainstream of road?",
                    "html": "<p>Model 24, Q81's off-street answer concerns location; parallel or angled arrangements can also occur off-street. </p><p>Quantitative load, duration and turnover need compatible periods and cohorts.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00250",
                            "set": 24,
                ...
                {
                    "id": "check-tran808-00251",
                    "status": "review",
                    "prompt": "Upper speed limit for regulation is",
                    "html": "<p><strong>The 85th-percentile convention is not an automatic safety or legal rule.</strong> Observed speeds must be considered with geometry, access, pedestrians and crash risk. A claimed universal 98th-percentile design-speed rule is also unsupported.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00251",
                ...
                {
                    "id": "check-tran808-00252",
                    "status": "review",
                    "prompt": "The background color of the informatory sign board is",
                ...
                {
                    "id": "check-tran808-00253",
                    "status": "review",
                    "prompt": "The signs should be mounted on sign panel and alternatively with",
                ...
                {
                    "id": "check-tran808-00254",
                    "status": "review",
                    "prompt": "The type of signalling system in which possible to vary the length of cycle, cycle division and the time schedule at each sign point is called",
                ...
                {
                    "id": "check-tran808-00255",
                    "status": "review",
                    "prompt": "The length of the side of warning sign boards of roads is",
                ...
                {
                    "id": "check-tran808-00256",
                    "status": "review",
                    "prompt": "As per IRC: G7 – 2001, the shape and colour of a STOP sign is",
                ...
                {
                    "id": "check-tran808-00257",
                    "status": "review",
                    "prompt": "Which factors influence night visibility in highway?",
                    "html": "<p><strong>Brighter pavement and closer lighting are not complete safety criteria.</strong> </p><p>Model 24, Q88–Q90 identify relevant visibility and lighting factors, but illuminance in lux differs from luminance in cd/m<sup>2</sup>, and glare, wetness, contrast and distribution remain important. </p>",
                    "sources": [
                        {
                            "id": "TRAN808-00257",
                            "set": 24,
                ...
                {
                    "id": "check-tran808-00258",
                    "status": "review",
                    "prompt": "Which factors to be considered in the design of road lighting?",
                    "html": "<p><strong>Brighter pavement and closer lighting are not complete safety criteria.</strong> </p>",
                    "sources": [
                        {
                            "id": "TRAN808-00258",
                            "set": 24,
                ...
                {
                    "id": "check-tran808-00259",
                    "status": "review",
                    "prompt": "The spacing of lighting units influenced by",
                    "html": "<p><strong>Brighter pavement and closer lighting are not complete safety criteria.</strong> </p><p>Existing utility poles or reduced spacing alone do not guarantee acceptable lighting.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00259",
                            "set": 24,
                ...
                {
                    "id": "check-tran808-00260",
                    "status": "review",
                    "prompt": "As per IRC, the minimum horizontal clearance required for lighting poles for the road with raised kerbs is ...... from the edge of raised kerb.",
                ...
                {
                    "id": "check-tran808-00261",
                    "status": "review",
                    "prompt": "The most cost-effective/economical layout of lighting for narrow roads is",
                    "html": "<p><strong>Brighter pavement and closer lighting are not complete safety criteria.</strong> </p><p>Model 25, Q80's single-sided economy applies only where the required performance and life-cycle assessment support it. </p>",
                    "sources": [
                        {
                            "id": "TRAN808-00261",
                            "set": 25,
                ...
                {
                    "id": "check-tran808-00264",
                    "status": "review",
                    "prompt": "Trips are classified into how many categories?",
                    "html": "<p><strong>Taxonomy is not a universal numerical law.</strong> </p><p>Model 25, Q82 stores three trip categories. </p><p>Human–vehicle–roadway and HBW/HBO/NHB are useful groupings, but their counts depend on the classification. </p><p>An identified textbook taxonomy is needed to justify the exclusive wording; no replacement count is invented.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00264",
                            "set": 25,
                ...
                {
                    "id": "check-tran808-00265",
                    "status": "review",
                    "prompt": "The best type of interchange can be provided with ______",
                    "html": "<p><strong>Cloverleaf does not mean no conflict or always best.</strong> </p><p>Model 25, Q83's universally best/highest-capacity claim is unsupported. </p><p>In Nepal's left-driving arrangement, conventional cloverleaf loops serve <strong>right turns</strong>, not the US left-turn description.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00265",
                            "set": 25,
                ...
                {
                    "id": "check-tran808-00266",
                    "status": "review",
                    "prompt": "The capacity of an uncontrolled intersection is ______",
                    "html": "<p>Model 25, Q84 stores 1200–1400 vehicles/h without the needed geometry, movement and conflicting-flow basis. </p><p>Its explanation additionally switches to PCU/h. </p><p>These are not interchangeable units or a general junction capacity.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00266",
                            "set": 25,
                ...
                {
                    "id": "check-tran808-00268",
                    "status": "review",
                    "prompt": "The type of parking in which the vehicles are parked along the kerb is called ______",
                    "html": "<p>Model 25, Q86 uses kerb parking generically; only wording that specifies parallel orientation would require parallel parking. </p><p>Quantitative load, duration and turnover need compatible periods and cohorts.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00268",
                            "set": 25,
