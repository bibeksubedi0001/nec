(function () {
    ...
    Object.assign(registry, {
        ACiE0501: {
            ...
            blocks: [
                {
                    ...
                    html: "<p>A load calculation starts with <strong>what acts, where it acts and how it reaches the ground</strong>. Gravity commonly travels from slab to beam, column or wall, foundation and soil. </p><p><strong>Mass is not weight.</strong> With mass density ρ in kg/m<sup>3</sup> and gravitational acceleration g in m/s<sup>2</sup>, unit weight γ<sub>w</sub> = ρg/1000 in kN/m<sup>3</sup>. Thus a 1000 kg mass weighs approximately 9.81 kN when g = 9.81 m/s<sup>2</sup>. A layer of thickness t metres gives area load q = γ<sub>w</sub>t in kN/m<sup>2</sup>. For a uniform one-way tributary strip of width b<sub>tr</sub>, the supporting line load is w = qb<sub>tr</sub> in kN/m; the total force over area A is qA.</p><p><em>Original worked example:</em> assume a 150 mm slab with unit weight 25 kN/m<sup>3</sup> and fixed finishes of 1.0 kN/m<sup>2</sup>. Its permanent area load is 25 × 0.150 + 1.0 = <strong>4.75 kN/m<sup>2</sup></strong>. A 3 m tributary width transfers <strong>14.25 kN/m</strong> to the beam, before the beam's own weight and any wall loads. These are assumed teaching inputs, not an occupancy-load table or a two-way slab analysis.</p><p>Fixed partitions, finishes and a permanently built stage contribute dead load; ordinary movable classroom furniture contributes imposed load. Both nevertheless produce <strong>gravitational forces from mass</strong>. Earthquake inertia instead involves mass and acceleration, F = ma. </p>",
                    moreHtml: "<p>Wind on roof sheeting first reaches its fasteners and purlins before the main frame and bracing. Omitting a connection from this path does not make its force disappear. These notes compare named code editions for study; they are not a completed structural design or certification of project compliance.</p><p>Wind is represented through aerodynamic pressure, while settlement is an imposed support movement whose force effects depend on restraint. These mechanisms cannot be interchanged to force a defective matching question to fit.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>An <strong>action</strong> is broader than a downward force: it can be an applied load or an imposed deformation. Classification concerns how the action varies over the relevant reference period, not whether it acts vertically or horizontally. The following classification is explicitly that of <strong>IS 800:2007 §5.3.1</strong>, rather than a claim that every code uses identical terminology.</p><table><thead><tr><th scope='col'>Action class</th><th scope='col'>Meaning and examples</th></tr></thead><tbody><tr><th scope='row'>Permanent</th><td>Present over the reference period with little change in magnitude: structural self-weight, fixed finishes and permanent equipment.</td></tr><tr><th scope='row'>Variable</th><td>Changes appreciably: construction and service-stage loading, occupancy loads, wind and earthquake actions in this IS 800 classification.</td></tr><tr><th scope='row'>Accidental</th><td>Exceptional actions such as vehicle collision or explosion, assessed in the corresponding accidental design situation.</td></tr></tbody></table><p><strong>Earthquake is not automatically an accidental action under IS 800:2007.</strong> Its explicit inclusion with variable actions means the bank's earthquake and construction/service-load choices are not mutually exclusive answers to an unqualified variable-action question. </p>",
                    moreHtml: "<p>A construction load may govern a temporarily unbraced frame even when the completed building is satisfactory. Conversely, calling equipment permanent does not make its moving contents or operating forces permanent. Separate components of an action when their variability differs.</p><p>Other standards may organize seismic design situations separately; use the terminology of the standard being discussed rather than transferring labels between systems.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>A <strong>characteristic load F<sub>k</sub></strong> is a specified representative value linked to the code's probability or other prescribed basis over a stated reference period. A characteristic maximum is neither the average observed load nor an absolute upper bound that nature cannot exceed. </p><p>For a simple single-action illustration, <strong>F<sub>d</sub> = γ<sub>f</sub>F<sub>k</sub></strong>, where γ<sub>f</sub> is the relevant partial load factor. With several actions, use the specified combination factors and signs. The structural analysis then produces an <strong>action effect E<sub>d</sub></strong>: axial force, shear, bending moment, stress or displacement. A strength check compares a compatible demand with resistance, E<sub>d</sub> ≤ R<sub>d</sub>; a serviceability check compares the relevant response with its service limit.</p><p>Do not confuse a load in kN with a moment in kN·m, or a pressure in kN/m<sup>2</sup> with a total force. The response also depends on span, stiffness, restraints and load position. </p>",
                    moreHtml: "<p>The bank's non-exceedance wording needs both a probability and a reference period; there is no universal percentage that can be attached to every load category.</p><p>Load factors address uncertainty in action magnitudes and their effects; material factors address a different part of the resistance model. Neither compensates for an omitted load path or negligent detailing.</p><p>Keep a record of whether an input is characteristic, already factored, or a code-defined intermediate such as design wind pressure. The word <em>design</em> in a wind or snow procedure does not by itself mean that the final structural load-combination factor has already been applied. Apply each prescribed operation once, under one consistent code basis.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>Imposed occupancy loads represent people, movable furniture, storage and use-related equipment. They can vary in <strong>both magnitude and position</strong>. A floor with light current occupancy is not therefore designed only for the people present on inspection day. </p><p><strong>IS 875 Part 2:1987</strong> is the imposed-load part of the IS 875 series. Part 1 addresses dead loads and unit weights, Part 3 wind, Part 4 snow, and Part 5 special loads and combinations; earthquake provisions belong to the appropriate IS 1893 part. <strong>NBC 103:1994</strong> adopts Part 2:1987 as stated in its foreword. </p><p><strong>Snow terminology is code-dependent.</strong> IS 875 Part 2:1987 §2.1 excludes snow from its imposed-load definition, so the bank's exclusion fits that context. IS 800:2007 §1.3.59 includes snow in its imposed-load definition. </p>",
                    moreHtml: "<p>Select the intended occupancy and applicable distributed and concentrated load cases, then examine the relevant structural effects.</p><p>These edition references do not establish that an arbitrary later IS revision automatically replaces an NBC provision.</p><p>For a continuous beam, loading every span need not maximize every span moment or support reaction. Move a concentrated load, or load the permitted adverse regions of a distributed-load pattern, to obtain an <strong>envelope</strong> of effects. A permanent wall normally stays at its specified position; occupancy may move. Allowable reductions and concentrated-load checks require their own code conditions, not a blanket percentage inferred from low average usage.</p><p>Keep the physical snow action separately identifiable in the load schedule even where the combination table groups it under imposed loading; do not count the same action twice.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>IS 875 Part 4:1987 §3.1</strong> expresses roof snow loading as <strong>S = μS<sub>0</sub></strong>. S<sub>0</sub> is the ground snow load for the location, μ is a dimensionless roof-shape coefficient, and S is the vertical snow load per unit roof plan area. S and S<sub>0</sub> must use the same pressure units, commonly kN/m<sup>2</sup>. The BIS catalogue also lists Part 4:2021; the quoted clause here is explicitly the checked 1987 edition, not a claim to reproduce the later standard.</p><p><em>Original worked example:</em> assume S<sub>0</sub> = 2.0 kN/m<sup>2</sup> and an applicable μ = 0.8 for one uniform case. Then S = <strong>1.6 kN/m<sup>2</sup></strong>. Over a 12 m by 5 m plan bay, the vertical snow force is 1.6 × 60 = <strong>96 kN</strong>. </p><p>The bank's fixed <strong>1.5 N/m<sup>2</sup></strong> is unsupported. It is only 0.0015 kN/m<sup>2</sup>, but changing its unit to kN/m<sup>2</sup> does not repair the absence of site snow data and roof geometry. </p>",
                    moreHtml: "<p>Ground snow depends on the site's snow climate and specified statistical basis. Roof geometry changes retention and distribution: slope may encourage sliding, but valleys, parapets, adjacent higher roofs and wind-driven drifting can create local concentrations. A steeper roof is not a reason to ignore every snow case. Balanced and unbalanced distributions can govern different members and connections.</p><p>The assumed μ is not offered as a default code coefficient; real geometry and all required distributions must be examined.</p><p>Roof maintenance load and roof snow load are different physical actions; one cannot supply the missing value for the other.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>NBC 104:1994</strong> adopts <strong>IS 875 Part 3:1987 with Nepal amendments</strong>. Its amended foreword describes <strong>two basic wind-speed zones</strong>, not three. This is a statement about that checked document; it should not be replaced by an unsupported Terai/hill/mountain three-zone mnemonic.</p><table><thead><tr><th scope='col'>NBC 104:1994 zone description</th><th scope='col'>Basic speed V<sub>b</sub></th></tr></thead><tbody><tr><th scope='row'>Lower plains and hills</th><td>47 m/s; broadly the Terai, Kathmandu Valley and lower-elevation areas.</td></tr><tr><th scope='row'>Higher hills and mountains</th><td>55 m/s; the text explicitly places areas above 3000 m in the second zone.</td></tr></tbody></table><p><strong>Altitude is not a complete site-assignment algorithm.</strong> The Nepal provisions also use district boundaries and account for unusually windy areas such as the Kali Gandaki valley. Check the actual geographical description and amendments before choosing V<sub>b</sub>. Site elevation above sea level and the building height z above ground are different quantities.</p><p>In the referenced <strong>1987 wind procedure, §§5.2–5.4</strong>, the basic speed is associated with an approximately <strong>3-second gust</strong>, the reference height of <strong>10 m in terrain Category 2</strong>, and a <strong>50-year return period</strong>. It is not a ten-minute average, a velocity at every roof height, or a promise of one such storm every fifty years. </p>",
                    moreHtml: "<p>The design speed at the required height follows after the appropriate risk, terrain/height and topographic factors.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>For an individual cladding element in <strong>IS 875 Part 3:2015 §7.3.1</strong>, the net normal force is <strong>F = (C<sub>pe</sub> − C<sub>pi</sub>)Ap<sub>d</sub></strong>. C<sub>pe</sub> and C<sub>pi</sub> are dimensionless external and internal pressure coefficients; A is the relevant element area in m<sup>2</sup>; p<sub>d</sub> is the pressure defined by that edition. If p<sub>d</sub> is in kN/m<sup>2</sup>, F is in <strong>kN</strong>. The net pressure itself is q<sub>net</sub> = (C<sub>pe</sub> − C<sub>pi</sub>)p<sub>d</sub>, without A.</p><p>Positive pressure acts <strong>toward the relevant surface</strong>. Positive external pressure pushes from outside toward the building; positive internal pressure pushes from inside toward the enclosure and therefore outward from the building. Taking net force positive inward explains the subtraction of C<sub>pi</sub>. </p><p><em>Original worked example using assumed 2015-procedure inputs:</em> let C<sub>pe</sub> = −0.8, C<sub>pi</sub> = +0.2, p<sub>d</sub> = 1.2 kN/m<sup>2</sup> and A = 5 m<sup>2</sup>. Then q<sub>net</sub> = (−0.8 − 0.2) × 1.2 = <strong>−1.2 kN/m<sup>2</sup></strong>, and F = <strong>−6 kN</strong>: 6 kN outward. The example illustrates signs and units, not a permitted coefficient selection for an unspecified building.</p><p>Check the applicable opening/internal-pressure cases and external pressure zones. Fasteners, local cladding, purlins and the overall frame can have different governing loaded areas and coefficients. A roof-normal wind force is not automatically a vertical load on horizontal plan area as used for snow; resolve directions before combining member effects. In an explicitly 1987 calculation, retain that edition's pressure and coefficient procedure instead of importing the 2015 p<sub>d</sub> definition.</p>",
                    moreHtml: "<p>A negative external coefficient represents suction, and a negative net result under this convention means outward loading.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>Earthquake-resistant design sets performance objectives at specified hazard levels. For frequent smaller shaking, the aim is to limit damage and preserve function. At more severe shaking, repairable damage may be acceptable; for rare strong shaking, life safety and avoidance of collapse are central aims. </p><p><strong>NBC 105:2025, foreword item (iv)</strong>, identifies <strong>E1 with a 475-year return period</strong> and <strong>E2 with a 2475-year return period</strong>. Its §2.1.1 gives the 475-year life-safety reference, while §2.1.2 uses a <strong>20-year return period for damage limitation</strong>. Do not label E1 as that serviceability event merely because it is the less rare of E1 and E2.</p><p>A return period T<sub>R</sub> describes a statistical rate of exceeding a defined hazard level, not a calendar appointment for the next earthquake. Under an explicitly assumed stationary Poisson occurrence model, the probability of at least one exceedance in duration t is <strong>P = 1 − exp(−t/T<sub>R</sub>)</strong>, with t and T<sub>R</sub> in the same time units.</p><p><em>Original probability illustration:</em> over 50 years, T<sub>R</sub> = 475 years gives approximately <strong>10.0%</strong> exceedance probability; T<sub>R</sub> = 2475 years gives approximately <strong>2.0%</strong>. The model does not imply regularly spaced events or predict an individual site's next damaging earthquake. </p>",
                    moreHtml: "<p><strong>These are design objectives, not a guarantee of zero damage in every minor earthquake or full operation after every major one.</strong> Structural and nonstructural performance both matter.</p><p>The code's hazard definitions and performance checks remain necessary even after the return-period label is known.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>A load combination represents a specified <strong>design situation and limit state</strong>; it is not an instruction to add every imaginable maximum. In the bank's notation, DL is dead load, LL imposed load, WL wind, EL earthquake and AL accidental load. </p><ol><li>Choose the governing standard, edition, structure type and strength or serviceability check.</li><li>Identify the characteristic actions, their locations and any code-defined accompanying values.</li><li>Generate the required occupancy patterns, environmental directions and favourable or unfavourable signs.</li><li>Apply the correct factors once and analyse each compatible combination.</li><li>Envelope each response separately: maximum compression, tension, bending, shear, drift or uplift need not come from the same case.</li></ol><p><strong>IS 800:2007 §3.5.2</strong> excludes simultaneous design wind and earthquake in its ordinary combinations. The related assumption in <strong>IS 1893 Part 1:2016 §6.2(b)</strong> concerns unlikely concurrence of extreme environmental events. </p><p>Dead load can be adverse for gravity bending but <strong>favourable against uplift</strong>. As an unfactored illustration only, 12 kN downward weight and 20 kN upward wind leave 8 kN net uplift, not 32 kN downward. </p>",
                    moreHtml: "<p><strong>WL/EL means wind or earthquake as alternatives</strong>, not their sum and not a numerical ratio.</p><p>It does not assert that an earthquake physically cannot occur on a windy day. Special hazards or project-specific design situations still require the applicable provisions, not a universal coincidence ban.</p><p>Appropriate stability factors and anchorage checks are still needed. Preserve signs rather than adding absolute values. Identify snow separately and use the selected code's roof-snow/imposed-load concurrence rules; do not assume either that all maxima coincide or that snow is automatically absent.</p><p>For a linear model, compatible action effects can be combined by superposition. Geometric or material nonlinearity can instead require analysis of the combined action set. Adding maxima from unrelated moving-load positions may create an impossible loading arrangement and is not a substitute for an envelope.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>A gantry girder supports moving crane wheel loads and participates in a system resisting <strong>vertical, transverse and longitudinal actions</strong>. A vertical-only beam calculation does not represent the whole crane-support system. </p><table><thead><tr><th scope='col'>Direction</th><th scope='col'>Typical source and transfer</th></tr></thead><tbody><tr><th scope='row'>Vertical</th><td>Crane self-weight and lifted load reach the rails through the wheels, then the runway girders, supports, columns and foundations.</td></tr><tr><th scope='row'>Transverse to runway</th><td>Crab/trolley motion and lateral crane effects reach lateral restraints and the supporting frame or bracing.</td></tr><tr><th scope='row'>Longitudinal along runway</th><td>Crane travel acceleration or braking reaches the runway system and its longitudinal bracing or other designed restraint path.</td></tr></tbody></table>",
                    moreHtml: "<p>Which member carries each horizontal action depends on the rail restraints, brackets, ties and bracing actually provided.</p><p>Obtain the crane manufacturer's wheel loads, spacings, travel arrangements and operating information. Move the load train to find governing bending, shear and support reactions; those extrema need not occur at the same position. Eccentric application can add torsion or local effects. Applicable dynamic allowances, serviceability and repeated-loading/fatigue requirements need their own verified provisions; no universal impact percentage is inferred from the bank's three-direction question.</p><p><strong>Final load-ledger check:</strong> record each action's origin, units, reference area or tributary width, characteristic or factored status, code edition, position and sign. Identify its path through the structure, the limit states and combinations checked, and the remaining missing data. This discipline connects the syllabus's dead, imposed, wind, snow and earthquake loads without disguising a list of remembered coefficients as a full building or gantry design.</p>",
            ...
            cautions: [
                {
                    "id": "check-desi787-00304",
                    "status": "review",
                    "prompt": "Wind Pressure at any height of structure does not depend on ______.",
                ...
                {
                    "id": "check-desi787-00002",
                    "status": "review",
                    "prompt": "Which of the following is not dead load?",
                ...
                {
                    "id": "check-desi787-00005",
                    "status": "review",
                    "prompt": "According to NBC, the velocity of wind in higher hills?",
                    "html": "<p>The higher-hill 55 m/s answer is supported, and the text explicitly places areas above 3000 m in zone 2. </p><p>District descriptions and unusually windy valleys also matter; neither a three-elevation-band mnemonic nor an altitude-only site rule accurately reproduces the checked document.</p>",
                    "sources": [
                        {
                            "id": "DESI787-00005",
                            "set": 2,
                ...
                {
                    "id": "check-desi787-00006",
                    "status": "review",
                    "prompt": "Basic wind speed = 55m/s and k1, k2, k3 all are 1 then wind pressure considered is",
                    "html": "<p><strong>Use the SI coefficient and units.</strong> With all wind factors equal to one, V<sub>z</sub> = 55 m/s and p<sub>z</sub> = 0.6V<sub>z</sub><sup>2</sup> = 1815 N/m<sup>2</sup> = 1.815 kPa. Square-law proportionality alone does not set the numerical coefficient.</p>",
                    "sources": [
                        {
                            "id": "DESI787-00006",
                            "set": 2,
                ...
                {
                    "id": "check-desi787-00007",
                    "status": "review",
                    "prompt": "How many wind zones are there in Nepal?",
                    "html": "<p><strong>Bank check — two Nepal wind zones:</strong> the <strong>3</strong> key conflicts with the Nepal-amended foreword of <strong>NBC 104:1994</strong>, which gives two zones with basic speeds <strong>47 and 55 m/s</strong>. </p><p>District descriptions and unusually windy valleys also matter; neither a three-elevation-band mnemonic nor an altitude-only site rule accurately reproduces the checked document.</p>",
                    "sources": [
                        {
                            "id": "DESI787-00007",
                            "set": 2,
                ...
                {
                    "id": "check-desi787-00029",
                    "status": "review",
                    "prompt": "What is permanent action according to the classification of actions by the IS code?",
                    "html": "<p><strong>Bank check — action classification and snow terminology:</strong> the self-weight permanent-action key is sound, but the explanation that puts earthquake outside variable actions conflicts with <strong>IS 800:2007 §5.3.1(b)</strong>, which includes wind and earthquake. </p>",
                    "sources": [
                        {
                            "id": "DESI787-00029",
                            "set": 4,
                ...
                {
                    "id": "check-desi787-00069",
                    "status": "review",
                    "prompt": "In roof truss, the value of snow load is taken as",
                ...
                {
                    "id": "check-desi787-00070",
                    "status": "review",
                    "prompt": "In non-parallel system of seismic design, 100% design seismic force of one direction and X% design seismic force of orthogonal direction is considered. The value of X is",
                ...
                {
                    "id": "check-desi787-00255",
                    "status": "review",
                    "prompt": "In limit state method, factor of safety for load is",
                    "html": "<p>The generic limit-state factor-of-safety question omits the combination and action, so its 1.5 key is not universal. </p>",
                    "sources": [
                        {
                            "id": "DESI787-00255",
                            "set": 28,
                ...
                {
                    "id": "check-desi787-00285",
                    "status": "review",
                    "prompt": "What is variable action according to classification of actions by IS code?",
                    "html": "<p><strong>The stated code classification includes earthquake action.</strong> IS 800:2007 clause 5.3.1(b) includes wind and earthquake among variable actions. Construction/service actions may also qualify, so the offered categories do not establish a unique answer without narrower wording.</p>",
                    "sources": [
                        {
                            "id": "DESI787-00285",
                            "set": 31,
                ...
                {
                    "id": "check-desi787-00287",
                    "status": "review",
                    "prompt": "Match the pair: A. Mass and gravitational effect, B. Mass and acceleration effect, C. Environmental effects with (i) wind load, (ii) Load due to settlement, (iii) Imposed load",
                ...
                {
                    "id": "check-desi787-00289",
                    "status": "review",
                    "prompt": "Which of the following is not included in Imposed load classification?",
                    "html": "<p>Snow is excluded from imposed load in IS 875 Part 2:1987 §2.1 but included in IS 800:2007 §1.3.59. </p><p>The snow-exclusion key therefore needs its Part 2 context, not a universal definition.</p>",
                    "sources": [
                        {
                            "id": "DESI787-00289",
                            "set": 31,
                ...
                {
                    "id": "check-desi787-00290",
                    "status": "review",
                    "prompt": "What is the minimum imposed load on roof trusses as per IS code?",
                ...
                {
                    "id": "check-desi787-00292",
                    "status": "review",
                    "prompt": "Which IS Code is used for designing a industrial building considering earthquake loads?",
                ...
                {
                    "id": "check-desi787-00293",
                    "status": "review",
                    "prompt": "For earthquake loads, axially loaded members have to resist ______",
                ...
                {
                    "id": "check-desi787-00295",
                    "status": "review",
                    "prompt": "Structures should be designed such that...",
                ...
                {
                    "id": "check-desi787-00296",
                    "status": "review",
                    "prompt": "Which of the following assumption is correct for earthquake design resistant structure?",
                    "html": "<p><strong>Bank check — code combination versus physical impossibility:</strong> the no-wind-plus-earthquake choices reflect the ordinary design-combination provisions, including IS 800:2007 §3.5.2 and the extreme-event assumption in IS 1893 Part 1:2016 §6.2(b). </p><p>They do not prove that earthquake and wind can never occur simultaneously. </p><p>Read WL/EL as alternative code actions and retain the required gravity contributions, signs and factors; special design situations need their own assessment rather than a universal claim that concurrence is impossible.</p>",
                    "sources": [
                        {
                            "id": "DESI787-00296",
                            "set": 32,
                ...
                {
                    "id": "check-desi787-00297",
                    "status": "review",
                    "prompt": "Which of the following relation is correct for design horizontal seismic coefficient?",
                    "html": "<p><strong>Bank check — legacy coefficient and elastic force reduction:</strong> A<sub>h</sub> = (Z/2)(I/R)(S<sub>a</sub>/g) is the legacy IS 1893 expression used by the bank, not a generic NBC 105 formula. </p><p>NBC 105:2025 instead uses C(T) = C<sub>h</sub>(T)ZI and C<sub>d</sub>(T<sub>1</sub>) = C(T<sub>1</sub>)/(R<sub>μ</sub>Ω<sub>u</sub>). </p>",
                    "sources": [
                        {
                            "id": "DESI787-00297",
                            "set": 32,
                ...
                {
                    "id": "check-desi787-00298",
                    "status": "review",
                    "prompt": "What is structural response factor?",
                    "html": "<p><strong>Bank check — legacy coefficient and elastic force reduction:</strong> A<sub>h</sub> = (Z/2)(I/R)(S<sub>a</sub>/g) is the legacy IS 1893 expression used by the bank, not a generic NBC 105 formula. </p><p>The factor 2 belongs to that convention. </p><p>NBC 105:2025 instead uses C(T) = C<sub>h</sub>(T)ZI and C<sub>d</sub>(T<sub>1</sub>) = C(T<sub>1</sub>)/(R<sub>μ</sub>Ω<sub>u</sub>). </p><p>Likewise, the response-factor explanation should refer to reducing <strong>elastic design-force demand</strong>, not reducing a known actual base shear. </p><p>The reduction depends on an eligible, adequately detailed structural system; it is not an arbitrary force discount.</p>",
                    "sources": [
                        {
                            "id": "DESI787-00298",
                            "set": 32,
                ...
                {
                    "id": "check-desi787-00299",
                    "status": "review",
                    "prompt": "The return period of earthquake E1 is",
                ...
                {
                    "id": "check-desi787-00300",
                    "status": "review",
                    "prompt": "Wind pressure acting normal to individual element of cladding units:",
                    "html": "<p><strong>Bank check — pressure versus force and the reference surface:</strong> the cladding expression <strong>(C<sub>pe</sub> − C<sub>pi</sub>)Ap<sub>d</sub></strong> gives force, despite the stem asking for pressure. </p><p>Remove A to obtain net pressure. </p><p>The p<sub>d</sub> formulation is specifically labelled IS 875 Part 3:2015 in these notes.</p>",
                    "sources": [
                        {
                            "id": "DESI787-00300",
                            "set": 32,
                ...
                {
                    "id": "check-desi787-00301",
                    "status": "review",
                    "prompt": "Internal pressure coefficient in a building is positive if acting from ______ and external pressure coefficient in a building positive if acting from ______.",
                    "html": "<p>Remove A to obtain net pressure. </p><p>The internal/external sign keys are consistent only when positive means toward the relevant surface: positive internal pressure pushes outward from the enclosure, while positive external pressure pushes inward. </p><p>A statement that every positive coefficient necessarily pushes toward the building interior would be wrong. </p><p>The p<sub>d</sub> formulation is specifically labelled IS 875 Part 3:2015 in these notes.</p>",
                    "sources": [
                        {
                            "id": "DESI787-00301",
                            "set": 32,
                ...
                {
                    "id": "check-desi787-00303",
                    "status": "review",
                    "prompt": "Positive sign of pressure coefficient indicates ______.",
                    "html": "<p><strong>Bank check — pressure versus force and the reference surface:</strong> the cladding expression <strong>(C<sub>pe</sub> − C<sub>pi</sub>)Ap<sub>d</sub></strong> gives force, despite the stem asking for pressure. </p><p>Remove A to obtain net pressure. </p><p>The internal/external sign keys are consistent only when positive means toward the relevant surface: positive internal pressure pushes outward from the enclosure, while positive external pressure pushes inward. </p><p>A statement that every positive coefficient necessarily pushes toward the building interior would be wrong. </p><p>The p<sub>d</sub> formulation is specifically labelled IS 875 Part 3:2015 in these notes.</p>",
                    "sources": [
                        {
                            "id": "DESI787-00303",
                ...
                {
                    "id": "check-desi787-00305",
                    "status": "review",
                    "prompt": "Which of the following relation between design pressure (p_z) and design wind speed (V_z) is correct?",
                    "html": "<p><strong>Bank check — quadratic dependence is not numerical equality:</strong> the keyed p<sub>z</sub> = V<sub>z</sub><sup>2</sup> expresses the intended square-law dependence but omits the SI coefficient. </p><p>The numerical relation is <strong>p<sub>z</sub> = 0.6V<sub>z</sub><sup>2</sup></strong> in N/m<sup>2</sup> for V<sub>z</sub> in m/s. </p><p>Thus the separate 55 m/s example gives <strong>1815 N/m<sup>2</sup> = 1.815 kPa</strong>; its bare numerical options need those units. </p><p>No exact numerical equality offered in the square-law item includes the required coefficient.</p>",
                    "sources": [
                        {
                            "id": "DESI787-00305",
                            "set": 33,
                ...
                {
                    "id": "check-desi787-00306",
                    "status": "review",
                    "prompt": "What is the partial safety factor for live load in combination of DL+LL for limit state of strength, where DL=Dead load, LL=Imposed load?",
                    "html": "<p><strong>Bank check — 1.5 and the live/dead comparison:</strong> 1.5 is correct for LL in the specified IS 800:2007 Table 4 strength combination DL + LL with one imposed action; DL also has factor 1.5 there. </p><p>The generic limit-state factor-of-safety question omits the combination and action, so its 1.5 key is not universal. </p>",
                    "sources": [
                        {
                            "id": "DESI787-00306",
                            "set": 33,
                ...
                {
                    "id": "check-desi787-00307",
                    "status": "review",
                    "prompt": "Which of the following load combination is not possible?",
                    "html": "<p><strong>Bank check — code combination versus physical impossibility:</strong> the no-wind-plus-earthquake choices reflect the ordinary design-combination provisions, including IS 800:2007 §3.5.2 and the extreme-event assumption in IS 1893 Part 1:2016 §6.2(b). </p>",
                    "sources": [
                        {
                            "id": "DESI787-00307",
                            "set": 33,
                ...
                {
                    "id": "check-desi787-00308",
                    "status": "review",
                    "prompt": "What is the partial safety factor for Dead load in combination of DL+LL+WL/EL for limit state of serviceability, where DL=Dead load, LL=Imposed load , WL=Wind load, EL=Earthquake load ?",
                    "html": "<p><strong>Dead-load factor 1.0 is correct for this stated SLS combination.</strong> The checked IS 800:2007 Table 4 combination is 1.0DL + 0.8LL + 0.8WL/EL. This does not mean every serviceability factor equals one.</p>",
                    "sources": [
                        {
                            "id": "DESI787-00308",
                            "set": 33,
                ...
                {
                    "id": "check-desi787-00309",
                    "status": "review",
                    "prompt": "What is the partial safety factor for dead load in combination of DL+ WL/EL for limit state of serviceability, where DL=Dead load, WL=wind load, EL=earthquake load?",
                    "html": "<p><strong>Dead-load factor 1.0 is correct for DL + WL/EL at SLS.</strong> The included actions have unity factors in that checked combination. Do not extend it to the three-action combination with imposed load.</p>",
                    "sources": [
                        {
                            "id": "DESI787-00309",
                            "set": 33,
                ...
                {
                    "id": "check-desi787-00310",
                    "status": "review",
                    "prompt": "What is the partial safety factor for imposed load in combination of DL+LL+AL , where DL=Dead load, WL=Wind load, AL=Accidental load ?",
                ...
                {
                    "id": "check-desi787-00311",
                    "status": "review",
                    "prompt": "What percent of factored load is notional horizontal force?",
                ...
                {
                    "id": "check-desi787-00313",
                    "status": "review",
                    "prompt": "Load factor used for live load are ______ than that used for dead loads.",
                    "html": "<p>The separate larger-for-live-load assertion fails in this very case and in other code-dependent comparisons. </p><p>Its case/loading-dependent alternatives are more defensible than a blanket inequality, but the question does not uniquely distinguish those overlapping alternatives.</p>",
                    "sources": [
                        {
                            "id": "DESI787-00313",
                            "set": 33,
