        ...
        AALL1004: {
            ...
            blocks: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension:</strong> the bank supplies no calibrated risk matrix or probability database. Qualitative analysis describes and prioritises risks using defined likelihood and impact categories. Quantitative analysis instead uses numerical quantities with an explicit basis, such as an event probability, delay distribution or monetary consequence.</p><p><strong>Hypothetical ordinal labels from 1 to 5</strong> establish a ranking, not equal numerical distances. An impact rating of 4 need not represent twice the loss of rating 2. Multiplying ordinal likelihood and impact labels may form a specified prioritisation index, but it does not calculate expected loss, a probability, variance or a scientifically calibrated risk magnitude.</p><table><thead><tr><th scope='col'>Assessment</th><th scope='col'>Interpretation</th></tr></thead><tbody><tr><th scope='row'>Qualitative matrix</th><td>Supports agreed escalation categories using clearly anchored descriptions.</td></tr><tr><th scope='row'>Quantitative event model</th><td>Combines a stated probability with a conditional consequence on a consistent basis.</td></tr><tr><th scope='row'>Sensitivity analysis</th><td>Shows which uncertain assumptions most affect the decision or forecast.</td></tr></tbody></table>",
                    moreHtml: "<p>Assess cost, time, safety, environment and service effects without pretending they share one natural unit. Severe safety consequences may require action irrespective of a low estimated frequency. Record evidence quality and disagreement, and revisit ratings when controls or exposure change. A low matrix score never waives a mandatory protection or approval requirement.</p>",
                    sources: []
                },
                {
                ...
                },
                {
                    ...
                    html: "<p><strong>Mitigation</strong> introduces measures intended to reduce the likelihood of an identified event, the severity of its consequences, or both. This is the distinction tested by the two assigned questions. Investigation, method improvement, inspection and physical protection have different mechanisms; specify which cause or consequence a proposed action addresses.</p><table><thead><tr><th scope='col'>Response</th><th scope='col'>What changes</th></tr></thead><tbody><tr><th scope='row'>Avoidance</th><td>Change or abandon the activity producing a particular exposure; reassess any new exposures.</td></tr><tr><th scope='row'>Mitigation</th><td>Reduce likelihood or consequence through effective controls.</td></tr><tr><th scope='row'>Transfer or sharing</th><td>Allocate specified consequences to another party, subject to its capacity and the agreement.</td></tr><tr><th scope='row'>Acceptance</th><td>Acknowledge the remaining exposure with appropriate authority, monitoring and contingency arrangements.</td></tr></tbody></table>",
                    moreHtml: "<p>Reducing risk toward a tolerable threshold is a mitigation objective; deciding to live with the residual is acceptance. Neither proves that risk has become zero. An action may introduce secondary risks, and a response that exists only on paper may leave the initial exposure unchanged.</p><p>Define an owner, implementation date, verification method and escalation trigger. Review residual risk after the measure is operating. Acceptance is not neglect, and contractual allocation does not remove the project manager's need to coordinate controls. No response strategy can be treated as complete elimination of every project risk, nor can an internal threshold override mandatory safety or environmental obligations.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension:</strong> none of the assigned questions provides a financing structure. Financing concerns how funds are raised and when they are available; funding concerns the ultimate source paying for the asset and its services. A financially attractive appraisal can still fail if construction cash is unavailable when commitments fall due.</p><table><thead><tr><th scope='col'>Source or arrangement</th><th scope='col'>Core obligation and risk</th></tr></thead><tbody><tr><th scope='row'>Debt</th><td>Contractual interest and principal payments, covenants and refinancing exposure.</td></tr><tr><th scope='row'>Equity</th><td>Residual ownership returns and losses; required return is not a guaranteed payment.</td></tr><tr><th scope='row'>Grant or public budget</th><td>Purpose restrictions, appropriation or disbursement conditions, eligibility and audit requirements.</td></tr><tr><th scope='row'>Public-private partnership</th><td>A delivery and risk-allocation arrangement that may combine private finance with user charges or public payments.</td></tr></tbody></table>",
                    moreHtml: "<p>Debt does not become project revenue, and equity is not free simply because no periodic interest invoice arrives. Grants can reduce repayment requirements but do not remove construction, operating or accountability obligations.</p><p>For a PPP, identify who carries construction, availability, demand, operating, foreign-exchange and termination risks. Private borrowing may ultimately be repaid through tariffs or government commitments; it is not a costless public asset. Evaluate affordability, enforceable obligations, lifecycle maintenance and contingent public liabilities as well as the initial capital contribution. No universal debt/equity ratio or PPP approval threshold is assumed here.</p>",
                    sources: []
                },
                {
                    id: "management-cash-flow-liquidity",
                    title: "A positive final balance can conceal an interim funding gap",
                    html: "<p><strong>Syllabus extension; hypothetical cash-flow example:</strong> the bank gives no dated receipts or payments. Start with zero cash, no interest and no existing credit facility. Assume each period's listed receipts and payments are netted at its end. All table amounts are <strong>thousand NRs</strong>; they are cash movements, not earned value or accounting profit.</p><table><thead><tr><th scope='col'>Period</th><th scope='col'>Receipts</th><th scope='col'>Payments</th><th scope='col'>Net cash</th><th scope='col'>Cumulative balance before finance</th></tr></thead><tbody><tr><th scope='row'>1</th><td>0</td><td>300</td><td>−300</td><td>−300</td></tr><tr><th scope='row'>2</th><td>400</td><td>500</td><td>−100</td><td>−400</td></tr><tr><th scope='row'>3</th><td>900</td><td>400</td><td>500</td><td>100</td></tr></tbody></table><p>For each period, <strong>balance = previous balance + receipts − payments</strong>. The minimum cumulative balance is −400 thousand NRs, so the example needs at least <strong>NRs400,000 of additional funding</strong> at the period boundaries before finance costs. The final NRs100,000 surplus of listed cash transactions does not prevent the earlier shortfall.</p>",
                    moreHtml: "<p>Separate when work is performed, when payment is certified and when cash arrives. Include supplier terms, payroll, retention, advance recovery, taxes and debt service on their actual timing basis. Payments occurring before receipts within a period can require a larger facility than this netted table shows. Stress-test delayed certification and collection, and distinguish a proposed credit line from one that is committed and drawable under its conditions.</p>",
                    sources: []
                },
                {
                    id: "management-cost-of-money-dscr",
                    title: "Calculate debt service coverage using the lender's cash-flow definition",
                    html: "<p><strong>Syllabus extension; every financial input is hypothetical.</strong> The bank supplies no loan terms or coverage test. Debt service coverage ratio is <strong>DSCR = cash flow available for debt service / scheduled debt service</strong> for the same period. The numerator, often called CFADS, is not simply revenue or accounting profit; its definition must follow the financing agreement.</p><p>Assume annual cash collections of NRs3.0 million, cash operating costs of NRs1.2 million and NRs0.3 million of agreed tax and working-capital deductions, with no other CFADS adjustments. Then <strong>CFADS = 1.5 million</strong>. These deductions exclude debt interest and principal so that debt service is not subtracted twice.</p><p>An opening loan balance of NRs2.5 million at a hypothetical 8% simple annual interest rate, with all principal repayment at year-end, incurs <strong>NRs200,000 interest</strong>. Add NRs800,000 scheduled principal: debt service is <strong>NRs1,000,000</strong>, DSCR is <strong>1.50</strong>, and closing principal is <strong>NRs1,700,000</strong>.</p><p>If collections fall 20% to NRs2.4 million while the specified costs and deductions remain fixed, CFADS becomes <strong>NRs900,000</strong> and DSCR <strong>0.90</strong>. The period's available cash cannot cover scheduled debt service without another permitted source.</p>",
                    moreHtml: "<p>A ratio of one is arithmetic coverage, not a universal acceptable covenant. Fees, compounding, repayment dates, reserve accounts and maintenance capital can change the calculation. Interest measures only part of financing cost; equity also has an opportunity cost. These are not current Nepal lending rates or an investment recommendation.</p>",
                    sources: []
                },
                {
                    id: "management-finance-bases-controls",
                    title: "Keep provisional sums, VAT and contingency on separate bases",
                    html: "<p><strong>Syllabus extension:</strong> no assigned question supplies a controlled project budget or reimbursement ledger. Percentage calculations require a named base; the same headline contract amount cannot be assumed for tax, bid evaluation, security, retention and damages.</p><table><thead><tr><th scope='col'>Term</th><th scope='col'>Meaning and control</th></tr></thead><tbody><tr><th scope='row'>PS: provisional sum</th><td>A stated contract allowance for work or services not fully defined at bidding, administered through the applicable instruction and valuation provisions.</td></tr><tr><th scope='row'>VAT: value added tax</th><td>A tax component determined by the applicable tax rules and transaction basis; it is not contractor profit or contingency.</td></tr><tr><th scope='row'>Contingency</th><td>A budget allowance for identified uncertainty or permitted unforeseen requirements, released under the project's authority and eligibility controls.</td></tr></tbody></table>",
                    moreHtml: "<p>PS and contingency can both relate to uncertainty but are not interchangeable accounts. A provisional allowance is not an automatic entitlement to spend its full value. Document whether a quoted total includes each component, avoid double counting and preserve the estimate revision used for each calculation.</p><p>Maintain budget, commitments, certified work, incurred cost and cash as reconciled but distinct records. Require authority, eligible purpose, supporting evidence and the correct funding source before payment. Public or grant finance may restrict eligible expenditure and require audit; expenditure is not reimbursable merely because somebody actually incurred it. Do not assume a current tax rate or import one contract's percentage base into another calculation.</p>",
                    sources: []
                },
                {
                ...
                },
                {
                    ...
                    html: "<p>A tender or bidding document is the package enabling bidders to understand the required work, prepare comparable offers and know how those offers will be assessed. The bank's phrase detailed <strong>depreciation</strong> of work items appears to be a wording defect for description or specification; asset depreciation is not the function being described.</p><table><thead><tr><th scope='col'>Package component</th><th scope='col'>Question answered</th></tr></thead><tbody><tr><th scope='row'>Instructions to Bidders (ITB), Bid Data Sheet (BDS) and forms</th><td>How, when and in what form must the bid be submitted?</td></tr><tr><th scope='row'>Evaluation and qualification criteria</th><td>What disclosed requirements and comparison method will be applied?</td></tr><tr><th scope='row'>Specifications, drawings and work requirements</th><td>What result, quality, interfaces and evidence are required?</td></tr><tr><th scope='row'>BOQ or price schedule</th><td>What items, quantities, units and pricing structure form the offer?</td></tr><tr><th scope='row'>General Conditions (GCC), Special Conditions (SCC) and contract forms</th><td>How will obligations, payment, changes, time and disputes be administered?</td></tr></tbody></table>",
                    moreHtml: "<p>A rate analysis explains a unit rate; an abstract estimate summarises cost; neither alone replaces the tender package. Check that drawings, specifications, quantities and units agree, and issue controlled clarification when they conflict.</p><p>The exact package depends on the delivery and pricing arrangement; not every procurement starts with a fully detailed BOQ. Also distinguish bidding documents from documents incorporated into the signed contract. The inspected PPMO template explicitly says its Instructions to Bidders are not part of the contract. Do not assume that every tender-stage statement automatically overrides the signed contractual order of precedence.</p>",
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension:</strong> the bank supplies no competing bids or complete evaluation record. The procurement method sets the route to market; it does not by itself determine the winner. Open competition, restricted procedures and direct procurement have different applicable conditions. Exceptional methods need their legal basis and approvals, not an invented small-value threshold.</p><table><thead><tr><th scope='col'>Assessment</th><th scope='col'>Purpose</th></tr></thead><tbody><tr><th scope='row'>Eligibility and qualification</th><td>Establish permitted participation and the bidder's required capacity, experience and resources.</td></tr><tr><th scope='row'>Responsiveness</th><td>Determine whether the offer materially meets the issued requirements.</td></tr><tr><th scope='row'>Price evaluation and selection</th><td>Apply only the disclosed corrections, adjustments, factors and selection rule.</td></tr></tbody></table><p>A low quoted total cannot cure failed qualification or a material deviation. In a two-envelope procedure, technical and price stages must follow the specified separation; undisclosed preferences must not be introduced after bids arrive.</p><p><strong>Identified-edition warning:</strong> the PPMO September 2026 NCB works SBD above NRs20 million, ITB 36.1, selects the substantially responsive bid price closest to the average, subject to its cost-estimate condition, rather than simply the lowest price. ITB 35.2 excludes <strong>VAT and PS</strong> from its comparison base, unlike the security bases that include PS.</p>",
                    moreHtml: "<p>The document also retains lowest-price wording in some other passages. These notes do not reconcile every cross-reference or certify current consolidated law. Read the complete applicable issued criteria instead of combining clauses or turning either lowest price or closest-to-average into a universal procurement rule.</p>",
                    sources: []
                },
                {
                    id: "management-boq-rate-risk",
                    title: "Quantity uncertainty can reverse a BOQ cost comparison",
                    html: "<p><strong>Syllabus extension; a wholly hypothetical two-item BOQ, not bank data or an official procurement.</strong> For this sensitivity exercise only, compare measured quantities multiplied by fixed offered rates, excluding tax and all other items. This is not an example of the September 2026 SBD's average-bid award rule.</p><table><thead><tr><th scope='col'>Item</th><th scope='col'>Estimated quantity</th><th scope='col'>A rate, NRs/m³</th><th scope='col'>B rate, NRs/m³</th></tr></thead><tbody><tr><th scope='row'>Excavation</th><td>1,000 m³</td><td>300</td><td>200</td></tr><tr><th scope='row'>Concrete</th><td>100 m³</td><td>8,000</td><td>9,500</td></tr></tbody></table><p>On estimated quantities, A totals <strong>NRs1,100,000</strong> and B <strong>NRs1,150,000</strong>. If excavation becomes 2,500 m³ while concrete remains 100 m³, the same-rate totals become <strong>NRs1,550,000 for A</strong> and <strong>NRs1,450,000 for B</strong>. The initial cheaper total is not the cheaper outcome in that changed scenario.</p><p>Equating 300Q + 800,000 to 200Q + 950,000 gives <strong>Q = 1,500 m³</strong>, at which both totals are NRs1,250,000. This identifies sensitivity to excavation quantity, not an authorised post-opening evaluation criterion.</p>",
                    moreHtml: "<p>Investigate quantity confidence, rate balance and the cash-flow effects of heavily priced early items. A real contract may allow re-rating or other valuation when quantities change; fixed rates here are an explicit model assumption. Do not retrospectively rerank bids using undisclosed quantities, assume every high rate is unlawful, or treat the estimated BOQ as a guarantee of final payment. Obtain justified rate analysis and follow the applicable evaluation and change provisions.</p>",
                    sources: []
                },
                {
                    id: "management-contract-pricing",
                    title: "Actual cost plus profit describes a family, not always a percentage fee",
                    html: "<p>When payment reimburses eligible actual construction cost plus an agreed fee, it belongs to the <strong>cost-reimbursable or cost-plus family</strong>. The bank selects cost-plus-percentage, but its stem says only certain profit. A percentage is one possible fee basis, not something established by those words alone.</p><table><thead><tr><th scope='col'>Pricing mode</th><th scope='col'>Basis and principal exposure</th></tr></thead><tbody><tr><th scope='row'>Lump sum</th><td>An agreed sum for defined obligations; scope changes and other contractual adjustments still need administration.</td></tr><tr><th scope='row'>Unit rate or remeasurement</th><td>Accepted measured quantities valued at applicable rates; quantity and re-rating provisions matter.</td></tr><tr><th scope='row'>Cost reimbursable</th><td>Eligible evidenced costs plus a fixed, percentage or incentive fee under agreed rules.</td></tr><tr><th scope='row'>Target-cost arrangement</th><td>Eligible cost is compared with an agreed target, with specified sharing or incentive rules.</td></tr></tbody></table>",
                    moreHtml: "<p>A percentage fee can increase when reimbursable cost increases; a fixed fee does not automatically do so. Target or incentive arrangements need a defined adjustment and sharing formula, not a vague promise of reasonable profit.</p><p>Design-build describes responsibility for design and construction, whereas lump sum or remeasurement describes pricing; these are different classification axes. Likewise, a work order is a means of authorising work, not proof of one universal price mechanism. Select and administer the actual arrangement against scope certainty, allocation of risk, records and applicable procurement rules. Nothing here authorises unlimited reimbursement of all expenses.</p>",
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension:</strong> the bank gives no cost ledger, fee agreement or reimbursement ceiling. Actual expenditure is not automatically allowable cost. Check the contract's eligible categories, authorisation, reasonableness, allocation, supporting evidence and any ceiling or target provisions. Separate reimbursable direct cost from the fee and from costs already recovered through another rate or overhead allowance.</p><p><strong>Hypothetical example, excluding VAT:</strong> supported eligible labour is NRs600,000 and materials NRs300,000. A further NRs50,000 lacks the required substantiation and is not included pending resolution. Eligible cost for this calculation is therefore <strong>NRs900,000</strong>, not NRs950,000.</p><table><thead><tr><th scope='col'>Alternative hypothetical agreement</th><th scope='col'>Fee</th><th scope='col'>Calculated payment, NRs</th></tr></thead><tbody><tr><th scope='row'>Fixed fee of NRs100,000</th><td>100,000</td><td>1,000,000</td></tr><tr><th scope='row'>Fee of 10% of eligible cost</th><td>90,000</td><td>990,000</td></tr></tbody></table>",
                    moreHtml: "<p>These are alternative contracts, not two fees charged together. Missing support does not automatically prove fraud, but it does prevent treating the amount as established reimbursement under the stated example.</p><p>Reconcile timesheets, invoices, goods receipt, plant records and subcontractor claims to the work package. Check duplicates, related-party transactions, excluded costs, prior approvals and agreed caps. Public or grant funding can impose additional eligibility and audit requirements. Retain the decision and evidence for disputed items instead of describing a cost-plus contract as actual cost plus unlimited profit.</p>",
                    sources: []
                },
                {
                ...
                },
                {
                    ...
                    html: "<p>The bank describes a 5% deduction from contractors' bills and links its return to defects liability. More precisely, <strong>retention</strong> is money withheld from payments under the contract, distinct from a separately issued performance guarantee. Do not assume every security deposit has the same release event.</p><p><strong>Identified-template scope:</strong> the PPMO September 2026 works SBD for NCB single-stage/two-envelope procurement above NRs20 million gives <strong>5% for Government of Nepal (GoN)-funded retention in SCC 54.1</strong>. Its development-partner field instead calls for a specified 5–10%. These are this template's settings, not a universal construction withholding law.</p><p><strong>GCC 54.2</strong> releases half the total retained amount upon the Project Manager's issue of the <strong>Defects Liability Certificate</strong>, and the other half on evidence of submission of the contractor's tax return to the concerned Internal Revenue Office. It does <strong>not</strong> say half at ordinary completion. Evidence of tax-return submission is also not the same wording as proof that every tax liability has been paid.</p><p><strong>Hypothetical arithmetic:</strong> if NRs4,000,000 is the certified amount subject to this 5% retention, the deduction is <strong>NRs200,000</strong>. For a hypothetical total retention pool of that amount, the two halves are <strong>NRs100,000 each</strong>, released only against the relevant conditions.</p>",
                    moreHtml: "<p>Expiry of a defects period and issue of its certificate are different events. Outstanding corrections, guarantee substitution and other release conditions need the actual contract provisions. Good progress alone does not establish an unconditional refund entitlement.</p>",
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension:</strong> the bank contains no reconciled final account or complete handover case. Completion, acceptance, the defects stage, final payment and release of securities are related but distinct events. The actual contract defines their certificates, conditions and authority; finishing visible construction does not automatically settle every obligation.</p><table><thead><tr><th scope='col'>Closeout stream</th><th scope='col'>Evidence to reconcile</th></tr></thead><tbody><tr><th scope='row'>Technical handover</th><td>Tests, commissioning, defect lists, approved changes and verified as-built information.</td></tr><tr><th scope='row'>Operational readiness</th><td>Operating manuals, training, asset identifiers, maintenance arrangements and responsible operators.</td></tr><tr><th scope='row'>Commercial account</th><td>Measured work, approved variations, determined claims, advances, retention, taxes and payment reconciliation.</td></tr><tr><th scope='row'>Continuing obligations</th><td>Defect correction, outstanding disputes, applicable warranty commitments and security-release conditions.</td></tr></tbody></table>",
                    moreHtml: "<p>Reconcile the final account against the authorised contract basis rather than treating every expenditure as recoverable. Prevent the same change being paid through both a revised quantity and a separate claim. Preserve unresolved items transparently with their status, owner and evidence.</p><p>The MIS should retain controlled final documents and a recoverable audit trail, not replace the project history with a single final total. As-built records must reflect verified construction and approved deviations; a contractor's marked-up drawing alone is not proof of acceptance. Transfer continuing risk and benefits-monitoring responsibilities to the operator so that administrative closure does not leave the asset without maintenance funding or accountable management.</p>",
                    sources: []
                }
            ],
            gaps: [
            ...
            cautions: [
                {
                    "id": "check-wate813-00071",
                    "status": "review",
                    "prompt": "What is the definition of mitigation in the context of risk management?",
                    "html": "<p><strong>Mitigation reduces likelihood or impact; it does not guarantee elimination.</strong> </p><p>Transfer allocates specified consequences, often financially. </p><p>An acceptable internal rating does not remove mandatory duties or the need to verify that controls work.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00071",
                            "set": 9,
                ...
                {
                    "id": "check-wate813-00073",
                    "status": "review",
                    "prompt": "Variability in the rate of return is known as",
                ...
                {
                    "id": "check-wate813-00075",
                    "status": "review",
                    "prompt": "What term denotes reduction of risk to a threshold level?",
                    "html": "<p>Reducing an exposure toward an acceptable threshold and accepting the remaining exposure are distinct decisions. </p><p>Transfer allocates specified consequences, often financially. </p><p>An acceptable internal rating does not remove mandatory duties or the need to verify that controls work.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00075",
                            "set": 9,
                ...
                {
                    "id": "check-wate813-00077",
                    "status": "review",
                    "prompt": "In which phase, detailed risk analysis is done?",
                ...
                {
                    "id": "check-wate813-00105",
                    "status": "review",
                    "prompt": "Insurance is an example of",
                ...
                {
                    "id": "check-basi674-00407",
                    "status": "review",
                    "prompt": "When actual cost of construction plus certain profit is paid to the contractor then such a contract is known as",
                ...
                {
                    "id": "check-basi674-00410",
                    "status": "review",
                    "prompt": "A fixed stipulated sum of penalty payable by the contractor having no relationship with real damage is known as",
                ...
                {
                    "id": "check-basi674-00413",
                    "status": "review",
                    "prompt": "Security deposit deducted at 5% from contractor’s bills is",
                ...
                {
                    "id": "check-basi674-00415",
                    "status": "review",
                    "prompt": "Earnest money to be deposited for works up to Rs. 5 lakhs is",
                ...
                {
                    "id": "check-basi674-00416",
                    "status": "review",
                    "prompt": "The following document contains detailed depreciation of all items of work including their bill of quantities, along with plans and drawings:",
