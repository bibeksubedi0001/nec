        ...
        ACiE0601: {
            ...
            blocks: [
                ...
                },
                {
                    ...
                    moreHtml: "<p>These are conventionally grouped with groundwater collection works because water enters through the ground. Beside a river, however, pumping may induce river water to infiltrate the bed and bank. The captured water can be a mixture of native groundwater and recently infiltrated surface water. That connection is important for microbial risk, travel time and the effect of a contaminated river event.</p><p>Natural filtration can reduce particles and alter water chemistry, but performance depends on sediments, clogging, hydraulic loading, temperature and travel pathways. A clear collector discharge does not prove removal of viruses or dissolved contaminants. Floodwater entering an unsealed well head can bypass the intended filtration path entirely.</p><p>Selection therefore requires permeable-layer information, seasonal river and groundwater levels, pumping or yield tests, sanitary protection and a maintainable collection arrangement. Assess scour, bank instability, collector clogging and interference with other abstractions. Compare the dependable treated output and operating burden, rather than assuming that the words infiltration or groundwater eliminate the need for treatment and monitoring.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    moreHtml: "<p>Bicarbonate-associated hardness is conventionally called temporary or carbonate hardness. Heating can shift carbonate equilibria and precipitate calcium carbonate; magnesium removal can involve hydroxide formation under suitable conditions. Non-carbonate hardness, associated conventionally with strong-acid anions, is not removed simply by the same boiling treatment. Chemical speciation and operating conditions determine the actual precipitate.</p><p>Scale in boilers reduces heat transfer and can contribute to overheating, so boiler-feed requirements differ from drinking-water acceptability. Non-volatile dissolved salts ordinarily <strong>raise</strong>, rather than depress, boiling temperature at fixed pressure. The small colligative effect is different from precipitation during heating and is not a practical test of whether water is safe.</p><p>Taste preferences are not universal. Calcium is a nutrient, but a hardness measurement is not a dental-health assessment. Most importantly, carbonate deposition does <strong>not guarantee prevention of lead release</strong>. Corrosion depends on water chemistry, materials, deposits and changing operating conditions. Suspected lead-bearing plumbing needs proper risk management and testing; a visible scale layer is not an acceptable safety assurance.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>pH</strong> characterises hydrogen-ion activity at measurement; <strong>alkalinity</strong> measures acid-neutralising capacity to a specified titration endpoint. Bicarbonate, carbonate and hydroxide commonly contribute, although other species can matter. Two waters at the same pH can have very different buffering capacities and therefore require different chemical doses to change pH.</p><p>For the conventional carbonate-hardness accounting, first express total hardness TH and total alkalinity A on the <strong>same CaCO<sub>3</sub>-equivalent basis</strong>. Then <strong>CH = min(TH, A)</strong> and <strong>NCH = TH − CH</strong>. These are non-negative equivalent quantities. Do not subtract a pH value, nitrate concentration or raw bicarbonate-ion mass from hardness.</p><table><thead><tr><th scope='col'>Hypothetical TH / A</th><th scope='col'>CH</th><th scope='col'>NCH</th></tr></thead><tbody><tr><th scope='row'>300 / 180</th><td>180</td><td>120</td></tr><tr><th scope='row'>120 / 180</th><td>120</td><td>0</td></tr><tr><th scope='row'>180 / 180</th><td>180</td><td>0</td></tr></tbody></table><p><em>All table inputs are added examples, in mg/L as CaCO<sub>3</sub>, not bank givens.</em> When alkalinity exceeds hardness, the excess can be balanced by ions such as sodium; it does not create negative non-carbonate hardness. The equal case belongs naturally to either limiting expression.</p>",
                    moreHtml: "<p>This bookkeeping supports softening analysis but is not a complete ionic-speciation or corrosion model. Titration endpoints, non-carbonate alkalinity and interfering constituents need consideration where significant. Neither high alkalinity nor acceptable pH demonstrates that pathogens or toxic chemicals are absent.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>Microorganisms have characteristic minimum, optimum and maximum growth temperatures under particular environmental conditions. Psychrophilic organisms prefer cold conditions, mesophilic organisms moderate conditions, and thermophilic organisms relatively high temperatures. These groups are useful biological descriptions, but their boundaries depend on the convention and species under discussion.</p><p>The bank's <strong>40–70°C</strong> thermophilic band is an approximate teaching range, not a universal operating envelope for all thermophiles. Its <strong>−20 to 20°C</strong> psychrophilic survival statement must not be used as a general growth interval. Survival in frozen material, metabolic activity in a liquid microenvironment and sustained reproduction are different observations. Not every organism found in a cold pond is a strict psychrophile.</p>",
                    moreHtml: "<p>Temperature affects reaction rates, oxygen solubility and disinfection performance as well as microbial ecology. Colder biological treatment can require more time or a different loading strategy; warming does not guarantee success if nutrients, oxygen, pH or retention conditions are unsuitable. Likewise, a chosen digester temperature does not by itself demonstrate pathogen destruction.</p><p>For design or process assessment, identify the relevant organisms and validated operating conditions, then consider loading, retention time and resilience to temperature changes. For a drinking-water sample, record temperature where the method requires it and preserve the sample correctly. Do not infer that water is safe because it is cold or because it briefly entered a named temperature band.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>E. coli</strong> is an important indicator of faecal contamination. WHO 2022 requires it not to be detectable in a 100 mL sample of water intended for drinking and treated water entering or within distribution. Detection requires immediate investigation. Absence in one sample is not proof that more resistant viruses or protozoa are absent.</p><p><strong>Total coliforms</strong> include organisms of environmental origin. They can indicate changes in treatment or distribution cleanliness and integrity, but their presence is not invariably proof of recent faecal contamination. Their interpretation is therefore not interchangeable with that of E. coli.</p><p>Representative sampling and preservation are as important as enumeration. Nepal's inspected directive §5(2) calls for microbiological testing within 6 hours, or, if that is not possible, transport/preservation at 4°C and testing within 24 hours; chlorine must be neutralised in chlorinated samples. Use the specified sterile containers and laboratory procedure. A poorly collected or delayed sample can misrepresent an otherwise correctly operated test.</p>",
                    moreHtml: "<p>Membrane filtration passes a measured sample through a suitable membrane and cultures retained organisms under the specified method, producing colony-forming-unit results. Multiple-tube fermentation estimates a most probable number from positive and negative growth outcomes; MPN is a statistical estimate, not a different contamination class. Membrane filtration can be efficient for suitable samples, but turbid water, competing growth or injured organisms can affect its suitability. No method is always the better test.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension:</strong> the assigned bank does not supply the complete standards table. These selected entries use Nepal's inspected 2079 notice and WHO's 2022 fourth edition incorporating both addenda, read with the 24 May 2023 corrigenda. They are not a certification of the latest amended legal position.</p><table><thead><tr><th scope='col'>Parameter</th><th scope='col'>Nepal 2079</th><th scope='col'>WHO 2022 interpretation</th></tr></thead><tbody><tr><th scope='row'>pH</th><td>6.5–8.5</td><td>No health-based value; operational control depends on water and materials.</td></tr><tr><th scope='row'>Turbidity</th><td>5 NTU</td><td>Treatment and acceptability guidance; not a universal health-based 5 NTU limit.</td></tr><tr><th scope='row'>Colour</th><td>5 TCU</td><td>Below 15 TCU often acceptable; no health-based colour value.</td></tr><tr><th scope='row'>Total hardness</th><td>500 mg/L, as printed</td><td>No health-based value; conventionally expressed as CaCO<sub>3</sub>.</td></tr><tr><th scope='row'>E. coli</th><td>0 CFU/100 mL</td><td>Not detectable in any 100 mL sample.</td></tr><tr><th scope='row'>Total coliform</th><td>0 CFU/100 mL in 95% of samples</td><td>Operational distribution indicator, not equivalent to a faecal indicator.</td></tr><tr><th scope='row'>Residual chlorine</th><td>0.10–0.50 mg/L; chlorinated systems only</td><td>Operating residual/contact guidance differs from the 5 mg/L free-chlorine health value.</td></tr></tbody></table><p>The Nepal hardness cell does <strong>not explicitly print as CaCO<sub>3</sub></strong>; teaching the normal convention does not change that transcription. Its total-coliform cell does not specify the assessment period, so do not append annually. Nepal's printed health/non-health classifications also need not match WHO's classifications.</p>",
                    moreHtml: "<p>Use the correct parameter, method, location and reporting basis. A result meeting one row does not certify the supply: microbial verification, chemical risk assessment and operational monitoring answer complementary questions.</p>",
                    sources: []
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension:</strong> this comparison adds primary-document information not fully given by the bank. All concentrations below are mg/L; WHO nitrate and nitrite values are explicitly for the ions, not nitrogen mass.</p><table><thead><tr><th scope='col'>Constituent</th><th scope='col'>Nepal 2079</th><th scope='col'>WHO 2022</th></tr></thead><tbody><tr><th scope='row'>Arsenic</th><td>0.05</td><td>0.01, provisional because of treatment performance and analytical achievability.</td></tr><tr><th scope='row'>Fluoride</th><td>0.50–1.50, minimum–maximum</td><td>1.5 upper guideline value; not a universal minimum or fluoridation target.</td></tr><tr><th scope='row'>Manganese</th><td>0.20</td><td>0.08 total manganese, provisional; consider infant exposure and acceptability separately.</td></tr><tr><th scope='row'>Nitrate</th><td>50</td><td>50 as nitrate ion; combined nitrate/nitrite condition also applies.</td></tr><tr><th scope='row'>Nitrite</th><td>3</td><td>3 as nitrite ion; combined condition also applies.</td></tr></tbody></table><p>The WHO corrigendum confirms <strong>0.08 mg/L manganese = 80 µg/L</strong>; reversing those units creates a thousand-fold error. WHO also discusses aesthetic effects around 0.02 mg/L, a different consideration from the health-based value. A provisional value still calls for risk management; the word does not mean the contaminant is harmless.</p><p>For fluoride, total intake and drinking-water consumption influence exposure. Nepal's minimum–maximum entry must not be attributed to WHO, and its conditional below-minimum exception needs the notice's qualifications. Likewise, Nepal's arsenic entry does not erase WHO's lower provisional value.</p>",
                    moreHtml: "<p>Select relevant testing from geology, agriculture, industry and sanitary hazards. A standards list is not evidence that every listed chemical is present or every unlisted chemical is absent. Treatment selection requires the measured chemical form and reliable performance, not a generic promise that a filter removes all metals.</p>",
                    sources: []
                },
                {
            ...
            cautions: [
                {
                    "id": "check-wate813-00326",
                    "status": "review",
                    "prompt": "When total hardness is less than alkanity",
                    "html": "<p><strong>Use a common CaCO<sub>3</sub> basis.</strong> When total hardness is less than alkalinity, all hardness is carbonate hardness and noncarbonate hardness is zero. Excess alkalinity is not extra hardness.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00326",
                            "set": 1,
                ...
                {
                    "id": "check-wate813-00001",
                    "status": "review",
                    "prompt": "Water may not contain much impurities if its source is",
                    "html": "<p><strong>Groundwater is not inherently safe.</strong> </p><p>A hill spring may have little suspended matter, but rapid fracture flow, contaminated recharge and collection defects can introduce pathogens. </p><p>Groundwater can also contain harmful dissolved chemicals. </p><p>Low turbidity, hill location and soil filtration do not establish potable quality or remove the need for appropriate barriers and verification.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00001",
                            "set": 2,
                ...
                {
                    "id": "check-wate813-00005",
                    "status": "review",
                    "prompt": "Blue baby syndrome is caused due to",
                    "html": "<p><strong>Nitrate is the exposure answer; nitrite is mechanistically active.</strong> </p><p>Nitrate can be reduced to nitrite, which oxidises haemoglobin and impairs oxygen transport. </p><p>Nitrite in the water also matters. </p><p>WHO's 50/3 mg/L values and combined ratio apply to nitrate and nitrite ions, not their nitrogen-mass concentrations.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00005",
                            "set": 2,
                ...
                {
                    "id": "check-wate813-00006",
                    "status": "review",
                    "prompt": "Such bacteria that grow more at high temperature (40 to 70°C) are called",
                    "html": "<p><strong>Thermophiles favour elevated temperatures.</strong> The quoted 40-70 degrees C band is approximate. Growth optimum, growth range and mere survival depend on species and medium.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00006",
                            "set": 2,
                ...
                {
                    "id": "check-wate813-00007",
                    "status": "review",
                    "prompt": "Trachoma can be avoided by",
                ...
                {
                    "id": "check-wate813-00008",
                    "status": "review",
                    "prompt": "Turbidity of water is expressed.",
                    "html": "<p><strong>NTU is not ppm.</strong> </p><p>Historical silica-scale reporting cannot establish a universal NTU-to-mg/L equivalence. </p><p>The original stored ppm key and numerical-comparability explanation remain unchanged in the bank and are not endorsed here.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00008",
                            "set": 2,
                ...
                {
                    "id": "check-wate813-00009",
                    "status": "review",
                    "prompt": "Which method is used to measure the color of water?",
                    "html": "<p><strong>Colour calibration and acceptance are separate.</strong> </p><p>Tintometer does not uniquely prescribe one apparatus. </p>",
                    "sources": [
                        {
                            "id": "WATE813-00009",
                            "set": 2,
                ...
                {
                    "id": "check-wate813-00010",
                    "status": "review",
                    "prompt": "A disease which is widespread and can reach globally is termed as",
                ...
                {
                    "id": "check-wate813-00011",
                    "status": "review",
                    "prompt": "Population forecasting for water supply for large & old town?",
                    "html": "<p><strong>Population method selection needs evidence.</strong> </p><p>Arithmetic growth can suit stable absolute increments and geometric growth sustained proportional increments. </p><p>Large/old versus rapidly growing does not uniquely select a valid model or establish its persistence over the design horizon.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00011",
                            "set": 3,
                ...
                {
                    "id": "check-wate813-00012",
                    "status": "review",
                    "prompt": "For a rapidly growing population, which method of projection is preferred?",
                    "html": "<p><strong>Population method selection needs evidence.</strong> </p><p>Large/old versus rapidly growing does not uniquely select a valid model or establish its persistence over the design horizon.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00012",
                            "set": 3,
                ...
                {
                    "id": "check-wate813-00013",
                    "status": "review",
                    "prompt": "What is the fire demand of the city of 1 lakh population by Buston's formula?",
                    "html": "<p><strong>Buston name/provenance is not verified normative evidence.</strong> </p><p>For the bank's Q = 5663√P with P in thousands and Q in L/min, one lakh gives 56,630 L/min. </p><p>That arithmetic does not authenticate a classical name, current code adoption, applicability range or safe fire design. </p><p>The two source records retain their original wording and keys.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00013",
                            "set": 3,
                ...
                {
                    "id": "check-wate813-00015",
                    "status": "review",
                    "prompt": "Find fire demand of 1 lakh population by Kuchling's.",
                    "html": "<p><strong>Kuichling/Kuchling calculation is conditional on the printed expression.</strong> </p><p>Q = 3182√100 gives 31,820 L/min, 530.3333 L/s or 1,909,200 L/hour; 530 L/s is rounded. </p><p>The name, coefficient and omitted scope have not been authenticated as a current requirement. </p><p>A fire duration and residual-pressure criterion are still missing.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00015",
                            "set": 3,
                ...
                {
                    "id": "check-wate813-00016",
                    "status": "review",
                    "prompt": "Permissible pH value for public water supply ranges between:",
                ...
                {
                    "id": "check-wate813-00018",
                    "status": "review",
                    "prompt": "If the initial population of a country is 1000000 and the birth rate and death rate are 10% and 4% respectively, what is the population of the country after 2 years?",
                ...
                {
                    "id": "check-wate813-00019",
                    "status": "review",
                    "prompt": "E. Coil dies when pH of water is",
                ...
                {
                    "id": "check-wate813-00020",
                    "status": "review",
                    "prompt": "The livestock demand should not exceed …… of total domestic demand.",
                    "html": "<p><strong>Neither the 20% animal ceiling nor urban exclusion is universal.</strong> </p><p>Include livestock when it is within the served demand boundary, using an inventory and appropriate service assumptions. </p><p>A large legitimate animal demand is not automatically oversizing, and seasonal alternative supplies cannot be assumed adequate without evidence.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00020",
                            "set": 3,
                ...
                {
                    "id": "check-wate813-00023",
                    "status": "review",
                    "prompt": "1 TCU is equivalent to",
                    "html": "<p><strong>Colour calibration and acceptance are separate.</strong> </p><p>A TCU refers to the colour of a specified standard containing 1 mg platinum/L, not an arbitrary 1 mg platinum–cobalt mixture. </p><p>Nepal 2079 lists 5 TCU; WHO's often-acceptable below-15-TCU statement is not a universal health-based limit.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00023",
                            "set": 4,
                ...
                {
                    "id": "check-wate813-00024",
                    "status": "review",
                    "prompt": "Water from reservoirs comes under the category of ______",
                    "html": "<p><strong>Surface-source generalisations need qualification.</strong> </p><p>Reservoirs are surface sources, but the required treatment train follows measured hazards rather than a universal full-treatment label. </p><p>Groundwater is not automatically the untreated safe alternative. </p>",
                    "sources": [
                        {
                            "id": "WATE813-00024",
                            "set": 4,
                ...
                {
                    "id": "check-wate813-00039",
                    "status": "review",
                    "prompt": "Which of the following is a better test to identify Coliforms?",
                ...
                {
                    "id": "check-wate813-00062",
                    "status": "review",
                    "prompt": "DO value of fresh pond water at 20° C temp, 760mm of Hg pressure, zero salinity",
                ...
                {
                    "id": "check-wate813-00084",
                    "status": "review",
                    "prompt": "Find fire demand of 1 lakh population by Kuichling’s.",
                    "html": "<p><strong>Kuichling/Kuchling calculation is conditional on the printed expression.</strong> </p><p>Q = 3182√100 gives 31,820 L/min, 530.3333 L/s or 1,909,200 L/hour; 530 L/s is rounded. </p><p>The name, coefficient and omitted scope have not been authenticated as a current requirement. </p><p>A fire duration and residual-pressure criterion are still missing.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00084",
                ...
                {
                    "id": "check-wate813-00136",
                    "status": "review",
                    "prompt": "Turbidity of raw water is a measure of",
                    "html": "<p>Suspended particles cause turbidity, but turbidity is an optical response rather than their directly measured mass concentration. </p>",
                    "sources": [
                        {
                            "id": "WATE813-00136",
                            "set": 15,
                ...
                {
                    "id": "check-wate813-00294",
                    "status": "review",
                    "prompt": "Ascariasis, scabies, trachoma and conjunctivitis, shinghoid etc... are example of",
                ...
                {
                    "id": "check-wate813-00297",
                    "status": "review",
                    "prompt": "Waterborne disease are also known as",
                ...
                {
                    "id": "check-wate813-00298",
                    "status": "review",
                    "prompt": "E-coil and coliform are known as",
                ...
                {
                    "id": "check-basi674-00379",
                    "status": "review",
                    "prompt": "As per Indian Standard Specifications, the peak discharge for domestic purposes per capita per minute, is taken",
                ...
                {
                    "id": "check-wate813-00299",
                    "status": "review",
                    "prompt": "Worm and viruses are also known as organism present water",
                ...
                {
                    "id": "check-wate813-00300",
                    "status": "review",
                    "prompt": "Most common surface water source is...",
                    "html": "<p><strong>Surface-source generalisations need qualification.</strong> </p><p>Groundwater is not automatically the untreated safe alternative. </p><p>A river's supposedly continuous adequate flow and most-common status also depend on season and region.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00300",
                            "set": 30,
                ...
                {
                    "id": "check-wate813-00303",
                    "status": "review",
                    "prompt": "Ground water is usually free from",
                    "html": "<p><strong>Groundwater is not inherently safe.</strong> </p><p>Groundwater can also contain harmful dissolved chemicals. </p>",
                    "sources": [
                        {
                            "id": "WATE813-00303",
                            "set": 30,
                ...
                {
                    "id": "check-wate813-00304",
                    "status": "review",
                    "prompt": "The per capita per day demand of water is taken as an average value of over a period of",
                    "html": "<p><strong>A lpcd numerator and population denominator must be defined.</strong> </p><p>Annual supply divided by 365P assumes the stated accounting year and a suitable population basis. </p><p>A municipal aggregate may include non-domestic uses and losses, but that does not mean each resident personally consumes that whole allocation or that every per-capita rate has identical scope.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00304",
                            "set": 30,
                ...
                {
                    "id": "check-wate813-00305",
                    "status": "review",
                    "prompt": "A city supply does not include",
                    "html": "<p><strong>Neither the 20% animal ceiling nor urban exclusion is universal.</strong> </p><p>Include livestock when it is within the served demand boundary, using an inventory and appropriate service assumptions. </p><p>A large legitimate animal demand is not automatically oversizing, and seasonal alternative supplies cannot be assumed adequate without evidence.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00305",
                ...
                {
                    "id": "check-wate813-00306",
                    "status": "review",
                    "prompt": "As per DWSS, fire demand in Nepal should not more than ...... ipcd.",
                ...
                {
                    "id": "check-wate813-00307",
                    "status": "review",
                    "prompt": "Which of the following causes a decreases in per capita consumption.",
                ...
                {
                    "id": "check-wate813-00309",
                    "status": "review",
                    "prompt": "When total hardness is greater than alkalinity then NCH is",
                    "html": "<p><strong>Hardness and alkalinity must share a basis.</strong> </p><p>CH = min(TH, alkalinity) and NCH = TH − CH are conventional CaCO<sub>3</sub>-equivalent calculations. </p><p>They do not allow subtraction of raw bicarbonate mass or pH from hardness. </p><p>At equality, CH = TH = alkalinity and NCH = 0.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00309",
                            "set": 30,
                ...
                {
                    "id": "check-wate813-00310",
                    "status": "review",
                    "prompt": "Temporary hardness in water is caused by... Of Ca and Mg:",
                ...
                {
                    "id": "check-wate813-00311",
                    "status": "review",
                    "prompt": "Which of the following is a waterborne disease?",
                    "html": "<p><strong>The non-waterborne distinction is not a zero-benefit claim.</strong> </p><p>Cholera is the intended waterborne example and measles is predominantly airborne. </p><p>Other infections mentioned as distractors can also have more than one transmission route.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00311",
                            "set": 31,
                ...
                {
                    "id": "check-wate813-00312",
                    "status": "review",
                    "prompt": "Water lost in theft and waste contributes to how much % of total consumption?",
                ...
                {
                    "id": "check-wate813-00313",
                    "status": "review",
                    "prompt": "Which is the correct statement regarding per capita demand?",
                    "html": "<p><strong>A lpcd numerator and population denominator must be defined.</strong> </p><p>Annual supply divided by 365P assumes the stated accounting year and a suitable population basis. </p><p>A municipal aggregate may include non-domestic uses and losses, but that does not mean each resident personally consumes that whole allocation or that every per-capita rate has identical scope.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00313",
                ...
                {
                    "id": "check-wate813-00317",
                    "status": "review",
                    "prompt": "Select the incorrect statement from the following option.",
                ...
                {
                    "id": "check-wate813-00318",
                    "status": "review",
                    "prompt": "Hardness of water is conventionally expressed in terms of equivalent amount of",
                    "html": "<p><strong>Units need the equivalence and density basis.</strong> mg/L as CaCO<sub>3</sub> is the conventional hardness reporting unit; raw ion mass is different. ppm equals mg/kg by mass and is only approximately numerically equal to mg/L in dilute water near 1 kg/L. </p>",
                    "sources": [
                        {
                            "id": "WATE813-00318",
                            "set": 31,
                ...
                {
                    "id": "check-wate813-00319",
                    "status": "review",
                    "prompt": "Which of the following is not a unit of hardness?",
                    "html": "<p><strong>Celsius measures temperature, not hardness.</strong> Hardness can be expressed on specified concentration or historical degree scales. Their conversion requires the named hardness scale, not a temperature unit.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00319",
                            "set": 31,
                ...
                {
                    "id": "check-wate813-00320",
                    "status": "review",
                    "prompt": "... is the water that form lather directly with the soap.",
                ...
                {
                    "id": "check-wate813-00321",
                    "status": "review",
                    "prompt": "Infiltration galleries are",
                    "html": "<p><strong>An infiltration gallery is a subsurface collector.</strong> It may use perforated drains rather than a large tunnel. Induced river infiltration is possible, so the collector is not automatically isolated from surface-water contamination.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00321",
                            "set": 32,
                ...
                {
                    "id": "check-wate813-00322",
                    "status": "review",
                    "prompt": "Infiltration wells are",
                    "html": "<p><strong>An infiltration well need not be deep.</strong> Its collection mechanism and hydraulic connection matter more than a fixed size or depth. A well near a river may receive induced river infiltration and still require water-quality protection.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00322",
                            "set": 32,
                ...
                {
                    "id": "check-wate813-00323",
                    "status": "review",
                    "prompt": "Example of aquifer is ...",
                    "html": "<p><strong>Geological labels are idealisations.</strong> </p><p>Sand/gravel must have connected transmissive pores to give useful yield. </p><p>Fractured granite can be an aquifer despite low intact-rock permeability, and mud or clay can transmit slowly rather than be perfectly impermeable. </p><p>The options do not replace site investigation or pumping tests.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00323",
                            "set": 32,
                ...
                {
                    "id": "check-wate813-00324",
                    "status": "review",
                    "prompt": "Example of aquaclude is ...",
                    "html": "<p><strong>Geological labels are idealisations.</strong> </p><p>Sand/gravel must have connected transmissive pores to give useful yield. </p><p>The options do not replace site investigation or pumping tests.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00324",
                            "set": 32,
                ...
                {
                    "id": "check-wate813-00325",
                    "status": "review",
                    "prompt": "When total hardness is more than alkanity",
                    "html": "<p><strong>Put hardness and alkalinity on the same CaCO<sub>3</sub> basis.</strong> When TH exceeds alkalinity, carbonate hardness equals alkalinity and noncarbonate hardness is TH minus alkalinity. Raw bicarbonate mass is not directly interchangeable.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00325",
                            "set": 32,
                ...
                {
                    "id": "check-wate813-00327",
                    "status": "review",
                    "prompt": "Psychophilic bacteria survive in between the temperature of ... degree Celsius",
                    "html": "<p><strong>Cold adaptation is not a universal survival interval.</strong> Psychrophiles favour low-temperature growth, but the quoted -20 to 20 degrees C range is not a single reproduction range for all species or proof of dominance in every winter pond.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00327",
                            "set": 32,
                ...
                {
                    "id": "check-wate813-00330",
                    "status": "review",
                    "prompt": "In water supply systems, how is the 'Demand Factor' defined?",
                ...
                {
                    "id": "check-wate813-00333",
                    "status": "review",
                    "prompt": "Which of the following diseases is NOT classified as a water-borne disease?",
                    "html": "<p>Cholera is the intended waterborne example and measles is predominantly airborne. </p><p>Water improvements do not replace disease-specific controls, but saying they do nothing for general hygiene or care is too absolute. </p><p>Other infections mentioned as distractors can also have more than one transmission route.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00333",
                            "set": 33,
                ...
                {
                    "id": "check-wate813-00334",
                    "status": "review",
                    "prompt": "The 'Blue Baby' syndrome (Methaemoglobinaemia) in infants is caused by the presence of excess levels of which substance in drinking water?",
                    "html": "<p><strong>Nitrate exposure acts through nitrite formation.</strong> Nitrite oxidises haemoglobin and impairs oxygen transport. Nitrate and nitrite concentrations must be reported on their stated ion or nitrogen basis; they are not interchangeable numbers.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00334",
                            "set": 33,
                ...
                {
                    "id": "check-wate813-00339",
                    "status": "review",
                    "prompt": "The 'Blue Baby' syndrome (methemoglobinemia) in infants is caused by the presence of excess of which chemical in drinking water?",
                    "html": "<p><strong>Nitrate exposure acts through nitrite formation.</strong> Nitrite oxidises haemoglobin and impairs oxygen transport. Nitrate and nitrite concentrations must be reported on their stated ion or nitrogen basis; they are not interchangeable numbers.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00339",
