(function () {
    ...
    Object.assign(registry, {
        ACiE0806: {
            code: "ACiE0806",
            questionCount: 67,
            formulaSheet: "<table><thead><tr><th scope='col'>Quantity</th><th scope='col'>Relation and basis</th></tr></thead><tbody><tr><th scope='row'>Water power</th><td>P<sub>w</sub> = ρgQH = 9.81QH kW.</td></tr><tr><th scope='row'>Similarity laws</th><td>Q ∝ ND<sup>3</sup>; H ∝ N<sup>2</sup>D<sup>2</sup>; P ∝ ρN<sup>3</sup>D<sup>5</sup>.</td></tr><tr><th scope='row'>Unit quantities</th><td>N<sub>u</sub> = N/√H; Q<sub>u</sub> = Q/√H; P<sub>u</sub> = P/H<sup>3/2</sup>.</td></tr><tr><th scope='row'>Specific speed</th><td>n<sub>s</sub> = N√P<sub>unit</sub>/H<sub>n</sub><sup>5/4</sup>; per jet n<sub>s,jet</sub> = n<sub>s</sub>/√z.</td></tr><tr><th scope='row'>Euler head</th><td>H<sub>E</sub> = (u<sub>1</sub>V<sub>w1</sub> − u<sub>2</sub>V<sub>w2</sub>)/g.</td></tr><tr><th scope='row'>Pelton wheel</th><td>V<sub>j</sub> = C<sub>v</sub>√(2gH<sub>n</sub>); speed ratio λ = u/V<sub>j</sub>, optimum λ = ½, η<sub>jet,max</sub> = (1 + k cosβ)/2.</td></tr><tr><th scope='row'>Francis inlet</th><td>u<sub>1</sub> = φ√(2gH<sub>n</sub>); D<sub>1</sub> = 60u<sub>1</sub>/(πN); B<sub>1</sub> = Q/(χπD<sub>1</sub>V<sub>m1</sub>).</td></tr><tr><th scope='row'>Draft-tube recovery</th><td>H<sub>rec</sub> = α<sub>1</sub>V<sub>1</sub><sup>2</sup>/(2g) − α<sub>2</sub>V<sub>2</sub><sup>2</sup>/(2g) − h<sub>L</sub>.</td></tr><tr><th scope='row'>Synchronous speed</th><td>N = 120f/p (p poles).</td></tr><tr><th scope='row'>Cavitation</th><td>σ = [H<sub>atm</sub> − H<sub>v</sub> − H<sub>s</sub>]/H<sub>n</sub>; pump NPSH<sub>a</sub> = H<sub>atm</sub> + z − h<sub>loss</sub> − H<sub>v</sub>.</td></tr></tbody></table>",
            blocks: [
                {
                    id: "machines-energy-chain",
                    title: "Follow the energy transfer before applying efficiency",
                    html: "<p>A <strong>hydraulic turbine</strong> extracts energy from water and delivers mechanical work through a rotating shaft. A generator then converts shaft work into electrical energy. A pump transfers energy in the opposite direction, from its driving shaft to the liquid. </p><p>For steady incompressible flow, hydraulic power associated with a head difference H is <strong>P<sub>w</sub> = ρgQH = γQH</strong>. Use ρ = 1000 kg/m<sup>3</sup> and g = 9.81 m/s<sup>2</sup> for the water numericals here, unless otherwise stated. Q is in m<sup>3</sup>/s, H in m and γ = ρg = 9810 N/m<sup>3</sup>; the result is W. Equivalently, <strong>P<sub>w</sub> = 9.81QH kW</strong>. One cumec is 1 m<sup>3</sup>/s. Head is energy per unit weight, not pressure alone.</p><ul><li><strong>Generation:</strong> P<sub>shaft</sub> = η<sub>t</sub>ρgQH<sub>n</sub>, where H<sub>n</sub> is net turbine head and η<sub>t</sub> is water-to-shaft efficiency.</li><li><strong>Generator terminals:</strong> P<sub>electric</sub> = η<sub>g</sub>P<sub>shaft</sub>. Station auxiliaries and downstream electrical losses are deducted separately when calculating export.</li><li><strong>Pumping:</strong> P<sub>shaft,in</sub> = ρgQH<sub>p</sub>/η<sub>p</sub>, where H<sub>p</sub> is the total head added by the pump. Motor input is larger again if motor losses are included.</li></ul>",
                    moreHtml: "<p>Hydraulic machines therefore include both energy-producing and energy-absorbing machines; they are not all turbines, nor are they all rotodynamic. A reciprocating positive-displacement pump is a counterexample to the latter generalization.</p><p>The lifting-power item's printed v can represent γ only if it means <em>specific weight</em>, not velocity. Multiplication by efficiency gives turbine output; it does not give the input needed to lift water. Always pair a stated overall efficiency with the same power boundary used in the equation. These are original teaching notes; source links identify the unchanged bank records, including their errors, rather than certify every stored explanation.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension, without an assigned equipment-schedule question:</strong> identify each component's location, operating function and failure consequence. A device that regulates normal flow is not automatically a maintenance isolation barrier or an emergency closure device. The following functional inventory supplies missing official-scope teaching, not extra question citations.</p><table><thead><tr><th scope='col'>Equipment</th><th scope='col'>Function and interface</th></tr></thead><tbody><tr><th scope='row'>Trash rack and cleaning system</th><td>Exclude damaging debris at the intake; accumulated blockage increases head loss and differential loading. A rack does not remove all fine abrasive sediment.</td></tr><tr><th scope='row'>Intake gate and stoplogs</th><td>Control or isolate a waterway according to their design. Maintenance stoplogs may require balanced or stopped flow; they must not be assumed capable of emergency closure under any discharge.</td></tr><tr><th scope='row'>Main turbine inlet valve</th><td>Isolate the unit supply. Butterfly or spherical valve selection depends on pressure, diameter, losses, operating forces and the specified closure duty.</td></tr><tr><th scope='row'>Guide vanes or nozzle needle</th><td>Regulate turbine admission; guide vanes also establish inlet direction. Their motion interacts with water-column transients and the governor.</td></tr><tr><th scope='row'>Pelton deflector</th><td>Divert a jet away from the buckets during rapid load reduction while flow reduction can follow a separately controlled rate.</td></tr><tr><th scope='row'>Tailrace gates, drains and dewatering equipment</th><td>Permit inspection of wetted spaces after suitable isolation. Leakage, groundwater and backwater remain design inputs.</td></tr><tr><th scope='row'>Hoists, servomotors and auxiliary services</th><td>Operate and maintain the water-control equipment. Lifting routes, hydraulic-oil supply, electrical supply and position feedback must be coordinated.</td></tr></tbody></table>",
                    moreHtml: "<p>Specify normal and transient pressure envelopes, sediment and corrosion exposure, leakage limits, operating loads, closure capability, access and the response to loss of power or control. Supports and embedded parts transmit equipment forces into the civil structure. A valve's nominal diameter or a gate's open area alone does not establish these requirements.</p>",
                    sources: []
                },
                {
                    id: "machines-impulse-reaction",
                    title: "Impulse and reaction describe the pressure-energy path",
                    html: "<p>In a conventional <strong>Pelton impulse turbine</strong>, the nozzle converts the available supply head into a free jet before the water meets the runner. The jet and exposed bucket surfaces operate approximately at local atmospheric pressure. </p>",
                    moreHtml: "<p>The runner extracts work by changing the water's momentum, not by maintaining a large pressure drop through a sealed, water-filled blade passage.</p><p>In a <strong>reaction turbine</strong>, such as Francis, Kaplan or fixed-blade propeller, the runner passages run full. At runner entry, water possesses both pressure and kinetic energy, and pressure changes through the runner while shaft work is extracted. Pressure energy alone is not the entire inlet energy, and inlet kinetic energy is not absent merely because the passage is enclosed.</p><p><strong>Energy-path sketch in words:</strong> Pelton supply passes through a nozzle, then an atmospheric jet, moving buckets and a freely draining casing. A Francis supply passes through a scroll case, distributor, water-filled runner and draft tube before reaching the tailrace. The first casing mainly collects and directs spent water; the reaction-turbine casing also forms part of the pressurized waterway.</p><p>Both impulse and reaction runners change the <em>velocity vector</em> and convert hydraulic energy into mechanical work. Thus does not change the form of energy is not a correct description of an impulse runner. Nor does changes velocity uniquely identify a reaction turbine. The useful distinction is the pressure-energy path through the runner, not the presence or absence of energy conversion.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>A turbine has several simultaneous classifications. Tangential, radial, axial and mixed flow describe the water path relative to the shaft. Impulse and reaction describe the energy-transfer arrangement. </p><table><thead><tr><th scope='col'>Runner family</th><th scope='col'>Water path and regulation</th><th scope='col'>Usual selection tendency</th></tr></thead><tbody><tr><th scope='row'>Pelton</th><td>Tangential free jets on impulse buckets; nozzle admission is regulated.</td><td>High head with comparatively lower discharge.</td></tr><tr><th scope='row'>Francis</th><td>Reaction runner, generally radial-inward entry turning toward axial discharge; adjustable guide vanes.</td><td>A broad intermediate head/discharge field, subject to the actual runner design.</td></tr><tr><th scope='row'>Kaplan</th><td>Axial reaction; adjustable runner pitch, normally coordinated with guide-vane admission.</td><td>Low head and high discharge, especially where operating flow varies.</td></tr><tr><th scope='row'>Fixed-blade propeller</th><td>Axial reaction with fixed runner pitch; changing admission does not change that pitch.</td><td>Low-head service with a duty range suited to its performance curve.</td></tr><tr><th scope='row'>Fourneyron</th><td>Historical outward radial-flow reaction turbine.</td><td>Recognize its outward radial path rather than use it as a modern universal selection recommendation.</td></tr></tbody></table><p>Head and discharge tendencies overlap; the bank's below-30-m description is not an absolute Kaplan limit. Manufacturer characteristics, specific-speed convention, regulation range, cavitation setting and site constraints decide a real selection. The DOE turbine-types reference supports the main classifications, not universal dimensional or head limits.</p>",
                    moreHtml: "<p>Fixed or adjustable blade pitch describes regulation. A vertical shaft is an installation orientation, not another name for axial flow.</p><p>For Francis, radial entry and axial departure give the name <strong>mixed flow</strong>. For a propeller, fixed to the hub must mean <strong>fixed pitch</strong>; Kaplan blades are also physically attached to a hub but can pivot. Fourneyron is both outward-flow and radial-flow, so those two descriptions are not mutually exclusive options.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>For <strong>geometrically similar</strong> rotodynamic machines at corresponding operating points, characteristic velocity scales with ND and area with D<sup>2</sup>. Hence <strong>Q ∝ ND<sup>3</sup></strong>. Comparable head coefficients give <strong>H ∝ N<sup>2</sup>D<sup>2</sup></strong>, and hydraulic power ρgQH gives <strong>P ∝ ρN<sup>3</sup>D<sup>5</sup></strong>. </p><p>At fixed diameter, the familiar speed laws are Q ∝ N, H ∝ N<sup>2</sup> and P ∝ N<sup>3</sup>. At fixed speed across a geometrically similar family, Q ∝ D<sup>3</sup>, H ∝ D<sup>2</sup> and <strong>P ∝ D<sup>5</sup></strong>. Reynolds-number effects, roughness, cavitation and efficiency differences can require corrections. Trimming only an impeller in an unchanged casing does not preserve all geometric similarity; a limited-trim D<sup>3</sup> power shortcut is a different approximation requiring its own conditions and pump curves.</p><p>For the <strong>same turbine diameter</strong> at comparable operation, head reduction gives <strong>N<sub>u</sub> = N/√H</strong>, <strong>Q<sub>u</sub> = Q/√H</strong> and <strong>P<sub>u</sub> = P/H<sup>3/2</sup></strong>. These conventional unit quantities describe corresponding operation at unit head in the selected units. They do not all become unity, and are not dimensionless coefficients.</p><p>Unit power is therefore <strong>P/H<sup>1.5</sup></strong>, not a requirement to impose both Q = 1 and H = 1 simultaneously. For water, that separate imposed condition would give 9.81 kW of hydraulic power and an efficiency-dependent output. The pump-diameter question's explanation multiplies D<sup>3</sup> flow by D<sup>2</sup> head but its stored key still says D<sup>3</sup>; the two statements are inconsistent.</p>",
                    moreHtml: "<p>Comparable efficiencies are needed when applying the power relation to shaft input/output. Use consistent speed units; dimensional constants include the rpm-to-revolutions-per-second conversion.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>The conventional power-based turbine specific speed is <strong>n<sub>s</sub> = N√P<sub>unit</sub>/H<sub>n</sub><sup>5/4</sup></strong>. N is rotational speed in rpm, H<sub>n</sub> is net head in m, and <strong>P<sub>unit</sub> is the output associated with one runner</strong>, conventionally the turbine shaft output for the selection correlation. It is not automatically whole-station power, generator electrical output or internal fluid-to-runner transfer power.</p><p>For similar machines at the same type of duty, N ∝ √H/D and P ∝ D<sup>2</sup>H<sup>3/2</sup> at comparable efficiency and density. Thus N√P scales as H<sup>5/4</sup>, explaining the exponent. Conceptually, n<sub>s</sub> is the speed of a similar turbine producing one selected power unit under one selected head unit. <strong>This conventional number is not dimensionless:</strong> its stated convention carries rpm·kW<sup>1/2</sup>/m<sup>5/4</sup>, or rpm·hp<sup>1/2</sup>/m<sup>5/4</sup>.</p><p>Mechanical horsepower is <strong>1 hp = 0.745699872 kW</strong>; the rounded classroom conversion is 0.746 kW/hp. Metric horsepower is different, approximately 0.73549875 kW. For the same physical machine, n<sub>s,kW</sub> = √0.745699872 × n<sub>s,mechanical hp</sub>. A range expressed using horsepower and feet cannot be applied unchanged to kW and metres.</p><p>For r equal runners sharing station output at the same head and speed, use P<sub>unit</sub> = P<sub>station</sub>/r; using total power would overstate the single-runner value by √r. For z equal-power Pelton jets, <strong>n<sub>s,jet</sub> = n<sub>s,runner</sub>/√z</strong> only when a correlation explicitly uses <em>per-jet</em> power. </p>",
                    moreHtml: "<p>Otherwise all jets on one runner belong in its one-runner power. On a consistent basis, Pelton tends toward lower, Francis intermediate and axial runners higher specific speed; this is a selection guide, not a substitute for a duty map.</p>",
                ...
                },
                {
                    ...
                    html: "<p><strong>First case: 2000 hp, 150 m and 300 rpm.</strong> H<sup>5/4</sup> = 150<sup>5/4</sup> ≈ 524.945 and √2000 ≈ 44.72136. Therefore <strong>n<sub>s</sub> = 300 × 44.72136/524.945 ≈ 25.5577</strong> in the rpm–hp–m convention. This supports the 25.56 choice. The repeated range question has exactly the same duty, so its corrected key is <strong>10–35, option D</strong>, not the former 35–60. A turbine-family label cannot change this arithmetic.</p><p>If the 2000 hp is mechanical horsepower, its output is 1491.399744 kW and the kW-based value is <strong>22.0701</strong>. That is the same physical duty in another convention, not evidence that one formula is wrong. Keep the convention alongside every reported result.</p><p><strong>Second case: H = 25 m, N = 200 rpm, Q = 9 m<sup>3</sup>/s and η = 0.90.</strong> Reading η as turbine water-to-shaft efficiency for the intended specific-speed calculation gives <strong>P = 0.90 × 9.81 × 9 × 25 = 1986.525 kW</strong>. This value is not 1986.525 hp. </p><table><thead><tr><th scope='col'>Power convention</th><th scope='col'>Power used</th><th scope='col'>n<sub>s</sub>, with N in rpm and H in m</th></tr></thead><tbody><tr><th scope='row'>kW</th><td>1986.525 kW</td><td>159.4601</td></tr><tr><th scope='row'>Mechanical hp</th><td>1986.525/0.745699872 ≈ 2663.97 hp</td><td>184.6588</td></tr><tr><th scope='row'>Rounded 746 W/hp</th><td>1986.525/0.746 ≈ 2662.90 hp</td><td>184.62</td></tr></tbody></table><p>The printed pair 2662.209 HP and 184.62 is evidently intended to use the rounded-horsepower convention, but its power value contains a numerical typo. The rounded conversion explains 184.62; it does not produce 2662.209. No original option or key is changed.</p>",
                    moreHtml: "<p>If instead the efficiency is water-to-electric, the same calculated output belongs at the terminals and a generator efficiency is needed to infer turbine shaft power.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>Draw an energy ledger before multiplying efficiencies. Let Q<sub>in</sub> be water admitted at the turbine boundary and Q<sub>r</sub> the portion passing through the runner. Let P<sub>r</sub> be fluid power actually transferred to the runner, P<sub>s</sub> the delivered turbine shaft power and P<sub>e</sub> generator terminal output. All powers must use the same unit, and H<sub>n</sub> must refer to the specified turbine hydraulic boundary.</p><table><thead><tr><th scope='col'>Efficiency</th><th scope='col'>Consistent definition</th></tr></thead><tbody><tr><th scope='row'>Volumetric</th><td>η<sub>v</sub> = Q<sub>r</sub>/Q<sub>in</sub>.</td></tr><tr><th scope='row'>Hydraulic, runner-flow basis</th><td>η<sub>h</sub> = P<sub>r</sub>/(ρgQ<sub>r</sub>H<sub>n</sub>).</td></tr><tr><th scope='row'>Mechanical</th><td>η<sub>m</sub> = P<sub>s</sub>/P<sub>r</sub>, allowing for the allocated mechanical losses.</td></tr><tr><th scope='row'>Turbine overall</th><td>η<sub>t</sub> = P<sub>s</sub>/(ρgQ<sub>in</sub>H<sub>n</sub>) = η<sub>v</sub>η<sub>h</sub>η<sub>m</sub> under this loss allocation.</td></tr><tr><th scope='row'>Generator</th><td>η<sub>g</sub> = P<sub>e</sub>/P<sub>s</sub>; water-to-terminal efficiency is η<sub>t</sub>η<sub>g</sub>.</td></tr></tbody></table><p>The hydraulic-efficiency bank item uses power available at the turbine inlet as its denominator. If that means <strong>ρgQ<sub>in</sub>H<sub>n</sub></strong>, its ratio already includes the leakage effect: it equals η<sub>v</sub>η<sub>h</sub> in the separate-flow convention above. Do not multiply it by η<sub>v</sub> a second time. If leakage is neglected, Q<sub>r</sub> = Q<sub>in</sub> and the distinction disappears.</p>",
                    moreHtml: "<p>A lost hydraulic head and a lost shaft power are different entries in this ledger. Likewise, nozzle-to-runner efficiency, whole-turbine efficiency and water-to-electric efficiency are not interchangeable percentages. Use a stated overall efficiency only once when obtaining Q from a given output.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>At any runner station, use <strong>V = u + W as a vector equation</strong>: V is absolute water velocity, u is blade/peripheral velocity and W is water velocity relative to the moving blade. All are in m/s. The whirl velocity V<sub>w</sub> is the <strong>tangential component of V</strong>, not a fourth independent vector or a replacement for u in the triangle. The meridional component V<sub>m</sub> lies in the radial/axial flow plane.</p><p><strong>Triangle in words:</strong> choose the positive tangent in the direction of runner motion and a perpendicular meridional direction along the local throughflow. Draw u on the tangent, then add W to reach V. The components satisfy W<sub>w</sub> = V<sub>w</sub> − u and W<sub>m</sub> = V<sub>m</sub>. </p><p>For steady mean-line flow, angular momentum gives runner torque <strong>T<sub>r</sub> = ρQ<sub>r</sub>(r<sub>1</sub>V<sub>w1</sub> − r<sub>2</sub>V<sub>w2</sub>)</strong>. Multiplying by ω = 2πN/60, with u = ωr, gives <strong>P<sub>r</sub> = ρQ<sub>r</sub>(u<sub>1</sub>V<sub>w1</sub> − u<sub>2</sub>V<sub>w2</sub>)</strong> and <strong>H<sub>E</sub> = (u<sub>1</sub>V<sub>w1</sub> − u<sub>2</sub>V<sub>w2</sub>)/g</strong>. Torque is in N·m, power in W and Euler work head H<sub>E</sub> in m. Appropriate mean components are assumed.</p><p>This is Newton's second law in angular-momentum form. Buckets and blades turn the water and alter its whirl, producing torque. A stationary bucket can experience force but delivers no rotational power because u = 0. </p>",
                    moreHtml: "<p>Define the angle axes and retain signs before using trigonometry; a positive speed magnitude does not determine the sign of whirl.</p><p>Euler head is the transferred work head; it equals net available head only in the corresponding lossless limit. Ordinary no-work Bernoulli cannot be applied through an operating runner while omitting its extracted work.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>Assume the printed <strong>100 mm nozzle-pipe diameter</strong> is the effective circular jet diameter d = 0.100 m, with net nozzle head H = 200 m and C<sub>v</sub> = 0.97. If it is only a supply-pipe bore, further nozzle geometry and contraction information would be needed; that distinction is not supplied.</p><p>The jet velocity is <strong>V<sub>j</sub> = 0.97√(2 × 9.81 × 200) ≈ 60.7626 m/s</strong>. Its area is π(0.100)<sup>2</sup>/4 = 0.00785398 m<sup>2</sup>, giving <strong>q<sub>j</sub> ≈ 0.47723 m<sup>3</sup>/s</strong>. Thus Q/q<sub>j</sub> = 1.25/0.47723 = <strong>2.6193</strong>.</p><p>The smallest whole-number nozzle capacity is three, matching the bank's integer choice only under that interpretation. Three full effective 100 mm jets would pass approximately <strong>1.4317 m<sup>3</sup>/s</strong>, not 1.25. To pass exactly 1.25 through three equal jets at the same velocity, <strong>d<sub>effective</sub> = √[4 × 1.25/(3π × 60.7626)] ≈ 0.09344 m = 93.44 mm</strong>.</p>",
                    moreHtml: "<p>After choosing a nozzle count, recalculate operating opening, jet interception and efficiency. Rounding a discharge quotient upward is a capacity decision; it does not preserve an exact full-opening flow constraint. Rounding downward would leave insufficient full-jet capacity in this simplified model.</p>",
                ...
                },
                {
                    ...
                    html: "<p>Draft tubes include <strong>straight divergent</strong> and <strong>elbow</strong> arrangements, with appropriate circular-to-noncircular transitions where required. An elbow can redirect a vertical runner discharge toward a shallower horizontal outfall, saving excavation depth but introducing a bend and more complicated diffusion. A draft tube is therefore not simply another name for an elbow with varying cross-section.</p><p>At fixed discharge, V = Q/A explains why a suitably larger outlet area reduces residual velocity. However, excessively rapid expansion creates an adverse pressure gradient that can separate the flow. </p><p>Using the recovered piezometric-head definition and approximately uniform inlet/outlet velocities, <strong>η<sub>d</sub> = H<sub>rec</sub> / [V<sub>1</sub><sup>2</sup>/(2g)] = 1 − (V<sub>2</sub>/V<sub>1</sub>)<sup>2</sup> − 2gh<sub>L</sub>/V<sub>1</sub><sup>2</sup></strong>. This states the assumed convention; another published efficiency definition must not be substituted unnoticed.</p><p>The unrecovered inlet kinetic head is the sum of <strong>outlet kinetic head and irreversible loss</strong>. Consequently, 1 − η<sub>d</sub> is not generally the loss coefficient 2gh<sub>L</sub>/V<sub>1</sub><sup>2</sup>. </p>",
                    moreHtml: "<p>Bend losses, inlet swirl, nonuniformity, tailwater, available length and civil-space constraints affect recovery. Large means appropriately expanded relative to the inlet, not indefinitely large or loss-free.</p><p>They coincide only if the outlet kinetic term is negligible under this model. Similarly, draft-tube efficiency is not whole-turbine efficiency, and its denominator is not the plant's net head.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>The bank gives <strong>P = 2250 kW, H = 5.5 m, inlet diameter 2.8 m, overall efficiency 0.87, draft-tube efficiency 0.78 and head loss 0.89</strong>. The loss has no printed unit; the calculation below explicitly assumes <strong>h<sub>L</sub> = 0.89 m of water</strong>, α<sub>1</sub> = α<sub>2</sub> = 1, and an output/head boundary consistent with P = η<sub>o</sub>ρgQH.</p><p><strong>Q = 2250/(0.87 × 9.81 × 5.5) ≈ 47.93266 m<sup>3</sup>/s</strong>. The inlet area is A<sub>1</sub> = π(2.8)<sup>2</sup>/4 ≈ 6.15752 m<sup>2</sup>, giving <strong>V<sub>1</sub> ≈ 7.78441 m/s</strong> and V<sub>1</sub><sup>2</sup> ≈ 60.59702 m<sup>2</sup>/s<sup>2</sup>. Retain unrounded intermediate values in the following check.</p><p>Rearranging the stated recovery-efficiency convention gives <strong>V<sub>2</sub><sup>2</sup> = (1 − η<sub>d</sub>)V<sub>1</sub><sup>2</sup> − 2gh<sub>L</sub></strong>. Substitution yields <strong>0.22 × 60.59702 − 19.62 × 0.89 ≈ −4.13046 m<sup>2</sup>/s<sup>2</sup></strong>. </p><p>There is also a useful bound: even if V<sub>2</sub> approached zero, η<sub>d,max</sub> = 1 − 2gh<sub>L</sub>/V<sub>1</sub><sup>2</sup> ≈ <strong>0.7118</strong>, below the stated 0.78. Ignoring the loss instead gives about 3.651 m/s, still not 1.767. </p>",
                    moreHtml: "<p>A real outlet speed cannot have a negative square, so <strong>none of the offered velocities follows from these givens under this definition</strong>.</p><p>The loss unit, efficiency definition or other givens need clarification; do not take the square root of an absolute value, discard the loss or alter data to force the stored answer.</p>",
                ...
                },
                {
                    ...
                    html: "<p>Cavitation involves vapour formation when relevant local <strong>absolute pressure approaches the liquid's vapour pressure</strong>, followed by collapse when pressure recovers. Pressure fluctuations and local minima matter, not just a section-average reading. </p><p>Use <strong>p<sub>abs</sub> = p<sub>gauge</sub> + p<sub>atm,site</sub></strong> and water vapour pressure p<sub>v</sub>(T). Atmospheric pressure decreases with site altitude, and vapour pressure rises with water temperature. </p><p>For one common simplified turbine-setting convention, <strong>σ<sub>available</sub> = [H<sub>atm,site</sub> − H<sub>v</sub>(T) − H<sub>s</sub>]/H<sub>n</sub></strong>, where H<sub>atm,site</sub> = p<sub>atm,site</sub>/(ρg), H<sub>v</sub> = p<sub>v</sub>/(ρg), and H<sub>s</sub> is the chosen runner reference elevation above tailwater, positive upward. All heads are in m. </p><p>In that simplified convention, H<sub>s</sub> ≤ H<sub>atm,site</sub> − H<sub>v</sub> − σ<sub>required</sub>H<sub>n</sub> expresses a limiting setting before an additional design margin. Lower tailwater, warmer water or reduced atmospheric pressure tightens the allowable setting. </p>",
                    moreHtml: "<p>Collapse can cause pitting, noise, vibration and loss of performance. A pressure drop is not sufficient by itself: the resulting absolute level and water temperature must be known.</p><p>Thus an unchanged gauge reading or geometric runner setting does not guarantee the same cavitation margin at another site. Negative gauge pressure alone is not cavitation.</p><p>Compare with the manufacturer's or model's required σ using the <strong>same datum and operating convention</strong>, plus the specified margin.</p><p>Actual runner pressure fields, swirl, transients and the applicable cavitation criterion need more detailed treatment. The bank's <strong>one-third atmosphere</strong> is not a universal threshold at either end of a draft tube.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>Reaction turbines and centrifugal pumps can develop low local pressures near blades, at an impeller eye or in a draft-tube region. <strong>Reciprocating pumps can also cavitate</strong>: suction lift, valve losses and the need to accelerate the inlet liquid can depress cylinder or suction-line pressure. A high delivery pressure says nothing by itself about the minimum pressure during suction.</p><p>For a steady suction calculation referenced to a pump's specified inlet datum, available net positive suction head is <strong>NPSH<sub>a</sub> = p<sub>s,abs</sub>/(ρg) + V<sub>s</sub><sup>2</sup>/(2g) − p<sub>v</sub>/(ρg)</strong>. For a large open supply reservoir, negligible surface velocity and that same datum, it can be written <strong>NPSH<sub>a</sub> = H<sub>atm,site</sub> + z<sub>reservoir</sub> − z<sub>pump</sub> − h<sub>loss,suction</sub> − H<sub>v</sub></strong>. Terms are in m of pumped liquid.</p>",
                    moreHtml: "<p>Compare available head with the applicable machine requirement and margin at the operating point. A centrifugal-pump NPSH curve's stated criterion is not automatically the threshold for absolutely no bubbles. A reciprocating system additionally needs its time-varying suction acceleration and valve behaviour checked; a mean-flow reservoir calculation can miss its lowest instantaneous pressure.</p><p>Consequently, the supplied pair <strong>reaction turbines and reciprocating pumps</strong> is possible as well as <strong>reaction turbines and centrifugal pumps</strong>. The stored option d is not unique. Pelton's usual atmospheric free-jet runner avoids the conventional reaction-runner suction arrangement, but impulse classification must not be read as immunity for every nozzle or local liquid-flow condition.</p>",
                    sources: [{ id: "WATE701-00379", set: 33, question: 51 }]
                },
                {
                    id: "machines-generators-rating",
                    title: "Generator types, kW, kVA and power factor",
                    html: "<p>The <strong>generator</strong>, not the turbine or transformer, converts mechanical shaft work into electrical energy by electromagnetic induction. A synchronous generator is common in hydropower; low-speed arrangements commonly use salient poles. </p><p>Generator efficiency relates two different power boundaries: <strong>P<sub>electric,kW</sub> = η<sub>g</sub>P<sub>shaft,kW</sub></strong>. Apparent power is then <strong>S<sub>kVA</sub> = P<sub>electric,kW</sub>/|PF|</strong> for nonzero generating power and nonzero power-factor magnitude. In general <strong>0 ≤ |PF| ≤ 1</strong>, and unity is possible. </p><p><strong>Original rating illustration, not bank data:</strong> 1000 kW at the generator shaft and η<sub>g</sub> = 0.96 give 960 kW at its terminals. At |PF| = 0.80, the corresponding apparent power is 960/0.80 = <strong>1200 kVA</strong>. At unity it is 960 kVA. Using 1000/0.80 would incorrectly substitute shaft power for electrical output.</p><p>Specify voltage, frequency, speed/poles, kVA or MVA, rated power factor, cooling and the thermal/reactive capability envelope together. For balanced three-phase operation, S = √3V<sub>LL</sub>I/1000 in kVA with line-to-line voltage in V and current in A. kVA arithmetic alone does not demonstrate adequate excitation, heating or fault capability. </p>",
                    moreHtml: "<p>Induction generators are an alternative in suitable systems, requiring a source of magnetizing reactive power; a simple grid-connected induction generator operates with generating slip rather than exactly at synchronous rotor speed. Converter-connected systems can decouple permitted shaft-speed variation from grid frequency.</p><p>Leading/lagging reactive operation and any signed convention must be stated; generally below unity is not a physical prohibition on unity.</p><p>Auxiliary consumption and transformer/cable losses reduce export beyond terminal output and must not be silently included in turbine efficiency.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>For a conventional synchronous AC generator, <strong>N<sub>sync</sub> = 120f/p</strong>, where f is frequency in Hz, N<sub>sync</sub> is mechanical speed in rpm and p is the <strong>total number of poles</strong>. North and south poles form pairs, so p must be a <strong>positive even integer: 2, 4, 6, …</strong>. </p><p>The bank's f = 50 Hz and N<sub>sync</sub> = 461.54 rpm give <strong>p = 120 × 50/461.54 ≈ 13</strong> algebraically. That is not a physically valid total pole count for the stated conventional machine. </p><table><thead><tr><th scope='col'>Total poles</th><th scope='col'>Speed at 50 Hz</th><th scope='col'>Interpretation</th></tr></thead><tbody><tr><th scope='row'>12</th><td>500 rpm</td><td>Valid alternative duty, not 461.54 rpm.</td></tr><tr><th scope='row'>14</th><td>428.571 rpm</td><td>Valid alternative duty, not 461.54 rpm.</td></tr><tr><th scope='row'>26</th><td>230.769 rpm</td><td>Thirteen pole pairs; also not the given duty.</td></tr></tbody></table><p>Real selection iterates among allowed synchronous speeds, hydraulic specific speed, runner diameter and coupling arrangements. A gearbox or converter would require explicitly different assumptions about which shaft speed or frequency is being stated. Neither is present in this question, and neither is invented to legitimize 13 total poles.</p>",
                    moreHtml: "<p>Do not confuse p with pole pairs or with the power P used in turbine formulas.</p><p><strong>No supplied option satisfies both the specified speed and frequency.</strong> Choosing a nearby even number changes the speed; it does not solve the original givens.</p>",
                ...
                },
                {
                    ...
                    moreHtml: "<p>With isolated <strong>load acceptance</strong>, electrical opposing torque initially rises and speed tends to fall; the control admits more water within its limits. During <strong>load rejection</strong>, electrical torque drops before hydraulic input has fully reduced, so the rotor tends to accelerate. Flywheel inertia limits the immediate rate of change but does not replace sustained governor control.</p><p>On a large interconnected grid, frequency is largely imposed by the system. Governor settings and droop then govern real-power response and load sharing rather than independently setting a different steady grid frequency. Excitation and the automatic voltage regulator chiefly address voltage/reactive behaviour and are different controls. Hydraulic and electrical dynamics remain coupled during disturbances.</p><p>Francis admission uses guide vanes; Kaplan operation coordinates guide vanes and runner pitch; Pelton uses nozzle needles, with deflectors where provided. Rapidly reducing flow can aggravate water hammer, whereas slow removal of turbine torque can increase overspeed. A Pelton deflector can quickly remove jet action from the runner while the needle reduces discharge at a separately controlled rate. Closure laws, transient limits, servo response and protection require a system study, not an arbitrary universal timing rule.</p>",
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension, without an assigned pump-curve dataset:</strong> a centrifugal impeller transfers shaft work to water; its diffuser or volute can convert part of the resulting velocity into pressure. Across defined suction and discharge sections, pump head is <strong>H<sub>p</sub> = (p<sub>d</sub> − p<sub>s</sub>)/(ρg) + z<sub>d</sub> − z<sub>s</sub> + (V<sub>d</sub><sup>2</sup> − V<sub>s</sub><sup>2</sup>)/(2g)</strong> for approximately uniform section velocities. Pressure difference alone is sufficient only when the other differences are negligible.</p><p>A simple steady system can have <strong>H<sub>system</sub> = H<sub>static</sub> + KQ<sup>2</sup></strong>, with K incorporating the applicable pipe/local-loss model in consistent units. The operating duty is an acceptable intersection of pump and system characteristics. </p><ul><li><strong>Series:</strong> add individual pump heads at the same throughflow, then intersect the combined curve with the system curve.</li><li><strong>Parallel:</strong> add individual discharges at the same head, allowing for branch conditions, then determine the combined system duty.</li><li><strong>Limits:</strong> check suction conditions, priming, minimum flow, cavitation, motor loading, pressure ratings and stable operation. Two pumps do not automatically double both flow and head.</li></ul>",
                    moreHtml: "<p>At a stated speed and impeller configuration, examine <strong>head–discharge, efficiency–discharge, shaft-input-power and required-NPSH curves</strong>. Many centrifugal pumps have falling head with rising discharge and an efficiency peak near a best-efficiency point, but the actual manufacturer's curve governs. Input power and the allowable continuous operating range must be checked rather than guessed from that usual head-curve shape.</p><p>Changing water levels, valve position, speed or pipe resistance shifts that intersection. A nameplate maximum flow is not automatically the delivered flow in the connected system.</p><p>Affinity laws estimate corresponding points only under their assumptions; the final operating point still comes from the system interaction. Detailed pump data are absent from this bank, so these curves and checks are a teaching workflow rather than a selected pump or certified operating schedule.</p>",
                    sources: []
                },
                {
                    id: "machines-reciprocating-displacement",
                    title: "Reciprocating displacement, slip and pressure dependence",
                    html: "<p>A reciprocating pump draws liquid into a chamber and displaces it through delivery valves using a piston or plunger. This <strong>positive-displacement</strong> principle is different from continuous rotodynamic impeller work. </p><p>For a single-acting cylinder of area A and stroke L, running at N crank revolutions per minute with one delivery stroke per revolution, <strong>Q<sub>theoretical</sub> = ALN/60</strong>. For an ideal double-acting cylinder with piston-rod area A<sub>rod</sub>, <strong>Q<sub>theoretical</sub> = (2A − A<sub>rod</sub>)LN/60</strong>. Areas are in m<sup>2</sup>, stroke in m and mean discharge in m<sup>3</sup>/s. This is a cycle-average displacement, not constant instantaneous flow.</p><p>At fixed speed and stroke, ideal displacement is independent of discharge pressure; the drive must supply the required force and work. Real delivery can differ through leakage, valve timing, compressibility, incomplete filling and suction limitations. Slip is commonly expressed as Q<sub>theoretical</sub> − Q<sub>actual</sub>; it is not always explainable as valve leakage alone. </p>",
                    moreHtml: "<p>The historical force-pump name describes some pressure-delivery arrangements; it is not a more precise modern classification than positive displacement.</p><p>Increased delivery pressure may reduce actual flow for a given real machine, but a universal decrease cannot be inferred without its operating model.</p><p>The stem with charge discharge pressure is corrupted. Even interpreting it as a change or increase of delivery pressure does not specify ideal versus actual delivery, speed or leakage. Pulsation-control arrangements can reduce fluctuations and suction acceleration, but adequate suction conditions and suitable pressure-relief/protection arrangements remain necessary. A high discharge pressure does not prevent suction cavitation.</p>",
                    sources: [
            ...
            cautions: [
                {
                    "id": "check-hydr626-00090",
                    "status": "review",
                    "prompt": "The ratio of diameter of jet to diameter of runner is ______",
                ...
                {
                    "id": "check-hydr626-00149",
                    "status": "review",
                    "prompt": "The water from penstocks enters the ______ which is spiral in shape and the area of cross section of casing goes on decreasing gradually.",
                    "html": "<p>Remaining scroll flow decreases as water enters the distributor, so a decreasing area is consistent with an approximately maintained section-mean velocity. </p><p>The casing receives penstock supply; the downstream draft tube has a different role. </p>",
                    "sources": [
                        {
                            "id": "HYDR626-00149",
                            "set": 1,
                ...
                {
                    "id": "check-hydr626-00013",
                    "status": "review",
                    "prompt": "Power needed to uplift water can be calculated as?",
                    "html": "<p><strong>Bank check: lifting input and turbine output are opposite efficiency applications.</strong> </p><p>The printed vQH is hydraulic lifting power only if v denotes specific weight γ. </p><p>Actual pump shaft input is ρgQH/η<sub>p</sub>, not ηρgQH. </p><p>The explanation switches incorrectly to generation. </p>",
                    "sources": [
                        {
                            "id": "HYDR626-00013",
                            "set": 3,
                ...
                {
                    "id": "check-hydr626-00053",
                    "status": "review",
                    "prompt": "Power generated by unit head under unit discharge condition is",
                ...
                {
                    "id": "check-hydr626-00055",
                    "status": "review",
                    "prompt": "The use of draft tube in reaction turbine helps to",
                    "html": "<p><strong>Bank check: recovery is partial, and Pelton still has residual energy.</strong> </p><p>A draft tube can recover some runner-exit kinetic head, less outlet kinetic energy and losses, and its usable setting is cavitation-limited. </p><p>It does not create head or guarantee recovery of most energy in every installation. </p><p>A conventional Pelton has no reaction-type suction draft tube because it operates with free jets and free discharge, not because the spent water has no energy left.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00055",
                            "set": 7,
                ...
                {
                    "id": "check-hydr626-00058",
                    "status": "review",
                    "prompt": "Pressure at the inlet and outlet of the draft tube shouldn’t be.",
                    "html": "<p>Site atmospheric pressure, altitude, tailwater and runner setting matter. </p><p>A pressure drop may or may not reach the vapour-pressure condition, and inlet/outlet pressures need not be equal. </p><p>The stored one-third-atmosphere rule is not treated as a universal limit.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00058",
                            "set": 8,
                ...
                {
                    "id": "check-hydr626-00059",
                    "status": "review",
                    "prompt": "What is the use of governor?",
                ...
                {
                    "id": "check-hydr626-00066",
                    "status": "review",
                    "prompt": "Draft tubes are not used in which of the following turbines?",
                    "html": "<p><strong>Bank check: recovery is partial, and Pelton still has residual energy.</strong> </p><p>A conventional Pelton has no reaction-type suction draft tube because it operates with free jets and free discharge, not because the spent water has no energy left.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00066",
                            "set": 9,
                ...
                {
                    "id": "check-hydr626-00067",
                    "status": "review",
                    "prompt": "The power of the centrifugal pump is proportional to?",
                ...
                {
                    "id": "check-hydr626-00069",
                    "status": "review",
                    "prompt": "Which of the following best describes the hydraulic efficiency of a turbine?",
                    "html": "<p>Runner power divided by inlet water power is the intended hydraulic ratio, while shaft power divided by runner-transferred power is mechanical efficiency. </p><p>Only the separate runner-flow hydraulic definition combines with an additional Q<sub>r</sub>/Q<sub>in</sub> factor. </p><p>Generator efficiency belongs beyond the turbine shaft.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00069",
                            "set": 9,
                ...
                {
                    "id": "check-hydr626-00070",
                    "status": "review",
                    "prompt": "A turbine develops 2000 hp under a head of 150 m while running at 300 rpm. What is the specific speed?",
                    "html": "<p><strong>The hp-based result is 25.5577.</strong> Use n<sub>s</sub> = 300 sqrt(2000)/150<sup>1.25</sup>. Conventional specific speed depends on the chosen power units; it is not the actual shaft speed or a dimensionless constant.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00070",
                            "set": 9,
                ...
                {
                    "id": "check-hydr626-00072",
                    "status": "review",
                    "prompt": "Width of buckets of Pelton wheel is",
                    "html": "<p><strong>Bank check: bucket proportions are empirical.</strong> </p><p>They give 425 mm width for an 85 mm jet and 19 buckets for D = 2 m, d = 0.25 m under those assumptions. </p><p>Final interception, clearance, bucket geometry and loading still require design evidence.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00072",
                            "set": 9,
                ...
                {
                    "id": "check-hydr626-00073",
                    "status": "review",
                    "prompt": "In a Hydropower plant, Pelton turbine with rated speed of 550 rpm is used. Power developed is 6 MW with net head=300m, if the ratio of jet to diameter of wheel =0.1 and overall efficiency =90%, find the number of jets needed if Cv=0.98, speed ratio =0.46",
                ...
                {
                    "id": "check-hydr626-00074",
                    "status": "review",
                    "prompt": "Calculate the total number of poles of generator for a francis turbine with synchronous speed of 461.54 rpm if f = 50 Hz",
                ...
                {
                    "id": "check-hydr626-00075",
                    "status": "review",
                    "prompt": "What should be the outlet velocity from a draft tube if P=2250 Kw, H=5.5m, inlet diameter = 2.8m, overall efficiency = 0.87, draft tube efficiency=78% and head loss = 0.89",
                ...
                {
                    "id": "check-hydr626-00076",
                    "status": "review",
                    "prompt": "A turbine is to operate under a head of 25m at 200 rpm. The discharge is 9 cumecs. If efficiency =90%, determine the power generated and specific speed of turbine",
                ...
                {
                    "id": "check-hydr626-00077",
                    "status": "review",
                    "prompt": "For discharge =300 cumecs, net head=5m, speed of turbine=50 rpm and efficiency =82% and specific speed =500 rpm, determine the number of kalima turbine need to utilize the full potential of the river:",
                ...
                {
                    "id": "check-hydr626-00078",
                    "status": "review",
                    "prompt": "What is the diameter if turbine runner in the peripheral coefficient of a Francis turbine is 0.678 working under a head of 150m and synchronous speed (N)=500",
                ...
                {
                    "id": "check-hydr626-00079",
                    "status": "corrected",
                    "prompt": "The specific speed of a turbine under a head of 150 m to develop 2000HP while running at 300 rpm is",
                    "html": "<p><strong>Corrected: 10-35, option D.</strong> The stated hp-based specific speed is 300 sqrt(2000)/150<sup>1.25</sup> = 25.5577, within this range.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00079",
                            "set": 10,
                ...
                {
                    "id": "check-hydr626-00080",
                    "status": "review",
                    "prompt": "A pelton wheel is supplied water under a head of 200m through a 100mm diameter nozzle pipe. Quantity of water supplied is 1.25 cumecs. Find number of jets assuming Cv=0.97",
                ...
                {
                    "id": "check-hydr626-00081",
                    "status": "review",
                    "prompt": "Find the specific speed of the turbine if speed = 6000 rpm, Power generation = 5MW in total by 2 turbines under head of 20m",
                ...
                {
                    "id": "check-hydr626-00082",
                    "status": "review",
                    "prompt": "Determine the number of buckets in a pelton wheel turbine with runner diameter=2m and jet diameter=0.25m",
                    "html": "<p><strong>Use the empirical bucket-count rule only as a preliminary estimate.</strong> Z about 15 + D/(2d) gives 19 for D = 2 m and d = 0.25 m. Actual interception, clearance and loading need further design checks.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00082",
                            "set": 10,
                ...
                {
                    "id": "check-hydr626-00083",
                    "status": "review",
                    "prompt": "In a reciprocating pump, with the charge discharge pressure,",
                    "html": "<p>The charge discharge pressure stem is corrupted. </p><p>At fixed stroke and speed, ideal reciprocating displacement is pressure-independent; real discharge can change with leakage, valve behaviour and suction conditions. </p><p>A universal decrease is not established without specifying a real operating model. </p>",
                    "sources": [
                        {
                            "id": "HYDR626-00083",
                            "set": 10,
                ...
                {
                    "id": "check-hydr626-00084",
                    "status": "review",
                    "prompt": "The ratio of power at the shaft of turbine and power delivered by water to runner is known as?",
                    "html": "<p><strong>Bank check: do not count volumetric loss twice.</strong> </p><p>Runner power divided by inlet water power is the intended hydraulic ratio, while shaft power divided by runner-transferred power is mechanical efficiency. </p><p>If inlet water power uses total admitted flow, that first ratio already includes leakage. </p><p>Only the separate runner-flow hydraulic definition combines with an additional Q<sub>r</sub>/Q<sub>in</sub> factor. </p><p>Generator efficiency belongs beyond the turbine shaft.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00084",
                            "set": 11,
                ...
                {
                    "id": "check-hydr626-00085",
                    "status": "review",
                    "prompt": "Cavitation in a draft tube occurs when ______",
                    "html": "<p><strong>Bank check: one-third atmosphere is not the cavitation criterion.</strong> </p><p>Assess local absolute pressure against water-temperature-dependent vapour pressure and the machine's required margin. </p><p>The stored one-third-atmosphere rule is not treated as a universal limit.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00085",
                            "set": 11,
                ...
                {
                    "id": "check-hydr626-00086",
                    "status": "review",
                    "prompt": "What is the purpose of a Draft tube?",
                    "html": "<p><strong>A draft tube recovers part of the runner-exit kinetic head.</strong> Outlet velocity and hydraulic losses limit recovery, while cavitation limits the usable setting. It does not create energy or guarantee complete recovery.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00086",
                            "set": 11,
                ...
                {
                    "id": "check-hydr626-00087",
                    "status": "review",
                    "prompt": "The exit diameter for a simple elbow draft tube should be ______",
                    "html": "<p><strong>Outlet area should be compared with inlet area.</strong> A larger exit can reduce residual velocity, but excessive diffusion and poor bend geometry cause separation and losses. “Large” alone is not a complete design requirement.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00087",
                            "set": 11,
                ...
                {
                    "id": "check-hydr626-00088",
                    "status": "review",
                    "prompt": "Draft tube is also called ______",
                    "html": "<p><strong>An elbow is one draft-tube form, not its universal alternative name.</strong> Straight divergent and other arrangements also exist. Identify the geometry rather than equating the entire component class with one shape.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00088",
                            "set": 11,
                ...
                {
                    "id": "check-hydr626-00089",
                    "status": "review",
                    "prompt": "If diameter of jet is 85mm and diameter of runner is 1.5 meter then calculate width of buckets.",
                    "html": "<p><strong>Bank check: bucket proportions are empirical.</strong> </p><p>They give 425 mm width for an 85 mm jet and 19 buckets for D = 2 m, d = 0.25 m under those assumptions. </p><p>The width calculation does not use the given 1.5 m runner diameter. </p><p>Final interception, clearance, bucket geometry and loading still require design evidence.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00089",
                            "set": 11,
                ...
                {
                    "id": "check-hydr626-00091",
                    "status": "review",
                    "prompt": "The depth of buckets of Pelton wheel",
                    "html": "<p><strong>Bank check: bucket proportions are empirical.</strong> </p><p>B ≈ 5d, depth ≈ 1.2d and Z ≈ 15 + D/(2d) are preliminary bank heuristics, not universal laws or verified mandatory clauses. </p><p>Final interception, clearance, bucket geometry and loading still require design evidence.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00091",
                            "set": 11,
                ...
                {
                    "id": "check-hydr626-00092",
                    "status": "review",
                    "prompt": "Find the diameter of jet D, if jet ratio m and diameter of jet d are given as 10 and 125mm.",
                ...
                {
                    "id": "check-hydr626-00093",
                    "status": "review",
                    "prompt": "Maximum efficiency of Pelton turbine is ______",
                    "html": "<p><strong>No universal 88% maximum.</strong> Jet, runner, mechanical and overall efficiencies have different boundaries. The ideal lossless-reversal limit is unity; practical losses and bucket geometry reduce performance.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00093",
                            "set": 11,
                ...
                {
                    "id": "check-hydr626-00097",
                    "status": "review",
                    "prompt": "Hydraulic energy is converted into another form of energy by hydraulic machines. What form of energy is that?",
                    "html": "<p><strong>The direction of energy conversion depends on the machine.</strong> A turbine converts hydraulic energy to shaft work; a pump uses shaft work to increase fluid energy. A broad hydraulic-machine statement needs that distinction.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00097",
                            "set": 12,
                ...
                {
                    "id": "check-hydr626-00101",
                    "status": "review",
                    "prompt": "Hydraulic Machines fall under the category",
                    "html": "<p><strong>Bank check: lifting input and turbine output are opposite efficiency applications.</strong> </p><p>Actual pump shaft input is ρgQH/η<sub>p</sub>, not ηρgQH. </p><p>The explanation switches incorrectly to generation. </p><p>Hydraulic machines also include pumps, and positive-displacement pumps are not rotodynamic; the two broad machinery stems need a turbine or turbomachinery restriction for their intended statements.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00101",
                            "set": 12,
                ...
                {
                    "id": "check-hydr626-00102",
                    "status": "review",
                    "prompt": "Which kind of turbines does not change the form of energy of water at the inlet?",
                    "html": "<p><strong>An impulse runner still extracts energy and changes velocity.</strong> Its buckets operate approximately at atmospheric pressure. Lack of a substantial pressure drop through the runner, not lack of energy conversion, distinguishes the impulse idealization.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00102",
                            "set": 12,
                ...
                {
                    "id": "check-hydr626-00103",
                    "status": "review",
                    "prompt": "Which type of turbine is used to change the velocity of the water through its flow?",
                    "html": "<p><strong>Velocity change does not uniquely identify a reaction turbine.</strong> Impulse and reaction runners both change water velocity while producing torque. Pressure change through the runner is the relevant distinction.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00103",
                            "set": 12,
                ...
                {
                    "id": "check-hydr626-00104",
                    "status": "review",
                    "prompt": "Which kind of turbine is a Fourneyron Turbine?",
                ...
                {
                    "id": "check-hydr626-00105",
                    "status": "review",
                    "prompt": "The main function of nozzle is to ______.",
                    "html": "<p><strong>Bank check: define nozzle function and the speed-ratio denominator.</strong> </p><p>A nozzle converts available head into jet kinetic energy; pressure variations is only an imprecise description. φ = u/√(2gH) and λ = u/V<sub>j</sub> differ when C<sub>v</sub> differs from one, with φ = C<sub>v</sub>λ. </p>",
                    "sources": [
                        {
                            "id": "HYDR626-00105",
                            "set": 13,
                ...
                {
                    "id": "check-hydr626-00108",
                    "status": "review",
                    "prompt": "The hydraulic turbine suitable for a range of 95 to 440 rpm is",
                ...
                {
                    "id": "check-hydr626-00139",
                    "status": "review",
                    "prompt": "Reciprocating pumps work on the principle of ______",
                    "html": "<p><strong>Bank check: distinguish ideal displacement from real delivery.</strong> </p><p>A universal decrease is not established without specifying a real operating model. </p><p>Positive displacement is the defining principle. </p><p>Force pump is historical terminology, not a complete universal synonym for every reciprocating arrangement.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00139",
                            "set": 16,
                ...
                {
                    "id": "check-hydr626-00140",
                    "status": "review",
                    "prompt": "Reciprocating pumps have ______ efficiency compared to centrifugal pumps",
                ...
                {
                    "id": "check-hydr626-00141",
                    "status": "review",
                    "prompt": "To obtain maximum hydraulic efficiency of impulse turbine, blade velocity should be ______ times the inlet velocity of jet.",
                    "html": "<p><strong>Bank check: half jet speed does not enforce 180° turning or an 88% ceiling.</strong> </p><p>For fixed k and backward-tangent exit angle β, η<sub>jet</sub> = 2λ(1 − λ)(1 + kcosβ) has its maximum at λ = 1/2, with maximum (1 + kcosβ)/2. </p><p>Bucket geometry sets the turning angle. </p><p>Nozzle, runner, mechanical and generator losses have different boundaries. </p><p>The ideal lossless-reversal limit is unity; 88% is an unverified practical figure, not a universal maximum.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00141",
                            "set": 16,
                ...
                {
                    "id": "check-hydr626-00142",
                    "status": "review",
                    "prompt": "Reciprocating pumps are also called as.....",
                    "html": "<p>A universal decrease is not established without specifying a real operating model. </p><p>Force pump is historical terminology, not a complete universal synonym for every reciprocating arrangement.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00142",
                            "set": 16,
                ...
                {
                    "id": "check-hydr626-00145",
                    "status": "review",
                    "prompt": "Velocity triangles are used to analyze",
                ...
                {
                    "id": "check-hydr626-00146",
                    "status": "review",
                    "prompt": "Radial flow reaction turbines contain spiral casing which area ______",
                    "html": "<p><strong>Bank check: scroll taper supports distribution, not exact constant velocity everywhere.</strong> </p><p>Remaining scroll flow decreases as water enters the distributor, so a decreasing area is consistent with an approximately maintained section-mean velocity. </p><p>Local flow, tongue/end geometry, losses and nonuniformity require detailed design beyond the ideal remaining-flow/area explanation.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00146",
                            "set": 17,
                ...
                {
                    "id": "check-hydr626-00147",
                    "status": "review",
                    "prompt": "The pressure at the exit of runner of reaction turbine is generally ______ than atmospheric pressure",
                ...
                {
                    "id": "check-hydr626-00148",
                    "status": "review",
                    "prompt": "In inward radial flow reaction turbine the ratio of tangential wheel at inlet to given velocity of jet is known as ______.",
                    "html": "<p><strong>Bank check: define nozzle function and the speed-ratio denominator.</strong> </p><p>The reaction-turbine peripheral coefficient uses theoretical spouting velocity, not necessarily an actual inlet jet. </p><p>Neither the name speed ratio nor the nozzle label supplies missing numerical assumptions.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00148",
                            "set": 17,
                ...
                {
                    "id": "check-hydr626-00186",
                    "status": "review",
                    "prompt": "The water from penstocks enters the ______ which is spiral in shape which the area of cross section of casing goes on decreasing gradually",
                    "html": "<p>Remaining scroll flow decreases as water enters the distributor, so a decreasing area is consistent with an approximately maintained section-mean velocity. </p><p>The casing receives penstock supply; the downstream draft tube has a different role. </p>",
                    "sources": [
                        {
                            "id": "HYDR626-00186",
                ...
                {
                    "id": "check-hydr626-00232",
                    "status": "review",
                    "prompt": "The value of power factor is generally:",
                ...
                {
                    "id": "check-wate701-00379",
                    "status": "review",
                    "prompt": "Which of the following machines have the possibility of cavitation?",
