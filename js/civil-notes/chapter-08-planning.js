        ...
        ACiE0801: {
            ...
            blocks: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Site selection considers both opportunities and problems.</strong> Sound rock may provide a favourable foundation, but the word rocky does not establish soundness. Joint orientation, weathering, faults, permeability, excavation behaviour and slope stability can govern dam abutments, tunnel support and powerhouse foundations. A positive result from geological investigation does not make geology irrelevant.</p><table><thead><tr><th scope='col'>Subject</th><th scope='col'>Planning question</th></tr></thead><tbody><tr><th scope='row'>Foundation and rock mass</th><td>Can the structures be supported and excavated safely, with practicable treatment of weak zones, seepage and instability?</td></tr><tr><th scope='row'>Sediment</th><td>What material arrives, when does it arrive, and how will deposition, abrasion and sediment handling affect useful storage, equipment and downstream conditions?</td></tr><tr><th scope='row'>Catchment and water</th><td>Is the usable flow sufficiently dependable for the intended service after competing uses and required releases?</td></tr><tr><th scope='row'>Hazards and access</th><td>How do floods, earthquakes, landslides and any relevant upstream lake-outburst hazards affect the layout, construction and operation?</td></tr></tbody></table>",
                    moreHtml: "<p>Unwanted sediment deposition is <strong>not a desirable site attribute</strong>. Nevertheless, sediment assessment and management are essential considerations. Deposition can reduce useful storage, while particles carried through machinery can cause abrasion; these are related but different mechanisms. A scheme without a large reservoir still needs a sediment strategy.</p><p>This resolves the two bank stems differently. In the question asking what is <em>not a consideration</em>, all four listed subjects deserve consideration, including rocky land. In the question asking what is <em>not a requirement</em>, sedimentation is defensible only if requirement means a desirable attribute. It does not mean that an engineer may omit sediment investigations. No site-specific rock quality, sediment rate or universal acceptance threshold is supplied.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>A potential estimate is conditional on its definition and assessment basis.</strong> Resource magnitude, engineering developability and economic attractiveness are separate filters. The official syllabus names all three; memorising one national number does not explain their relationship.</p><table><thead><tr><th scope='col'>Category</th><th scope='col'>Meaning</th><th scope='col'>What it does not establish</th></tr></thead><tbody><tr><th scope='row'>Gross or theoretical</th><td>An idealised physical resource account derived from water and elevation under the assessment's stated hydrological and geographical assumptions.</td><td>That all the resource can be captured by real, acceptable projects.</td></tr><tr><th scope='row'>Technical</th><td>The portion that can be developed using the technologies, layouts and engineering constraints included in the study.</td><td>That construction costs, revenues, impacts and financing make every candidate attractive.</td></tr><tr><th scope='row'>Economic</th><td>The technically developable opportunities that pass the specified economic evaluation, with its costs, benefits, prices, discounting and exclusions.</td><td>That funding, all permissions or a purchaser are already secured.</td></tr></tbody></table><p>Installed capacity is the rating of facilities actually installed on the stated date; planned capacity describes proposed facilities. Neither is the same as national potential. A fraction such as feasible potential divided by gross potential is an assessment ratio, <strong>not turbine efficiency, capacity factor or a permanent percentage applicable to every river</strong>. The bank's 42 GW question needs precisely these category distinctions.</p>",
                    moreHtml: "<p>With <strong>compatible boundaries, units and definitions</strong>, economic potential is no greater than technical potential, which is no greater than gross potential. These are nested views of a resource, not independent quantities to add. Studies may place environmental or other exclusions at different screening stages, so retain their actual terminology rather than relabelling a published total.</p>",
                ...
                },
                {
                    ...
                    html: "<p><em>Syllabus extension: measurement basis for Nepal and world power-potential comparisons.</em> None of the 17 assigned records supplies a complete annual-generation calculation. The following account is an authored illustration, not reconstructed bank data.</p><p><strong>Power is a rate; energy accumulates over time.</strong> One MW is 1000 kW, one GW is 1000 MW, and one TWh is 1000 GWh. Station installed capacity C is the sum of the relevant generating-unit power ratings. </p><p>For power in MW and duration in hours, <strong>E<sub>MWh</sub> = ΣP<sub>i</sub>Δt<sub>i</sub></strong>. For a fixed capacity and consistent generation boundary, <strong>CF = E<sub>MWh</sub>/(C<sub>MW</sub>T<sub>h</sub>)</strong>, giving <strong>E<sub>GWh</sub> = C<sub>MW</sub>T<sub>h</sub>CF/1000</strong>. </p><p><strong>Authored comparison:</strong> assume a 365-day year, so T = 8760 h. A hypothetical 100 MW station at CF = 0.50 produces <strong>438 GWh/year</strong>. Another at 80 MW and CF = 0.75 produces <strong>525.6 GWh/year</strong>. </p>",
                    moreHtml: "<p>A single unit's rating is not the whole station's rating, and a generator rating in MVA cannot simply be read as the same numerical MW output.</p><p>CF is the capacity factor, not the efficiency of a turbine. Water availability, operation, losses, outages and grid acceptance affect achieved energy.</p><p>The smaller installed capacity produces more annual energy under these explicit assumptions. No actual project capacity factor is being asserted.</p><p>Therefore a ranking by MW is not a ranking by yearly GWh. Similarly, TWh/year potential cannot be compared directly with a national MW estimate. Dividing annual energy by the year's hours gives average power; converting it into an equivalent installed capacity additionally requires the assumed capacity factor and a compatible operating basis.</p>",
                    sources: []
                },
                {
                    id: "planning-nepal-legacy-potential",
                    title: "Attribute the 83,000 and 42,000 MW figures to their historical account",
                    html: "<p><strong>The Hydropower Development Policy, 2058 (2001), introduction records the familiar 83,000/42,000 MW account.</strong> Its historical resource statement gives about 83,000 MW of potential and describes about 42,000 MW as feasible from <strong>financial–technical perspectives</strong>. Preserve that combined wording when citing the policy rather than treating it as a modern technical-only inventory.</p><table><thead><tr><th scope='col'>Historical quantity</th><th scope='col'>Equivalent unit</th><th scope='col'>Interpretation</th></tr></thead><tbody><tr><th scope='row'>83,000 MW</th><td>83 GW</td><td>The legacy aggregate resource figure commonly cited as gross/theoretical potential; it is not capacity already installed.</td></tr><tr><th scope='row'>42,000 MW</th><td>42 GW</td><td>The policy's financial–technical feasibility figure, commonly used as the legacy economically feasible answer in examination material.</td></tr></tbody></table><p>The bank's 42 GW choice follows that legacy convention. Its explanation then calls the same amount technically feasible and merges technical, economic and environmental constraints without identifying an assessment. That does not establish a separate, up-to-date technical estimate. Nor should 42 GW be written as 42,000 GW: the MW-to-GW conversion is a factor of 1000.</p><p>Use a three-part memory aid: <strong>number, category, source year</strong>. The policy is evidence for the statement published in 2001, not proof that exactly that amount would satisfy present costs, permits, environmental requirements or financing conditions. </p>",
                    moreHtml: "<p>New hydrological data, layouts and evaluation assumptions can change a later assessment without changing the correctness of quoting the older document accurately.</p>",
                    sources: [{ id: "HYDR626-00290", set: 31, question: 67 }]
                },
                {
                    id: "planning-wecs-2019-potential",
                    title: "Read WECS 2019 with its hydrology and border-accounting basis",
                    html: "<p><em>Syllabus extension: an identified assessment beyond the bank's single legacy potential question.</em> The Water and Energy Commission Secretariat, WECS, <strong>Assessment of Hydropower Potential of Nepal, Final Report, July 2019</strong>, provides a separately defined account. The supporting research inspected section 7.4.1, printed page 64, and section 11.1, printed page 116.</p><table><thead><tr><th scope='col'>WECS 2019 result</th><th scope='col'>Basis to retain</th></tr></thead><tbody><tr><th scope='row'>72,544 MW gross potential</th><td><strong>72.544 GW at 40% flow exceedance</strong>; the national account includes half the potential of international-border reaches.</td></tr><tr><th scope='row'>32,680 MW ROR techno-economic potential</th><td><strong>32.680 GW</strong> from the report's run-of-river project screening. This is not a technical-only result, a complete inventory of storage alternatives or an operating-fleet total.</td></tr></tbody></table><p>A flow at 40% exceedance, Q<sub>40</sub>, is equalled or exceeded for 40% of the reference flow-duration record. It is <strong>not a 40% conversion efficiency or an automatic 40% annual capacity factor</strong>, and it is not a guarantee of the same continuous operating interval in every year. </p><p>Do not place 83,000, 72,544, 42,000 and 32,680 in one column and interpret their differences as a measured loss of Nepal's resource. First reconcile hydrology, coverage, shared reaches, candidate schemes, exclusions and economic assumptions. The 2001 financial–technical account and the 2019 techno-economic account are <strong>not automatically like-for-like estimates</strong>.</p><p>WECS's <strong>Energy Sector Synopsis Report 2024, FY2079/80</strong>, section 4.1.2.3 and Table 4.5, printed page 55, repeats 72,544 MW with attribution to WECS 2019. A later publication repeating a figure does not turn it into a newly measured 2024 or 2026 potential.</p>",
                    moreHtml: "<p>The border-reach half share is an accounting convention of this assessment; it does not halve every Nepal river or determine legal ownership by itself.</p>",
                    sources: []
                },
                {
                    id: "planning-world-potential-2011",
                    title: "World potential needs a dated energy assessment, not a plant ranking",
                    html: "<p><em>Syllabus extension: gross, technical and economic potential of the world.</em> The assigned world questions concern individual stations, not the global resource. For the latter, the inspected <strong>IPCC SRREN, Chapter 5: Hydropower, 2011</strong>, sections 5.2–5.2.1, printed pages 444–446, reports estimates attributed to <strong>IJHD 2010</strong>.</p><table><thead><tr><th scope='col'>Dated world estimate</th><th scope='col'>Quantity</th><th scope='col'>Meaning</th></tr></thead><tbody><tr><th scope='row'>Theoretical annual potential</th><td><strong>39,894 TWh/year</strong></td><td>An annual physical energy-resource estimate, not a station rating.</td></tr><tr><th scope='row'>Technical annual potential</th><td><strong>14,576 TWh/year</strong></td><td>The technically developable annual-energy estimate in the cited assessment.</td></tr><tr><th scope='row'>Corresponding technical capacity</th><td><strong>3,721 GW</strong></td><td>A capacity equivalent derived using assumed regional capacity factors; not 3,721 TWh/year and not an additional resource to add to 14,576 TWh/year.</td></tr></tbody></table><p>The conversion concept is <strong>E = ΣC<sub>i</sub>T CF<sub>i</sub></strong>, with compatible units and regional assumptions. A global annual energy value alone cannot establish a unique installed-capacity equivalent. These dated global energy estimates also cannot be ranked directly against Nepal's Q<sub>40</sub>-based MW account without reconciling the measurement basis.</p><p>Use these numbers as a <strong>2011 assessment reporting 2010 estimates</strong>, not as a present-day inventory. The size of Three Gorges or Baihetan answers a station-capacity question and says nothing by itself about the world's remaining economic resource.</p>",
                    moreHtml: "<p><strong>Economic potential is time- and location-dependent.</strong> Construction and transmission costs, competing supplies, demand, discounting and the treatment of environmental and social constraints influence which technical opportunities are worth developing. The inspected material does not establish a single current world economic total for these notes; none is invented by applying an arbitrary percentage to technical potential.</p>",
                    sources: []
                },
                {
                    id: "planning-economic-and-financial-appraisal",
                    title: "A physically possible project may be uneconomic or unfinanceable",
                    html: "<p><em>Syllabus extension: how economic potential is screened.</em> The bank supplies no project cash-flow series, price basis or financing model. This framework explains the distinction without inventing a tariff, discount rate, royalty, payback period or guaranteed return.</p><table><thead><tr><th scope='col'>Assessment</th><th scope='col'>Central question</th></tr></thead><tbody><tr><th scope='row'>Physical and technical</th><td>Can the selected layout produce the intended service safely with the available water, head, technology and infrastructure?</td></tr><tr><th scope='row'>Economic</th><td>Do the benefits justify the real resources used, compared with alternatives under a stated assessment boundary?</td></tr><tr><th scope='row'>Financial</th><td>Can the developer meet actual expenditures and financing obligations from contractual receipts and committed funding?</td></tr><tr><th scope='row'>Policy and legal</th><td>Does the proposal align with policy objectives and satisfy applicable rights, permissions and obligations? These are not substitutes for either of the preceding appraisals.</td></tr></tbody></table><p>A general discounted account is <strong>NPV = Σ[(B<sub>t</sub> − C<sub>t</sub>)/(1 + r)<sup>t</sup>]</strong>, including initial investment and later costs or benefits in their proper periods. Here B<sub>t</sub> and C<sub>t</sub> are consistently defined benefits and costs, r is the stated period discount rate, and t is the period index. </p><p>Test sensitivity to dry-year flows, construction delay, cost escalation, demand and sale assumptions. A project can have positive economic value but lack a financeable revenue arrangement; conversely, a favourable private contract does not prove that all wider costs are justified. DoED's 2018 study guidance includes cost–benefit comparison in optimisation, not a universal optimum capacity or financial guarantee.</p>",
                    moreHtml: "<p>Economic valuation and financial cash receipts need not use the same amounts. Keep real or nominal price treatment consistent with the chosen rate.</p><p>Compare alternatives on a common service and life-cycle basis. Extra installed MW may produce little additional energy if useful water is rarely available, although dependable peak service can have value distinct from annual energy. Include access, evacuation, mitigation, operation, sediment-related maintenance and major rehabilitation rather than comparing turbine purchase costs alone.</p>",
                    sources: []
                },
                {
                    id: "planning-reconnaissance-to-feasibility",
                    title: "Development studies progressively reduce decision uncertainty",
                    html: "<p><strong>Development begins with choices, not concrete.</strong> The DoED <strong>Guidelines for Study of Hydropower Projects, 2018</strong>, printed pages 2–3, distinguishes study stages, including detailed design. Reconnaissance, pre-feasibility and feasibility have different purposes even when some investigations continue across their boundaries.</p><table><thead><tr><th scope='col'>Stage</th><th scope='col'>Work and useful output</th></tr></thead><tbody><tr><th scope='row'>Reconnaissance or identification</th><td>Screen river reaches, existing information, demand and broad constraints. Identify candidate schemes and obvious reasons to reject or investigate them.</td></tr><tr><th scope='row'>Pre-feasibility</th><td>Compare plausible sites and layouts using preliminary surveys and estimates. Select promising alternatives and specify the investigations needed to distinguish them reliably.</td></tr><tr><th scope='row'>Feasibility</th><td>Develop the evidence for a go/no-go decision: hydrology, geology, layout, energy, access, grid connection, costs, environmental and social implications, risks and implementation arrangements.</td></tr></tbody></table>",
                    moreHtml: "<p>Feasibility is not simply a more precise name for reconnaissance. For example, a map-based high-head opportunity can be downgraded by poor rock along its tunnel, an expensive connection, inadequate dry-season supply or unacceptable impacts. The assessment must respond to that evidence rather than preserve the first advertised capacity at any cost.</p><p>The outcome may be development, redesign, further investigation, postponement or rejection. A favourable feasibility report does not itself certify financing, every statutory approval or construction readiness. These study labels describe decision maturity; project-specific terms of reference and applicable procedures still govern the required work.</p>",
                ...
                },
                {
                    ...
                    html: "<p><strong>Pharping was Nepal's first hydropower plant, with an original installed capacity of 500 kW.</strong> NEA's <strong>Generation Directorate 2082/2083, 18th issue</strong>, printed page 93, records inauguration on <strong>22 May 1911</strong> and <strong>two 250 kW generating units</strong>. The bank's 1911 AD, or 1968 BS, and 500 kW answers are consistent with this historical account.</p><p>The unit account is <strong>2 × 250 kW = 500 kW = 0.5 MW</strong>. Neither one 250 kW unit nor 500 MW represents the original station total. </p><p>Separate three kinds of historical milestone: <strong>the first generating plant</strong>, <strong>the later creation of a national electricity institution</strong>, and <strong>subsequent growth in project size and system capability</strong>. The start of generation in 1911 is not NEA's establishment date, and the date of a later annual report is not the plant's commissioning year.</p><p>A useful chronology proceeds from Pharping to NEA's formation in 1985, the 1992 electricity-sector Act and 1993 implementing Rules, the identified 2001 hydropower policy, and later project milestones. This is a framework for understanding institutional and technical development, not a claim to list every plant or policy event in Nepal's history.</p>",
                    moreHtml: "<p>Installed power is a rating; the supplied historical facts do not give the station's annual energy or prove that its original rating is continuously available now.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><em>Syllabus extension: hydropower policy beyond the assigned institution and history questions.</em> Use the identified <strong>Hydropower Development Policy, 2058 (2001)</strong>, rather than an unspecified hydropower policy. The supplied research inspected its objectives in section 3 and the storage, multipurpose, environmental and resettlement provisions in sections 5.5–5.8.</p><ul><li><strong>Storage and multipurpose development:</strong> evaluate how regulation can serve power and other intended water uses. Identify the timing of benefits and conflicts rather than adding an irrigation label to a power-only operating plan.</li><li><strong>Environmental mitigation:</strong> integrate environmental effects into alternative selection, investigations, design and costs. An attractive installed capacity does not demonstrate acceptable impacts.</li><li><strong>Resettlement and social implications:</strong> identify affected people, land and livelihoods and account for the measures needed; these are planning inputs, not costs that can be omitted to make an alternative appear cheaper.</li><li><strong>Coordinated implementation:</strong> translate objectives into an evidence-based scheme and programme, recognising that separate legal and commercial instruments govern actual implementation.</li></ul><p>These points explain the role of the <strong>2001 document</strong>. They do not certify that every clause, incentive or procedure in that historical English text is the fully consolidated rule applicable in September 2026. No current royalty, capacity exemption, approval period or PPA guarantee is inferred from it.</p>",
                    moreHtml: "<p>Policy explains <strong>what development should achieve and which considerations should guide it</strong>. It is not itself a completed feasibility study, a licence for a particular river reach, a financing commitment or a contract for electricity purchase. Its historical potential figures and its policy objectives must also be read separately: a national resource estimate does not approve a particular layout.</p>",
                    sources: []
                },
                {
                    id: "planning-electricity-act-and-rules",
                    title: "Distinguish an establishing Act, sector legislation and implementing Rules",
                    html: "<p><em>Syllabus extension: acts and regulation governing hydropower development.</em> The inspected legal references are identified English editions, not a certification of all amendments or present legal status. Learn each instrument's <strong>title, year and role</strong> before learning any project-specific procedure.</p><table><thead><tr><th scope='col'>Instrument</th><th scope='col'>Role supported by the inspected material</th></tr></thead><tbody><tr><th scope='row'>Nepal Electricity Authority Act, 2041 (1984)</th><td>The enabling statute named by NEA for its establishment; distinct from general electricity-sector licensing legislation.</td></tr><tr><th scope='row'>Electricity Act, 2049 (1992)</th><td>The sector Act whose sections 3–5 contain licensing provisions concerning electricity survey and development activities. Survey, generation, transmission and distribution are not interchangeable permissions.</td></tr><tr><th scope='row'>Electricity Rules, 2050 (1993)</th><td>Implementing Rules made under section 40 of the Electricity Act. They provide the subordinate procedural framework rather than constituting a separate Act establishing NEA.</td></tr><tr><th scope='row'>Hydropower Development Policy, 2058 (2001)</th><td>A policy instrument setting development direction; it is neither the NEA Act nor the Electricity Rules.</td></tr></tbody></table>",
                    moreHtml: "<p>A <strong>PPA is a commercial agreement</strong>, not an Act or a government licence. A study guideline tells an engineer what a study should address; it does not automatically confer a water-use right or replace environmental, land, forest or connection requirements that apply to the particular project.</p><p>For actual practice, identify the competent authorities and obtain the applicable, amended texts and project conditions. Check which activities require which permissions and how they interact before committing to a programme. The old English copies alone cannot establish current exemptions, royalties, tariff rights, application deadlines or the completeness of a present-day approval checklist. None of those numerical or latest-status claims is made here.</p>",
                    sources: []
                },
                {
                    id: "planning-kaligandaki-and-upper-tamakoshi",
                    title: "Nepal's operating milestones need both a date and a scheme type",
                    html: "<p><strong>Compare projects within a stated operating fleet and time period.</strong> A historical largest-plant question is normally about installed generating capacity, not dam height, reservoir volume, yearly generation or every announced proposal. The following profiles retain the dates and classifications supported by the inspected NEA reports.</p><table><thead><tr><th scope='col'>Project</th><th scope='col'>Capacity and scheme</th><th scope='col'>Dated interpretation</th></tr></thead><tbody><tr><th scope='row'>Kaligandaki A</th><td><strong>144 MW; peaking run-of-river.</strong></td><td>The bank's intended historical operating-fleet comparison shortly before 2020. NEA's Generation Directorate 2082/2083 plant table, printed page 99, supports the peaking-ROR classification.</td></tr><tr><th scope='row'>Upper Tamakoshi</th><td><strong>456 MW; daily peaking run-of-river.</strong></td><td>NEA's Annual Report 2025/2026, UTKHPL section, PDF pages 110–111, records commercial operation on <strong>20 August 2021</strong>.</td></tr></tbody></table><p>The 456 MW figure is larger than 144 MW, but the ratio of their capacities does not give the ratio of annual energy, dry-season dependable output or economic value. Those comparisons need flow, head, operation and the appropriate measured or modelled energy periods.</p><p>Read before 2020 as the bank's historical comparison, not a claim that Kaligandaki A existed throughout all earlier history. Likewise, retain Upper Tamakoshi as the supported 456 MW operating milestone after its 2021 commissioning, <strong>not an undated promise that it remains Nepal's largest or that every unit is available today</strong>.</p>",
                    moreHtml: "<p><strong>Daily peaking</strong> means that available pondage and operating arrangements can shift releases and output within the day. It does not make the project a seasonal storage scheme capable of moving an arbitrary monsoon volume into the dry season. Equally, calling a project ROR does not necessarily mean it has no pondage or operational regulation.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>China Three Gorges Corporation's project profiles support the capacity comparison intended by the two world-ranking questions.</strong> The operator pages were inspected in the supporting research and rechecked on 6 September 2026. </p><table><thead><tr><th scope='col'>Station</th><th scope='col'>Location and reported capacity</th><th scope='col'>Comparison being made</th></tr></thead><tbody><tr><th scope='row'>Three Gorges</th><td>Yangtze River, China; <strong>22.5 GW = 22,500 MW</strong>.</td><td>The larger installed-capacity station in the cited comparison; the operator describes multiple water-management benefits as well as generation.</td></tr><tr><th scope='row'>Baihetan</th><td>Jinsha River, the upper Yangtze; <strong>16 GW = 16,000 MW</strong>, with <strong>16 units of 1 GW each</strong>.</td><td>The operator describes it as second to Three Gorges in this station-capacity context.</td></tr></tbody></table>",
                    moreHtml: "<p>This is an attribution to those profiles, not an independently updated world inventory or a claim based on their footer copyright year.</p><p>These profiles support the bank's intended first/second <strong>installed generating capacity</strong> comparison. Use the proper name <strong>Three Gorges</strong>, not the bank's Three George spelling. Baihetan's one-gigawatt unit rating is not its station total, and a station total is not the combined capacity of a river cascade.</p><p>Annual energy ranking needs actual generation over the same stated year; drought, releases, outages and operation can change it. Dam height, reservoir storage, individual unit size and multipurpose benefits are different metrics again. No current global maximum across all such meanings of largest, and no yearly energy ranking, is inferred here.</p><p>Finally, a profile's reference to the start of operation must not be confused with the date all units reached the total quoted rating. Keep <strong>metric, unit, status and evidence date</strong> together whenever turning a project fact into a historical or planning comparison.</p>",
                    sources: [
            ...
            cautions: [
                {
                    "id": "check-hydr626-00295",
                    "status": "review",
                    "prompt": "Largest upcoming hydropower plant of Nepal is",
                ...
                {
                    "id": "check-hydr626-00119",
                    "status": "review",
                    "prompt": "What is not a consideration for site selection of hydroelectric power plant?",
                ...
                {
                    "id": "check-hydr626-00126",
                    "status": "review",
                    "prompt": "Which stage of hydropower development involves detailed engineering design, procurement, and construction?",
                ...
                {
                    "id": "check-hydr626-00127",
                    "status": "review",
                    "prompt": "Which act provides for the establishment of the Nepal Electricity Authority (NEA)?",
                    "html": "<p><strong>The establishing statute is the Nepal Electricity Authority Act, 1984/2041.</strong> The separate Electricity Act, 2049 (1992) did not establish NEA. The authority's establishment date in 1985 is distinct from the Act's year.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00127",
                            "set": 15,
                ...
                {
                    "id": "check-hydr626-00289",
                    "status": "review",
                    "prompt": "Nepal Electricity Authority(NEA) is established under the",
                    "html": "<p>The correct statute is the <strong>Nepal Electricity Authority Act, 1984/2041</strong>. </p><p>NEA was established on <strong>16 August 1985 / 1 Bhadra 2042</strong>, not in the Act's 1984 year. </p><p>Electricity Act and Nepal Electricity Act 1984 are not the exact establishing title; the separate Electricity Act, 2049 (1992), did not establish NEA.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00289",
                            "set": 31,
                ...
                {
                    "id": "check-hydr626-00290",
                    "status": "review",
                    "prompt": "What is the economically feasible power potential of Nepal?",
                ...
                {
                    "id": "check-hydr626-00292",
                    "status": "review",
                    "prompt": "What is the right sequential order for Power development nowadays in case of Nepal?",
                ...
                {
                    "id": "check-hydr626-00294",
                    "status": "review",
                    "prompt": "Largest hydropower plant of Nepal before 2020 AD is",
                    "html": "<p><strong>Largest must retain its date and metric.</strong> </p><p>Kaligandaki A's <strong>144 MW</strong> is the bank's historical pre-2020 operating-fleet comparison. </p><p>Upper Tamakoshi's <strong>456 MW</strong> and <strong>daily peaking ROR</strong> classification are supported by NEA's 2025/2026 report, which records commercial operation on <strong>20 August 2021</strong>. </p><p>These facts do not certify today's complete fleet ranking, current availability or annual-energy ranking, and daily peaking is not seasonal storage.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00294",
                ...
                {
                    "id": "check-hydr626-00296",
                    "status": "review",
                    "prompt": "The hydropower plant capacity of Bheri Babai Diversion Multipurpose Project is",
                ...
                {
                    "id": "check-hydr626-00297",
                    "status": "review",
                    "prompt": "The largest hydropower project of the world is",
                    "html": "<p>Use Three Gorges rather than Three George. </p><p>This is not an annual-generation, dam-height, reservoir-size or single-unit ranking, and it does not establish a timeless current maximum for every meaning of largest.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00297",
                            "set": 32,
                ...
                {
                    "id": "check-hydr626-00298",
                    "status": "review",
                    "prompt": "The second largest hydropower project of the world is",
                    "html": "<p><strong>World station rankings are capacity-specific.</strong> </p><p>The inspected CTG profiles support <strong>Three Gorges, 22,500 MW</strong>, and <strong>Baihetan, 16,000 MW</strong>, with Baihetan described as second to Three Gorges. </p><p>Use Three Gorges rather than Three George. </p><p>This is not an annual-generation, dam-height, reservoir-size or single-unit ranking, and it does not establish a timeless current maximum for every meaning of largest.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00298",
                            "set": 32,
                ...
                {
                    "id": "check-hydr626-00305",
                    "status": "review",
                    "prompt": "Which of the following is not a requirement for site selection of hydroelectric power plant?",
                ...
                {
                    "id": "check-hydr626-00307",
                    "status": "review",
                    "prompt": "Hydroelectric power plant is mainly located in ......",
