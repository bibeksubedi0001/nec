(function () {
    ...
    Object.assign(registry, {
        AALL1005: {
            ...
            blocks: [
                {
                    ...
                    html: "<p><strong>Syllabus extension:</strong> this bank does not provide a complete professional-responsibility case. Engineering professional practice joins technical judgement with accountability for the people and environments affected by a decision. A drawing, inspection or recommendation can influence construction workers, users, neighbours, maintenance staff and future generations, including people who never signed the consultant's contract.</p><p><strong>Public interest</strong> therefore cannot mean simply satisfying the paying client's immediate preference. Consider safety, reliable service, accessibility, environmental effects, affordability and the distribution of benefits and burdens. An apparently inexpensive scheme may transfer maintenance costs or flood exposure to a less influential community. Identifying that transfer is part of the engineering problem, not an optional publicity exercise.</p><p>Professional judgement requires a defensible chain from evidence to assumptions, analysis, alternatives and recommendation. State uncertainty and the limits of the commission; obtain specialist advice where necessary. A limitation should tell the decision-maker what has not been established, rather than hide an unresolved danger in small print.</p>",
                    moreHtml: "<p>Public safety and honest reporting guide these notes. The NEC conduct provisions are explained in their identified editions under the regulatory-body topic; neither a study note nor a favourable commercial decision constitutes legal, design or construction approval.</p>",
                    sources: []
                },
                {
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension; hypothetical case:</strong> this bank supplies no community survey, environmental baseline or alternative-design dataset. A proposed municipal drain would relieve a busy street but discharge towards a downstream settlement. A professional comparison must examine the receiving system and affected people, rather than define success only at the upstream property boundary.</p><table><thead><tr><th scope='col'>Perspective</th><th scope='col'>Evidence needed before recommending</th></tr></thead><tbody><tr><th scope='row'>Upstream users</th><td>Service interruptions, access needs and the existing cause of flooding.</td></tr><tr><th scope='row'>Downstream residents</th><td>Receiving capacity, flow pathways and changes in flood or pollution exposure.</td></tr><tr><th scope='row'>Maintenance workers</th><td>Safe access, sediment removal needs and a funded maintenance responsibility.</td></tr><tr><th scope='row'>Less-heard users</th><td>Accessible consultation with tenants, vendors and people with mobility limitations.</td></tr></tbody></table><p>Compare avoidance, route changes and other feasible service arrangements over construction, operation, maintenance and eventual replacement. Consultation can expose missing access routes or seasonal behaviour, but consultation alone cannot establish hydraulic adequacy. Conversely, a modelled capacity does not settle fairness or affordability.</p>",
                    moreHtml: "<p>The defensible recommendation records remaining uncertainty, how concerns changed the alternatives and who owns follow-up actions. Do not invent survey results, consent or environmental approval. Detailed BES, IEE and EIA procedures belong to the environmental-assessment topic; this case teaches the professional obligation to notice transferred impacts.</p>",
                    sources: []
                },
                {
                    id: "professional-ethical-reasoning",
                    title: "Resolve an ethical dilemma through evidence, duties and accountable action",
                    html: "<p><strong>Syllabus extension:</strong> this bank does not supply a worked ethical dilemma. A dilemma arises when obligations or interests pull in different directions, such as programme pressure versus an unresolved inspection finding. Ethical reasoning is not a search for a slogan that makes the difficult fact disappear.</p><ol><li><strong>Establish the facts:</strong> separate direct observations, reported claims, assumptions and missing evidence. Identify any immediate danger before completing paperwork.</li><li><strong>Identify affected parties and duties:</strong> consider the public, workers, client, employer and profession, along with the applicable law and agreed technical responsibilities.</li><li><strong>Develop defensible alternatives:</strong> seek clarification, independent review, a controlled hold or a revised scope rather than treating silent acceptance and resignation as the only options.</li><li><strong>Choose and communicate:</strong> explain the evidence, uncertainty and consequences to the people able to act; refuse an unsupported certification or dishonest instruction.</li><li><strong>Record and follow through:</strong> assign corrective actions, retain the decision trail and verify closure.</li></ol>",
                    moreHtml: "<p>Consequences matter, but a hoped-for benefit does not justify falsifying evidence. A superior's instruction also does not transfer away the signer's professional responsibility. Where serious danger is immediate, warn affected people, seek a controlled stop and refer to qualified responsible staff without waiting for a routine meeting. Obtain appropriate legal advice when duties or lawful disclosure routes are uncertain.</p>",
                    sources: []
                },
                {
                    id: "professional-conflicts-and-gifts",
                    title: "A conflict must be disclosed and managed, not merely acknowledged privately",
                    html: "<p><strong>Syllabus extension; hypothetical situations:</strong> this bank contains no conflict-of-interest or gift case. A conflict exists when another interest could improperly influence professional judgement. It may be actual, potential or reasonably perceived; proof that a decision has already been corrupted is not required before managing the conflict.</p><table><thead><tr><th scope='col'>Situation</th><th scope='col'>Defensible professional response</th></tr></thead><tbody><tr><th scope='row'>A relative owns a supplier being assessed</th><td>Disclose the relationship before assessment and arrange independent allocation or review of the decision.</td></tr><tr><th scope='row'>A supplier offers a personal benefit during evaluation</th><td>Decline an inducement, record the offer and follow the applicable reporting and gift policy.</td></tr><tr><th scope='row'>Two clients have incompatible interests</th><td>Identify confidentiality and loyalty constraints before accepting or continuing the conflicting role.</td></tr></tbody></table><p>Disclosure is the beginning, not automatic permission to continue. Recusal, an independent reviewer or declining the work may still be necessary. A benefit does not become acceptable simply because it is called hospitality or is offered after an award. No monetary safe-harbour for gifts is invented here.</p>",
                    moreHtml: "<p>Keep the professional judgement, reasons and relevant communications traceable. Legitimate agreed remuneration is different from an undisclosed inducement. These examples illustrate integrity and independence; they do not replace the particular employer's rules or applicable anti-corruption and procurement law.</p>",
                    sources: []
                },
                {
                    id: "professional-competence-and-review",
                    title: "Qualification, registration and task-specific competence are different tests",
                    html: "<p><strong>Syllabus extension:</strong> this bank does not provide a competence assessment or supervision record. An engineering degree establishes an educational qualification; NEC registration establishes a regulatory status. Neither demonstrates that the person is competent in every specialist task, software package, temporary-works system or unfamiliar ground condition.</p><p>Before accepting work, define the technical scope and identify the knowledge, experience, resources and review needed. Rule 18(1)(d) of the inspected NEC Regulations requires work and advice to remain within the relevant field of study or acquired knowledge and skills, with referral to an appropriate expert outside that field. Reading a checklist is not equivalent to acquiring the competence needed to take responsibility.</p><p>Delegation requires clear instructions, suitable supervision and review proportional to the consequences of error. The responsible engineer must understand the assumptions and conclusions being adopted, not merely collect signatures from junior staff. Where review discovers a material uncertainty, resolve it or expressly limit the conclusion and arrange further investigation; do not disguise it as completed verification.</p>",
                    moreHtml: "<p>Continuing education, peer discussion and a record of lessons learned help maintain competence as practice changes. A course attendance certificate is evidence of participation, not automatic authority for a new specialist role or a substitute for registration. No universal CPD-hour quota or renewal entitlement is asserted here.</p>",
                    sources: []
                },
                {
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension:</strong> this bank supplies no NEA history question or professional-development record. The <strong>Nepal Engineers' Association</strong> states in its official introduction that it was <strong>established in 1962</strong>. No unverified founding day is added here. It is a professional association, not Nepal Electricity Authority and not the Nepal Engineering Council.</p><p>NEC and NEA can interact without becoming the same body. For example, the Act provides association representation in the Council, and the Regulations include an NEA representative in the inquiry committee. Such participation does not transfer the Council's regulatory powers to the association or its local committees.</p>",
                    moreHtml: "<p>NEA's introduction describes continuing engineering education, training and workshops, professional networking, technical discussion, member support and policy advocacy. These activities can help an engineer learn revised practice, exchange lessons across disciplines and contribute technical evidence to public debate. Advocacy represents professional concerns; it should not be confused with a statutory decision granting an individual's registration.</p><p>A useful continuing-learning record states the skill gap, activity completed, learning gained and how it was applied or independently reviewed. Attendance alone proves neither competence nor licence renewal. Check current programme information before enrolling; this topic does not promise particular courses, accreditation credit or membership benefits remain available.</p>",
                    sources: []
                },
                {
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension:</strong> this bank does not provide climate projections, emissions data or a resilience assessment. Climate mitigation addresses greenhouse-gas emissions and removals; adaptation addresses the consequences of changing climate. General hazard mitigation is a broader risk-reduction term, so these meanings should not be silently interchanged.</p><p>Adaptation requires appropriate climate evidence, uncertainty ranges, failure consequences and a maintainable response. Do not assume a historical rainfall record perfectly predicts future conditions or apply an invented universal climate factor. Flexible layouts, monitoring and planned review can be more defensible than presenting one uncertain forecast as certain.</p>",
                    moreHtml: "<p>For a long-lived asset, examine material production, construction, operation, maintenance and end-of-life effects within a stated boundary. Lower initial material use may not lower whole-life impacts if it shortens service life or increases repairs. Conversely, excessive conservatism can consume resources without proportionate benefit. Safety and applicable performance requirements remain constraints rather than optional weights that a favourable carbon score cancels.</p><p>Also examine exclusion: service tariffs, inaccessible warnings or digital-only complaint channels can leave vulnerable users behind. Consultation and disaggregated service evidence complement technical modelling. A professional recommendation explains residual risks, who bears them and who will review changing conditions; it does not guarantee immunity from future disasters.</p>",
                    sources: []
                },
                {
                    ...
                    html: "<p>A <strong>hazard</strong> is a source or situation capable of harm. <strong>Exposure</strong> describes who can encounter it, by what route and for how long. <strong>Risk</strong> concerns the likelihood and severity of harm in those circumstances, considering existing controls. An unguarded moving part remains a hazard even when nobody is presently near it; exposure changes when cleaning or maintenance brings a person close.</p><table><thead><tr><th scope='col'>Useful category</th><th scope='col'>Typical source of harm</th></tr></thead><tbody><tr><th scope='row'>Physical</th><td>Noise, vibration, radiation and temperature extremes.</td></tr><tr><th scope='row'>Mechanical</th><td>Moving plant, entanglement and crushing points.</td></tr><tr><th scope='row'>Chemical</th><td>Hazardous gases, vapours, dusts and corrosive materials.</td></tr><tr><th scope='row'>Biological</th><td>Pathogens associated with sewage or contaminated materials.</td></tr><tr><th scope='row'>Ergonomic</th><td>High force, repetitive work and unsuitable posture.</td></tr></tbody></table><p>Categories can overlap. Machinery can create both noise and crushing hazards; OSHA's confined-space definition of physical hazard expressly includes mechanical energy. Classification helps identify controls, but does not require each situation to fit exactly one box.</p>",
                    moreHtml: "<p>The bank selects physical hazards as more common without naming a workplace, population, period or frequency measure. That is not evidence of a universal ranking. Prioritise the actual site's exposure, consequence and control failures rather than the selected category alone. Fatigue, work organisation and communication barriers also deserve assessment.</p>",
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension:</strong> this bank does not supply a control-selection assessment. NIOSH's hierarchy ranks <strong>elimination, substitution, engineering controls, administrative controls and personal protective equipment</strong> in that preferred order. It is a prevention framework, not evidence that US requirements have been adopted in Nepal.</p><table><thead><tr><th scope='col'>Level</th><th scope='col'>Illustrative professional design choice</th></tr></thead><tbody><tr><th scope='row'>Elimination</th><td>Locate a component so the hazardous access task is no longer needed.</td></tr><tr><th scope='row'>Substitution</th><td>Specify a less hazardous process or quieter equipment after assessing new risks.</td></tr><tr><th scope='row'>Engineering</th><td>Provide suitable guarding, separation, extraction or protected access.</td></tr><tr><th scope='row'>Administrative</th><td>Plan access, competence, inspections, coordination and exposure-limiting work arrangements.</td></tr><tr><th scope='row'>PPE</th><td>Select, fit, maintain and train for protection against assessed residual exposure.</td></tr></tbody></table><p>Higher-level controls generally reduce dependence on repeated individual decisions. An effective barrier can protect several workers; a warning relies on each person noticing, understanding and responding. Nevertheless, barriers and ventilation need inspection and maintenance, and a substitute may introduce a different hazard.</p>",
                    moreHtml: "<p>Use complementary controls and verify their performance. PPE is not dispensable where required, but issuing helmets or masks does not correct an unstable excavation or an unassessed atmosphere. This comparison does not select a respirator, design a protective system or authorize a hazardous task.</p>",
                    sources: []
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension:</strong> this bank supplies no excavation design, electrical isolation plan or fall-protection assessment. Professional oversight begins with recognition of changing conditions and clearly assigned responsibility, not improvised corrective work by an observer.</p><table><thead><tr><th scope='col'>Hazard setting</th><th scope='col'>Professional checks and responsible expertise</th></tr></thead><tbody><tr><th scope='row'>Excavations</th><td>Ground and water conditions, adjacent loads, utilities, protective works and access require competent assessment and inspection.</td></tr><tr><th scope='row'>Electrical work</th><td>Damaged equipment, water and exposed conductors require controlled access and qualified electrical staff managing isolation and verification.</td></tr><tr><th scope='row'>Work at height</th><td>Platform integrity, edges, openings, access and protective arrangements require a planned system and appropriate specialist review.</td></tr></tbody></table><p>Rainfall, altered excavation geometry, moved equipment or removed protection can invalidate an earlier assessment. A signed checklist is evidence of an inspection at its stated time and scope, not proof that conditions cannot change. Coordinate adjoining employers so one activity does not undermine another's safeguards.</p>",
                    moreHtml: "<p>When an immediate serious concern appears, warn affected people, withdraw from exposure, seek a controlled stop and notify responsible qualified personnel. Do not enter unstable ground, touch suspected energized equipment or improvise rescue to investigate the concern. The necessary engineered controls and emergency arrangements must be established by competent staff under the applicable rules; no generic depth, distance or fall-height limit is invented here.</p>",
                    sources: []
                },
                {
                    id: "professional-confined-space-framework",
                    title: "Confined-space permission depends on a complete managed system",
                    html: "<p><strong>Syllabus extension:</strong> this bank provides no confined-space classification, entry permit or emergency plan. Under the cited US construction definition, a confined space permits bodily entry, has limited or restricted entry or exit and is not designed for continuous occupancy. Its permit-space classification additionally depends on serious hazards such as a hazardous atmosphere, engulfment or trapping configuration. Applicable Nepal requirements and the actual task must be established separately.</p><p>A permit records authorization for defined work under defined conditions; it does not permanently certify a space as safe. Changes in inflow, adjoining work, equipment, ventilation or monitoring can require stopping and reassessment. Underground construction and confined-space standards also have different scopes; do not assemble a permissive hybrid from whichever clauses appear easiest.</p>",
                    moreHtml: "<p>A professional review asks whether entry can be avoided and, if not, whether qualified personnel have identified the hazards, necessary isolation, atmospheric assessment, access control, communications, supervision and emergency arrangements. An oxygen reading addresses only one part of that assessment. A dry-looking chamber may still have toxic gases, unexpected inflow or energy hazards.</p><p>If danger or an emergency is suspected, warn, keep unprotected people out and obtain trained emergency assistance from a safe location. These notes give no entry-rescue, chemical treatment or respiratory-equipment selection procedure. Attempting an improvised rescue can create additional casualties.</p>",
                    sources: []
                },
                {
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension; wholly hypothetical case:</strong> this bank provides no site observation or incident log. From a safe position, an engineer observes displaced temporary support while a crew is preparing to continue work. The engineer has not established its cause or remaining capacity. The immediate responsibility is to warn and seek protective action, not to enter the hazard zone to obtain a better photograph.</p><table><thead><tr><th scope='col'>Log element</th><th scope='col'>Appropriate entry</th></tr></thead><tbody><tr><th scope='row'>Observation</th><td>Record the location, observation time and visible displacement; separate observation from others' reports.</td></tr><tr><th scope='row'>Uncertainty</th><td>State that cause, extent and capacity have not been established.</td></tr><tr><th scope='row'>Immediate response</th><td>Record the warning, requested controlled stop and notification to the responsible site lead.</td></tr><tr><th scope='row'>Action owner</th><td>Assign assessment and corrective planning to qualified temporary-works and safety personnel.</td></tr><tr><th scope='row'>Closure evidence</th><td>Record the competent assessment, authorized action, verification and responsible release decision.</td></tr></tbody></table>",
                    moreHtml: "<p>A promise to repair is not closure, and a signature added afterwards must not imply an earlier inspection occurred. Retain the original observation and subsequent revisions. Review whether design coordination, inspection or communication failures contributed, without treating an allegation as a proven cause. This case teaches accountable reporting, not support design, a rescue method or permission to restart work.</p>",
                    sources: []
                }
            ],
            gaps: [
            ...
            cautions: [
                {
                    "id": "check-wate813-00112",
                    "status": "review",
                    "prompt": "Among the following types of hazard which one is more common?",
                ...
                {
                    "id": "check-wate813-00082",
                    "status": "review",
                    "prompt": "The number of goals of sustainable development is",
