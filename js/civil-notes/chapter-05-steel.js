(function () {
    ...
    Object.assign(registry, {
        ACiE0505: {
            code: "ACiE0505",
            questionCount: 60,
            formulaSheet: "<table><thead><tr><th scope='col'>Quantity</th><th scope='col'>Relation and basis</th></tr></thead><tbody><tr><th scope='row'>Compression capacity</th><td>P<sub>d</sub> = A<sub>e</sub>f<sub>cd</sub>; f<sub>cd</sub> = χf<sub>y</sub>/γ<sub>m0</sub>; χ = min{1, 1/[φ + √(φ<sup>2</sup> − λ<sup>2</sup>)]}.</td></tr><tr><th scope='row'>Tension: yield and rupture</th><td>T<sub>dg</sub> = A<sub>g</sub>f<sub>y</sub>/γ<sub>m0</sub>; T<sub>dn</sub> = 0.9A<sub>n</sub>f<sub>u</sub>/γ<sub>m1</sub>.</td></tr><tr><th scope='row'>Net area</th><td>A<sub>n</sub> = (b − d<sub>h</sub>)t; staggered A<sub>n</sub> = t[b − Σd<sub>h</sub> + Σs<sup>2</sup>/(4g)].</td></tr><tr><th scope='row'>Bolt shear</th><td>V<sub>dsb</sub> = f<sub>ub</sub>(n<sub>n</sub>A<sub>nb</sub> + n<sub>s</sub>A<sub>sb</sub>)/(√3γ<sub>mb</sub>).</td></tr><tr><th scope='row'>Bolt bearing</th><td>V<sub>dpb</sub> = 2.5k<sub>b</sub>dtf<sub>u</sub>/γ<sub>mb</sub>.</td></tr><tr><th scope='row'>Bolt tension</th><td>T<sub>db</sub> = min(0.9f<sub>ub</sub>A<sub>n</sub>/γ<sub>mb</sub>, f<sub>yb</sub>A<sub>sb</sub>/γ<sub>m0</sub>).</td></tr><tr><th scope='row'>Fillet weld throat</th><td>t<sub>e</sub> = s/√2 ≈ 0.707s.</td></tr><tr><th scope='row'>Weld resistance</th><td>f<sub>wd</sub> = f<sub>u</sub>/(√3γ<sub>mw</sub>), γ<sub>mw</sub> = 1.25 shop; R = f<sub>wd</sub>t<sub>e</sub>L<sub>e</sub>.</td></tr><tr><th scope='row'>Combined weld stress</th><td>σ<sub>eq</sub> = √(σ<sup>2</sup> + 3τ<sup>2</sup>).</td></tr><tr><th scope='row'>Radius of gyration</th><td>r = √(I/A); slenderness governs the buckling axis.</td></tr><tr><th scope='row'>Base bearing</th><td>q = N/A ± M/Z; concrete bearing 0.45f<sub>ck</sub>·min[√(A<sub>1</sub>/A<sub>2</sub>), 2].</td></tr></tbody></table>",
            blocks: [
                {
