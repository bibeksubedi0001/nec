        ...
        AALL1001: {
            ...
            blocks: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension.</strong> The bank supplies no completed title block, revision history or drawing register. Read these before interpreting geometry: project and component identity, drawing number, sheet number, revision, issue purpose, units, scale, projection convention and responsible preparation/checking information. An attractive but superseded detail is not a reliable construction instruction.</p><p>Arrange related views so that the reader can transfer widths, heights and depths without guessing. Reserve room for dimensions outside the object, section identifiers and explanatory notes. A detail at a different scale needs its own scale label; one title-block scale cannot silently describe every view on a mixed-scale sheet. State when a diagram is not to scale.</p>",
                    moreHtml: "<p>Use a consistent drawing register and cross-reference the correct detail and sheet. A revision should identify what changed and the issue to which the change belongs. Check that referenced schedules and specifications correspond to the same design information, rather than combining individually plausible but incompatible editions.</p><p>A plotted or scanned copy can be resized. Its appearance is therefore not authority for an omitted dimension. Confirm the issued document, read the written dimensions and obtain clarification where required. These are communication principles; project-specific approval, signature and document-control requirements must come from the applicable instructions.</p>",
                    sources: []
                },
                {
                    id: "drawing-line-types-and-diagrams",
                    title: "Line type communicates meaning; line weight establishes hierarchy",
                    html: "<p><strong>Syllabus extension.</strong> No assigned question provides a line legend or tests a plotted line-weight schedule. The following are conventional distinctions, not a claimed universal set of code-prescribed widths. Meaning depends on both the pattern and its context.</p><table><thead><tr><th scope='col'>Feature</th><th scope='col'>Conventional treatment</th></tr></thead><tbody><tr><th scope='row'>Visible edge or outline</th><td>Continuous line, visually stronger than auxiliary construction lines.</td></tr><tr><th scope='row'>Hidden edge</th><td>Fine, short dashed line identifying a feature behind the visible surface.</td></tr><tr><th scope='row'>Centre or axis</th><td>Fine chain pattern, commonly long dashes separated by short dashes or dots.</td></tr><tr><th scope='row'>Dimension and extension</th><td>Fine continuous lines, distinct from physical object edges.</td></tr><tr><th scope='row'>Cutting plane</th><td>Distinctly identified line with direction indicators and a section designation.</td></tr></tbody></table><p>A centreline indicates an axis or symmetry; it is not an additional hidden edge. Keep dash patterns legible after reduction and avoid letting a hidden line obscure a coincident visible outline. <strong>Hypothetical plotting choice:</strong> 0.25 mm auxiliary lines and 0.50 mm emphasized outlines demonstrate hierarchy, not mandatory standard values.</p>",
                    moreHtml: "<p>A line diagram deliberately simplifies a system to show arrangement or connections. A structural centreline or pipe schematic does not, by itself, specify member thickness, physical clearances or fabrication geometry. Use a legend and labels rather than assuming every drawn crossing is a connection.</p>",
                    sources: []
                },
                {
                    id: "drawing-dimensions-units-and-tolerances",
                    title: "Dimensions specify the object; measuring the print does not",
                    html: "<p><strong>Syllabus extension.</strong> The assigned bank gives no dimensioned component or tolerance schedule. A dimension line carries a size between defined limits; extension lines identify those limits. Leaders connect notes to features. Dimension from functional datums where possible, avoid ambiguous repeated dimensions and do not force the reader to infer an essential size from scale.</p><p><strong>Hypothetical example:</strong> in a drawing whose linear units are mm, Ø40 specifies a diameter of 40 mm and R20 a radius of 20 mm. A size 40 ± 0.2 permits 39.8–40.2 mm under that stated size requirement; it does not also specify surface finish, roundness or positional tolerance. At scale 1:2, the nominal 40 mm diameter appears 20 mm across on an undistorted print, but its dimension remains 40.</p>",
                    moreHtml: "<p>Write <strong>actual object dimensions</strong>, whatever the view scale. Declare the length units, and identify any exceptions explicitly. Angular values need their own angular notation. A radius dimension, conventionally prefixed R, concerns the centre-to-arc distance; a diameter dimension, prefixed Ø, concerns the full circular size. They are not interchangeable labels for any curved outline.</p><p>Chains of dimensions can accumulate tolerances; baseline dimensions locate features from a common reference. Written dimensions carry the intended size, but conflicting written information still requires clarification. Neither selecting a convenient dimension nor scaling a photocopy resolves a design discrepancy.</p>",
                    sources: []
                },
                {
                    ...
                    html: "<p>A scale compares a represented length with the corresponding actual length. The <strong>representative fraction, RF = drawing length / actual length</strong>, is dimensionless only after the two lengths use the same units. A reduction has RF below one, full size has RF equal to one and enlargement has RF above one. A larger denominator in 1:N means a smaller image of the same object.</p><p>The assigned statement is <strong>1 cm = 100 m</strong>. Since 1 m = 100 cm, the actual distance is 10,000 cm. Therefore <strong>RF = 1 cm / 10,000 cm = 1/10,000</strong>, written <strong>1:10000</strong>. Dividing the bare numbers 1 and 100 without converting metres would leave a hidden unit mismatch and give the wrong ratio.</p><p><strong>Syllabus extension — hypothetical transfer:</strong> at that same scale, an actual represented length of 245 m occupies 245/100 = <strong>2.45 cm</strong>. Conversely, multiply a paper length in centimetres by 100 to obtain metres under this stated scale. This extra length is not a bank given.</p>",
                    moreHtml: "<p>RF describes a linear relationship, not an area or volume ratio. Check that the copy has not been rescaled before taking approximate graphical measurements. On a construction drawing, a written dimension or properly issued coordinate remains preferable to estimating a size with a ruler.</p>",
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension.</strong> The bank contains no complete multiview object with specified dimensions. Orthographic projection uses parallel projectors perpendicular to a viewing plane. A front view expresses width and height; a top view expresses width and depth; a side view expresses depth and height. Each view omits the coordinate along its own viewing direction.</p><p>Corresponding features must align between views. A face parallel to the viewing plane appears in its true shape at the selected scale; an inclined face is foreshortened. A line perpendicular to the plane appears end-on as a point. Hidden lines can identify concealed edges but do not substitute for every missing dimension or interior detail.</p><p><strong>Hypothetical rectangular block:</strong> width 60 mm, depth 40 mm and height 30 mm. At scale 1:2, its front outline measures 30 × 15 mm on paper, its top 30 × 20 mm and its side 20 × 15 mm. The dimension labels still give the actual 60, 40 and 30 mm sizes, not the reduced paper sizes.</p>",
                    moreHtml: "<p>Choose the front view to reveal important shape and minimize unnecessary hidden detail. Add enough complementary views, sections and annotations to define the part. A neat outline is not evidence that an unseen recess, slope or hole has been specified.</p>",
                    sources: []
                },
                {
                    id: "drawing-first-and-third-angle-placement",
                    title: "First-angle and third-angle projection place the same views differently",
                    html: "<p><strong>Syllabus extension.</strong> No assigned question identifies a projection symbol or asks for first-angle versus third-angle placement. Choose and state the convention before arranging views; do not infer it merely from the drawing's country of origin.</p><p>In <strong>first-angle projection</strong>, the object lies between observer and projection plane. In <strong>third-angle projection</strong>, the projection plane lies between observer and object. Unfolding those planes produces different sheet arrangements even though the view is still named for the direction from which the object is observed.</p><table><thead><tr><th scope='col'>View relative to front</th><th scope='col'>First angle</th><th scope='col'>Third angle</th></tr></thead><tbody><tr><th scope='row'>Top view</th><td>Below</td><td>Above</td></tr><tr><th scope='row'>Right-side view</th><td>To the left</td><td>To the right</td></tr><tr><th scope='row'>Left-side view</th><td>To the right</td><td>To the left</td></tr></tbody></table>",
                    moreHtml: "<p>Read the declared convention and projection symbol, then transfer the appropriate shared dimensions. A view placed to the left is not necessarily a left-side view. Maintain the selected method throughout the sheet, or identify an exceptional view explicitly. Mixing first-angle top-view placement with third-angle side-view placement can reverse the interpretation of an asymmetric feature while every individual outline still looks plausible. View placement does not change the actual-size dimension labels.</p>",
                    sources: []
                },
                {
                    id: "drawing-single-projection-cylinder-ambiguity",
                    title: "A single outline does not uniquely establish a cylinder",
                    html: "<p>An orthographic view maps spatial points onto a plane and suppresses depth along the viewing direction. Different solids can therefore share the same outline. A right circular cylinder viewed along its axis gives a circle, but suitably oriented cones and hemispheres can also give circular projections. A rectangular side outline is likewise not unique to a cylinder; a rectangular prism can have it.</p><p>The assigned question stores cylinder as its answer. Its explanation, however, describes a <strong>rectangle AND a circular base view: two views</strong>, not a single projection. That description cannot prove the stem's claim about one projection preserving defining geometry. No supplied figure or projection direction removes the ambiguity.</p><p>The engineering objective is sufficient, unambiguous information, not a fixed view count. Select complementary views or sections where hidden shape remains uncertain. Do not treat stored option A as an automatically correct geometric conclusion; the original question and key remain unchanged.</p>",
                    moreHtml: "<p>Adding a diameter symbol Ø, a height and a statement of uniform cylindrical form can often communicate a familiar cylinder using one dimensioned view. The additional information then comes from <strong>annotations and an assumed form</strong>, not from the projected outline alone. Other familiar solids can also be constrained by suitable annotations; this does not make cylinder uniquely correct under the question as written.</p>",
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension — hypothetical geometry throughout.</strong> Consider a uniform sleeve 120 mm long, with outside diameter 100 mm and a concentric through bore of diameter 60 mm. The assigned bank supplies none of these dimensions. A transverse section normal to its axis is an annulus: hatched material surrounds an unhatched circular opening.</p><p>The radial wall thickness is <strong>(100 − 60)/2 = 20 mm</strong>, not the 40 mm difference of diameters. A longitudinal section through the axis shows two 20 mm material bands separated by the 60 mm bore, extending through the stated 120 mm length. Hatched bands and the unhatched opening must agree with the transverse section and the diameter annotations.</p>",
                    moreHtml: "<p>Without a section, concealed bore edges may appear as hidden lines in an elevation. The section makes their physical meaning clearer but does not create extra material at the centreline. Verify whether a bore is through or blind and whether ends include shoulders; the word uniform is an explicit assumption in this example.</p><p>A section shows true sectional shape only when the viewing plane is parallel to the section plane. An oblique view may foreshorten that shape, requiring an auxiliary view for true geometry. This is drawing interpretation, not a calculation of section inertia or structural capacity.</p>",
                    sources: []
                },
                {
                    ...
                    moreHtml: "<p>Follow each section and detail reference to its named view and sheet. Cross-check the same feature's identity, dimensions, material notes and level between architectural, structural and service information. A centreline position does not by itself establish a finished face, and a top level is not an underside level without the intervening thickness.</p><p>Before setting out, distinguish overall dimensions from clear openings, structural dimensions from finishes, and datum-based coordinates from dimensions chained through other components. Confirm site measurements where required. A schematic connection or attractive pictorial does not establish access for assembly, reinforcement congestion, maintenance space or a construction sequence.</p><p>Record a discrepancy and request clarification through the project's communication process; do not invent a missing dimension or silently modify the drawing. An issued clarification should propagate to affected views and schedules. As-built records should document verified installed information rather than merely relabel an earlier design. Clear communication is part of technical accuracy, but these general steps do not certify approval or compliance.</p>",
                    sources: []
                }
            ],
            gaps: [
            ...
            cautions: [
                {
                    "id": "check-basi674-00220",
                    "status": "review",
                    "prompt": "In a diagonal scale only",
                    "html": "<p><strong>Diagonal-scale wording and accuracy:</strong> showing units, tenths and hundredths is the intended capability, but the word only and the nested options are not a rigorous uniqueness statement. </p>",
                    "sources": [
                        {
                            "id": "BASI674-00220",
                            "set": 18,
                ...
                {
                    "id": "check-basi674-00221",
                    "status": "review",
                    "prompt": "In an engineering drawing it is written scale 1 cm=100 m. Which ratio does it correspond to?",
                ...
                {
                    "id": "check-basi674-00228",
                    "status": "review",
                    "prompt": "A scale is to be devised to read into metre, centimeter and decimeter. Which type of the following scales is best suited for this purpose?",
                    "html": "<p>A diagonal scale also reads coarser values. </p><p>The explanation's claim of higher precision than every plain or vernier scale is unsupported; compare actual least counts and errors.</p>",
                    "sources": [
                        {
                            "id": "BASI674-00228",
                            "set": 18,
                ...
                {
                    "id": "check-basi674-00432",
                    "status": "review",
                    "prompt": "Which of the following solid figures can be represented by a single projection on a 2D plane without losing its defining geometric properties (like a circle or square)?",
