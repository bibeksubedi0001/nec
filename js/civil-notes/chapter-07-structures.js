(function () {
    ...
    Object.assign(registry, {
        ACiE0705: {
            ...
            blocks: [
                {
                    ...
                    html: "<p>A regulator controls a particular connection or reach in the canal network. A <strong>canal head regulator</strong> admits water from a river diversion headworks into the canal. A <strong>distributary head regulator</strong> controls the entrance of an offtaking distributary or minor. A <strong>cross regulator</strong> lies across the parent canal, commonly just downstream of an offtake, and maintains an upstream level from which that offtake can draw.</p><p>During low supply, cross regulation may preserve the head needed at the branch without increasing the total water available. Closing its gates can isolate the downstream parent reach, but then incoming supply and upstream storage must be managed. It is not a device that creates water or independently guarantees every distributary its demand.</p>",
                    moreHtml: "<p><strong>Plan-view diagram in words:</strong> follow the river past the diversion weir; a side entrance with gates leads into the main canal. Farther along, a distributary branches sideways through its own head regulator. Across the continuing parent canal, below that branch, a cross regulator restricts the downstream passage and can back water up toward the branch entrance. The two nearby regulators therefore control different paths.</p><p><small>The supplied NEC topic defines the study scope, not numerical design-code requirements. The network descriptions are original teaching schematics. A canal module is outlet terminology; it must not replace the missing term canal head regulator in the diversion-headworks item.</small></p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension, without an assigned complete impervious-floor design dataset:</strong> an impervious floor separates surface flow from a pervious foundation and helps control underseepage. Upstream and downstream cutoffs modify seepage paths and the pressure distribution. Floor joints, cutoff connections and filters must remain functional. A longer floor alone does not demonstrate a safe exit gradient or eliminate piping.</p><p>Start with the differential heads and foundation strata for the relevant operating states. Use a suitable seepage model or flow net to obtain pressures beneath the floor and local exit gradients. The local gradient <strong>i = Δh/Δs</strong> is head loss Δh divided by flow-path distance Δs, both in m. Soil stability, stratification, filters and the applicable safety basis determine the allowable gradient; a total creep length is not a substitute for those local checks.</p><p>At a floor section, let u<sub>b</sub> and u<sub>t</sub> be water pressures at its actual bottom and top faces in kPa, positive in compression. Net upward water loading is <strong>u<sub>net</sub> = u<sub>b</sub> − u<sub>t</sub></strong>. A bare, unfactored unit-area self-weight check is <strong>t ≥ max(0, u<sub>net</sub>)/γ<sub>c</sub></strong>, where t is thickness in m and γ<sub>c</sub> is the full concrete unit weight in kN/m<sup>3</sup>. This is only a lower-bound equilibrium check, not a structural design. </p>",
                    moreHtml: "<p>If face pressure depends on the trial thickness, solve that dependence consistently. Do not also substitute buoyant unit weight after already accounting for both face pressures.</p><p>Check bending, joints, sliding, foundation response and the prescribed load/safety combinations, including high groundwater, empty canal, flood tailwater and ineffective drainage where relevant. Surface-flow energy needs a cistern or another suitable dissipater and downstream protection. The seepage floor and the energy-dissipation system solve different problems: neither adequate cutoff length nor a hydraulic jump alone proves the other requirement satisfied.</p>",
                    sources: []
                },
                {
                    id: "irrigation-outlet-purpose-and-module-classes",
                    title: "Classify outlets by which water levels affect discharge",
                    html: "<p>An irrigation outlet transfers water from a supplying channel to a watercourse. Conventional canal management normally places farm-watercourse outlets on distributaries and minors rather than directly on major main canals, so allocation and measurement remain manageable. This is a system-management convention, not a physical impossibility of constructing a turnout in a main canal.</p><table><thead><tr><th scope='col'>Class</th><th scope='col'>Discharge dependence at a fixed setting</th><th scope='col'>Necessary qualification</th></tr></thead><tbody><tr><th scope='row'>Non-modular</th><td>Depends on both supplying-channel and receiving-watercourse levels.</td><td>A downstream rise can reduce the available head and delivery.</td></tr><tr><th scope='row'>Semi-modular</th><td>Depends on upstream head but not downstream level while the outlet remains hydraulically isolated from it.</td><td>Independence ends when the modular or free-flow limit is exceeded.</td></tr><tr><th scope='row'>Rigid modular</th><td>Maintains its intended discharge despite changes in both levels.</td><td>Only within the specified operating range and with the regulating mechanism functioning.</td></tr></tbody></table>",
                    moreHtml: "<p>A non-modular outlet does have a discharge relationship; it simply needs both boundary levels. That extra dependence makes equitable delivery harder when watercourse levels vary or users interfere with them. A rigid module's constancy is not unlimited: insufficient supply head, excessive backwater, blockage or a changed setting can invalidate the intended behaviour.</p><p>Draw the upstream pool, controlling crest or opening, and downstream pool before assigning a class. Classification concerns the response of the complete outlet under stated conditions, not merely whether one component is a pipe, gate or masonry wall.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>For a small, orifice-controlled opening flowing freely to atmosphere, <strong>q = C<sub>d</sub>A√(2gH)</strong>. Here q is outlet discharge in m<sup>3</sup>/s, A is opening area in m<sup>2</sup>, C<sub>d</sub> is an appropriate dimensionless discharge coefficient, g is gravitational acceleration and H is upstream head above the opening centre in m when approach velocity is negligible. A circular opening of diameter D has A = πD<sup>2</sup>/4. The centre-head approximation requires suitable opening size and submergence upstream.</p><p>For a fully submerged orifice between nearly still pools, replace H with <strong>ΔH = Z<sub>u</sub> − Z<sub>d</sub></strong>, the difference between upstream and downstream water-surface elevations on the same datum. Thus a higher receiving level reduces q at unchanged upstream level. If approach or receiving velocities are important, use the appropriate energy-head corrections and calibrated relation rather than silently identifying total head with water depth.</p><p>A long full pipe is not automatically a sharp-edged orifice. Its energy balance must include entrance, friction, bends and exit effects. For example, Darcy–Weisbach friction is <strong>h<sub>f</sub> = f(ℓ/D)V<sup>2</sup>/(2g)</strong>, where f is the dimensionless Darcy friction factor, ℓ and D are pipe length and diameter in m, and V = q/A is mean velocity in m/s. Local losses use suitable coefficients; no final C<sub>d</sub> or friction factor is supplied by the bank.</p>",
                    moreHtml: "<p>A properly operating free pipe outlet is commonly a semi-module, historically called a flexible module. That name does not mean mathematical flexibility equals one. Tailwater drowning, partial filling, a water surface below the opening top, sediment or altered control geometry can change its rating and classification. Establish the actual flow regime first.</p>",
                ...
                },
                {
                    ...
                    html: "<p>Two independent questions identify the four separated cross-drainage arrangements: <strong>which stream passes above</strong>, and <strong>whether the lower stream has a free surface or fills a pressure conduit</strong>. Do not classify a structure from the word siphon alone. In the usual arrangements below, the upper stream is carried in an open trough or channel.</p><table><thead><tr><th scope='col'>Arrangement</th><th scope='col'>Upper stream</th><th scope='col'>Lower stream and regime</th></tr></thead><tbody><tr><th scope='row'>Aqueduct</th><td>Canal over drain</td><td>Drain flows with a free surface and clearance below the canal trough.</td></tr><tr><th scope='row'>Siphon aqueduct</th><td>Canal over drain</td><td>Drain flows under pressure through barrels below the canal.</td></tr><tr><th scope='row'>Superpassage</th><td>Drain over canal</td><td>Canal flows with a free surface and clearance below the drainage trough.</td></tr><tr><th scope='row'>Canal siphon</th><td>Drain over canal</td><td>Canal flows through a pressure conduit below the drain.</td></tr></tbody></table>",
                    moreHtml: "<p><strong>Section sketch in words:</strong> draw the upper stream, the thickness of its supporting trough, and the lower passage beneath it. An air gap over the lower design water surface indicates the free-flow case. A designed full barrel carrying the lower stream indicates the pressure-conduit case. Label canal and drain before attaching the name.</p><p>Drainage under pressure beneath a canal is therefore a siphon aqueduct, not a superpassage. The label describes the intended design condition; a pressure barrel may carry a smaller flow partially full at another time. Mixing arrangements such as level crossings belong to a different layout and must not be forced into this separated-stream grid.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    moreHtml: "<p><strong>Plan and profile in words:</strong> the drain approaches the canal junction; an upstream drainage crest can control admission into the common pool. A regulator on the drainage downstream of the junction controls the receiving route, while a cross regulator on the canal below the crossing manages the continuing canal level and discharge. The bank describes an upstream drainage crest at canal FSL as one layout; actual crest elevation must suit the operating levels and flood plan.</p><p>The gates must be coordinated. Restricting the canal outlet while admitting a drain flood can raise the common pool; restricting the drainage route can cause upstream flooding. Design therefore requires simultaneous flow paths, permissible stages, sediment handling and a reliable operating rule, including gate or power failure where relevant.</p><p>A level crossing is not a closed pressure pipe simply because water levels are close. Mixing has consequences for silt, water quality and the timing of supply. Where those consequences or the flood capacity are unacceptable, compare separated-stream alternatives even when a near-level arrangement appears geometrically convenient.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>In a siphon aqueduct, the <strong>upper canal trough slab</strong> can also form the <strong>roof of the drainage barrel</strong>. The <strong>bottom floor or invert</strong> lies beneath the lower drain. These are different structural surfaces with different water-pressure paths. A statement about a pucca floor is ambiguous until the intended surface is identified.</p><table><thead><tr><th scope='col'>Surface and condition</th><th scope='col'>Relevant upward loading</th></tr></thead><tbody><tr><th scope='row'>Siphon-aqueduct roof</th><td>Drainage pressure beneath the roof opposes roof weight and any downward canal-water loading.</td></tr><tr><th scope='row'>Lower drain invert</th><td>Foundation seepage or groundwater pressure beneath the floor can exceed pressure from water above it.</td></tr><tr><th scope='row'>Ordinary aqueduct with clear free flow below</th><td>The lower stream does not apply internal water pressure to a roof it does not contact; a protected bottom floor can still experience foundation uplift.</td></tr></tbody></table>",
                    moreHtml: "<p>The named adverse roof combination is <strong>canal empty and drain flowing full with pressure beneath the roof</strong>: the downward canal-water load is absent. It is a useful bank load case, not proof of the maximum for every head, groundwater level or transient state. Actual pressure diagrams and all required operating, flood, maintenance and exceptional combinations must be compared.</p><p>In an ordinary aqueduct, the lack of lower-stream roof pressure follows from free-flow clearance, not from canal-water weight somehow preventing pressure. Canal seepage and a high subsoil water table can still load a lower impervious floor even when the drain is empty. An upper watertight conveyance trough also does not imply that every free-flow lower channel has a continuous pucca floor; bed protection depends on scour, seepage and foundation conditions.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    moreHtml: "<p><strong>Longitudinal sketch in words:</strong> draw a steep falling ground line and a canal bed made of several gently descending reaches. At selected locations, a fall steps the bed down to the next reach. Draw the water surface and energy line separately: their positions depend on depth, velocity and local controls, not just the ground line.</p><p>If the designed canal-bed slope is steeper than the ground slope, <strong>pumping is not automatically required</strong>. A gravity canal may instead need progressively deeper excavation, a changed alignment or adjusted starting level, subject to available head, outlet command and feasible earthworks. Conversely, a seemingly favourable ground slope does not guarantee gravity delivery if downstream water levels require more head than is available.</p><p>Use a surveyed profile and a common elevation datum to locate falls. Avoid fixing them solely at arbitrary distance intervals: branches, crossings, foundation conditions, allowable velocities and the water levels required at offtakes constrain their location. A fall is an energy-management structure, not a surplus-disposal escape.</p>",
            ...
            cautions: [
                {
                    "id": "check-irri951-00244",
                    "status": "review",
                    "prompt": "In case of aqueduct and syphon aqueduct, the maximum permissible reduction for piers width in waterway from Lacey’s perimeter is:",
                ...
                {
                    "id": "check-irri951-00030",
                    "status": "review",
                    "prompt": "The structure provided to discharge extra water from canal is",
                    "html": "<p>Water passing a cross regulator continues down the parent canal; an escape discharges to a receiving route outside it. </p>",
                    "sources": [
                        {
                            "id": "IRRI951-00030",
                            "set": 4,
                ...
                {
                    "id": "check-irri951-00069",
                    "status": "review",
                    "prompt": "The function of cross regulator in irrigation",
                    "html": "<p><strong>Bank check: cross regulation is not external surplus disposal.</strong> </p><p>Water passing a cross regulator continues down the parent canal; an escape discharges to a receiving route outside it. </p><p>The cross-regulator all-functions explanation is overbroad if overflow is taken to mean an escape. </p><p>Closing the head regulator usually reduces new inflow, not directly causes surplus; delayed travel, downstream closure and backwater changes explain possible remaining stage problems.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00069",
                            "set": 8,
                ...
                {
                    "id": "check-irri951-00073",
                    "status": "review",
                    "prompt": "Canal fall is provided if",
                ...
                {
                    "id": "check-irri951-00077",
                    "status": "review",
                    "prompt": "In a syphon flume, having length 100m, width 10 m and depth 2 m, velocity is reduced to 2.5 m/s. Calculate head loss, given 0.015 for concrete lining.",
                ...
                {
                    "id": "check-irri951-00078",
                    "status": "review",
                    "prompt": "In a Sarda type fall, the rectangular crest, may be used for discharge upto",
                    "html": "<p><strong>Bank check: retain the fall-family and unit discrepancies.</strong> </p><p>Ounces is not a discharge unit, and the separate explanation's claimed printed 6-to-14 correction is a provenance statement, not independent verification of either value as a current design rule.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00078",
                            "set": 8,
                ...
                {
                    "id": "check-irri951-00080",
                    "status": "review",
                    "prompt": "The sensitivity of a rigid module is",
                    "html": "<p>S = (Y/q)(dq/dY) and F = (Q/q)(dq/dQ). </p><p>Zero sensitivity remains valid for a rigid module within range. </p>",
                    "sources": [
                        {
                            "id": "IRRI951-00080",
                            "set": 9,
                ...
                {
                    "id": "check-irri951-00226",
                    "status": "review",
                    "prompt": "Canal head regulator",
                    "html": "<p><strong>Bank check: sediment and flood control have limits.</strong> </p><p>A head regulator can regulate admission, reduce sediment entry and shut off the intended supply, but its sill does not remove all suspended silt and its gates do not exclude every flood regardless of failure, overtopping or bypass seepage. </p>",
                    "sources": [
                        {
                            "id": "IRRI951-00226",
                            "set": 22,
                ...
                {
                    "id": "check-irri951-00227",
                    "status": "review",
                    "prompt": "A regulator is generally aligned at",
                ...
                {
                    "id": "check-irri951-00228",
                    "status": "review",
                    "prompt": "Regulator is provided with",
                ...
                {
                    "id": "check-irri951-00229",
                    "status": "review",
                    "prompt": "The minimum capacity of the escape channel is kept as...... Of the channel capacity.",
                ...
                {
                    "id": "check-irri951-00230",
                    "status": "review",
                    "prompt": "For proportionality, weir type outlets should be set at",
                ...
                {
                    "id": "check-irri951-00231",
                    "status": "review",
                    "prompt": "The type of irrigation module which makes the equitable distribution of water more difficult is:",
                    "html": "<p><strong>A non-modular outlet still has a hydraulic relationship.</strong> Its discharge depends on upstream and downstream levels, making equitable distribution harder when either varies. Dependence on two heads is not absence of a discharge law.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00231",
                            "set": 22,
                ...
                {
                    "id": "check-irri951-00232",
                    "status": "review",
                    "prompt": "Rate of change of discharge through an irrigation outlet becomes equal to the rate of change of water depth in the channel when its",
                    "html": "<p><strong>Bank check: normalize the changes in sensitivity and flexibility.</strong> </p><p>S = (Y/q)(dq/dY) and F = (Q/q)(dq/dQ). </p><p>The printed F = dq/dQ omits normalization, and equal rates for S = 1 must mean equal fractional changes, not dimensional discharge and depth increments. </p><p>A flexible outlet does not generally have sensitivity one; proportionality means F = 1, not necessarily S = 1.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00232",
                            "set": 22,
                ...
                {
                    "id": "check-irri951-00233",
                    "status": "review",
                    "prompt": "A free pipe outlet is a :",
                    "html": "<p><strong>Bank check: module independence is conditional.</strong> </p><p>A free pipe may act as a semi-module while its control remains independent of downstream level, but drowning or a changed pipe-flow regime can remove that independence. </p><p>Flexible module is legacy terminology, not proof that F = 1. </p>",
                    "sources": [
                        {
                            "id": "IRRI951-00233",
                            "set": 22,
                ...
                {
                    "id": "check-irri951-00234",
                    "status": "review",
                    "prompt": "The type of irrigation module, which is usually considered as best, is:",
                    "html": "<p><strong>Bank check: dependence on two heads is still a relationship.</strong> </p><p>An adjustable orifice semi-module permits manual resetting but does not automatically maintain constant discharge as upstream head changes. </p><p>The preferred or best label needs operating and economic criteria, not an unsupported constant-flow claim.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00234",
                            "set": 23,
                ...
                {
                    "id": "check-irri951-00235",
                    "status": "review",
                    "prompt": "Which one of the following statements is INCORRECT about a syphon aqueduct?",
                    "html": "<p><strong>Bank check: canal-bed elevation is not the underside clearance test.</strong> </p><p>Drain HFL can lie below the internal canal bed yet above the underside of its supporting trough because the slab has thickness. </p><p>Compare the actual flood profile with that underside and the required clearance. </p><p>Full lower-barrel flow is pressure-conduit flow; calling it siphonic action does not establish suction or remove the need for an energy and tailwater calculation.</p><p>The 22.5° contraction, 30° expansion and 5:1 rising-slope statements lack a checked source and clear geometric conventions. </p><p>Likewise, 2–3 m/s is indicative, not a cavitation-safe threshold. </p><p>Site head, pressure profile, sediment and erosion conditions remain necessary.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00235",
                            "set": 23,
                ...
                {
                    "id": "check-irri951-00241",
                    "status": "review",
                    "prompt": "In a syphon aqueduct, the worst condition of uplift on the roof occurs when:",
                    "html": "<p>Canal empty with drain full is a named adverse siphon-roof combination, not an automatic maximum for every possible head or transient.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00241",
                            "set": 23,
                ...
                {
                    "id": "check-irri951-00242",
                    "status": "review",
                    "prompt": "The velocity of drainage water in the barrels of a syphon-aqueduct is normally limited to",
                    "html": "<p><strong>Bank check: transition and velocity numbers are not verified code limits.</strong> </p><p>Likewise, 2–3 m/s is indicative, not a cavitation-safe threshold. </p><p>Site head, pressure profile, sediment and erosion conditions remain necessary.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00242",
                            "set": 23,
                ...
                {
                    "id": "check-irri951-00243",
                    "status": "review",
                    "prompt": "In an aqueduct provided with a pucca bottom floor, the uplift will occur",
                    "html": "<p><strong>Bank check: floor terminology and uplift mechanisms are mixed.</strong> </p><p>A lower drainage invert is not the upper canal trough slab or barrel roof. </p><p>Free clearance prevents lower-stream contact pressure on an ordinary aqueduct roof; canal-water weight does not prevent pressure from existing. </p><p>Groundwater and seepage can still uplift the bottom floor. </p>",
                    "sources": [
                        {
                            "id": "IRRI951-00243",
                            "set": 23,
                ...
                {
                    "id": "check-irri951-00245",
                    "status": "review",
                    "prompt": "Select the incorrect statement from the following",
                    "html": "<p><strong>Bank check: transition and velocity numbers are not verified code limits.</strong> </p><p>The 22.5° contraction, 30° expansion and 5:1 rising-slope statements lack a checked source and clear geometric conventions. </p><p>Expansions generally need gentle recovery to limit separation; the angle pair is not a basis for reversing that reasoning. </p><p>Likewise, 2–3 m/s is indicative, not a cavitation-safe threshold. </p><p>Site head, pressure profile, sediment and erosion conditions remain necessary.</p><p>The pucca-floor explanation substitutes the upper conveyance floor for the lower-channel protection being discussed, so it cannot certify the stored incorrect-statement key. </p>",
                    "sources": [
                        {
                            "id": "IRRI951-00245",
                            "set": 23,
                ...
                {
                    "id": "check-irri951-00246",
                    "status": "review",
                    "prompt": "The floor of the aqueduct is subjected to uplift pressure due to",
                    "html": "<p><strong>Bank check: floor terminology and uplift mechanisms are mixed.</strong> </p><p>Free clearance prevents lower-stream contact pressure on an ordinary aqueduct roof; canal-water weight does not prevent pressure from existing. </p><p>Groundwater and seepage can still uplift the bottom floor. </p>",
                    "sources": [
                        {
                            "id": "IRRI951-00246",
                            "set": 24,
                ...
                {
                    "id": "check-irri951-00247",
                    "status": "review",
                    "prompt": "When a canal flowing under pressure is carried below a natural drainage such that its F.S.L. does not touch the underside of the supporting structure, the structure so provided, is called",
                ...
                {
                    "id": "check-irri951-00248",
                    "status": "review",
                    "prompt": "In a syphon aqueduct",
                    "html": "<p>Drain HFL can lie below the internal canal bed yet above the underside of its supporting trough because the slab has thickness. </p><p>Compare the actual flood profile with that underside and the required clearance. </p><p>Full lower-barrel flow is pressure-conduit flow; calling it siphonic action does not establish suction or remove the need for an energy and tailwater calculation.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00248",
                            "set": 24,
                ...
                {
                    "id": "check-irri951-00249",
                    "status": "review",
                    "prompt": "The structure constructed to allow drainage water to flow under pressure through an inverted syphon below a canal, is called",
                ...
                {
                    "id": "check-irri951-00251",
                    "status": "review",
                    "prompt": "In a canal syphon, the flow is",
                ...
                {
                    "id": "check-irri951-00253",
                    "status": "review",
                    "prompt": "In canal system, outlet for the water course can’t be provided at",
                ...
                {
                    "id": "check-irri951-00258",
                    "status": "review",
                    "prompt": "The ratio of the rate of change of discharge in outlet and parent channel, is known as",
                    "html": "<p><strong>Bank check: normalize the changes in sensitivity and flexibility.</strong> </p><p>S = (Y/q)(dq/dY) and F = (Q/q)(dq/dQ). </p><p>A flexible outlet does not generally have sensitivity one; proportionality means F = 1, not necessarily S = 1.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00258",
                            "set": 25,
                ...
                {
                    "id": "check-irri951-00259",
                    "status": "review",
                    "prompt": "An outlet which maintains a constant discharge irrespective of fluctuation in the water levels of the supplying channel or water course, is known as",
                    "html": "<p><strong>A rigid module is independent of both water levels only within its operating range.</strong> Adequate head and a functioning control mechanism are required; the definition does not guarantee constant flow under unlimited level changes.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00259",
                            "set": 25,
                ...
                {
                    "id": "check-irri951-00264",
                    "status": "review",
                    "prompt": "Which of the following types of falls use parabolic glacis for energy dissipation?",
                    "html": "<p><strong>Bank check: retain the fall-family and unit discrepancies.</strong> </p><p>Sarda is a vertical-drop family, not the sloping-glacis description attached to Sardis. </p><p>Montague's parabolic glacis is not synonymous with an ogee. </p>",
                    "sources": [
                        {
                            "id": "IRRI951-00264",
                            "set": 25,
                ...
                {
                    "id": "check-irri951-00265",
                    "status": "review",
                    "prompt": "In a Sardis type fall, rectangular crest is used for discharge upto",
                    "html": "<p><strong>Bank check: retain the fall-family and unit discrepancies.</strong> </p><p>The 14 cumec rectangular-crest limit remains an unverified legacy convention. </p>",
                    "sources": [
                        {
                            "id": "IRRI951-00265",
                            "set": 25,
                ...
                {
                    "id": "check-irri951-00266",
                    "status": "review",
                    "prompt": "Which of the following can be used as a meter fall ?",
                ...
                {
                    "id": "check-irri951-00345",
                    "status": "review",
                    "prompt": "The canal regulator, which is constructed at a diversion head works is called",
                ...
                {
                    "id": "check-irri951-00348",
                    "status": "review",
                    "prompt": "Distributary head regulators are provided",
                    "html": "<p>A head regulator can regulate admission, reduce sediment entry and shut off the intended supply, but its sill does not remove all suspended silt and its gates do not exclude every flood regardless of failure, overtopping or bypass seepage. </p><p>The distributary-head functions are useful operating objectives, not guarantees independent of approach hydraulics, capacity and maintenance.</p>",
                    "sources": [
                        {
                            "id": "IRRI951-00348",
                            "set": 33,
