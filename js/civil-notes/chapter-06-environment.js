(function () {
    ...
    Object.assign(registry, {
        ACiE0606: {
            ...
            blocks: [
                {
                    ...
                    html: "<p><strong>Environmental Impact Assessment, EIA</strong>, is a systematic process for identifying, predicting and evaluating the environmental consequences of a proposal and its reasonable alternatives before a development decision. It combines technical investigation, affected people's knowledge, mitigation planning and a documented decision. It is not merely an environmental chapter attached after the engineering design is irreversible.</p><p>Its preventive purpose explains why early comparison matters. Relocating an intake, avoiding unstable ground or changing a waste-treatment process may prevent an impact that later compensation cannot satisfactorily repair. The principle is prevention rather than waiting for damage and then attempting a cure.</p><p>Public interest extends beyond the developer's boundary: downstream water users, neighbouring households, workers, ecosystems and future users may bear costs not reflected in construction expenditure. Environmental assessment therefore includes physical, biological, health and social consequences, beneficial as well as adverse, with significance judged using evidence and context.</p>",
                    moreHtml: "<p>The process can improve a project, justify conditions, identify an unacceptable alternative or support refusal. It does not presume that every development is bad, guarantee that approval will follow or reduce every trade-off to a single score. Good assessment makes assumptions, uncertainties and residual impacts visible so the competent decision-maker can judge them. Report approval also remains distinct from obtaining every other permission needed to build and operate.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>EPR 2077 <strong>Rule 3</strong> associates the assessment categories with three schedules. The category follows the applicable proposal characteristics and legal triggers, not whichever acronym a proponent prefers.</p><table><thead><tr><th scope='col'>Category</th><th scope='col'>Full name</th><th scope='col'>Rule 3 schedule</th></tr></thead><tbody><tr><th scope='row'>BES</th><td>Brief Environmental Study</td><td>Schedule 1</td></tr><tr><th scope='row'>IEE</th><td>Initial Environmental Examination</td><td>Schedule 2</td></tr><tr><th scope='row'>EIA</th><td>Environmental Impact Assessment</td><td>Schedule 3</td></tr></tbody></table><p>These are proportionate assessment routes. A proposal assigned to IEE does not automatically undertake BES first and EIA afterwards. Conversely, a project that meets an EIA trigger cannot avoid it simply by producing a shorter report. A competent review can require a fuller assessment when warranted; that conditional escalation is different from a mandatory three-step ladder.</p><p>An IEE identifies relevant consequences and mitigation under its own applicable requirements. It should not be reduced to a universally informal preliminary study whose only purpose is deciding whether EIA follows. Early identification may avoid redesign and some costs, but required mitigation may also increase direct expenditure while reducing environmental harm.</p>",
                    moreHtml: "<p>BES is an actual category in the inspected Nepal Rules, not merely an acronym used in unspecified foreign frameworks. All three routes need the applicable study preparation, participation, approval and follow-up obligations. Their names do not by themselves establish that a particular site, expansion or associated facility is exempt.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Screening</strong> determines which assessment requirements apply. It is different from scoping, which determines the issues and study boundaries within an assessment. Begin with a clear proposal description: function, capacity, area, technology, location, resources, discharges, construction works, operating arrangements and associated facilities.</p><p>Identify protected or otherwise sensitive locations, affected communities, existing pressures and plausible impact pathways. Compare every applicable schedule entry and location condition, recording the instrument and amendment basis. Do not substitute a generic significance opinion for a binding statutory trigger, nor assume that one favourable size comparison resolves every trigger.</p>",
                    moreHtml: "<p>Project size is often a useful legal trigger but an incomplete environmental proxy. A small facility beside a sensitive spring can create important consequences, while two processes with the same capacity may have different water, energy or waste demands. Deliberately splitting a connected proposal into small components can conceal its combined effects; assess the actual proposal and its legally relevant associated works.</p><p>The developer's preference is not an objective exemption criterion, although factual information supplied by the developer must be evaluated. Proportionate screening directs detailed assessment effort towards proposals that need it; requiring the same full EIA for every negligible activity would consume resources without corresponding benefit. Document the reasoning, evidence gaps and responsible authority so the outcome can be reviewed rather than treated as an unsupported verbal assurance.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>Screening is a decision process, not a commitment to always require a full EIA. Depending on the governing framework and facts, outcomes can include a required full assessment, another applicable study category, further information or a reasoned conclusion that EIA is not required. Nepal's historical 1993 guidelines, clause 7(3), expressly recognize a no-EIA outcome.</p><p>A preliminary investigation used in screening should describe the proposal, receptors, public concern, likely pathways and important uncertainties. It is not normally a detailed prediction of every imaginable impact. Request focused additional evidence when it could change the screening decision, rather than collecting an undirected full baseline.</p>",
                    moreHtml: "<p>This does not mean no environmental obligations exist. A proposal below a full-EIA trigger may still require BES, IEE, sector permissions, pollution controls or local requirements. A defensible record explains the proposal boundaries, applicable criteria, evidence and reasons. Merely asserting no consideration is needed is inadequate, but its poor wording does not make every no-EIA outcome unacceptable.</p><p>Do not equate this generic preliminary investigation with every statutory Nepal IEE. The latter is an assessment category with defined requirements. The bank's never-acceptable question confuses an unsupported assertion with a legally and technically justified outcome, while its explanation itself acknowledges that no EIA can be required where the relevant evidence and rules support that conclusion.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Scoping</strong> identifies the potentially significant issues requiring detailed attention, the alternatives to compare and the spatial and temporal boundaries of the study. Screening asks which assessment route applies; scoping asks what the selected EIA must investigate. It is neither the completed impact prediction nor an inventory of every conceivable minor effect.</p><p>EPR 2077 <strong>Rule 4</strong> provides the formal scoping process for EIA before EIA-report preparation. The scoping-report format is Schedule 5. BES and IEE still need appropriate study planning and approved terms of reference, but should not be described as requiring the identical formal EIA scoping process solely because all studies need a scope.</p>",
                    moreHtml: "<p>A useful investigation combines experience of similar proposals, site reconnaissance, structured checklists or interaction matrices and consultation with affected people and relevant institutions. Trace source–pathway–receptor connections: a spoil site may influence a downstream intake beyond the immediate construction boundary, while a temporary work camp can create different effects from long-term operation.</p><p>Record why issues were included or set aside, what uncertainties remain, which seasons matter and which specialists or measurements are required. Include reasonable alternatives early enough for them to influence design. Efficient scoping can reduce wasted effort, but saving money is not its sole objective and cannot justify excluding a potentially significant impact. It supplies the basis for the EIA ToR rather than certifying that all impacts are already known.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>Describe an impact's direction, magnitude, extent, duration, frequency, likelihood and reversibility. Then evaluate significance using the affected receptor's sensitivity, applicable objectives and the quality of evidence. A small physical change can be significant for a scarce habitat or a household's only water source; a large number without a receptor context may be misleading.</p><p>Qualitative labels such as high, medium and low should have transparent criteria. Quantitative predictions need units, baseline, assumptions and uncertainty. Combining them in a matrix is useful only if the scoring does not conceal unacceptable effects or pretend that ordinal scores are precise physical measurements.</p>",
                    moreHtml: "<p>Ecological, human-health and social effects all belong in a relevant assessment. Air, water, land and noise are environmental media or issue groupings, not a universal exhaustive set of <strong>four impact types</strong>. Other classifications distinguish direct/indirect, cumulative, beneficial/adverse, temporary/permanent or reversible/irreversible effects. State the framework rather than treating its category count as a natural law.</p><p>Jobs and economic benefits are relevant to the overall assessment and decision, but they do not change the technical magnitude, duration or affected area of environmental damage. Keep beneficial and adverse pathways visible rather than subtracting jobs from habitat loss to make the latter disappear. Evaluate residual significance after feasible mitigation, including who bears the residual risk and how performance will be verified.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>Duration describes how long an impact persists. Study duration describes how long evidence collection and assessment take. Project life, construction period, report-submission deadlines and impact duration are separate clocks. A short construction activity can create a permanent habitat change, while a long-running operation may generate intermittent reversible noise.</p><p>The inspected 1994 unofficial English translation of Nepal's <strong>National EIA Guidelines 1993, clause 25(2)(c)</strong>, describes short-term impacts as lasting about <strong>three years</strong>, medium-term as more than three but less than twenty, and long-term as beyond twenty. This is an identified historical classification, not a universal scientific rule or a reason to ignore the applicable present assessment framework.</p><p>The bank's <strong>5–10-year short-term EIA</strong> claim is therefore not supported by that cited historical framework. Do not force one of its offered ranges into the correct explanation. State the actual duration relevant to the receptor and the adopted classification, including any boundary ambiguity rather than silently inventing a threshold.</p>",
                    moreHtml: "<p>Predictions should consider construction, operation, closure and recovery where relevant, including delayed and seasonal effects. Explain whether a consequence stops immediately when the action stops or persists through stored contamination, altered drainage or lost access. Use sensitivity cases where duration is uncertain, and design monitoring to test the mechanism and recovery rather than only the administrative completion date.</p>",
                ...
                },
                {
                    ...
                    html: "<p>Population distribution and movement influence who is exposed, when they are present and whether they can access information, shelter and services. The bank associates them with social vulnerability, which is a useful lens, but movement is not automatically vulnerability. A well-supported evacuation can reduce risk; displacement into unsafe housing can increase it.</p><table><thead><tr><th scope='col'>Dimension</th><th scope='col'>Example assessment question</th></tr></thead><tbody><tr><th scope='row'>Physical</th><td>Can buildings, bridges and water systems withstand the identified hazard?</td></tr><tr><th scope='row'>Social and health</th><td>Who faces mobility, communication, care or access barriers?</td></tr><tr><th scope='row'>Economic</th><td>Which livelihoods and households lack reserves or alternatives?</td></tr><tr><th scope='row'>Environmental</th><td>Have ecosystem changes increased susceptibility or removed protective functions?</td></tr></tbody></table><p>Capacity analysis identifies warning systems, local knowledge, trained personnel, resilient lifelines, social networks and available resources. Avoid treating poverty, disability or age as a complete individual risk score; actual circumstances, exposure and accessible support matter.</p>",
                    moreHtml: "<p>Use appropriately disaggregated information with privacy protection, consult affected groups and update the assessment as occupancy and services change. Distinguish people located in a hazard footprint from the proportion expected to suffer a given consequence. Vulnerability assessment supports mitigation, preparedness and recovery decisions, not only a single phase before an event.</p>",
                ...
                },
                {
                    ...
                    html: "<p>Relevant hazards can be geophysical, hydrometeorological, biological or technological, with combinations and cascading effects. Nepal's earthquake, flood, landslide, drought, fire and outbreak concerns require different evidence and interventions. A statutory natural/non-natural classification should not be assumed identical to every international hazard taxonomy.</p><p>Earthquake shaking can trigger slope failures, damage water systems and block rescue routes. Heavy rainfall can combine river flooding, debris flows and landslides. Drought can affect water supply and livelihoods over an extended period. Human land use, construction and service conditions influence exposure and consequences; calling an event natural does not mean its disaster losses are unaffected by people.</p><p>Tsunamis commonly arise from rapid displacement of seawater associated with a sufficiently disruptive undersea earthquake. Not every submarine earthquake generates one; landslides and volcanic processes can also do so. That global mechanism is not evidence of direct marine-tsunami exposure at a Nepal site.</p>",
                    moreHtml: "<p><strong>Outbreak onset is variable</strong>: some infections spread or become apparent rapidly, while others develop over longer periods. Multiple biological, social and environmental factors may contribute, but outbreak is not a universally slow-onset category. Likewise, a hazard assessment should not require every event to have several overlapping natural causes before it counts.</p><p>Describe frequency using a dated event catalogue, location and metric. The bank's all-of-these frequency answer identifies possible recurrent concerns, not a measured ranking. Examine joint and cascading effects rather than adding independently estimated losses without checking dependence.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>A common teaching framework groups disaster management into <strong>mitigation, preparedness, response and recovery</strong>. Other frameworks distinguish prevention, rehabilitation, reconstruction or additional functions. Four is a conventional grouping, not a universal count of all actions or mutually exclusive stages.</p><table><thead><tr><th scope='col'>Function</th><th scope='col'>Illustrative purpose</th></tr></thead><tbody><tr><th scope='row'>Mitigation</th><td>Reduce adverse effects through safer structures, siting and protective measures.</td></tr><tr><th scope='row'>Preparedness</th><td>Build warning, planning, training and resource readiness.</td></tr><tr><th scope='row'>Response</th><td>Protect life and meet urgent needs during and immediately after impact.</td></tr><tr><th scope='row'>Recovery</th><td>Restore and improve systems while reducing future risk.</td></tr></tbody></table><p><strong>Vulnerability analysis is not exclusive to preparedness.</strong> It guides mitigation priorities before an event, helps target urgent support during response and identifies safer reconstruction choices during recovery. Reassess as population, infrastructure and hazards change.</p>",
                    moreHtml: "<p>Coordination and adaptability are important, so inflexibility is inconsistent with effective management. Flexibility does not mean abandoning assigned responsibilities or safety procedures: use reliable information, clear command and communication arrangements, contingency options and documented decisions. Response may begin while mitigation work continues elsewhere, and recovery planning can begin before immediate relief ends. Treat the cycle as interacting functions rather than a calendar that permits action only in one labelled phase.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Disaster Risk Reduction, DRR</strong>, aims to prevent new risk and reduce existing risk while managing residual risk. Prevention seeks to avoid risk; mitigation lessens adverse consequences where complete avoidance is not feasible. Preparedness and effective services support both, but an emergency plan is not a substitute for a structurally adequate building.</p><table><thead><tr><th scope='col'>Hazard or pathway</th><th scope='col'>Engineering measures</th><th scope='col'>Limits to assess</th></tr></thead><tbody><tr><th scope='row'>Earthquake</th><td>Suitable siting, continuous load paths, ductile detailing, retrofit and restraint of nonstructural components.</td><td>Ground failure, construction quality, occupancy and the applicable seismic design basis.</td></tr><tr><th scope='row'>Flood</th><td>Avoidance, drainage capacity, protected critical equipment and designed safe exceedance routes.</td><td>Blockage, overtopping, downstream transfer, maintenance and changing hydrology.</td></tr><tr><th scope='row'>Landslide or debris flow</th><td>Drainage, appropriate slope geometry, support or protective works where justified.</td><td>Groundwater, failure mechanism, runout and effects on neighbouring slopes.</td></tr><tr><th scope='row'>Fire and technological failure</th><td>Separation, protection systems, safe egress and reliable essential controls.</td><td>Power loss, maintenance, human access and credible compound failures.</td></tr><tr><th scope='row'>Water-related illness after disruption</th><td>Protected supply, sanitation containment and reliable treatment barriers.</td><td>Access, contamination pathways, operation and public-health coordination.</td></tr></tbody></table>",
                    moreHtml: "<p>Measures need site investigation, design verification, quality control, inspection and resources for operation. A retaining wall is not a generic cure for every unstable slope, and a levee can move risk elsewhere. These are general engineering principles, not invented code dimensions or a claim of design approval.</p>",
                ...
                },
                {
                    ...
                    html: "<p>The inspected <strong>Disaster Risk Reduction and Management Act, 2074 (2017)</strong>, in MoHA's English publication incorporating the first amendment 2075, assigns different functions to different bodies. Section 2(k) identifies the Ministry as the <strong>Ministry of Home Affairs, MoHA</strong>. Calling MoHA the lead ministry does not mean the ministry alone performs every approval function.</p><table><thead><tr><th scope='col'>Body and provision</th><th scope='col'>Role in the inspected Act</th></tr></thead><tbody><tr><th scope='row'>National Council, sections 3 and 5</th><td>Chaired by the Prime Minister; national policy/programmes and policy direction.</td></tr><tr><th scope='row'>Executive Committee, sections 6 and 8</th><td>Chaired by the Home Minister; submits policy/plans to the Council and approves strategic plans/programmes.</td></tr><tr><th scope='row'>NDRRMA, sections 10 and 11</th><td>National Disaster Risk Reduction and Management Authority under MoHA, supervised by the Executive Committee; implementation, coordination, information and secretariat functions.</td></tr></tbody></table><p>NDRRMA's tasks include disaster information, research, rescue/relief coordination, emergency-operation functions and support resources under the listed provisions. It is not Nepal or Natural Disaster Risk Reduction and Management Authority; the first word is <strong>National</strong>.</p>",
                    moreHtml: "<p>For an actual project or emergency, identify the relevant national, provincial, district, local and sectoral responsibilities rather than routing every matter to one body. The bank's phrase which ministry passes DRM strategy compresses lead-ministry and statutory committee roles. The exact approval described above belongs to the identified Act and edition, not an unaudited claim about every later instrument.</p>",
                    sources: [
            ...
            cautions: [
                {
                    "id": "check-wate813-00108",
                    "status": "review",
                    "prompt": "All the primarily concerned and other categories’ indirect impact of hazard among the following",
                ...
                {
                    "id": "check-wate813-00072",
                    "status": "review",
                    "prompt": "Which one among the following is the correct order of steps taken during the process of Environmental Impact Assessment (EIA)?",
                ...
                {
                    "id": "check-wate813-00074",
                    "status": "review",
                    "prompt": "Vulnerability analysis comes in which part of the Disaster Management Cycle",
                ...
                {
                    "id": "check-wate813-00076",
                    "status": "review",
                    "prompt": "Which ministry passes DRM strategy?",
                ...
                {
                    "id": "check-wate813-00079",
                    "status": "review",
                    "prompt": "In which of the following scoping is required?",
                ...
                {
                    "id": "check-wate813-00081",
                    "status": "review",
                    "prompt": "When was the first environmental act introduced in Nepal?",
                ...
                {
                    "id": "check-wate813-00090",
                    "status": "review",
                    "prompt": "Which of the elements of the EIA process does the following expression describe? ......narrowing the application of EIA to those projects that may have significant environmental impacts.....",
                    "html": "<p><strong>Screening selects the required assessment route.</strong> It identifies proposals subject to the relevant statutory criteria. Sensitivity and connected works matter; a developer's preferred informal score cannot replace binding schedule triggers.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00090",
                            "set": 10,
                ...
                {
                    "id": "check-wate813-00094",
                    "status": "review",
                    "prompt": "What are the key factors which must be taken into account when determining where a project requires EIA or not?",
                    "html": "<p>The developer's opinion alone does not establish exemption. </p><p>Connected works and technology differences must not disappear behind a size-only comparison.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00094",
                            "set": 11,
                ...
                {
                    "id": "check-wate813-00095",
                    "status": "review",
                    "prompt": "In some jurisdictions, project size is used as a proxy screening criteria What is the key problem with this approach?",
                    "html": "<p><strong>Screening criteria need the legal and factual basis:</strong> size, sensitivity and community effects matter, but binding schedule triggers cannot be displaced by a preferred informal score. </p><p>Connected works and technology differences must not disappear behind a size-only comparison.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00095",
                            "set": 11,
                ...
                {
                    "id": "check-wate813-00096",
                    "status": "review",
                    "prompt": "Which of the following is never an acceptable outcome of the screening process?",
                ...
                {
                    "id": "check-wate813-00097",
                    "status": "review",
                    "prompt": "Where a preliminary EIA is carried out during screening, which of the following should not be included?",
                    "html": "<p><strong>Preliminary investigation is not every statutory IEE:</strong> screening work need not contain a detailed assessment of all potential impacts. </p><p>However, Nepal's IEE is also an assessment category with its own requirements, not universally an informal step whose only function is deciding whether EIA follows.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00097",
                            "set": 11,
                ...
                {
                    "id": "check-wate813-00100",
                    "status": "review",
                    "prompt": "Which of the following are not required to be included in a scoping report or ToR?",
                    "html": "<p><strong>Estimated study budget is required in the identified ToR formats:</strong> EPR Schedule 8, chapter 5, item 5.2 and Schedule 7 item 5(b) include it. A fully itemized contractual budget is a different matter, but the explanation's blanket claim that budgets are private and excluded is incorrect.</p><p><strong>Bank details are not study resources:</strong> excluding the proponent's bank-account particulars does not exclude required estimated study budgets, mitigation costs or monitoring resources. </p><p>Keep this question separate from the defective categorical ToR-budget explanation.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00100",
                            "set": 11,
                ...
                {
                    "id": "check-wate813-00103",
                    "status": "review",
                    "prompt": "Which of the following is not a material consideration when making impact predictions of environmental damage?",
                ...
                {
                    "id": "check-wate813-00104",
                    "status": "review",
                    "prompt": "Which of the following are indirect impacts?",
                ...
                {
                    "id": "check-wate813-00106",
                    "status": "review",
                    "prompt": "All are the principle of emergency management except?",
                ...
                {
                    "id": "check-wate813-00107",
                    "status": "review",
                    "prompt": "Which of the following is wrong?",
                ...
                {
                    "id": "check-wate813-00109",
                    "status": "review",
                    "prompt": "Slow occurrences and multi casual among the following natural disaster",
                ...
                {
                    "id": "check-wate813-00110",
                    "status": "review",
                    "prompt": "Natural disasters generally involve which of the following?",
                ...
                {
                    "id": "check-wate813-00111",
                    "status": "review",
                    "prompt": "Common cause of tsunami",
                ...
                {
                    "id": "check-wate813-00113",
                    "status": "review",
                    "prompt": "Commonly used type of epidemiological study design for disaster among the following",
                ...
                {
                    "id": "check-wate813-00114",
                    "status": "review",
                    "prompt": "More frequent type of disaster in Nepal among the following",
                ...
                {
                    "id": "check-wate813-00115",
                    "status": "review",
                    "prompt": "Where undertaken, EIA should be used to help determine whether consent is given for development",
                    "html": "<p><strong>Assessment findings inform consent.</strong> Approval of an environmental report does not itself grant every construction, land or operating permission, or guarantee that the project must be approved.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00115",
                            "set": 13,
                ...
                {
                    "id": "check-wate813-00120",
                    "status": "review",
                    "prompt": "Environmental impacts can be of types:",
                ...
                {
                    "id": "check-wate813-00121",
                    "status": "review",
                    "prompt": "A short-term environmental impact assessment EIA has a time period of:",
                ...
                {
                    "id": "check-wate813-00122",
                    "status": "review",
                    "prompt": "How many stages are there in EIA:",
                ...
                {
                    "id": "check-wate813-00123",
                    "status": "review",
                    "prompt": "The full form of IEE is",
                    "html": "<p><strong>IEE means Initial Environmental Examination.</strong> In Nepal it is a statutory assessment category with its own requirements, not merely an informal screening step whose only purpose is deciding whether EIA follows.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00123",
                            "set": 13,
                ...
                {
                    "id": "check-wate813-00125",
                    "status": "review",
                    "prompt": "The full form of BES in EIA is",
                ...
                {
                    "id": "check-wate813-00126",
                    "status": "review",
                    "prompt": "Once EIA is complete ...",
                    "html": "<p><strong>Assessment approval versus project permissions:</strong> the findings must inform the required decision, and the report goes through the competent route under Rules 8–9. </p><p>Not every report goes directly to MoFE or a municipal chief. </p><p>Environmental-report approval does not replace all other permissions or guarantee approval of the proposal.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00126",
                            "set": 14,
                ...
                {
                    "id": "check-wate813-00127",
                    "status": "review",
                    "prompt": "Process for IEE and EIA is provided by...for development activities in Nepal.",
                ...
                {
                    "id": "check-wate813-00128",
                    "status": "review",
                    "prompt": "Administrative Process for IEE and EIA is provided by... for approval, preparation and implementation",
                ...
                {
                    "id": "check-wate813-00129",
                    "status": "review",
                    "prompt": "IEE is done to",
                ...
                {
                    "id": "check-wate813-00130",
                    "status": "review",
                    "prompt": "How many distinct types of actions are defined as part of disaster management?",
                ...
                {
                    "id": "check-wate813-00131",
                    "status": "review",
                    "prompt": "The full form of NDRRMA is",
                ...
                {
                    "id": "check-wate813-00133",
                    "status": "review",
                    "prompt": "Nepal Ranks ... in terms of earthquake",
                    "html": "<p><strong>Unverified rankings:</strong> the eleventh-earthquake and thirtieth-flood claims have no verified dated index or metric in these sources. </p>",
                    "sources": [
                        {
                            "id": "WATE813-00133",
                            "set": 14,
                ...
                {
                    "id": "check-wate813-00134",
                    "status": "review",
                    "prompt": "Nepal Ranks ...th in terms of flood risk.",
                    "html": "<p><strong>Unverified rankings:</strong> the eleventh-earthquake and thirtieth-flood claims have no verified dated index or metric in these sources. </p><p>Do not assert them as current world ranks or attribute them to the World Risk Report without checking the actual edition and measure.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00134",
                            "set": 14,
                ...
                {
                    "id": "check-wate813-00135",
                    "status": "review",
                    "prompt": "Populations and their movements is vulnerability.",
                ...
                {
                    "id": "check-wate813-00338",
                    "status": "review",
                    "prompt": "Which of the following is typically NOT included as a mandatory component in an Environmental Impact Assessment (EIA) report?",
                    "html": "<p><strong>Bank details are not study resources:</strong> excluding the proponent's bank-account particulars does not exclude required estimated study budgets, mitigation costs or monitoring resources. </p>",
                    "sources": [
                        {
                            "id": "WATE813-00338",
                            "set": 33,
