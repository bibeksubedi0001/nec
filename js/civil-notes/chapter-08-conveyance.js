(function () {
    ...
    Object.assign(registry, {
        ACiE0805: {
            ...
            blocks: [
                {
                    ...
                    html: "<p>The conveyance system delivers water with usable head from the source to the turbine. A typical run-of-river arrangement has an intake, sediment-control works, a headrace, a forebay and a penstock. A reservoir can itself perform the forebay function where it supplies the pressure-conduit entrance. These are functional arrangements, not a compulsory sequence of identical structures at every site.</p><table><thead><tr><th scope='col'>Component or regime</th><th scope='col'>Hydraulic meaning</th></tr></thead><tbody><tr><th scope='row'>Free-surface tunnel</th><td>Water has an air-exposed surface and normally leaves an air space below the crown. Pressure below that surface is not zero; approximately hydrostatic pressure acts where the flow assumptions permit.</td></tr><tr><th scope='row'>Pressure tunnel</th><td>The operating water passage runs full. Pressure and elevation together determine the hydraulic grade, which need not follow the invert.</td></tr><tr><th scope='row'>Penstock</th><td>A pressure conduit supplying the turbine. It can feed a reaction-turbine scroll case or an impulse-turbine manifold and nozzles; a scroll case is not universal.</td></tr><tr><th scope='row'>Pressure shaft</th><td>A steep or vertical underground pressure-waterway reach. Its hydraulic and structural design must account for the local pressure and surrounding ground.</td></tr></tbody></table>",
                    moreHtml: "<p>A conventional forebay is normally at the <strong>downstream end of the headrace, before the penstock</strong>, not necessarily before the river intake. A surge chamber is connected to the pressure waterway to exchange water during transients; all generating flow need not pass through the chamber as though it were a tank in series. Distinguish both structures from the tailrace downstream of the turbine.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension:</strong> the assigned bank has no complete longitudinal energy-profile calculation. Use a common elevation datum and consistent pressure reference before comparing a tunnel, forebay, shaft and turbine.</p><p>For a section with elevation z, mean velocity V and pressure p, <strong>H = z + p/(ρg) + αV<sup>2</sup>/(2g)</strong>. Here H and z are in metres, p in Pa, ρ in kg/m<sup>3</sup>, g in m/s<sup>2</sup>, and α is the dimensionless kinetic-energy correction coefficient. The <strong>hydraulic grade line, HGL = z + p/(ρg)</strong>; the energy grade line lies αV<sup>2</sup>/(2g) above it.</p><p>For steady incompressible flow without a machine between the selected sections, <strong>H<sub>1</sub> = H<sub>2</sub> + h<sub>f</sub> + h<sub>m</sub></strong>. Distributed friction and local losses reduce available energy. </p><p><em>Added illustration, not bank data:</em> a gauge-pressure HGL at elevation 160 m and a pipe-centre elevation of 100 m give 60 m of gauge pressure head. With ρ = 1000 kg/m<sup>3</sup> and g = 9.81 m/s<sup>2</sup>, p = <strong>588.6 kPa</strong>. This is a local pressure calculation, not the plant's net head or a verified maximum transient pressure. Plot both maximum and minimum pressure envelopes for structural and cavitation assessment.</p>",
                    moreHtml: "<p>Changes of elevation or area can increase or decrease local pressure even while total energy decreases. Net turbine head is the difference between the appropriate upstream and downstream total heads, with waterway losses assigned consistently; it is not simply height above the powerhouse floor.</p>",
                    sources: []
                },
                {
                ...
                },
                {
                    ...
                    html: "<p>A circular section is efficient for internal pressure because a continuous circular shell can resist it primarily through hoop tension. Under approximately uniform radial external pressure, a ring can develop compression, although instability and imperfections still require checks. This explains the bank's circular-section preference without declaring it the strongest shape for every ground-loading pattern.</p><table><thead><tr><th scope='col'>Consideration</th><th scope='col'>Implication for selection</th></tr></thead><tbody><tr><th scope='row'>Internal water pressure</th><td>Favour a pressure-efficient section and a verified pressure-resisting system; shape alone does not supply tensile strength or watertightness.</td></tr><tr><th scope='row'>Unequal ground stresses or joint-controlled blocks</th><td>Account for nonuniform loads, bending, deformation and support interaction, even in a circular tunnel.</td></tr><tr><th scope='row'>Free-surface flow and access</th><td>Horseshoe or D-shaped sections can provide useful invert and working-space geometry where the complete hydraulic and structural design supports the choice.</td></tr><tr><th scope='row'>Non-cohesive ground</th><td>Supported circular shield and segmental tunnels can be feasible. Face stability, groundwater and support govern; cohesionlessness does not prohibit a circle.</td></tr></tbody></table>",
                    moreHtml: "<p><strong>Unsupported excavation and a supported tunnel are different systems.</strong> Neither dry sand nor fractured rock should be assumed to form a stable unsupported opening simply because a preferred section has been drawn. Conversely, the need for support is not evidence that circular geometry is unsuitable.</p><p>Where high internal pressure coincides with weak rock or inadequate confinement, assess alignment, leakage, hydraulic jacking and engineered lining. A circular outline plus an unspecified concrete lining is not a complete solution. Steel and concrete cannot be exchanged without examining their pressure-resistance and crack-control roles.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension:</strong> these records do not contain a structural lining analysis. Separate hydraulic smoothing, erosion resistance, groundwater control, ground support and internal-pressure containment. One lining may serve several purposes, but satisfying one does not demonstrate all the others.</p><table><thead><tr><th scope='col'>Waterway treatment</th><th scope='col'>Behaviour to establish</th></tr></thead><tbody><tr><th scope='row'>Unlined competent rock</th><td>Requires verified rock-mass stability, erosion resistance, permeability and, for pressure service, adequate confinement.</td></tr><tr><th scope='row'>Shotcrete and rock support</th><td>Can stabilize exposed ground under an engineered support design. A support layer is not automatically a watertight pressure shell.</td></tr><tr><th scope='row'>Concrete or reinforced concrete</th><td>Provides a defined hydraulic surface and structural functions as designed. Cracking, joints, reinforcement, external head and surrounding-ground interaction matter.</td></tr><tr><th scope='row'>Steel pressure lining</th><td>Can provide tensile pressure containment and leakage control, but welds, corrosion, local details, contact and external-pressure buckling require assessment.</td></tr></tbody></table>",
                    moreHtml: "<p>Pressure sharing between lining and rock follows <strong>deformation compatibility, stiffness and actual contact</strong>, not an arbitrary percentage. Gaps, cracking, groundwater, permeability and contact treatment change that interaction. A cracked concrete lining may transmit water pressure into joints even when it still provides a smooth flow surface.</p><p>Loading also reverses with operating state. During pressure operation, internal water pressure may dominate; when the waterway is empty, external groundwater may govern. Permanent support, drainage and pressure lining must therefore be examined as an interacting system over construction, filling, operation and dewatered conditions, not only at one full-supply state.</p>",
                    sources: []
                },
                {
                    id: "faults-and-pressure-confinement",
                    title: "Faults, confinement and treatment — syllabus extension",
                    html: "<p><strong>Syllabus extension:</strong> no site-specific fault, stress or groundwater dataset accompanies the bank. Rock cover is geometric information; it is not a direct measurement of the least confining stress or of normal stress on an unfavourably oriented discontinuity.</p><p>For a water-filled joint, the elementary effective-normal-stress idea is <strong>σ′<sub>n</sub> ≈ σ<sub>n</sub> − u</strong>, with normal stress and joint-water pressure u expressed in the same units. Increasing joint pressure reduces clamping. Hydraulic jacking, joint opening and leakage depend on stress orientation, joint connectivity, deformation and material resistance; this relation is a mechanism explanation, not a standalone fracture-pressure criterion.</p>",
                    moreHtml: "<p><em>Added conceptual case, not bank data:</em> a pressure tunnel crosses a fault close to a steep valley side. Vertical cover may appear substantial while confinement normal to the fault is small and the fault provides a leakage path towards the slope. A circular section does not remove either condition. Investigation must establish the rock mass, stresses, discontinuities, groundwater and likely response before choosing alignment and containment.</p><p>Possible engineered responses include alignment changes, appropriate support, contact treatment, permeability-reduction grouting or pressure lining. Contact grouting and ground improvement have different objectives; neither guarantees confinement merely by being named. Drainage must be compatible with the required water-pressure boundary and acceptable groundwater effects. <strong>No universal bolt spacing, investigation-hole spacing, lining thickness or cover/head ratio is adopted.</strong> Treatment and monitoring must be tailored to the actual weak zones and pressure envelope.</p>",
                    sources: []
                },
                {
                    id: "lining-rule-and-segment-materials",
                    title: "A unit conversion and a historical material are not design rules",
                    html: "<p>The bank's legacy lining proportion is <strong>t<sub>mm</sub> = 42D<sub>m</sub></strong>, where the subscripts indicate numerical values in millimetres and metres. A dimensionally explicit form is <strong>t/(1 mm) = 42[D/(1 m)]</strong>. With both lengths expressed in the same unit, it becomes <strong>t = 0.042D</strong>, not t = 42D.</p><p><em>Added unit illustration, not bank data:</em> D = 5 m would give 210 mm = 0.210 m under that proportion. This demonstrates conversion only. The coefficient's applicable material, loading, calibration range and authoritative provenance have not been established. It is <strong>not a structural lining rule or verified current code requirement</strong>. Pressure, ground loads, reinforcement, cracking, groundwater and construction details cannot be inferred from D alone.</p>",
                    moreHtml: "<p>Cast-iron segments are a historical suitable lining for shield-driven subaqueous tunnels. Their segmented form permitted a supported ring to be assembled within the construction system. Watertight performance still depends on joints, seals, connections and the surrounding interface, rather than on the material name alone.</p><p><strong>Modern concrete segmental linings can also be suitable.</strong> The records that offer cement concrete alongside cast iron therefore do not establish cast iron as the only possible answer without further context. Compare handling and erection loads, ground and water pressure, ring/joint behaviour, durability and leakage requirements. Historical suitability is not evidence that modern alternatives are prohibited.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    moreHtml: "<p><strong>Staged excavation</strong> divides the cross-section into portions, such as an upper heading and a lower bench. This changes the exposed opening and the opportunities for support and access. It can be chosen for more than one ground class; the method name alone does not establish that the rock is perfectly self-supporting or that support can be omitted.</p><p>The bank's three labels for cut, relief and perimeter functions describe zones within a face, <strong>not three full-face excavation stages</strong>. This resolves the apparent conflict between the three-sections record and the record that defines full-face as the entire section. Their wording asks different things without making that distinction clear.</p><p>The separate heading-and-trenching wording is inconsistent with the heading-and-benching concept being examined. Only the distinction between geometric stages is adopted here. <strong>A construction-method label does not determine a drilling or firing sequence.</strong> The source's procedural alternatives, or their opposites, are not taught as universal instructions; detailed excavation procedures are outside these conceptual notes.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>Ground-support arrangements, excavation equipment and profile-control terms are different classifications. They can overlap in one engineered tunnel system; they are not an interchangeable list of complete designs.</p><table><thead><tr><th scope='col'>Term</th><th scope='col'>Concept and qualification</th></tr></thead><tbody><tr><th scope='row'>Forepoling</th><td>Presupport ahead of the exposed roof region in weak or unstable ground. Soft and running ground can overlap; suitability depends on the full support and groundwater-control system.</td></tr><tr><th scope='row'>Needle-beam arrangement</th><td>A traditional temporary-support concept. Its name does not establish a universal ground class, span or adequate support capacity.</td></tr><tr><th scope='row'>Shield</th><td>A protective construction system associated with excavation and lining. Shielded equipment is not restricted exclusively to soft ground.</td></tr><tr><th scope='row'>Compressed-air tunnelling</th><td>A historical pressure-supported working-environment concept. Low-permeability clay can limit air loss, but permeability alone does not establish stability or a suitable working-pressure condition.</td></tr><tr><th scope='row'>Drifter</th><td>A rock-drilling machine whose mounting and positioning can permit horizontal, upward or downward work. Not every drifter is pneumatic or track-mounted.</td></tr><tr><th scope='row'>Trimmer or perimeter terminology</th><td>Refers to control of the final excavation profile, not an instruction about the order in which equipment must operate.</td></tr></tbody></table>",
                    moreHtml: "<p>The compressed-atmosphere wording is interpreted only in its bank context of compressed-air tunnelling. A soil-name answer such as clay does not establish permissible worker exposure, groundwater control or construction safety. These notes provide <strong>conceptual vocabulary and qualified selection considerations only</strong>, with no drilling patterns, firing sequences or explosives instructions.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    moreHtml: "<p>Similarly, central and side drains describe position. A side drain can also be permanent, and an open ditch can also be a side drain. The bank's options therefore mix classifications. A question about the general removal of water can reasonably use dewatering, whereas an all-of-the-above answer needs a question about applicable categories, not a claim that every term means the same thing.</p><p><strong>Open ditch drainage can be used inside appropriate free-surface or construction tunnels.</strong> It is not exclusively a surface-road feature. Its capacity, gradient, maintenance access, sediment control and receiving level must be suitable. This does not authorize an uncontrolled opening through a pressure-retaining lining; the waterway's operating pressure boundary must remain part of the design.</p><p>Water behind a lining can create external pressure, especially when internal water level falls. Drainage effectiveness depends on connected flow paths and usable outfalls, and can be reduced by clogging or submergence. Uncontrolled groundwater lowering can also affect surrounding ground and water resources. A drainage label alone establishes neither zero external head nor acceptable ground response.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension; added example, not bank data.</strong> Assume Q<sub>in</sub> = 2 m<sup>3</sup>/s, Q<sub>out</sub> = 3 m<sup>3</sup>/s for 30 s, no spill and negligible other losses. The required drawdown storage is (3 − 2) × 30 = <strong>30 m<sup>3</sup></strong>. This is an assumed flow history, not a prediction of actual headrace or governor response.</p><p>For a constant A<sub>F</sub> = 60 m<sup>2</sup>, the level change is Δz = −30/60 = <strong>−0.50 m</strong>. Merely finding room for 30 m<sup>3</sup> does not prove that this drawdown is usable. Suppose, solely for this illustration, initial inlet submergence is 1.80 m and the separately stipulated minimum is 1.50 m, both measured to the same fixed datum.</p><p>The permissible drawdown from that constraint is only <strong>0.30 m</strong>, so this area provides 60 × 0.30 = <strong>18 m<sup>3</sup></strong> of usable storage before reaching the stipulated minimum. The calculated 0.50 m drop would leave 1.30 m submergence. Under these simplified assumptions, meeting the 30 m<sup>3</sup> demand within 0.30 m drawdown requires A<sub>F</sub> ≥ <strong>100 m<sup>2</sup></strong>.</p>",
                    moreHtml: "<p>This is a conditional storage-area bound, <strong>not a finished forebay design or a universal submergence requirement</strong>. Variable plan area, approach hydraulics, headrace response, overflow, sediment and structural requirements may change the solution. During a sustained rejection of turbine flow, an unchanged incoming supply ultimately needs a controlled outlet or spill path; a finite balancing volume cannot absorb a continuing imbalance indefinitely.</p>",
                    sources: []
                },
                {
                    id: "forebay-submergence-bank-check",
                    title: "Check the supplied submergence arithmetic without certifying the rules",
                    html: "<p>The actual bank data are <strong>Q = 3.6 m<sup>3</sup>/s</strong> and <strong>D = 1.55 m</strong>. Full-circle area A = π(1.55)<sup>2</sup>/4 = <strong>1.88692 m<sup>2</sup></strong>, so the penstock mean velocity is V = Q/A = <strong>1.90787 m/s</strong>. This is not the mean approach velocity over the entire forebay.</p><table><thead><tr><th scope='col'>Rule stated in the explanation</th><th scope='col'>Conditional substitution</th></tr></thead><tbody><tr><th scope='row'>h<sub>s1</sub> = 1.5V<sup>2</sup>/(2g)</th><td>With g = 9.81 m/s<sup>2</sup>, h<sub>s1</sub> ≈ 0.2783 m.</td></tr><tr><th scope='row'>h<sub>s2</sub> = 0.5V√D</th><td>Using the explanation's numerical metre-second convention gives h<sub>s2</sub> ≈ 1.1876 m.</td></tr><tr><th scope='row'>Larger of those two values</th><td>1.1876 m, or about 1.19 m, only if both stated rules are adopted.</td></tr></tbody></table><p>The second expression is <strong>not dimensionally homogeneous with a dimensionless coefficient 0.5</strong>: V√D has units m<sup>3/2</sup>/s, so the numerical coefficient encodes a unit convention equivalent to s/√m. Neither the origin nor calibration range of these correlations was verified. The keyed 1.18 is nearby, but conventional rounding of the calculated larger value to two decimals is 1.19.</p>",
                    moreHtml: "<p>Submergence also needs a stated datum, such as inlet centre or crown, which this item does not define. Actual vortex and air-entrainment behaviour depends on inlet geometry, approach circulation, operating level and discharge. The calculation checks the explanation's arithmetic; <strong>it does not establish a universal minimum-submergence design criterion</strong>.</p>",
                ...
                },
                {
                    ...
                    html: "<p>A long water column has inertia: its discharge cannot follow a changing turbine demand without pressure differences that accelerate or decelerate it. A surge connection provides local storage exchange so the headrace flow can adjust over time. It <strong>mitigates specified pressure variations</strong>; it does not guarantee zero water hammer or perfectly constant turbine pressure.</p><p>With flow into the tank taken positive, <strong>Q<sub>s</sub> = Q<sub>headrace</sub> − Q<sub>penstock</sub></strong> and, for a simple constant-area tank, <strong>A<sub>s</sub> dz/dt = Q<sub>s</sub></strong>. Discharges are in m<sup>3</sup>/s, tank area in m<sup>2</sup>, and level z in m. The flow difference, not turbine load considered in isolation, determines the instantaneous level-change sign.</p><table><thead><tr><th scope='col'>Initial demand change</th><th scope='col'>Typical initial response</th></tr></thead><tbody><tr><th scope='row'>Load rejection and reduced turbine flow</th><td>Headrace inflow initially exceeds the reduced penstock demand; water enters the tank and its level rises.</td></tr><tr><th scope='row'>Load acceptance and increased turbine flow</th><td>Penstock demand initially exceeds the headrace supply; stored water leaves the tank and its level falls.</td></tr></tbody></table>",
                    moreHtml: "<p>Subsequent overshoot and oscillation mean that the level need not continue moving monotonically in that initial direction. Water-column kinetic energy and gravity-related storage energy are exchanged; friction and other losses can damp the motion. Fast elastic waves in the remaining pressure conduit are a related but distinct phenomenon. The bank's decreased-load answers describe one important case, not the only case in which a surge tank acts.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension:</strong> no assigned question supplies a numerical surge-period or governor-stability design. Consider an ideal constant-level reservoir, a uniform tunnel of length L and area A<sub>t</sub>, and a simple open tank of area A<sub>s</sub>. After turbine flow is shut off, take v positive towards the tank and z positive above the reservoir's equilibrium level. Neglect friction, elastic waves, tank-water inertia and connection losses.</p><p>Continuity gives <strong>A<sub>s</sub> dz/dt = A<sub>t</sub>v</strong>. The excess tank head opposes motion from the reservoir, so water-column momentum gives <strong>(L/g) dv/dt = −z</strong>. Differentiating continuity and substituting momentum yields <strong>d<sup>2</sup>z/dt<sup>2</sup> + [gA<sub>t</sub>/(LA<sub>s</sub>)]z = 0</strong>.</p><p>Thus <strong>ω<sup>2</sup> = gA<sub>t</sub>/(LA<sub>s</sub>)</strong> and <strong>T = 2π√[LA<sub>s</sub>/(gA<sub>t</sub>)]</strong>. With L in m, both areas in m<sup>2</sup> and g in m/s<sup>2</sup>, T is in seconds. Gravity provides the restoring mechanism; acoustic wave speed does not appear in this lumped, rigid-column oscillation model.</p><p><em>Added illustration, not bank data:</em> L = 1000 m, A<sub>t</sub> = 5 m<sup>2</sup>, A<sub>s</sub> = 20 m<sup>2</sup> and g = 9.81 m/s<sup>2</sup> give T ≈ <strong>127 s</strong>. This is a period, not an allowable closure time or an adequate tank height. Initial conditions are still needed to determine amplitude.</p>",
                    moreHtml: "<p>The ideal equation has <strong>no damping</strong>. Real losses, restrictions and changing turbine demand alter the response. Design must check upsurge, downsurge, freeboard, minimum level and <strong>governor–waterway stability</strong>; a plausible period or large storage volume alone proves none of those requirements. Air-cushion chambers require their additional gas-pressure model.</p>",
                    sources: []
                },
                {
                    ...
                    moreHtml: "<p>Mild steel is a type of steel, so those two options overlap in the bank. Conversely, wild steel is not an established material grade. A usable design specification must identify strength, toughness, weldability, joint quality, corrosion protection and the applicable manufacturing and inspection requirements, rather than merely select the word steel.</p><p>Wall adequacy depends on the pressure envelope and the complete load path. Supports and anchors introduce local bending and longitudinal forces; branches and transitions change stresses and losses. Sediment abrasion, chemical corrosion and access for inspection can affect material and detailing decisions even when the plant has high head.</p><p>Separate the hydraulic diameter from nominal product dimensions and structural wall thickness. Increasing thickness does not necessarily increase the internal flow area, and a hydraulically adequate bore can still have an inadequate pressure rating or external-pressure resistance. No material in this comparison is approved for an unspecified duty.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>A thin-wall elastic approximation is <strong>a = √[(K/ρ)/(1 + ψKD/(Et))]</strong>. K is water bulk modulus, E is pipe Young's modulus, t is wall thickness and ψ represents restraint and associated Poisson effects in the adopted model. K here is <strong>not</strong> a local head-loss coefficient. Use K and E in the same pressure units and D and t in the same length units.</p><p>The actual bank gives D = <strong>40 cm = 0.40 m</strong>, t = <strong>4 mm = 0.004 m</strong>, E = <strong>2.1 × 10<sup>11</sup> Pa</strong> and K = <strong>2.1 × 10<sup>9</sup> Pa</strong>. Add the explicit assumptions <strong>ρ = 1000 kg/m<sup>3</sup></strong> and <strong>ψ = 1</strong>. Then KD/(Et) = (2.1 × 10<sup>9</sup> × 0.40)/(2.1 × 10<sup>11</sup> × 0.004) = <strong>1</strong>.</p><p>Consequently <strong>a = √(2.1 × 10<sup>6</sup>/2) = 1024.7 m/s</strong>. The stored 1000 m/s is the approximate offered choice, not the exact calculated value. For comparison under the same water properties, suppressing pipe-wall compliance would give √(K/ρ) ≈ 1449.1 m/s; the flexible wall reduces celerity.</p><p>Neither ψ = 1 nor the stated water density is universal. Entrained gas, different restraint, viscoelastic pipe behaviour and composite lining/rock systems can need another model. </p>",
                    moreHtml: "<p>This calculation supplies wave speed only; pipe length, initial flow, boundary conditions and operating history are still needed to determine transient pressure. Do not borrow this speed to fill missing data in another bank question.</p>",
                ...
                },
                {
                    ...
                    html: "<p>In the elementary reservoir–uniform-pipe–downstream-valve system, a disturbance travels from the valve to the upstream boundary and returns in <strong>T<sub>crit</sub> = 2L/a</strong>. L is the relevant pipe length in m, a is pressure-wave speed in m/s, and the comparison time is in seconds. The bank's symbol c denotes this same wave speed, not water discharge velocity.</p><p>A closure time <strong>T<sub>c</sub> &lt; 2L/a</strong> is rapid in this convention; equality is the limiting case. The general gradual-closure condition is <strong>T<sub>c</sub> &gt; 2L/a</strong>. Values such as 4L/a or 5L/a can be particular gradual times, but they do not replace the general inequality. An option with T<sub>c</sub> &lt; 4L/a also includes rapid closures, so it is not an equivalent criterion.</p><p><em>Added time-scale example, not bank data:</em> L = 600 m and a = 1200 m/s give T<sub>crit</sub> = <strong>1 s</strong>. Under the stated simple model, a 0.4 s closure is rapid and a 3 s closure is gradual. This classification does not by itself calculate either pressure envelope.</p>",
                    moreHtml: "<p>A slow total valve stroke can still contain a sharp final change in discharge because valve position and discharge are not generally proportional. Networks, surge connections and variable-area passages have multiple travel and reflection paths. Thus gradual does not mean no water hammer, and a single travel-time inequality is not a complete closure-law or surge-protection design.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>A surge tank can reduce hydraulic-transient loads on a waterway and turbine, but it is not universal protection against all runner or penstock damage. Nor does every closed conduit automatically require the same surge arrangement. Need and form follow the complete waterway, machine controls, pressure envelope and consequences of loss of function.</p><table><thead><tr><th scope='col'>Physical concern</th><th scope='col'>Engineering assessment</th></tr></thead><tbody><tr><th scope='row'>Positive transient pressure</th><td>Pressure-rated containment and a coordinated analysis of surge storage, controls and any engineered relief arrangements.</td></tr><tr><th scope='row'>Low pressure or cavity formation</th><td>Minimum absolute-pressure envelope, appropriate storage exchange and air-management assessment; protective devices themselves alter the transient.</td></tr><tr><th scope='row'>Mass-surge oscillation and machine response</th><td>Upsurge/downsurge limits, governor interaction and stability, including the effects of restrictions and operating-state changes.</td></tr><tr><th scope='row'>Sediment and corrosion</th><td>Actual concentration, grading, hardness, water chemistry, wear exposure, material protection and maintainability; these are not solved by surge storage.</td></tr></tbody></table>",
                    moreHtml: "<p><strong>High head does not imply sediment-free water.</strong> High-head run-of-river schemes can convey abrasive sediment, and a deep reservoir intake is not guaranteed to exclude it. Sediment management, lining or coating selection, velocities and wear allowance must address the actual service environment. The bank's exclusion of sediment from penstock design is not adopted.</p><p>These are protective design concepts, not operating settings or field procedures. A completed design requires a coupled hydraulic and structural analysis, appropriate failure cases and professional review. Original stored answers remain distinct from the limitations explained here.</p>",
                    sources: [
            ...
            cautions: [
                {
                    "id": "check-hydr626-00189",
                    "status": "review",
                    "prompt": "Which statement about surge tank is wrong?",
                    "html": "<p><strong>These wrong-statement items are inconsistent:</strong> one keys total closure and the other exact turbine-inlet location. </p><p>A conventional open tank is vented, but a <strong>closed air-cushion chamber does work</strong>. </p><p>Exact turbine-inlet placement is also not universal. </p><p>Tank type and layout must be identified; choosing one stored answer does not make every other statement correct.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00189",
                            "set": 1,
                ...
                {
                    "id": "check-hydr626-00007",
                    "status": "review",
                    "prompt": "A hydropower plant is going to be installed in Nepal. The power plant has the following characteristics: Gross Head (H) = 25 m, Design flow (Q) = 0.7 m3/s & The length of the penstock pipe (L) is 500 m long. the effective diameter of penstock pipe required is?",
                ...
                {
                    "id": "check-hydr626-00037",
                    "status": "review",
                    "prompt": "What is the minimum submergence that should be provided for a fore bay of Q = 3.6m3/s, D = 1.55m?",
                ...
                {
                    "id": "check-hydr626-00038",
                    "status": "review",
                    "prompt": "Which element of hydroelectric power plant prevents the penstock from water hammer phenomenon?",
                    "html": "<p><strong>A surge tank mitigates selected pressure variations.</strong> It accepts or supplies water while conveyance flow adjusts. It does not hold pressure perfectly constant or eliminate all downstream elastic water-hammer waves; losses are needed to damp oscillation.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00038",
                            "set": 6,
                ...
                {
                    "id": "check-hydr626-00039",
                    "status": "review",
                    "prompt": "What is the function of a surge tank function?",
                    "html": "<p><strong>A surge tank mitigates selected pressure variations.</strong> It accepts or supplies water while conveyance flow adjusts. It does not hold pressure perfectly constant or eliminate all downstream elastic water-hammer waves; losses are needed to damp oscillation.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00039",
                ...
                {
                    "id": "check-hydr626-00040",
                    "status": "review",
                    "prompt": "Which is used to protect turbine and runner from damage",
                ...
                {
                    "id": "check-hydr626-00041",
                    "status": "review",
                    "prompt": "The function of a surge tank is to",
                    "html": "<p>It does not ensure constant pressure or eliminate every downstream elastic transient. </p><p>Open-tank mass oscillation is gravity-restored, and damping requires losses; the ideal lossless oscillator does not damp itself.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00041",
                            "set": 6,
                ...
                {
                    "id": "check-hydr626-00044",
                    "status": "review",
                    "prompt": "What is the function of a surge tank?",
                    "html": "<p><strong>Mitigation is not elimination:</strong> a surge tank accepts or supplies water while the conveyance flow adjusts, reducing specified pressure variations. </p><p>It does not ensure constant pressure or eliminate every downstream elastic transient. </p><p>Open-tank mass oscillation is gravity-restored, and damping requires losses; the ideal lossless oscillator does not damp itself.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00044",
                            "set": 6,
                ...
                {
                    "id": "check-hydr626-00045",
                    "status": "review",
                    "prompt": "Which one of the following methods of tunneling is used in hard rocks?",
                    "html": "<p><strong>Method choice is qualified:</strong> heading and benching is a conventional rock-tunnelling arrangement, but is not restricted to perfectly self-supporting hard rock. </p><p>Shields are not exclusively soft-ground equipment.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00045",
                            "set": 6,
                ...
                {
                    "id": "check-hydr626-00046",
                    "status": "review",
                    "prompt": "Which of the following drainage is not used in tunnel?",
                ...
                {
                    "id": "check-hydr626-00048",
                    "status": "review",
                    "prompt": "Which one of the following linings is suitable for shield driven tunnels particularly in the subaqueous regions?",
                    "html": "<p><strong>Cast iron is historically suitable, not uniquely possible:</strong> modern concrete segmental linings may also suit shield-driven subaqueous tunnels. </p><p>Two of these records offer concrete as well, making exclusivity questionable without more context. </p>",
                    "sources": [
                        {
                            "id": "HYDR626-00048",
                            "set": 7,
                ...
                {
                    "id": "check-hydr626-00049",
                    "status": "review",
                    "prompt": "A flow control valve at the end of a 1 km long pipe is closed gradually in 10 seconds. If the rise of pressure head due to water hammer is 20 meters of water. What the velocity of water before the valve closure?",
                ...
                {
                    "id": "check-hydr626-00050",
                    "status": "review",
                    "prompt": "The velocity of propagation of water hammer pressure in a pipe carrying water and having diameter = 40 cm, pipe thickness = 4 mm, with E (Modulus of elasticity) of the pipe material =2.1×10^11 Pa, and K (Bulk modulus of water) =2.1×10^9 Pa, is",
                ...
                {
                    "id": "check-hydr626-00051",
                    "status": "review",
                    "prompt": "In high head hydro power, tplanthe velocity of water in penstock is about",
                ...
                {
                    "id": "check-hydr626-00068",
                    "status": "review",
                    "prompt": "Penstock in a hydroelectric power plant is",
                    "html": "<p><strong>A penstock supplies the turbine under pressure:</strong> connection to a scroll case describes applicable reaction-turbine arrangements, not every turbine. </p><p>An impulse machine can be supplied through manifolds and nozzles. </p><p>Wall adequacy is governed by the complete load and pressure envelope, not surge pressure alone.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00068",
                            "set": 9,
                ...
                {
                    "id": "check-hydr626-00128",
                    "status": "review",
                    "prompt": "Forebay provides temporary storage before the water goes to the turbine. Following perform the function of forebay",
                ...
                {
                    "id": "check-hydr626-00151",
                    "status": "review",
                    "prompt": "Penstocks are made up of ______.",
                    "html": "<p><strong>Steel and mild steel overlap:</strong> mild steel belongs to the broader steel category, so the Model 17 options are not mutually exclusive. </p><p>Steel is common but not the only possible penstock material. </p>",
                    "sources": [
                        {
                            "id": "HYDR626-00151",
                            "set": 17,
                ...
                {
                    "id": "check-hydr626-00152",
                    "status": "review",
                    "prompt": "A penstock in a hydroelectric power plant is:",
                    "html": "<p><strong>A penstock supplies the turbine under pressure:</strong> connection to a scroll case describes applicable reaction-turbine arrangements, not every turbine. </p><p>An impulse machine can be supplied through manifolds and nozzles. </p><p>Wall adequacy is governed by the complete load and pressure envelope, not surge pressure alone.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00152",
                ...
                {
                    "id": "check-hydr626-00153",
                    "status": "review",
                    "prompt": "Which statement about a surge tank is wrong?",
                    "html": "<p><strong>These wrong-statement items are inconsistent:</strong> one keys total closure and the other exact turbine-inlet location. </p><p>A conventional open tank is vented, but a <strong>closed air-cushion chamber does work</strong>. </p><p>Exact turbine-inlet placement is also not universal. </p><p>Tank type and layout must be identified; choosing one stored answer does not make every other statement correct.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00153",
                ...
                {
                    "id": "check-hydr626-00154",
                    "status": "review",
                    "prompt": "The phenomenon of formation of vapour bubbles and sudden collapsing of the vapour bubbles in the penstock is called as:",
                    "html": "<p><strong>Cavitation needs the missing pressure condition:</strong> compare local absolute pressure with water vapour pressure at the relevant temperature. </p><p>Negative gauge pressure alone is insufficient. </p><p>Vapour can collapse after pressure recovery elsewhere or later in the transient, not necessarily at the point of formation.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00154",
                            "set": 18,
                ...
                {
                    "id": "check-hydr626-00155",
                    "status": "review",
                    "prompt": "Which phenomenon in a pipe flow is termed as water hammer?",
                    "html": "<p><strong>Water hammer is broader than the familiar example:</strong> sudden downstream closure can produce a pressure rise in a penstock, but transients also include pressure drops and reflected waves. </p><p>Other closed hydraulic passages can experience them. </p><p>Gradual changes are not automatically transient-free, and a perfectly rigid instantaneous-stop singularity is not physically infinite pressure.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00155",
                            "set": 18,
                ...
                {
                    "id": "check-hydr626-00156",
                    "status": "review",
                    "prompt": "Which section of a tunnel is most suitable for structural consideration?",
                    "html": "<p><strong>A circular section is efficient for internal pressure and near-uniform radial loading.</strong> Anisotropic ground stress, discontinuities, deformation and buckling can govern differently. It is not inherently strongest for every tunnel condition.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00156",
                            "set": 18,
                ...
                {
                    "id": "check-hydr626-00157",
                    "status": "review",
                    "prompt": "Which section of a tunnel is suitable where the tunnel is subjected to high internal pressure, but does not have good quality of rock and/or adequate rock cover around it?",
                    "html": "<p><strong>A circle does not cure inadequate confinement:</strong> high internal pressure in weak rock or near a low-confinement boundary needs an engineered lining, ground and leakage assessment. </p><p>Unspecified concrete and steel are not interchangeable pressure-containment solutions, and vertical cover alone does not exclude hydraulic jacking.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00157",
                            "set": 18,
                ...
                {
                    "id": "check-hydr626-00158",
                    "status": "review",
                    "prompt": "The valve closure is said to be gradual if the time required to close the valve is:",
                    "html": "<p><strong>2L/a is a model-specific return time:</strong> the general elementary gradual-closure criterion is T<sub>c</sub> &gt; 2L/a for a reservoir–pipe–valve system. </p><p>Particular multiples such as 4L/a or 5L/a can satisfy it but are not the defining boundary. </p><p>Longer closure does not guarantee zero pressure rise or identify the correct slow-closure formula.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00158",
                            "set": 18,
                ...
                {
                    "id": "check-hydr626-00159",
                    "status": "review",
                    "prompt": "To attain the required shape of the tunnel section, we use:",
                ...
                {
                    "id": "check-hydr626-00160",
                    "status": "review",
                    "prompt": "For the full face method, the excavation to be done is generally divided into:",
                    "html": "<p><strong>Three face zones are not three excavation stages:</strong> full-face means the whole cross-section is advanced as one stage rather than as heading and bench portions. </p><p>Functional labels within the face do not contradict that definition. </p>",
                    "sources": [
                        {
                            "id": "HYDR626-00160",
                            "set": 18,
                ...
                {
                    "id": "check-hydr626-00161",
                    "status": "review",
                    "prompt": "Which one of the following is considered to be an advantage of the heading and benching method of tunnel construction?",
                    "html": "<p><strong>Method choice is qualified:</strong> heading and benching is a conventional rock-tunnelling arrangement, but is not restricted to perfectly self-supporting hard rock. </p><p>Possible overlap of work can help progress; it does not guarantee continuous excavation or eliminate support needs. </p>",
                    "sources": [
                        {
                            "id": "HYDR626-00161",
                            "set": 18,
                ...
                {
                    "id": "check-hydr626-00163",
                    "status": "review",
                    "prompt": "Which one of the following statements is not correct with regard to heading and trenching method of tunnelling?",
                ...
                {
                    "id": "check-hydr626-00164",
                    "status": "review",
                    "prompt": "Forepoling method is generally adopted for tunnelling in:",
                ...
                {
                    "id": "check-hydr626-00165",
                    "status": "review",
                    "prompt": "If 'D' is the diameter of tunnel in meters, then the thickness of lining in mm, as per the empirical formula is given by:",
                    "html": "<p><strong>42D is a legacy numerical-unit proportion:</strong> t in mm = 42 times D in m corresponds to t = 0.042D in consistent length units. </p><p>Its technical provenance and applicability remain unverified. </p><p>The conversion is correct, but it is not a structural lining calculation, universal minimum thickness or verified current-code clause.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00165",
                            "set": 19,
                ...
                {
                    "id": "check-hydr626-00166",
                    "status": "review",
                    "prompt": "In case of drift method of tunnelling, the drift may be excavated at:",
                    "html": "<p><strong>Drift position is flexible, and rock is not an exclusive definition:</strong> top, centre and bottom pilot openings are possible according to their purpose and ground conditions. </p><p>A drift's investigation or access function does not establish stability of the eventual full opening.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00166",
                            "set": 19,
                ...
                {
                    "id": "check-hydr626-00169",
                    "status": "review",
                    "prompt": "The method of draining in the tunnels, is generally known as:",
                    "html": "<p><strong>Drainage terms are not interchangeable synonyms:</strong> dewatering can use gravity or pumping; foredrainage describes control ahead of excavation; permanent drainage describes service life. </p><p>An all-of-the-above response can describe applicable categories only with suitable wording. </p><p>Neither record demonstrates a complete drainage layout or zero groundwater pressure.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00169",
                            "set": 19,
                ...
                {
                    "id": "check-hydr626-00171",
                    "status": "review",
                    "prompt": "Circular section of tunnels is not suitable for:",
                    "html": "<p><strong>Non-cohesive soil does not prohibit circular tunnels:</strong> engineered circular shield and segmental systems can be used in such ground. </p><p>An unsupported opening may be unstable, but that is not the same as a supported tunnel being geometrically unsuitable. </p><p>Face stability, support and groundwater control determine feasibility.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00171",
                            "set": 19,
                ...
                {
                    "id": "check-hydr626-00172",
                    "status": "review",
                    "prompt": "Drifters can be used to drill:",
                    "html": "<p><strong>Drifter capability depends on the equipment:</strong> horizontal, upward and downward orientations are possible where mounting and positioning permit. </p><p>The explanation's pneumatic and track-mounted description is not a definition of every drifter. </p><p>This is equipment vocabulary, not a drilling procedure.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00172",
                            "set": 19,
                ...
                {
                    "id": "check-hydr626-00173",
                    "status": "review",
                    "prompt": "Which of the following lining materials is useful for shield driven tunnels in sub aqueous regions?",
                    "html": "<p>Two of these records offer concrete as well, making exclusivity questionable without more context. </p><p>Joints, seals and the complete lining system determine watertightness; a material label does not guarantee it.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00173",
                            "set": 20,
                ...
                {
                    "id": "check-hydr626-00174",
                    "status": "review",
                    "prompt": "The most suitable soil for compressed air tunneling is:",
                    "html": "<p><strong>Low permeability explains the clay heuristic, not a complete method choice:</strong> reduced air loss can be advantageous in the historical compressed-air context. </p><p>Ground stability, groundwater and specialist safety requirements remain separate. </p>",
                    "sources": [
                        {
                            "id": "HYDR626-00174",
                            "set": 20,
                ...
                {
                    "id": "check-hydr626-00175",
                    "status": "review",
                    "prompt": "Drift method of tunnelling is used to construct tunnels in:",
                    "html": "<p><strong>Drift position is flexible, and rock is not an exclusive definition:</strong> top, centre and bottom pilot openings are possible according to their purpose and ground conditions. </p><p>Rock is a conventional application, but it can also be broken or require support. </p><p>A drift's investigation or access function does not establish stability of the eventual full opening.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00175",
                            "set": 20,
                ...
                {
                    "id": "check-hydr626-00176",
                    "status": "review",
                    "prompt": "Whenever closed conduits are used in hydroelectric power plant, ______ is/are used to limit the abnormal pressure in the conduit.",
                    "html": "<p><strong>Whenever is too broad:</strong> a surge chamber is one means of limiting abnormal pressure, not a compulsory identical feature of every closed conduit. </p><p>The need and arrangement depend on hydraulic length, pressure-wave behaviour, machine controls, allowable pressure range and the complete protective system.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00176",
                            "set": 20,
                ...
                {
                    "id": "check-hydr626-00178",
                    "status": "review",
                    "prompt": "Location of a surge tank, in a hydro electric power station is near the:",
                    "html": "<p><strong>Near the turbine is relative, not an exact location:</strong> a conventional surge connection is often near the headrace–penstock transition. </p><p>Geology, elevation, operating hydraulic level, access and remaining pressure-conduit length control placement. </p><p>It need not be physically as close as possible to the runner or exactly at its inlet.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00178",
                            "set": 20,
                ...
                {
                    "id": "check-hydr626-00179",
                    "status": "review",
                    "prompt": "The surge tank controls the water when the load on the turbine is:",
                    "html": "<p><strong>The tank responds to load increases and decreases.</strong> Reduced turbine flow usually causes initial upsurge; increased demand initially draws water from storage. Later oscillations can reverse those tendencies.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00179",
                            "set": 20,
                ...
                {
                    "id": "check-hydr626-00180",
                    "status": "review",
                    "prompt": "What parameter is commonly used to determine the diameter of a hydropower tunnel?",
                ...
                {
                    "id": "check-hydr626-00181",
                    "status": "review",
                    "prompt": "Which parameter is crucial in determining the size of a forebay?",
                ...
                {
                    "id": "check-hydr626-00182",
                    "status": "review",
                    "prompt": "What is the main function of a surge tank in a hydropower plant?",
                    "html": "<p><strong>Mitigation is not elimination:</strong> a surge tank accepts or supplies water while the conveyance flow adjusts, reducing specified pressure variations. </p><p>Open-tank mass oscillation is gravity-restored, and damping requires losses; the ideal lossless oscillator does not damp itself.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00182",
                            "set": 21,
                ...
                {
                    "id": "check-hydr626-00183",
                    "status": "review",
                    "prompt": "Which factor is NOT considered in the design of a penstock for a high-head hydropower plant?",
                ...
                {
                    "id": "check-hydr626-00184",
                    "status": "review",
                    "prompt": "Location of a surge tank, in a hydro electric power station is near",
                    "html": "<p><strong>Near the turbine is relative, not an exact location:</strong> a conventional surge connection is often near the headrace–penstock transition. </p><p>Geology, elevation, operating hydraulic level, access and remaining pressure-conduit length control placement. </p><p>It need not be physically as close as possible to the runner or exactly at its inlet.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00184",
                ...
                {
                    "id": "check-hydr626-00188",
                    "status": "review",
                    "prompt": "Penstocks are made up of ______",
                    "html": "<p><strong>Material wording is defective.</strong> “Wild steel” is not a penstock specification. Steel is common, but actual material, strength, joints and pressure rating depend on the design; a generic name does not establish them.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00188",
                            "set": 21,
                ...
                {
                    "id": "check-hydr626-00191",
                    "status": "review",
                    "prompt": "Which one section of tunnel is most suitable for structural consideration",
                    "html": "<p><strong>A circular section is efficient for internal pressure and near-uniform radial loading.</strong> Anisotropic ground stress, discontinuities, deformation and buckling can govern differently. It is not inherently strongest for every tunnel condition.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00191",
                ...
                {
                    "id": "check-hydr626-00192",
                    "status": "review",
                    "prompt": "Which one section of tunnel is suitable where the tunnel is subjected to high internal pressure, but does not have good quality of rock for adequate rock cover around it",
                    "html": "<p><strong>A circle does not cure inadequate confinement:</strong> high internal pressure in weak rock or near a low-confinement boundary needs an engineered lining, ground and leakage assessment. </p><p>Unspecified concrete and steel are not interchangeable pressure-containment solutions, and vertical cover alone does not exclude hydraulic jacking.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00192",
                ...
                {
                    "id": "check-hydr626-00194",
                    "status": "review",
                    "prompt": "For full face method, the excavation to be done is generally divided into",
                    "html": "<p><strong>Three face zones are not three excavation stages:</strong> full-face means the whole cross-section is advanced as one stage rather than as heading and bench portions. </p><p>Functional labels within the face do not contradict that definition. </p><p>Entire face does not require simultaneous removal of every point at one instant.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00194",
                            "set": 22,
                ...
                {
                    "id": "check-hydr626-00201",
                    "status": "review",
                    "prompt": "Which of the following lining material is useful for shield driven tunnels in sub aqueous regions?",
                    "html": "<p>Two of these records offer concrete as well, making exclusivity questionable without more context. </p><p>Joints, seals and the complete lining system determine watertightness; a material label does not guarantee it.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00201",
                ...
                {
                    "id": "check-hydr626-00202",
                    "status": "review",
                    "prompt": "The most suitable soil for compressed atmosphere is",
                    "html": "<p>Ground stability, groundwater and specialist safety requirements remain separate. </p><p>Compressed atmosphere is incomplete terminology; no suitable working pressure or exposure condition follows from either question.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00202",
                            "set": 23,
                ...
                {
                    "id": "check-hydr626-00204",
                    "status": "review",
                    "prompt": "Whenever closed conduits are used in hydroelectric power plant, ______ is used to limit the abnormal pressure in the conduit.",
                    "html": "<p><strong>Whenever is too broad:</strong> a surge chamber is one means of limiting abnormal pressure, not a compulsory identical feature of every closed conduit. </p><p>The need and arrangement depend on hydraulic length, pressure-wave behaviour, machine controls, allowable pressure range and the complete protective system.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00204",
                ...
                {
                    "id": "check-hydr626-00205",
                    "status": "review",
                    "prompt": "Water hammer is developed in a",
                    "html": "<p><strong>Water hammer can occur in closed hydraulic passages.</strong> Rapid flow changes produce pressure waves, including rises, drops and reflections. A penstock is a familiar example, not the only possible location.</p>",
                    "sources": [
                        {
                            "id": "HYDR626-00205",
                            "set": 23,
