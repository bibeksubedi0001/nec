(function () {
    ...
    Object.assign(registry, {
        ACiE0903: {
            ...
            blocks: [
                {
                    ...
                    html: "<p><strong>Geological origin explains how a rock formed; it does not certify road performance.</strong> Aggregates form the load-carrying skeleton of granular and asphalt layers. Their mineralogy, weathering, shape, grading and interaction with water and binder all matter. </p><table><thead><tr><th scope='col'>Origin</th><th scope='col'>Formation and examples</th><th scope='col'>Material-selection question</th></tr></thead><tbody><tr><th scope='row'>Igneous</th><td>Solidification of magma or lava; granite and basalt.</td><td>Is the actual material sound, rather than weathered, fractured or highly porous?</td></tr><tr><th scope='row'>Sedimentary</th><td>Deposition and consolidation, or chemical accumulation; sandstone and limestone.</td><td>Are cementation, bedding and resistance to wetting adequate?</td></tr><tr><th scope='row'>Metamorphic</th><td>Transformation of existing rock by heat and pressure; quartzite, gneiss and marble.</td><td>Will foliation, cleavage or polishing behaviour impair the proposed use?</td></tr></tbody></table><p>Selection proceeds from source investigation and representative sampling to tests appropriate to the intended course, followed by comparison with an identified specification. A test method defines how an index is obtained; an application specification decides what is acceptable. These notes cover official 9.3 materials, asphalt mixes and subgrade evaluation. </p>",
                    moreHtml: "<p>A strong intact rock can still produce an unsuitable aggregate if crushing creates excessive flakes or the delivered stockpile contains weak, dirty particles.</p><p>Sound igneous rocks are often useful roadstones, but good sedimentary and metamorphic sources also exist. The bank's igneous answer is a broad tendency, not a unique strength classification. Ordinary crushed stone, gravel and sand are conventionally <strong>normal-weight aggregates</strong>; normal weight is neither a specified crushing resistance nor proof of durability.</p><p>References identify inspected editions, not current adoption or construction approval, and all </p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>The familiar coarse/fine division uses the 4.75 mm IS sieve.</strong> IS 383:1970 defines fine aggregate as material mostly passing that sieve, with only the permitted coarser fraction; coarse aggregate is mostly retained. Thus the bank's two size classes and less-than-4.75-mm answers are useful introductory descriptions, not guarantees that every particle in a supplied sand passes the boundary sieve.</p><p>Asphalt specifications additionally control <strong>mineral filler</strong>, the very fine mineral component contributing to the binder–filler mastic. The key conversion is <strong>0.075 mm = 75 μm</strong>, not 0.75 mm or 75 mm. </p><p>In the inspected DoR specifications, 2073 with Third Amendment 2082, <strong>Table 13.27</strong> permits <strong>85–100% passing 0.075 mm</strong> for DBM mineral filler. It also controls the coarser filler sieves. The 75 μm answer therefore names a control sieve; it does not mean that 100% must pass it, or that the whole asphalt aggregate blend should have the filler grading.</p><p>The coarse/fine boundary is itself application-dependent: the DBM material clauses use <strong>2.36 mm for their 13.2 mm NMAS case</strong>, rather than the 4.75 mm boundary used for the larger listed NMAS cases. Read the relevant mix definition before assigning fractions. </p>",
                    moreHtml: "<p>Approved rock dust, hydrated lime or cement may serve this function, subject to the specified grading and other requirements; any dusty or clay-rich waste is not automatically acceptable filler.</p><p>More fines increase surface area and can increase binder demand, while unsuitable plastic fines impair moisture resistance; fineness alone is not quality.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Sieve analysis measures particle-size distribution; production screening separates stockpiles.</strong> Obtain a representative sample, reduce it without preferentially selecting large or small particles, condition it as the method requires, and sieve from coarse to fine. </p><p>If M is the original dry sample mass and m<sub>i</sub> is the mass retained on sieve i, <strong>retained percentage = 100m<sub>i</sub>/M</strong>. Cumulative retained percentage sums that sieve and all coarser sieves; <strong>percentage passing = 100 − cumulative percentage retained</strong>. </p><p><strong>Hypothetical illustration, not bank data:</strong> a 1000 g sample has 100 g retained on 19 mm and a further 250 g retained on 9.5 mm, with no intermediate sieve in this illustrative account. Passing percentages are 90% at 19 mm and 65% at 9.5 mm. The 250 g is an individual retained mass, not the cumulative retained mass of 350 g.</p><p>For blending, let f<sub>i</sub> be each stockpile's dry mass fraction, with Σf<sub>i</sub> = 1. At each sieve, <strong>P<sub>blend</sub> = Σf<sub>i</sub>P<sub>i</sub></strong>. Hypothetically, mixing 60% of stock A passing 20% and 40% of stock B passing 80% gives <strong>44% passing</strong> that sieve. </p>",
                    moreHtml: "<p>Avoid overloading or forcing particles through apertures. Where the specification requires wet sieving, use the prescribed washing procedure to separate adhering fines rather than assuming dry shaking removes them.</p><p>Include the pan in the mass-recovery check. For a correctly ordered sieve series, percentage passing cannot increase as the aperture becomes smaller.</p><p>Satisfying one sieve cannot establish an acceptable blend: check the whole envelope, continuity, segregation risk and ingredient quality.</p>",
                ...
                },
                {
                    ...
                    html: "<p><strong>A base course does not have one universal maximum aggregate size.</strong> WBM, WMM, BM, DBM and other bases have different grading envelopes and construction requirements. </p><p>A common <strong>maximum-size</strong> description is the smallest specified sieve through which all the material passes. The inspected DoR asphalt-table notes define <strong>nominal maximum aggregate size, NMAS, as one sieve size larger than the first sieve retaining more than 10% of the material</strong>. Retain the document's sieve series and definition; maximum and NMAS need not be identical.</p><p><strong>Hypothetical illustration:</strong> suppose 100%, 95% and 80% pass successive 19, 13.2 and 9.5 mm sieves, and all larger sieves pass 100%. Individual retention is 5% on 13.2 mm and 15% on 9.5 mm. Under that NMAS convention, <strong>NMAS is 13.2 mm</strong>, while the all-passing maximum-size sieve is <strong>19 mm</strong>. This example is not a recovered bank grading.</p><p>DoR Table 13.33 labels its BC gradings <strong>19 mm and 13.2 mm NMAS</strong>. Neither is 19.5 mm. The bank's 50 mm base answer lacks a product and grading, while its 19.5 mm surface answer does not match the 19 mm or 13.2 mm in its explanation. </p>",
                    moreHtml: "<p>Particle size must suit the selected product, compacted lift, equipment and required surface. Large particles in too thin a lift can bridge, segregate or prevent uniform compaction; selecting a nominal size alone does not design the layer.</p><p>Do not round a specified sieve designation to the nearest offered option or reconstruct a missing grading chart from memory.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Shape controls packing, interlock and susceptibility to particle breakage.</strong> Angular, reasonably cubical particles can mobilise more interlock than rounded particles under comparable grading, binder and compaction conditions. </p><p>For a prescribed sieve fraction, let <strong>d<sub>mean</sub> = (d<sub>upper</sub> + d<sub>lower</sub>)/2</strong>. In the archived IS 2386 Part I method, a flaky particle has <strong>thickness &lt; 0.6d<sub>mean</sub></strong>; an elongated particle has <strong>length &gt; 1.8d<sub>mean</sub></strong>. These shape tests apply to the relevant coarse-aggregate sieve fractions and are not applied to material smaller than 6.3 mm under that method.</p><p><strong>Hypothetical shape example:</strong> for particles passing 20 mm and retained on 16 mm, the mean sieve size is 18 mm. The thickness boundary is <strong>10.8 mm</strong> and the length boundary is <strong>32.4 mm</strong>. The 0.6 ratio classifies a particle; it does not permit 60% of a stockpile to be flaky. </p>",
                    moreHtml: "<p>Excessively thin or elongated particles may orient unfavourably and break during compaction or traffic. Sharp sand is therefore a conditional stability preference, not a guarantee independent of the rest of the mix.</p><p>A flakiness index instead expresses the mass of classified flaky material relative to the eligible tested mass, using the prescribed fraction weighting.</p><p>Combined flakiness/elongation acceptance needs its own procedure. The DoR DBM table note first removes flaky particles, then determines elongation on the remaining non-flaky material using that remaining mass as its denominator before adding the stated indices. Do not substitute the sum of two independently measured, overlapping whole-sample percentages. The bank's three-fifths wording is a dimensional definition, not an application acceptance limit.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Aggregate bulk density includes the spaces between particles in the measuring container.</strong> It depends on grading, particle shape, moisture and how the container is filled or compacted. </p><p>For dry aggregate mass M in container volume V, <strong>ρ<sub>bulk</sub> = M/V</strong>. If the compatible particle density is G<sub>s</sub>ρ<sub>w</sub>, its represented particle volume is M/(G<sub>s</sub>ρ<sub>w</sub>). Subtracting that volume from V gives <strong>n = 1 − ρ<sub>bulk</sub>/(G<sub>s</sub>ρ<sub>w</sub>)</strong>. The percentage is 100n. Porosity uses total volume as denominator; void ratio instead uses the represented particle volume.</p><p><strong>Assigned calculation:</strong> take the stated 2.6 kg/L as dry packing bulk density, G<sub>s</sub> = 2.8 on the corresponding particle-volume basis, and the exercise approximation ρ<sub>w</sub> = 1 kg/L. Then <strong>100(1 − 2.6/2.8) = 7.142857…% ≈ 7.1429%</strong>, or 7.1% to one decimal place. Both offered <strong>A: 7.1 and B: 7.10 denote the same number</strong>; the stored A choice is not numerically unique.</p><p>With bulk-dry particle gravity, the calculated spaces exclude pores already included inside particle envelopes. Using apparent or true-solid gravity changes what is counted as void volume. Wet density must not be divided by a dry-particle density without correction. This conditional bank example does <strong>not</strong> identify G<sub>mm</sub> from aggregate G<sub>s</sub> or calculate asphalt air voids.</p>",
                    moreHtml: "<p>Particle specific gravity describes a different volume. Neither a loose aggregate packing density nor its particle specific gravity is automatically a compacted-asphalt or voidless-mixture property.</p>",
                ...
                },
                {
                    ...
                    html: "<p><em>Syllabus extension: aggregate absorption and specific-gravity measurements.</em> No assigned question supplies a full oven-dry, saturated-surface-dry and immersed mass dataset. The following example is hypothetical, using the displacement principles of the archived IS 2386 Part III methods.</p><p>For a suitable coarse-aggregate immersion method, call the oven-dry mass M<sub>d</sub>, the saturated-surface-dry mass in air M<sub>SSD</sub>, and the immersed apparent mass, corrected for the basket, M<sub>sub</sub>. </p><ul><li><strong>Particle-envelope volume:</strong> (M<sub>SSD</sub> − M<sub>sub</sub>)/ρ<sub>w</sub>.</li><li><strong>Bulk-dry particle gravity G<sub>sb</sub>:</strong> M<sub>d</sub>/(M<sub>SSD</sub> − M<sub>sub</sub>).</li><li><strong>SSD particle gravity:</strong> M<sub>SSD</sub>/(M<sub>SSD</sub> − M<sub>sub</sub>).</li><li><strong>Apparent particle gravity G<sub>sa</sub>:</strong> M<sub>d</sub>/(M<sub>d</sub> − M<sub>sub</sub>); the denominator excludes the water-permeable pore volume.</li><li><strong>Water absorption:</strong> 100(M<sub>SSD</sub> − M<sub>d</sub>)/M<sub>d</sub>, percent of dry aggregate mass.</li></ul><p><strong>Hypothetically</strong>, M<sub>d</sub> = 2600 g, M<sub>SSD</sub> = 2640 g and M<sub>sub</sub> = 1640 g give G<sub>sb</sub> = <strong>2.600</strong>, SSD gravity <strong>2.640</strong>, G<sub>sa</sub> ≈ <strong>2.7083</strong> and water absorption ≈ <strong>1.5385%</strong>. At ρ<sub>w</sub> = 1 g/cm<sup>3</sup>, the envelope occupies 1000 cm<sup>3</sup>.</p>",
                    moreHtml: "<p>SSD means the accessible pores have been conditioned with water but external free water has been removed. It does not mean oven dry.</p><p>Control conditioning time, temperature, trapped air and the SSD endpoint. Fine aggregate needs the method appropriate to its size, not an improvised basket test. Water absorption is not identical to bitumen absorption: the fluids, conditioning and accessible pore volumes differ. Use measured asphalt-mixture properties to determine effective binder rather than subtracting the water-absorption percentage from binder content.</p>",
                    sources: []
                },
                {
                    id: "materials-acv-method-and-force",
                    title: "ACV measures fines formed under a specified compressive loading",
                    html: "<p><strong>Aggregate crushing value, ACV, is a percentage index, not the breaking load of a single stone.</strong> The archived IS 2386 Part IV:1963 standard test uses the aggregate fraction <strong>passing 12.5 mm and retained on 10 mm</strong>. The post-loading fines are assessed on <strong>2.36 mm</strong>; that is not the lower preparation sieve.</p><ol><li>Prepare the prescribed surface-dry sample. If heat drying is used, follow the method's conditioning requirements and cool before testing.</li><li>Measure the quantity, then place it in the nominal 150 mm cylindrical test cell in three approximately equal layers, <strong>25 tamping strokes per layer</strong>. Level the surface and seat the plunger horizontally without jamming.</li><li>Apply the compressive load uniformly so the specified <strong>40 tonne-force is reached in 10 minutes</strong>. The amended apparatus-capability wording does not turn this into an arbitrary rapid-loading test.</li><li>Unload, recover the material without losing fines, sieve on 2.36 mm and determine the passing mass.</li></ol><p><strong>ACV = 100M<sub>fines</sub>/M<sub>sample</sub>.</strong> Hypothetically, 600 g of fines from a 3000 g sample gives <strong>20%</strong>; these masses are illustrative, not bank givens. The archived method uses duplicate tests and specified rounding for the reported mean. </p><p><strong>Force conversion:</strong> 1 tf = 9.80665 kN, so <strong>40 tf = 392.266 kN</strong>, conventionally rounded to <strong>400 kN</strong>. It is not 4000 N, which is only 4 kN. The bank's 40 ton wording intends a force; its 4000n version has no correct option. Crushing-before-full-load wording should not be read as a required early catastrophic failure.</p>",
                    moreHtml: "<p>Changing the tested size or using the smaller apparatus requires its particular provisions and can change comparability.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>A low degradation percentage generally means better resistance under that particular test.</strong> ACV measures fines under gradually applied compression; AIV measures fines under repeated impact; LA measures degradation from tumbling, abrasion and impact. They share a percentage form but do not measure an identical failure process.</p><table><thead><tr><th scope='col'>Measure</th><th scope='col'>Reported quantity</th><th scope='col'>Direction of greater resistance</th></tr></thead><tbody><tr><th scope='row'>ACV</th><td>Fines percentage under the specified load.</td><td>Lower, within the method's applicable range.</td></tr><tr><th scope='row'>AIV</th><td>Fines percentage after the specified blows.</td><td>Lower.</td></tr><tr><th scope='row'>LA loss</th><td>Percentage mass lost from the retained test fraction.</td><td>Lower.</td></tr><tr><th scope='row'>Ten-percent-fines value</th><td>Load required to produce the defined fines percentage.</td><td>Higher load, not lower percentage.</td></tr></tbody></table><p>The archived IS 2386 Part IV ACV scope warns that <strong>ACV of 30 or higher may give anomalous results</strong> and directs use of the ten-percent-fines value instead. This is a <strong>test-method limitation</strong>, not a rule that every material giving 30% must be rejected for every road layer.</p><p>The two assigned less-than-10/above-35 stems omit the test. One explanation calls the measure ACV and the other calls it AIV. Strong/weak is the intended qualitative direction, but those descriptors are not universal acceptance classes. </p>",
                    moreHtml: "<p>Likewise, neither percentage is an unconfined compressive stress in MPa. State the test, size fraction, conditioning, repeatability and intended application before drawing a material-selection conclusion.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Aggregate impact value, AIV, characterises resistance to sudden shock.</strong> Under the archived IS 2386 Part IV method, the prepared dry sample passes 12.5 mm and is retained on 10 mm. A 13.5–14.0 kg hammer falls approximately <strong>380 mm</strong>, with the specified 5 mm tolerance, for <strong>15 blows</strong> at intervals of at least one second.</p><p>Preparation details must not be confused with ACV: fill the measuring cylinder in three layers with 25 strokes each to establish the sample quantity, then transfer the whole sample to the secured impact cup and give it <strong>one tamping of 25 strokes</strong>. After impact, separate the fines on the <strong>2.36 mm sieve</strong>. Weigh passing and retained fractions; the archived procedure rejects a result when their recovered total is more than 1 g below the initial mass, and requires a fresh test.</p><p><strong>AIV = 100M<sub>passing</sub>/M<sub>initial</sub>.</strong> In the assigned example, initial mass is 300 g and retained mass is 180 g. With the exercise's implied mass conservation, passing mass is <strong>300 − 180 = 120 g</strong>. Hence <strong>AIV = 100 × 120/300 = 40%</strong>.</p><p>The fraction 120/300 is <strong>0.4</strong>; 0.4% would instead mean a fraction of 0.004. The other assigned problem, with 60% retained, leaves <strong>40% passing</strong> and gives the same percentage AIV. </p>",
                    moreHtml: "<p>Use duplicate results and method-specific reporting, then compare with the applicable course limit. A high retained fraction indicates less degradation only when the initial sample and recovery basis are comparable.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>A test result becomes an acceptance decision only through an applicable specification.</strong> The following are maximum percentage values in the inspected DoR <strong>Standard Specifications, 2073 with Third Amendment 2082</strong>. </p><table><thead><tr><th scope='col'>Product and table</th><th scope='col'>LA max, %</th><th scope='col'>AIV max, %</th></tr></thead><tbody><tr><th scope='row'>WBM base, 12.5</th><td>40</td><td>30</td></tr><tr><th scope='row'>WBM subbase, 12.5</th><td>45</td><td>40</td></tr><tr><th scope='row'>Penetration macadam, 13.17</th><td>40</td><td>30</td></tr><tr><th scope='row'>BM, 13.24</th><td>40</td><td>30</td></tr><tr><th scope='row'>DBM, 13.26</th><td>35</td><td>27</td></tr><tr><th scope='row'>BC, 13.32</th><td>30</td><td>24</td></tr><tr><th scope='row'>Surface dressing, 13.13</th><td>35</td><td>27</td></tr></tbody></table><p>For water-softening WBM aggregate, Table 12.5 directs the wet impact method. The <strong>WBM base AIV limit is 30%, not 40%</strong> in this DoR table; 40% is its base LA limit and its subbase AIV limit. </p><p><strong>Assigned LA example:</strong> 1.88 kg out of 5 kg passing the final sieve represents <strong>37.6%</strong> loss. Against this table it satisfies the penetration-macadam LA limit, but not DBM, BC or surface dressing. </p><p>Keep concrete separate. <strong>IS 383:1970 §3.4</strong> gives AIV not exceeding <strong>30% for concrete wearing surfaces</strong>, including road/runway examples, and <strong>45% for other concrete</strong>, as an alternative to its crushing-value assessment. This supports a historical concrete-specific distinction, not a 30% rule for every asphalt wearing course. Not exceeding also allows equality; it is not the bank's strict less-than wording.</p>",
                    moreHtml: "<p>They are not attributed to an unidentified Indian chart and do not replace project requirements or the other material tests.</p><p>The bank's Indian-conditions stems do not name a verifiable Indian edition, and one does not even name the test.</p><p>That is an <strong>LA-only comparison</strong>, not approval for penetration macadam and not proof of the stored generic surface-course choice.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Soundness testing assesses resistance to disruptive weathering processes.</strong> Prepared aggregate fractions undergo prescribed cycles of sulfate-solution immersion and drying. Salt crystallisation in accessible pores can cause breakdown. </p><table><thead><tr><th scope='col'>IS 383:1970 §3.6 general guide after five cycles</th><th scope='col'>Na<sub>2</sub>SO<sub>4</sub>, %</th><th scope='col'>MgSO<sub>4</sub>, %</th></tr></thead><tbody><tr><th scope='row'>Fine aggregate</th><td>10</td><td>15</td></tr><tr><th scope='row'>Coarse aggregate</th><td>12</td><td>18</td></tr></tbody></table><p>That historical concrete provision addresses <strong>exposure to frost</strong>, has limits set by purchaser–supplier agreement, and allows an aggregate failing the accelerated test if it passes a specified freezing-and-thawing test satisfactory to the user. The numbers in its note are general guidance within those conditions, not universal highway acceptance limits. The DoR DBM coarse-aggregate table separately gives sodium/magnesium maxima of 12/18%; its product scope remains necessary.</p><p>The bank's 12/18 answer therefore needs <strong>coarse aggregate</strong> and the relevant test/specification context. Its offered 10/15 pair is meaningful for the fine-aggregate guide. </p>",
                    moreHtml: "<p>After the specified cleaning, drying and size assessment, loss is calculated relative to the initial dry mass and combined using the method's fraction weighting.</p><p>It is an accelerated index, not a prediction of years of service or an exact physical reproduction of every freeze–thaw event. Sodium sulfate and magnesium sulfate are different test media; do not compare their numerical losses against the same unqualified limit. Test cycles, fraction sizes and conditioning must accompany a reported value.</p><p>Mechanical impact resistance, sulfate soundness, water absorption and concrete alkali reactivity examine different risks; passing one does not eliminate the others.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Water-bound macadam develops a mechanically interlocked coarse-aggregate skeleton.</strong> Rolling brings stones into stable contact. Screenings enter the larger voids; water helps fines move and the layer consolidate under rolling. </p><p>The bank's stone-dust and crushed-aggregate-dust answers express this conventional function. However, <strong>screenings and additional binding material are not automatically the same thing</strong>. DoR §1203 permits specified, predominantly non-plastic alternatives such as natural angular pit sand for screenings where allowed. </p>",
                    moreHtml: "<p>Suitable binding fines help prevent ravelling. This is not the hydration mechanism of a cement-treated base, nor the bituminous bond of a premixed asphalt layer.</p><p>Additional binding material is Engineer-approved with the prescribed properties; it may be unnecessary when the screenings are suitably crushable. The statement that sand can have no role in WBM is too absolute.</p><p>Material selection also depends on service. A shoulder supports pavement edges and can carry stopped vehicles, emergency manoeuvres or construction traffic. It is <strong>not a zero-load area</strong>. A footpath can have different loads, but still needs durability, drainage and a stable finished surface.</p><p>Waste brick or other recycled aggregate is therefore a candidate to investigate, not a blanket permission for shoulders. Characterise contamination, grading, wet breakdown, absorption, strength and compaction, and check the specific application requirements. A porous brick fraction may absorb considerable water and change grading through crushing. Neither shoulder nor footpath is uniquely established as acceptable by the bank's undefined insufficient-strength condition. The educational comparison does not approve recycled material for an untested project.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Bitumen is an organic, predominantly hydrocarbon binder.</strong> Refinery paving bitumen is obtained from petroleum processing, which supports the bank's petroleum answer. Natural bitumen also occurs in deposits and bituminous rocks; refinery origin is not the definition of every bituminous material. </p><table><thead><tr><th scope='col'>Material</th><th scope='col'>Distinction</th></tr></thead><tbody><tr><th scope='row'>Petroleum bitumen</th><td>A refined paving binder, selected and tested for the proposed mixture and climate.</td></tr><tr><th scope='row'>Coal tar</th><td>A product of destructive distillation of coal, historically used in some road applications; not petroleum bitumen.</td></tr><tr><th scope='row'>Wood tar</th><td>A different destructive-distillation product, showing why generic tar does not uniquely identify coal.</td></tr><tr><th scope='row'>Cement and lime</th><td>Inorganic materials with different binding mechanisms. Not every lime is a hydraulic binder.</td></tr></tbody></table>",
                    moreHtml: "<p>In pavement-mixture usage, asphalt concrete means the designed mixture of aggregate, filler and bituminous binder, not just a container of neat binder.</p><p>The tar question is uniquely coal only when <strong>coal tar</strong> is intended: its wood option can also produce a tar. Do not treat tar and bitumen as interchangeable products merely because both are dark and viscous. Product-specific health, compatibility and handling requirements also differ.</p><p>Stone, soil and mineral dust are permanent highway constituents in their appropriate roles. Petrol is normally a fuel, not a load-bearing paving constituent, so it is the intended contrast in the bank. However, petroleum distillates can be part of manufactured cutback binders; that fact does not authorise improvising a fuel–binder mixture on site. Water in an emulsion is a carrier, not a fossil-derived organic binder.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Cutbacks and emulsions reduce application viscosity by different mechanisms.</strong> A cutback contains bitumen and a petroleum distillate; its properties develop as the volatile component is lost. </p><table><thead><tr><th scope='col'>DoR Table 6.13 product</th><th scope='col'>Maximum water, percent by mass</th></tr></thead><tbody><tr><th scope='row'>RC cutback</th><td>0.2%</td></tr><tr><th scope='row'>MC cutback</th><td>0.2%</td></tr><tr><th scope='row'>SC cutback</th><td>0.5%</td></tr></tbody></table><p>These verified values belong to the <strong>2073 specifications with Third Amendment 2082</strong>. Table 6.12 for VG paving bitumen does not provide a universal 0.2% water-content row. Consequently, the bank's unqualified bitumen-moisture question does not uniquely specify a governing product.</p>",
                    moreHtml: "<p>Rapid-, medium- and slow-curing designations concern cutback behaviour. An emulsion disperses bitumen droplets in water with an emulsifying system; breaking and subsequent water loss permit a continuous binder film to develop.</p><p>Emulsion rapid-, medium- and slow-setting labels must not be confused with cutback curing classes. Aggregate mineralogy, charge, moisture, fines, weather and mixing conditions affect emulsion compatibility and breaking. Water is intentionally part of the emulsion, so an incidental-water limit for a different product cannot be imposed on the complete emulsion.</p><p>Distinguish supplied emulsion mass from residual bitumen mass in mix or spray calculations. Residue tests describe the binder left after the prescribed separation/conditioning, not the whole emulsion. Unexpected water in a hot-binder system can generate steam and foaming; compliance with a composition limit is not a safe-heating prescription. Use the specified product and controlled procedures, not ad hoc addition of water or fuel to hot bitumen.</p>",
                ...
                },
                {
                    ...
                    html: "<p><strong>Ductility is the extension of a standard binder briquette before its thread breaks.</strong> It is reported in cm, not as a stress or a penetration. The conventional pulling rate in the assigned question is <strong>5 cm/min = 50 mm/min</strong>. Temperature and whether the specimen is original binder or conditioned residue must accompany the result; the bank explanation's 27°C is not universal.</p><table><thead><tr><th scope='col'>DoR Table 6.12 grade</th><th scope='col'>Minimum RTFO-residue ductility at 25°C, cm</th></tr></thead><tbody><tr><th scope='row'>VG10</th><td>75</td></tr><tr><th scope='row'>VG20</th><td>50</td></tr><tr><th scope='row'>VG30</th><td>40</td></tr><tr><th scope='row'>VG40</th><td>25</td></tr></tbody></table><p>These are <strong>residue after rolling thin-film oven, RTFO, conditioning</strong> requirements, not four virgin-binder minima. Table 6.15 separately specifies <strong>50 cm at 27°C for cationic-emulsion residue</strong>. Thus minimum road-bitumen ductility is not universally 50 cm. </p><p><strong>Viscosity</strong> measures resistance to flow: dynamic viscosity has units Pa·s, with <strong>1 poise = 0.1 Pa·s</strong>; kinematic viscosity is ν = η/ρ, with <strong>1 cSt = 1 mm<sup>2</sup>/s</strong>. The DoR VG table tests absolute viscosity at 60°C and kinematic viscosity at 135°C. </p><p><strong>Binder specific gravity G<sub>b</sub></strong> is a dimensionless density ratio at stated reference temperatures. The bank's 0.97–1.02 is an illustrative range, not a universal purity or acceptance interval; volume conversion requires the measured product value. For a common water reference, binder volume is M<sub>b</sub>/(G<sub>b</sub>ρ<sub>w</sub>).</p><p><strong>Flash point</strong> concerns transient ignition of vapour in a specified test; <strong>fire point</strong> concerns sustained burning. Neither is a recommended heating target, a decomposition temperature or the mix's laying temperature. The DoR VG table's minimum Cleveland-open-cup flash point of <strong>220°C</strong> is a test requirement, not an operating instruction. Product-specific production controls and safe procedures remain necessary.</p>",
                    moreHtml: "<p>RTFO conditioning addresses short-term ageing effects; it is not a direct prediction of a fixed number of service years.</p><p>Ring-and-ball softening point is an operational test temperature, not a sharp thermodynamic melting point. Penetration, VG and performance grading are different classification systems; PG temperature labels concern the adopted pavement-temperature model, not an automatic conversion from penetration.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Premixing and surface treatment are different material systems.</strong> A premix coats a graded aggregate blend before laying. A surface dressing applies binder and cover chippings as a treatment; it is not simply a thin batch of DBM. A layer's name describes more than whether it looks black.</p><table><thead><tr><th scope='col'>System</th><th scope='col'>Structural and material distinction</th></tr></thead><tbody><tr><th scope='row'>BM</th><td>DoR §1307 describes an open-graded bituminous macadam premix. Drainage and protection are important because water can be trapped within the pavement system.</td></tr><tr><th scope='row'>DBM</th><td>DoR §1308 describes dense bituminous macadam mainly, but not exclusively, for base/binder and profile-corrective courses.</td></tr><tr><th scope='row'>BC</th><td>A dense asphalt-concrete mixture used for wearing and profile-corrective courses under §1309.</td></tr><tr><th scope='row'>Purpose-designed gap/open mixes</th><td>Different aggregate skeletons, mastic contents and drainage functions require their own design criteria; they are not defective dense mixes by definition.</td></tr></tbody></table>",
                    moreHtml: "<p>The bank's bituminous-bound-macadam answer is a conventional premixed-base choice, not proof that BM and DBM are the same product or that every macadam is a freely draining layer. Highway is a valid DBM application, not an exclusive road category.</p><p><strong>Bleeding</strong> occurs when excess binder appears at the surface, often as the available void space becomes inadequate under heat and traffic. Controlled design air voids accommodate mixture changes while sufficient effective binder protects and binds particles. Too little binder or poor compaction can promote ravelling and moisture damage.</p><p>The remedy is not to maximise air voids or intentionally connect them in ordinary dense asphalt. Interconnected permeability can admit water and accelerate deterioration. Distinguish the controlled void structure of a dense mix from a separately designed porous surfacing, and check binder content, grading and compaction together.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Marshall mix design compares trial mixtures, not just one maximum-load result.</strong> Select suitable ingredients and grading, prepare replicate specimens at a series of binder contents, condition and compact using the specified method, determine mixture gravities and voids, then assess stability and flow. </p><p>For the inspected <strong>DoR VG-binder DBM</strong>, Table 13.29 specifies <strong>75 blows on each face</strong> and stability testing at <strong>60°C</strong>, with minimum stability 9.0 kN, flow 2–4 mm, air voids 3–5%, and VFB 65–75%. Section 1308(3)(b) selects binder content at <strong>4% design air voids</strong>, while also meeting the other requirements. VMA minima depend on NMAS and design air voids; 4% air voids alone is not approval.</p><p>Retain method variants: the clause calls for modified Marshall equipment and <strong>152.4 mm specimens when maximum aggregate size exceeds 26.5 mm</strong>, with stated stability/flow scaling. Modified binders also have different criteria. Cold-mix Table 13.40 instead uses <strong>50 blows per face and 25°C</strong>, with its specified curing, including 72-hour room-temperature curing for the stated stability test. Therefore neither 75 blows nor 60°C is universal across every Marshall application. The 60°C test condition is not proof of the hottest temperature every pavement reaches.</p>",
                    moreHtml: "<p>Stability is a load, commonly kN; flow is deformation in mm. Optimum binder content must satisfy the combined design requirements, not merely maximise stability or density.</p><p><strong>Actual binder content</strong> in an existing mix is determined by an appropriate extraction or ignition method, with corrections for moisture, mineral matter and method-specific aggregate loss as applicable. These measurements are distinct from choosing an optimum content by Marshall design. Penetration and ductility test the binder itself.</p><p>A job-mix formula needs definite ingredient proportions, grading, gravities, performance results and production temperatures, followed by trials and verification. Superpave's gyratory/volumetric approach is a separate syllabus comparison, not permission to substitute a gyration count for Marshall blows without redesign and applicable approval.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><em>Syllabus extension: asphalt proportioning by mass.</em> None of the assigned questions supplies a complete binder-mass conversion exercise. The numbers below are hypothetical illustrations, not recovered bank givens or recommended binder contents.</p><p>For a conventional dry-aggregate and binder mixture, let M<sub>b</sub> be binder mass, M<sub>s</sub> dry aggregate mass including mineral filler, and M = M<sub>b</sub> + M<sub>s</sub>. Neglect air mass. Define <strong>P<sub>b</sub> = 100M<sub>b</sub>/M</strong> and <strong>P<sub>s</sub> = 100M<sub>s</sub>/M = 100 − P<sub>b</sub></strong>. Both are percentages of total mix mass. Alternatively, <strong>B = 100M<sub>b</sub>/M<sub>s</sub></strong> is binder as a percentage of aggregate mass.</p><p>Eliminating the masses gives <strong>B = 100P<sub>b</sub>/(100 − P<sub>b</sub>)</strong> and <strong>P<sub>b</sub> = 100B/(100 + B)</strong>. The denominators differ because adding binder increases the total mass. These are mass percentages, not the volume percentages of binder-filled voids.</p><ul><li><strong>Hypothetical 5% of total mix:</strong> 5 kg binder with 95 kg aggregate gives B = 100 × 5/95 = <strong>5.2632%</strong> of aggregate mass.</li><li><strong>Hypothetical 5% of aggregate:</strong> 5 kg binder with 100 kg aggregate makes 105 kg mix, so P<sub>b</sub> = 100 × 5/105 = <strong>4.7619%</strong> of total mix mass.</li></ul>",
                    moreHtml: "<p>DoR's DBM job-mix formula expresses binder by <strong>total mix mass</strong>, but coarse/fine/filler proportions by <strong>total aggregate mass including filler</strong>. Those component percentages must be normalised before combining them. For emulsions or cutbacks, separately account for water or volatile carrier and the specified residue basis; do not substitute the entire supplied binder-product mass for residual bitumen mass in a dry-mixture equation.</p>",
                    sources: []
                },
                {
                ...
                },
                {
                    ...
                    html: "<p><em>Syllabus extension: primary-method CBR reference forces and hypothetical calculations.</em> No assigned record gives a measured load–penetration curve. The reference values are from <strong>Figure 2 and §7.3 of IS 2720 Part 16:1987</strong>; the specimen loads below are invented only to demonstrate the calculation.</p><table><thead><tr><th scope='col'>Penetration</th><th scope='col'>Tabulated total reference force</th><th scope='col'>Conversion to kN</th></tr></thead><tbody><tr><th scope='row'>2.5 mm</th><td>1370 kgf</td><td>13.4351105 kN ≈ 13.4351 kN</td></tr><tr><th scope='row'>5.0 mm</th><td>2055 kgf</td><td>20.15266575 kN ≈ 20.1527 kN</td></tr></tbody></table><p>These use <strong>1 kgf = 9.80665 N</strong>. The alternative pair 13.24/19.96 kN is <strong>not the exact conversion of these IS total loads</strong>. Figure 2 also prints unit loads of 70/105 kg/cm<sup>2</sup>, understood as force per area in the historical notation. </p><p><strong>CBR = 100P<sub>test</sub>/P<sub>reference</sub>.</strong> Hypothetically, corrected total loads of 137 kgf at 2.5 mm and 164.4 kgf at 5 mm give <strong>10% and 8%</strong>, respectively. The 2.5 mm value, 10%, is used under the ordinary selection rule. Converting both numerator and denominator to kN leaves each ratio unchanged.</p><p>If a different hypothetical test gives <strong>10% at 2.5 mm and 12% at 5 mm</strong>, do <strong>not</strong> simply select 12% after one test. The method requires a repeat; use the 5 mm CBR when that behaviour is confirmed. A greater absolute 5 mm force by itself is irrelevant because its reference force is also greater.</p><p><strong>CBR can exceed 100%</strong> when the test material resists penetration more than the reference material under the defined conditions. Such a value is not a calculation error merely for exceeding 100, and does not turn CBR into an allowable bearing pressure or a modulus.</p>",
                    moreHtml: "<p>Do not divide a total force in kN by a unit pressure. Use total/total or pressure/pressure at the same penetration, retaining the identified table's basis rather than mixing rounded columns.</p>",
                    sources: []
                },
                {
                    id: "materials-resilient-modulus-from-cbr",
                    title: "An empirical CBR correlation estimates, rather than measures, modulus",
                    html: "<p><strong>Resilient modulus M<sub>R</sub> measures recoverable stiffness under repeated loading.</strong> In a cyclic triaxial interpretation, <strong>M<sub>R</sub> = Δσ<sub>d</sub>/ε<sub>r</sub></strong>, where Δσ<sub>d</sub> is the applied cyclic deviator stress and ε<sub>r</sub> the recoverable axial strain. Strain is dimensionless, so modulus has stress units. Permanent accumulated strain is not the denominator.</p><p>The identified DoR <strong>Guidelines for the Design of Flexible Pavements-2014, Second Edition 2021</strong>, §5.2, Eqs. 13–14, gives the following subgrade estimates, with CBR entered as the <strong>percentage number</strong>:</p><ul><li><strong>M<sub>R</sub> = 10CBR MPa</strong> for CBR ≤ 5.</li><li><strong>M<sub>R</sub> = 17.6CBR<sup>0.64</sup> MPa</strong> for CBR &gt; 5.</li></ul><p>For the assigned <strong>CBR = 5%</strong>, use the first branch with 5, not 0.05: <strong>M<sub>R</sub> = 50 MPa</strong>. The stored 50 MPa result is supported by this guideline. Do not describe it as a directly verified NRS correlation clause, continue 10CBR across every CBR range, or silently substitute a different correlation from another design method.</p><p>For comparison, a <strong>hypothetical repeated-load measurement</strong> of 80 kPa cyclic stress and 0.001 recoverable strain gives <strong>80,000 kPa = 80 MPa</strong>. This is not a recovered CBR value. </p><p>Section 5.3's layered-subgrade/embankment treatment uses a <strong>deflection-equivalent composite modulus</strong>, not an arithmetic average, with its design estimate capped at <strong>100 MPa</strong>. The assigned 50 MPa is not that cap. The 2021 document was inspected through an identified nongovernment HERMES copy; it was not byte-compared with the inaccessible official DoR download, and its title does not establish later current adoption.</p>",
                    moreHtml: "<p>Moisture, density, confinement, stress level and testing history affect measured stiffness; an empirical CBR estimate cannot uniquely reproduce it.</p>",
                ...
                },
                {
                    ...
                    html: "<p><strong>The Hveem stabilometer determines an empirical resistance value, R-value.</strong> As described in FHWA NHI-05-037 §5.4.2, vertical loading of a conditioned, compacted specimen produces a measured lateral pressure through the surrounding membrane/fluid system. </p><p><strong>Plate-bearing equipment measures pressure–settlement response.</strong> For the stated loading point and support conditions, <strong>k = σ/δ</strong>, where σ = P/A is applied pressure and δ is settlement. Thus k has dimensions force/length<sup>3</sup>, or pressure per length. It is not P/δ, which would instead be a force–displacement stiffness.</p><p><strong>Hypothetical unit example:</strong> σ = 100 kPa and δ = 2 mm = 0.002 m give <strong>k = 50,000 kPa/m = 50 MPa/m = 0.05 N/mm<sup>3</sup></strong>. Writing 50 MPa omits the length denominator. </p><p>FHWA §5.4.6 emphasises that k depends on the soil <strong>and</strong> the loaded slab/plate size and stiffness, as well as the support system. A small plate and a large slab do not automatically give the same value. State plate geometry, selected settlement or pressure range, loading history, moisture and whether subbase/composite support is represented. The bank's 750 mm plate and 1.25 mm settlement describe a particular convention, not the definition of every k test.</p>",
                    moreHtml: "<p>The pressure ratio and the apparatus displacement response enter the index. It measures resistance to deformation; it is not the radius of a stress bulb, an elastic modulus in MPa or the CBR percentage.</p><p>In contrast, resilient modulus divides stress by dimensionless recoverable strain and is correctly reported in MPa.</p><p>CBR-to-R, CBR-to-modulus and modulus-to-k relationships require their own calibrated method and matching conditions. The primary FHWA manual explains these concepts but is not a Nepal specification or a source of automatic permission to substitute its design correlations into a DoR calculation.</p>",
                    sources: [
            ...
            cautions: [
                {
                    "id": "check-tran808-00174",
                    "status": "review",
                    "prompt": "The ______ test can be conducted in-situ as well as in the laboratory.",
                    "html": "<p><strong>Field/laboratory CBR is condition-dependent:</strong> in-situ and laboratory versions exist, but field-moisture CBR is not automatically soaked remoulded CBR. </p><p>Preserve density, water content, compaction, surcharge, oversize treatment and soaking. </p><p>The general assertion that all direct-shear testing is laboratory-only is too broad; these questions identify a conventional CBR capability, not an exclusive classification of every possible test.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00174",
                            "set": 1,
                ...
                {
                    "id": "check-tran808-00032",
                    "status": "review",
                    "prompt": "In water bound macadam roads, binding material, is",
                    "html": "<p><strong>WBM fines are not a cementing binder:</strong> stone dust is the intended conventional answer, but screenings and separately specified binding material must be distinguished. </p><p>DoR §1203 allows appropriate non-plastic angular pit sand as screenings where permitted, and additional binding material may be unnecessary with suitably crushable screenings. </p><p>The explanation's absolute exclusion of sand is too broad; water assists the mechanical process.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00032",
                            "set": 4,
                ...
                {
                    "id": "check-tran808-00033",
                    "status": "review",
                    "prompt": "Which premix is used in the base course?",
                    "html": "<p><strong>BM, DBM and road category:</strong> the specified BM is an open-graded premix, whereas DBM is a dense mixture mainly used in base/binder and profile-corrective courses. </p>",
                    "sources": [
                        {
                            "id": "TRAN808-00033",
                            "set": 4,
                ...
                {
                    "id": "check-tran808-00034",
                    "status": "review",
                    "prompt": "The aggregate impact value of the aggregate used in",
                    "html": "<p><strong>Concrete-specific impact limits:</strong> IS 383:1970 supports AIV <strong>≤30% for concrete wearing surfaces</strong> and <strong>≤45% for other concrete</strong>, not every material named road or runway. </p><p>The bank's strict less-than signs also differ from not exceeding. </p>",
                    "sources": [
                        {
                            "id": "TRAN808-00034",
                            "set": 5,
                ...
                {
                    "id": "check-tran808-00035",
                    "status": "review",
                    "prompt": "In LA Abrasion test 1.88kg out of 5kg passed through 1.7mm sieve then the aggregate is suitable for",
                ...
                {
                    "id": "check-tran808-00038",
                    "status": "review",
                    "prompt": "If the penetration grade is 62, the penetration value is ...",
                ...
                {
                    "id": "check-tran808-00039",
                    "status": "review",
                    "prompt": "Minimum bitumen ductility value to use in road.",
                    "html": "<p>The amended DoR VG10/20/30/40 table specifies <strong>RTFO-residue ductility at 25°C of at least 75/50/40/25 cm</strong>. </p><p>Its separate cationic-emulsion residue requirement is 50 cm at 27°C. </p><p>There is no universal original-road-bitumen minimum of 50 cm at every temperature.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00039",
                            "set": 5,
                ...
                {
                    "id": "check-tran808-00040",
                    "status": "review",
                    "prompt": "Rate of stretching bitumen in ductility test",
                    "html": "<p><strong>Ductility needs grade, condition and temperature:</strong> the conventional 5 cm/min rate is not 5 mm/min. </p><p>The amended DoR VG10/20/30/40 table specifies <strong>RTFO-residue ductility at 25°C of at least 75/50/40/25 cm</strong>. </p><p>Its separate cationic-emulsion residue requirement is 50 cm at 27°C. </p>",
                    "sources": [
                        {
                            "id": "TRAN808-00040",
                            "set": 5,
                ...
                {
                    "id": "check-tran808-00041",
                    "status": "review",
                    "prompt": "If CBR = 5%, then resilient modulus as per NRS is",
                ...
                {
                    "id": "check-tran808-00042",
                    "status": "review",
                    "prompt": "What is the standard temperature for Marshall Stability test?",
                    "html": "<p>DoR hot DBM's <strong>75-blow/60°C</strong> conditions differ from its specified cold-mix <strong>50-blow/25°C</strong> conditions and from modified specimen procedures. </p><p>The 60°C test is not a universal maximum service temperature.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00042",
                            "set": 5,
                ...
                {
                    "id": "check-tran808-00043",
                    "status": "review",
                    "prompt": "The distance between two samples in a penetration test should be ______",
                ...
                {
                    "id": "check-tran808-00046",
                    "status": "review",
                    "prompt": "What is the impact value of aggregate if total wt. = 300gm & wt. retained on 2.36mm sieve = 180gm?",
                ...
                {
                    "id": "check-tran808-00047",
                    "status": "review",
                    "prompt": "The maximum moisture content on Bitumen is",
                ...
                {
                    "id": "check-tran808-00049",
                    "status": "review",
                    "prompt": "Which is the organic binding material used in road pavement?",
                    "html": "<p>Bitumen is organic, while cement and lime are inorganic, but not every lime is hydraulic. </p><p>None of these facts authorises improvised fuel or water addition to hot binder.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00049",
                            "set": 6,
                ...
                {
                    "id": "check-tran808-00050",
                    "status": "review",
                    "prompt": "Bitumen content is determined by which test.",
                    "html": "<p><strong>Marshall design is not extraction:</strong> optimum binder content is selected from trial-mixture results and combined criteria; actual content in an existing mix is measured by appropriate extraction/ignition methods. </p><p>DoR hot DBM's <strong>75-blow/60°C</strong> conditions differ from its specified cold-mix <strong>50-blow/25°C</strong> conditions and from modified specimen procedures. </p>",
                    "sources": [
                        {
                            "id": "TRAN808-00050",
                            "set": 6,
                ...
                {
                    "id": "check-basi674-00150",
                    "status": "review",
                    "prompt": "Aggregate crushed before the application of full load of ______",
                    "html": "<p><strong>ACV force error:</strong> BASI674-00150 keys 4000n, but the inspected standard test applies <strong>40 tf = 392.266 kN</strong>, conventionally rounded to 400 kN, over 10 minutes. </p><p>There is no correct force option in that version. </p><p>Neither stem means that the sample must fail catastrophically before the prescribed load is reached.</p>",
                    "sources": [
                        {
                            "id": "BASI674-00150",
                            "set": 13,
                ...
                {
                    "id": "check-basi674-00160",
                    "status": "review",
                    "prompt": "A value less than 10 signifies an exceptionally ______ while above 35 would normally be regarded as ______.",
                    "html": "<p><strong>The test index is not identified.</strong> Values below 10 and above 35 cannot define universal aggregate classes without naming ACV, AIV or another method. Lower degradation indicates greater resistance only under the same test basis.</p>",
                    "sources": [
                        {
                            "id": "BASI674-00160",
                            "set": 13,
                ...
                {
                    "id": "check-tran808-00125",
                    "status": "review",
                    "prompt": "The materials not included in highway construction are ______.",
                    "html": "<p>Petrol is normally a fuel rather than a permanent paving constituent; manufactured cutbacks can nevertheless contain petroleum distillates. </p><p>None of these facts authorises improvised fuel or water addition to hot binder.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00125",
                            "set": 13,
                ...
                {
                    "id": "check-tran808-00130",
                    "status": "review",
                    "prompt": "Bitumen is a by-product of ______.",
                    "html": "<p><strong>Binder and constituent scope:</strong> petroleum is the intended source of refinery paving bitumen, but natural bitumen exists. </p><p>Petrol is normally a fuel rather than a permanent paving constituent; manufactured cutbacks can nevertheless contain petroleum distillates. </p><p>None of these facts authorises improvised fuel or water addition to hot binder.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00130",
                            "set": 13,
                ...
                {
                    "id": "check-tran808-00131",
                    "status": "review",
                    "prompt": "Tar is a by-product of ______.",
                ...
                {
                    "id": "check-tran808-00133",
                    "status": "review",
                    "prompt": "Aggregates obtained from which type of rocks are strong?",
                    "html": "<p><strong>Origin and angularity are not stand-alone quality certificates:</strong> sound igneous rock is often useful, but weathered igneous material can fail and other rock origins can be suitable. </p>",
                    "sources": [
                        {
                            "id": "TRAN808-00133",
                            "set": 13,
                ...
                {
                    "id": "check-tran808-00135",
                    "status": "review",
                    "prompt": "The flaky aggregates should not exceed ______.",
                ...
                {
                    "id": "check-basi674-00161",
                    "status": "review",
                    "prompt": "Los Angeles machine consists of circular drum of internal diameter ______ mm and length ______ mm.",
                    "html": "<p><strong>The checked IS apparatus is 700 mm inside diameter by 500 mm inside length.</strong> The 520 mm length in the offered key conflicts with that source. The cited amended rotation speed is 30-33 rpm; apparatus values need the stated test edition.</p>",
                    "sources": [
                        {
                            "id": "BASI674-00161",
                            "set": 14,
                ...
                {
                    "id": "check-basi674-00163",
                    "status": "review",
                    "prompt": "A maximum aggregate impact value of ______ percent is allowed for WBM base course in Indian conditions.",
                    "html": "<p><strong>WBM test/edition ambiguity:</strong> one stem expressly asks AIV and the other only a maximum value, with an explanation naming LA. </p><p>In amended DoR Table 12.5, <strong>base LA/AIV = 40/30%</strong> and <strong>subbase = 45/40%</strong>; base AIV is not 40%. </p><p>These Nepal provisions do not independently verify the bank's unspecified Indian specification. </p><p>Keep the test, layer, conditioning and document attached to any limit.</p>",
                    "sources": [
                        {
                            "id": "BASI674-00163",
                            "set": 14,
                ...
                {
                    "id": "check-basi674-00164",
                    "status": "review",
                    "prompt": "Aggregates to be used for wearing coupe, impact value shouldn’t exceed ______ percent.",
                    "html": "<p>The bank's strict less-than signs also differ from not exceeding. </p>",
                    "sources": [
                        {
                            "id": "BASI674-00164",
                            "set": 14,
                ...
                {
                    "id": "check-tran808-00137",
                    "status": "review",
                    "prompt": "The fine aggregates are having a size less than ______.",
                    "html": "<p><strong>Size-class qualifications:</strong> fine/coarse are conventional aggregate classes, with fine aggregate mostly passing 4.75 mm under IS 383 and prescribed grading allowances. </p><p>Some asphalt clauses use a different boundary. </p>",
                    "sources": [
                        {
                            "id": "TRAN808-00137",
                            "set": 14,
                ...
                {
                    "id": "check-tran808-00139",
                    "status": "review",
                    "prompt": "If the bulk density of an aggregate is 2.6kg/lit and Gs is 2.8 then, the percentage of voids is ______.",
                ...
                {
                    "id": "check-tran808-00142",
                    "status": "review",
                    "prompt": "The skid resistance is measured in ______.",
                ...
                {
                    "id": "check-tran808-00145",
                    "status": "review",
                    "prompt": "The aggregates which do not have sufficient strength like waste bricks can be used in ______.",
                ...
                {
                    "id": "check-tran808-00146",
                    "status": "review",
                    "prompt": "In crushing test, dry aggregates passing through ______, run rice and retained ______.",
                ...
                {
                    "id": "check-tran808-00151",
                    "status": "review",
                    "prompt": "A maximum value of ______ percent is allowed for WBM base course in Indian conditions.",
                    "html": "<p><strong>WBM test/edition ambiguity:</strong> one stem expressly asks AIV and the other only a maximum value, with an explanation naming LA. </p><p>In amended DoR Table 12.5, <strong>base LA/AIV = 40/30%</strong> and <strong>subbase = 45/40%</strong>; base AIV is not 40%. </p><p>These Nepal provisions do not independently verify the bank's unspecified Indian specification. </p><p>Keep the test, layer, conditioning and document attached to any limit.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00151",
                ...
                {
                    "id": "check-tran808-00152",
                    "status": "review",
                    "prompt": "Aggregates to be used for wearing course, the impact value shouldn’t exceed ______ percent.",
                    "html": "<p>The bank's strict less-than signs also differ from not exceeding. </p><p>Asphalt limits are product-specific: amended DoR gives DBM 27% and BC 24%, so a universal 30% wearing-course rule is not established.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00152",
                            "set": 15,
                ...
                {
                    "id": "check-tran808-00153",
                    "status": "review",
                    "prompt": "The loss in weight should not exceed ______ percent when tested with sodium sulphate and ______ percent with magnesium sulphate solution.",
                ...
                {
                    "id": "check-tran808-00158",
                    "status": "review",
                    "prompt": "According to size, aggregates is/are classified into ______ types.",
                    "html": "<p><strong>Size classes depend on the specification.</strong> Fine and coarse aggregate commonly use the 4.75 mm boundary under the cited IS convention, with grading allowances. Mineral filler has a separate grading and is not the whole fine-aggregate blend.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00158",
                            "set": 16,
                ...
                {
                    "id": "check-tran808-00160",
                    "status": "review",
                    "prompt": "What is the size of fine aggregates?",
                    "html": "<p><strong>Size-class qualifications:</strong> fine/coarse are conventional aggregate classes, with fine aggregate mostly passing 4.75 mm under IS 383 and prescribed grading allowances. </p><p>Some asphalt clauses use a different boundary. </p>",
                    "sources": [
                        {
                            "id": "TRAN808-00160",
                ...
                {
                    "id": "check-tran808-00162",
                    "status": "review",
                    "prompt": "Aggregate crushed before the application of full load of ______.",
                    "html": "<p>There is no correct force option in that version. </p><p>TRAN808-00162's 40 ton intends tonne-force, not a mass-only load unit. </p><p>Neither stem means that the sample must fail catastrophically before the prescribed load is reached.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00162",
                            "set": 16,
                ...
                {
                    "id": "check-tran808-00165",
                    "status": "review",
                    "prompt": "The DBM is used in ______",
                    "html": "<p><strong>BM, DBM and road category:</strong> the specified BM is an open-graded premix, whereas DBM is a dense mixture mainly used in base/binder and profile-corrective courses. </p><p>The bank's BBM terminology does not establish a separate verified specification, nor make DBM an open drainage layer. </p><p>Highway is a valid DBM use but not an exclusive permitted road category.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00165",
                            "set": 16,
                ...
                {
                    "id": "check-tran808-00166",
                    "status": "review",
                    "prompt": "The filler material should pass from ______",
                    "html": "<p>Some asphalt clauses use a different boundary. </p><p>Mineral filler has its own grading: <strong>75 μm = 0.075 mm</strong>, and amended DoR Table 13.27 allows <strong>85–100% passing</strong>, not invariably 100%. </p><p>Do not apply the filler grading to the whole aggregate blend.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00166",
                            "set": 16,
                ...
                {
                    "id": "check-tran808-00168",
                    "status": "review",
                    "prompt": "Bleeding may be avoided by ______",
                ...
                {
                    "id": "check-tran808-00169",
                    "status": "review",
                    "prompt": "Which aggregate produce higher stability of mix?",
                    "html": "<p>Sharp sand can improve interlock only under comparable grading, binder and compaction conditions. </p><p>Neither label uniquely establishes strength, mix stability, durability or course acceptance.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00169",
                            "set": 17,
                ...
                {
                    "id": "check-tran808-00170",
                    "status": "review",
                    "prompt": "Maximum size of aggregate in base course is...",
                    "html": "<p><strong>Maximum-size questions are under-specified:</strong> 50 mm cannot be a universal base maximum without the product and grading. </p><p>Maximum and nominal maximum size are different concepts; a nearest-number substitution cannot repair the missing definition or supply an exact answer.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00170",
                            "set": 17,
                ...
                {
                    "id": "check-tran808-00171",
                    "status": "review",
                    "prompt": "Maximum size of aggregate in surface course is ...",
                    "html": "<p>The surface key <strong>19.5 mm</strong> is not the <strong>19 mm or 13.2 mm</strong> named in its explanation and the BC NMAS headings. </p><p>Maximum and nominal maximum size are different concepts; a nearest-number substitution cannot repair the missing definition or supply an exact answer.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00171",
                            "set": 17,
                ...
                {
                    "id": "check-tran808-00172",
                    "status": "review",
                    "prompt": "The specific gravity of bitumen lies between ______",
                ...
                {
                    "id": "check-tran808-00173",
                    "status": "review",
                    "prompt": "The tests to evaluate the strength of subgrade soil can be broadly classified as",
                    "html": "<p><strong>Test-family names do not make their results equivalent:</strong> shear strength, plate support response and penetration resistance are different properties. </p><p>CBR is not allowable bearing pressure, SPT blow count or resilient modulus, and repeated-load stiffness is an additional important pavement characterisation. </p><p>Any correlation needs its own material, unit and conditioning basis.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00173",
                            "set": 17,
                ...
                {
                    "id": "check-tran808-00290",
                    "status": "review",
                    "prompt": "Who proposed the widely accepted thumb criterion for identifying frost susceptible soils?",
                ...
                {
                    "id": "check-tran808-00304",
                    "status": "review",
                    "prompt": "______ is used to test the resistance value or R-value of the material ______.",
                    "html": "<p><strong>R-value and k are different outputs:</strong> stabilometer is supported for the R-value, but the extra blank supplies no further material identity. </p>",
                    "sources": [
                        {
                            "id": "TRAN808-00304",
                            "set": 28,
                ...
                {
                    "id": "check-tran808-00335",
                    "status": "review",
                    "prompt": "In water bound macadam roads, the binding material is",
                    "html": "<p><strong>WBM fines are not a cementing binder:</strong> stone dust is the intended conventional answer, but screenings and separately specified binding material must be distinguished. </p><p>DoR §1203 allows appropriate non-plastic angular pit sand as screenings where permitted, and additional binding material may be unnecessary with suitably crushable screenings. </p><p>The explanation's absolute exclusion of sand is too broad; water assists the mechanical process.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00335",
                ...
                {
                    "id": "check-tran808-00339",
                    "status": "review",
                    "prompt": "The Modulus of subgrade Reaction is determined by",
                    "html": "<p>Plate-bearing equipment supports the k answer; <strong>k = pressure/settlement</strong> has units such as kPa/m or N/mm<sup>3</sup>, not MPa alone. </p><p>The stated 750 mm/1.25 mm convention is not a universal definition; plate/slab size, stiffness and support conditions affect k.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00339",
                            "set": 31,
                ...
                {
                    "id": "check-tran808-00362",
                    "status": "review",
                    "prompt": "Tests to evaluate subgrade strength are classified as",
                    "html": "<p><strong>Test-family names do not make their results equivalent:</strong> shear strength, plate support response and penetration resistance are different properties. </p><p>CBR is not allowable bearing pressure, SPT blow count or resilient modulus, and repeated-load stiffness is an additional important pavement characterisation. </p><p>Any correlation needs its own material, unit and conditioning basis.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00362",
                ...
                {
                    "id": "check-tran808-00363",
                    "status": "review",
                    "prompt": "Test conducted in-situ and in laboratory",
                    "html": "<p><strong>Field/laboratory CBR is condition-dependent:</strong> in-situ and laboratory versions exist, but field-moisture CBR is not automatically soaked remoulded CBR. </p><p>Preserve density, water content, compaction, surcharge, oversize treatment and soaking. </p><p>The general assertion that all direct-shear testing is laboratory-only is too broad; these questions identify a conventional CBR capability, not an exclusive classification of every possible test.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00363",
