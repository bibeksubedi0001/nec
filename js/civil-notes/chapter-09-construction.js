(function () {
    ...
    Object.assign(registry, {
        ACiE0906: {
            ...
            blocks: [
                {
                    ...
                    html: "<p><strong>Official 9.6 scope:</strong> activities, techniques, tools, equipment and plants used in road construction; preparation of road subgrade; field compaction control and soil stabilization; construction of asphalt concrete layers; construction procedure for penetration macadam, bituminous bound macadam and plain cement concrete pavements; road maintenance, repair and rehabilitation.</p><ol><li><strong>Before earthworks:</strong> review drawings and contract requirements; establish survey control, utility locations, access, material sources, traffic management and environmental safeguards.</li><li><strong>Prepare the foundation:</strong> clear and strip, provide drainage, manage unsuitable material, and organize cut-to-fill movements without destabilizing slopes.</li><li><strong>Build upward:</strong> condition and compact each approved lift, verify its properties and geometry, then protect it before covering it.</li><li><strong>Construct the selected pavement:</strong> use the approved granular, bituminous or concrete process, including interfaces, edges and joints.</li><li><strong>Complete and hand over:</strong> verify drainage, shoulders, surface quality, tests, safety furniture and the particular opening requirements; retain location-linked records for maintenance.</li></ol><p>A <strong>hold point</strong> prevents the next operation from concealing work that still needs approval. Contractor quality control manages the process; inspection and acceptance checks establish whether the specified result has been demonstrated. These notes use the government-hosted <strong>DoR Standard Specifications 2073, with Third Amendment 2082, effective 1 Shrawan 2082</strong>, for identified clauses. They do not establish contractual precedence, latest-publication status or construction approval. Foreign references support principles, not automatic Nepal adoption.</p>",
                    moreHtml: "<p><em>Source-free syllabus extension: this construction workflow supplies context that the assigned questions do not set out as a complete project.</em> Construction is a sequence of dependent operations. A smooth wearing course cannot compensate for buried organic soil, an unaccepted lift or a blocked drainage outlet. Plan work fronts so that inspection, material supply and protection keep pace with excavation and paving.</p>",
                    sources: []
                },
                {
                    ...
                    moreHtml: "<p>Compaction densifies material mechanically; consolidation is time-dependent volume change associated with drainage under sustained loading. These processes must not be treated as synonyms.</p><p>The subgrade has to support both construction traffic and the completed pavement. Failure develops when the applied demand exceeds the available support, including where moisture, poor compaction, unsuitable soil or nonuniform foundation conditions reduce that support. <strong>Inadequate stability and excessive applied stress are credible causes; insufficient applied traffic stress is not an equivalent failure mechanism.</strong> Insufficient compactive effort is a different issue and cannot silently replace that wording.</p><p>Maintain a discharge route for runoff throughout the operation. Proof rolling, where specified and appropriately loaded, helps reveal soft areas; it neither replaces density testing nor authorizes repeated heavy loading on ground that is already failing.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>Soil improvement may provide a temporary working platform, reduce moisture sensitivity or swelling, or create a designed structural layer. These objectives require different evidence. A surface that supports today's construction vehicle is not automatically a durable stabilized base, and a stabilizer does not remove the need for drainage.</p><table><thead><tr><th scope='col'>Approach</th><th scope='col'>Mechanism and design question</th></tr></thead><tbody><tr><th scope='row'>Mechanical blending and compaction</th><td>Change grading or the proportion of fines, then densify the mixture. Does the resulting material have suitable grading, plasticity, support and moisture behaviour?</td></tr><tr><th scope='row'>Cement or lime treatment</th><td>Hydration, cementation and/or soil–additive reactions alter behaviour. Check compatibility, dosage, mixing, curing, strength and durability.</td></tr><tr><th scope='row'>Bituminous treatment</th><td>Binder adhesion and moisture protection can improve suitable sand or soil–aggregate mixtures. Demonstrate coating, stability and moisture resistance.</td></tr><tr><th scope='row'>Other improvement systems</th><td>Geosynthetic separation or reinforcement, drainage and specialist ground treatment act differently; choose and design the required function.</td></tr></tbody></table>",
                    moreHtml: "<p>Textbooks may group these into <strong>three broad families</strong>, or combine and subdivide them differently. That count is a taxonomy, not a physical law. Likewise, <strong>admixture</strong> only means an added material unless its nature is specified. Blending sand or crushed aggregate to change grading can be mechanical stabilization; adding reactive cement or lime is not made mechanical merely because a mixer is used.</p><p>For sandy soil, <strong>sand–bitumen is a valid stabilization option</strong>, but soil–cement, grading correction or other treatments may be preferable. Soil name alone does not establish the most common or best solution. Lime is most useful where suitable reactive fines are present; clean sand does not acquire a strong pozzolanic bond from lime alone without a suitable reactive constituent. Compare laboratory performance, construction capability, water exposure, cost and environmental constraints before choosing.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Soil–cement</strong> is a deliberately proportioned mixture of soil or aggregate, cement and water that is mixed, compacted and cured to develop a bound material. Smaller treatment quantities may primarily modify plasticity or workability. The intended structural credit must follow the demonstrated product properties, not the name alone.</p><ol><li>Characterize the soil, water and proposed cement; prepare trial mixtures with controlled dosage and the relevant curing and exposure conditions.</li><li>Establish a treated-material moisture–density reference and required strength/durability, accounting for the time between mixing and compaction.</li><li>Pulverize and spread to controlled depth. Meter cement uniformly, control dust, and mix water and additive through the full depth, including lane overlaps.</li><li>Shape and compact within the permitted working period; do not leave untreated seams or attempt to compact already hardened lumps into a uniform layer.</li><li>Cure promptly, restrict traffic and verify both the constructed layer and its developed properties before covering.</li></ol><p>For the specific <strong>cement-treated base/subbase in §1202(3)</strong>, the cited specification requires at least <strong>98% Part 8 MDD</strong>, completion of compaction within <strong>two hours of mixing or a shorter period where necessary in dry weather</strong>, and <strong>seven days of curing</strong>. These are not universal limits for every stabilized soil or concrete pavement. </p>",
                    moreHtml: "<p>Cement can treat suitable <strong>fine-grained as well as coarse-grained soils</strong>. FHWA's stabilization discussion explicitly includes low-plasticity clays, sandy soils and granular soils. Highly plastic soil may be difficult to pulverize and mix; some materials require pretreatment or a different solution. Organic constituents and sulfates can interfere with performance and need evaluation. For equal solids mass and comparable grain shape, <strong>finer grains have greater specific surface area</strong>, not larger grains. Surface area and mixing difficulty help explain binder demand; neither establishes an only-coarse-soils rule.</p><p>Cement content matters, but its effect cannot be separated from soil, moisture, density, mixing and curing by declaring admixtures the single dominant factor.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>A base and subbase may both be granular, but the product specification still controls. <strong>CBR is a penetration-resistance ratio</strong>; field relative compaction is a dry-density ratio. The density used to prepare a laboratory CBR specimen must not be copied into the field-acceptance column.</p><table><thead><tr><th scope='col'>DoR product</th><th scope='col'>Minimum laboratory CBR</th><th scope='col'>Field compaction provision</th></tr></thead><tbody><tr><th scope='row'>GSB, §1201 / Table 12.2</th><td>Subbase 30%</td><td>At least 95% Part 8 MDD, §1201(5).</td></tr><tr><th scope='row'>WBM, §1203 / Table 12.5</th><td>Base 80%; subbase 30%</td><td>The specified rolling, screenings, wet-grouting and setting process; the CBR specimen-density row is not a separate stated field-density percentage.</td></tr><tr><th scope='row'>Crusher-run macadam, Table 12.9</th><td>Base 80%; subbase 60%</td><td>Base at least 98%; subbase at least 95% Part 8 MDD, §1204(3)(ii).</td></tr><tr><th scope='row'>WMM, Table 12.11</th><td>Base 80%; subbase 60%</td><td>Base at least 98%; subbase at least 95% Part 8 MDD, §1208(7).</td></tr></tbody></table><p>The CBR requirements above retain the tables' <strong>unless specified in the Contract</strong> qualification. Their CBR specimens are prepared at <strong>95% of Part 8 heavy-compaction MDD</strong> and tested by the referenced method. Thus a WMM base's 80% CBR is evaluated at the stated laboratory density even though its field density requirement is 98%. Do not describe the 80% as field compaction.</p><p>For <strong>crusher-run macadam and WMM, both base and subbase</strong>, Tables 12.9 and 12.11 limit the <strong>material passing 425 μm</strong> to <strong>LL ≤25 and PI ≤6</strong>. The bank's base LL value has this material-specific support, but its blanket claim that subbase plasticity limits are relaxed is wrong for these same products. A limit belonging to another subbase cannot be substituted without changing the product definition.</p>",
                    moreHtml: "<p>Check grading, particle quality, plasticity, support, thickness and drainage together. Passing a density test does not rehabilitate soft, contaminated or excessively plastic aggregate, and passing a material test does not prove it was placed correctly.</p>",
                ...
                },
                {
                    ...
                    html: "<p>Select equipment from the material, digging level, reach, haul distance, access and receiving operation. A machine that excavates rapidly can still delay the project if trucks, spreading or compaction cannot keep up. Inspect the working platform and slope stability as part of the selection, especially near water or excavation edges.</p><table><thead><tr><th scope='col'>Equipment or operation</th><th scope='col'>Typical use and boundary</th></tr></thead><tbody><tr><th scope='row'>Front shovel</th><td>Excavation principally above track level with a suitable face; not the natural first choice for a soft underwater reach below the machine.</td></tr><tr><th scope='row'>Backhoe</th><td>Controlled excavation below track level, trenches and localized cuts; reach and platform access constrain the task.</td></tr><tr><th scope='row'>Dragline</th><td>A suspended bucket is cast outward and dragged toward the machine, useful for suitable soft or wet material and below-track excavation. This supports the bank's choice among its options, not every dredging operation.</td></tr><tr><th scope='row'>Scraper and haul truck</th><td>A scraper can cut, carry and spread suitable earth; a truck carries material loaded by other equipment. Hauling requires a workable route and turnaround.</td></tr><tr><th scope='row'>Conveyor and hoist</th><td>Conveying transports along an installation; hoisting lifts a load. A conveyor frame can remain fixed while its belt, screw or buckets <strong>move with respect to that frame</strong>.</td></tr></tbody></table>",
                    moreHtml: "<p>Crawler tracks spread load over a large contact area, reducing average ground pressure for a given machine weight. Cleats can mobilize soil shear resistance and improve traction on suitable earth. But <strong>contact area alone does not establish a friction coefficient</strong>: soil strength, moisture, sinkage, track design and slip matter. Ice, loose sand and firm earth behave differently; the bank's ranking is a simplified equipment-context answer, not a constant valid for every earth surface.</p><p>Keep transport routes separate from accepted layers where practicable. Repeated truck passage that contaminates or ruts the formation consumes construction quality as well as time.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>A quarry production chain must deliver acceptable <strong>grading, shape, strength, durability and cleanliness</strong>. Primary and secondary crushing reduce size; screens separate fractions; controlled recombination produces the intended grading. </p><ul><li><strong>Stockpiles:</strong> separate size fractions on clean, drained ground; control contamination and segregation during building, reclaiming and loading.</li><li><strong>Wet-mix plant:</strong> meter aggregate fractions and water to deliver a uniform granular mixture. Stockpile or transport changes can alter moisture and grading after mixing.</li><li><strong>Hot-mix asphalt plant:</strong> calibrate aggregate feeds, drying/heating, filler and binder metering, and mixing; manage moisture, dust collection and temperature without burning the binder.</li><li><strong>Concrete batching plant:</strong> control weighed solid constituents and measured water, account for aggregate moisture, and deliver a consistent mixture within its usable time.</li><li><strong>Paving train:</strong> coordinate plant output, transport, paver speed, rollers or concrete vibrators, finishing and protection equipment.</li></ul>",
                    moreHtml: "<p>A jaw or cone crusher works mainly by compression. A <strong>vertical-shaft impactor, VSI</strong>, is commonly used for shaping because impact and particle interaction can improve cubical form.</p><p>Crusher name is not a material certificate. Feed rock, reduction ratio, crusher setting, speed, wear and recirculation influence particle shape and fines production. Jaw and cone products are not inevitably flaky; a VSI cannot make intrinsically weak or weathered rock durable. Test the actual product and separate rejected material from approved stock.</p><p>Trial production links laboratory approval to the actual plant and placing method. A changed material source, unstable feeder or failed thermometer requires investigation and the appropriate approval, not an assumption that the previous job-mix formula still describes the output. Keep batch records traceable to the layer and location constructed.</p>",
                ...
                },
                {
                    ...
                    html: "<p><strong>Downtime</strong> is time during the defined scheduled period when equipment is unavailable to perform its duty. It can include planned maintenance or servicing as well as unplanned breakdown and repair. </p><p>For scheduled hours H<sub>s</sub> and counted downtime H<sub>d</sub>, define <strong>availability A = (H<sub>s</sub> − H<sub>d</sub>)/H<sub>s</sub></strong>. If productive hours are H<sub>p</sub>, utilization on an available-time basis is <strong>U = H<sub>p</sub>/(H<sub>s</sub> − H<sub>d</sub>)</strong>. Productive time is then H<sub>s</sub>A U. A different utilization denominator produces a different number; label it before comparing equipment records.</p><p>For a repetitive operation, nominal output is <strong>q × 60/T</strong>, where q is useful quantity per cycle and T is cycle time in minutes. Bucket fill, payload limits and material state determine q. </p>",
                    moreHtml: "<p>A serviceable machine waiting for work, trucks, access or instructions is <strong>idle but available</strong>. Report the accounting convention: not every nonproductive hour is a machine reliability failure.</p><p>A truck cycle includes loading, outward travel, dumping, return and the delays explicitly included in the estimate. Effective output also depends on the available working time and synchronization with other machines.</p><p>The system cannot sustainably exceed its slowest required operation: excavation, hauling, spreading, moisture conditioning or compaction. Adding trucks to a loader-limited operation may only lengthen queues. Conversely, an expensive paver can stand idle while a plant or transport shortage interrupts delivery.</p><p>Do not deduct downtime twice by applying a separate availability factor after using a measured output that already includes the same downtime. Separate controllable process delays from scheduled service and breakdowns; the remedy for poor dispatching is different from the remedy for an unreliable machine.</p>",
                ...
                },
                {
                    ...
                    html: "<p><em>Source-free syllabus extension and hypothetical worked example: every capacity, time and conversion factor here is an invented planning input.</em> A loader has a 1.50 m<sup>3</sup> bucket, an assumed fill factor of 0.80 and a basic cycle of 0.50 min. Its useful bucket quantity is <strong>1.20 loose m<sup>3</sup></strong>, so basic output is 1.20 × 60/0.50 = <strong>144 loose m<sup>3</sup>/h</strong>.</p><p>Assume minor operating delays reduce loader output within available hours by a factor of 0.75: <strong>144 × 0.75 = 108 loose m<sup>3</sup>/h</strong>. Separately, a six-hour scheduled shift has one hour of planned equipment unavailability, leaving five available hours. Do not include that hour again in the 0.75 factor. Loader-limited shift production is <strong>108 × 5 = 540 loose m<sup>3</sup></strong>.</p><p>Each truck carries an assumed permitted <strong>6 loose m<sup>3</sup></strong> and completes a <strong>20-minute round cycle including loading, travel, dumping and return</strong>. Assume all trucks share the five available hours and this cycle is the applicable effective estimate. One truck supplies 6 × 60/20 = <strong>18 loose m<sup>3</sup>/h</strong>. Six trucks nominally match the loader: 6 × 18 = 108. Five trucks limit the system to 90 loose m<sup>3</sup>/h before any other bottleneck.</p><p>For a separately assumed conversion of <strong>0.80 compacted m<sup>3</sup> per loose m<sup>3</sup></strong>, the six-truck estimate becomes 540 × 0.80 = <strong>432 compacted m<sup>3</sup> per shift</strong>. This conversion belongs to the hypothetical material and target state, not a universal shrinkage factor or a field-density criterion.</p>",
                    moreHtml: "<p>This is a nominal fleet balance, not an operational guarantee. Check payload mass limits, variable haul speeds, queueing, weather, spreading and the roller's demonstrated output. Dispatching more loose volume does not prove that the same volume of acceptable compacted work has been produced.</p>",
                    sources: []
                },
                {
                    id: "mass-haul-signs-and-volume-basis",
                    title: "Mass haul: cumulative balance is meaningful only on one volume basis",
                    html: "<p>A mass-haul diagram plots <strong>cumulative net earthwork volume against chainage</strong>. Declare cut positive and fill negative, choose an initial ordinate M<sub>0</sub>, and convert usable cut and required fill to one common state. Then <strong>M<sub>i</sub> = M<sub>0</sub> + Σ(V<sub>usable cut</sub> − V<sub>fill</sub>)</strong>. In these notes the common state is equivalent compacted volume.</p><p>A rising segment represents a positive net increment of usable cut; a falling segment represents an increment in which fill exceeds usable cut. A falling segment can still lie above the starting ordinate and therefore need not mean a project-wide deficit. <strong>M<sub>end</sub> − M<sub>0</sub> &lt; 0</strong> indicates a net material deficit, requiring borrow under this convention. A positive difference indicates a net surplus to allocate or dispose of appropriately.</p><p>Bank, loose and compacted volumes are not interchangeable. With conserved dry solids, <strong>V<sub>comp</sub> = V<sub>bank</sub>ρ<sub>d,bank</sub>/ρ<sub>d,comp</sub></strong>. Reject unsuitable fractions before crediting reusable cut, and use material-specific density or shrink/swell information. Separate spoil from reusable stock; excavation volume alone is not the quantity available for structural fill.</p><p>Two points at the same ordinate enclose a volumetrically balanced reach, subject to material suitability and access. Within a properly balanced haul lobe, the area between the mass curve and its balance line represents a <strong>haul moment</strong>, with units such as m<sup>3</sup>·m; dividing by the transferred volume gives mean haul distance. Ordinates themselves are volumes, not distances or hauling cost.</p>",
                    moreHtml: "<p>A zero net balance does not guarantee no borrowing or wasting: unsuitable cut, timing, blocked routes or uneconomic haul can require both. The diagram informs allocation, while construction staging and haul-cost analysis determine feasible movements. The bank's word Burrow should be read as the intended earthwork term <strong>borrow</strong>, without altering the stored record.</p>",
                ...
                },
                {
                    ...
                    html: "<p><em>Source-free syllabus extension and hypothetical worked example: the assigned question supplies no chainage volumes or shrink/swell data.</em> Start at M<sub>0</sub> = 0. Assume suitable soil has dry density <strong>1.60 Mg/m<sup>3</sup> in the bank</strong> and the chosen planning state is <strong>2.00 Mg/m<sup>3</sup> compacted</strong>. Conservation of dry mass gives <strong>0.80 compacted m<sup>3</sup> per bank m<sup>3</sup></strong>. These assumed densities define the balance, not a new construction acceptance requirement.</p><p>Reach A has 1000 bank m<sup>3</sup> of cut, of which an assumed 10% by bank volume is rejected before use. Its usable compacted equivalent is 1000 × 0.90 × 0.80 = <strong>720 m<sup>3</sup></strong>. Reach B has 300 bank m<sup>3</sup> of wholly suitable cut, equivalent to <strong>240 compacted m<sup>3</sup></strong>. Reach C has no cut.</p><table><thead><tr><th scope='col'>Reach</th><th scope='col'>Usable cut / fill, compacted m<sup>3</sup></th><th scope='col'>Net / cumulative, compacted m<sup>3</sup></th></tr></thead><tbody><tr><th scope='row'>A</th><td>720 / 500</td><td>+220 / +220</td></tr><tr><th scope='row'>B</th><td>240 / 400</td><td>−160 / +60</td></tr><tr><th scope='row'>C</th><td>0 / 160</td><td>−160 / −100</td></tr></tbody></table><p>Total usable cut is <strong>960 compacted m<sup>3</sup></strong>, compared with <strong>1060 compacted m<sup>3</sup></strong> of fill. Required net borrow is <strong>100 compacted m<sup>3</sup></strong>. If the borrow is wholly suitable and has the same assumed density conversion, obtain 100/0.80 = <strong>125 bank m<sup>3</sup></strong>. With an additional assumed bulking factor of 1.25 loose/bank, its hauling volume is <strong>156.25 loose m<sup>3</sup></strong>.</p><p>If the diagram were shifted to start at ordinate +500, it would finish at +400: the deficit would still be 100, despite a positive displayed endpoint. This is why the final ordinate must be compared with the initial datum. </p>",
                    moreHtml: "<p>The calculation assumes the usable cuts can actually be transferred when needed; it does not select a haul route or prove suitability from density alone.</p>",
                    sources: []
                },
                {
                    id: "prime-tack-and-surface-seals",
                    title: "Prime, tack and seal: distinguish preparation, bonding and preservation",
                    html: "<p>Identify a sprayed treatment by <strong>its substrate and intended function</strong>, not merely by the presence of bitumen. An emulsion describes a binder form; tack coat describes a construction function. Therefore spray of emulsion and tack coat can describe the same operation rather than mutually exclusive alternatives.</p><table><thead><tr><th scope='col'>Treatment</th><th scope='col'>Principal purpose</th><th scope='col'>What it does not establish</th></tr></thead><tbody><tr><th scope='row'>Prime coat</th><td>Low-viscosity binder prepares an absorbent non-bituminous surface, penetrates and binds surface fines, and affords limited moisture protection.</td><td>It does not create aggregate toughness or replace adequate structural support.</td></tr><tr><th scope='row'>Tack coat</th><td>A controlled thin film bonds an appropriate existing or primed surface to the new bituminous layer; substrates can include old asphalt and concrete.</td><td>It is not a standalone wearing course, profile correction or primary skid-resistance treatment.</td></tr><tr><th scope='row'>Surface seal</th><td>The selected treatment preserves a suitable surface, limits infiltration and/or restores texture.</td><td>It cannot by itself restore failed support or exhausted structural capacity.</td></tr></tbody></table><p>DoR §1302 and Table 13.10 include bituminous, primed granular and cement-concrete substrates for tack application. A granular base may need prime and then the specified tack before a dense bituminous course; these are not always alternatives. </p><p>The tables' stated spray rates are <strong>application quantities</strong>. Do not silently relabel an emulsion rate as residual bitumen or mix kg/m<sup>2</sup> with L/m<sup>2</sup>. §1302(2) specifically prohibits site dilution or heating of RS1 emulsion. Binder form, approved method and break/curing requirements matter.</p>",
                    moreHtml: "<p>Clean and approve the receiving surface, repair defects, establish a uniform spray through trials and protect the film from traffic contamination.</p><p>The phrase surfacing over an impervious pavement is insufficient by itself to identify tack: an overlay or preservation treatment can also be placed there. The decisive feature in the bank's intended tack examples is <strong>bonding before the new layer</strong>.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>Classify distress by <strong>material, pattern, location, extent, severity and progression</strong>, then investigate the mechanism. Cracking, deformation, disintegration and surface texture defects can coexist. A photograph or a single label rarely proves which layer failed or which treatment will last.</p><table><thead><tr><th scope='col'>Observed pattern</th><th scope='col'>Interpretation to investigate</th></tr></thead><tbody><tr><th scope='row'>Interconnected wheel-path cracks</th><td>Fatigue is a strong candidate; determine structural condition and the contribution of underlying support.</td></tr><tr><th scope='row'>Larger block-like asphalt pattern</th><td>Shrinkage, aging and thermal behaviour may dominate; it is not automatically traffic fatigue.</td></tr><tr><th scope='row'>Longitudinal seam crack</th><td>Check construction joint density and bonding as well as possible structural or settlement effects.</td></tr><tr><th scope='row'>Fine network in concrete</th><td>Concrete map cracking or surface crazing needs a concrete-specific diagnosis, not an asphalt-fatigue label.</td></tr></tbody></table><p>FHWA LTPP's May 2014 manual distinguishes asphalt fatigue and block cracking, and separately identifies concrete map cracking. Therefore the bank's unrestricted map-equals-alligator wording should not be generalized. Its phrase Fishing of side slopes has no established technical meaning here and remains unresolved.</p>",
                    moreHtml: "<p><strong>Alligator or fatigue cracking in asphalt</strong> is associated with repeated traffic loading and commonly develops into an interconnected pattern in wheel paths. Repeated tensile strain accumulates damage when structural demand and the material system's capacity are incompatible. Weak or moisture-sensitive support, inadequate pavement thickness and deteriorated asphalt can accelerate the process.</p><p>Bottom-up initiation from tensile strain near the base of an asphalt layer is an important model, <strong>not the only possible crack initiation</strong>. Surface-initiated damage and combined mechanisms also occur. Distinguish <strong>weak subgrade</strong> from <strong>insufficient thickness of the pavement layers</strong>; describing the subgrade simply as too thin does not establish the structural deficiency.</p><p>Sealing can reduce ingress through suitable cracks, but does not restore load-carrying capacity to a broken fatigue zone. Investigate drainage and support and select localized structural repair or designed rehabilitation where needed.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Rutting</strong> is a longitudinal depression in a wheel path. It is a surface observation, not proof that only the wearing course has deformed. Permanent strain can accumulate in asphalt, granular layers, subgrade or several layers together. A rut may also have side ridges from lateral displacement.</p><ul><li><strong>Densification:</strong> an inadequately compacted layer becomes denser under traffic, reducing its thickness.</li><li><strong>Shear deformation:</strong> an unstable mixture or weak supporting layer flows laterally under repeated loading. Adequate initial density alone does not prevent this mechanism.</li><li><strong>Moisture-related weakening:</strong> stripping can reduce asphalt cohesion and stiffness, while wet support can deform more readily.</li><li><strong>Aggregate problems:</strong> unsuitable flaky particles can break or form a poor load-carrying skeleton and contribute to instability. They are not categorically unrelated to rutting.</li></ul>",
                    moreHtml: "<p><strong>Shoving</strong> is localized longitudinal displacement or bulging, often where vehicles brake, accelerate or turn. <strong>Corrugation</strong> describes a repeated wave-like surface pattern. The bank's longitudinal-ridging description intends shoving, but a ridge beside a rut does not by itself establish that diagnosis. Examine the direction of movement, location and surrounding profile.</p><p>Measure transverse profiles and rut depths, examine cores or pits where justified, and relate the layer geometry to mix and compaction records. A narrow unstable asphalt zone and a broad depression extending through weak lower layers require different remedies. Standing water in ruts adds a safety concern and can accelerate moisture damage.</p><p><strong>Good compaction reduces densification-related rutting; it does not guarantee a rut-free road.</strong> Prevention also requires an appropriate aggregate skeleton and binder, controlled voids and temperatures, adequate layer thickness, drainage, support and workmanship. Mill and replace unsound asphalt where appropriate; if deformation originates deeper, correct that layer rather than merely levelling the visible trough.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Reflection cracking</strong> occurs when movement at an existing crack or joint concentrates strain in a new layer above it. An asphalt overlay over jointed concrete is a clear example: opening and closing, or differential vertical movement across the underlying joint, can initiate a crack in the overlay near the same location. Reflection can also occur over other cracked asphalt or bound layers.</p><table><thead><tr><th scope='col'>Movement being described</th><th scope='col'>Likely question to ask</th></tr></thead><tbody><tr><th scope='row'>Old joint opens or steps beneath the overlay</th><td>Is concentrated movement reflecting through the new layer?</td></tr><tr><th scope='row'>New layer slides along a weak interface</th><td>Is the defect slippage or shear failure requiring bond and material repair?</td></tr><tr><th scope='row'>Whole support settles or moves</th><td>Does the foundation need investigation beyond either crack label?</td></tr></tbody></table>",
                    moreHtml: "<p>Compare the observed crack spacing and alignment with the known underlying joints and repairs. LTPP's joint-reflection description explicitly depends on knowing the slab layout. A regular transverse crack pattern alone does not prove the substrate is concrete, and the time to reflection is not universally one or two seasons.</p><p><strong>Interlayer slippage</strong> is different. If the new layer slides relative to the layer beneath it because the interface is weak, braking or turning can produce crescent-shaped slippage cracks and displacement. Inadequate tack, dust or contamination, poor application and an unstable mixture are possible contributors. This is not necessarily a reflection of an old joint.</p><p>The bank's phrase relative movement of pavement layer is therefore under-specified. For rehabilitation, stabilize deficient support or load transfer where necessary and select an appropriate joint treatment, interlayer, saw-and-seal or reconstruction strategy under an approved design. A stress-absorbing interlayer may reduce or delay reflection, but cannot promise to eliminate movement. Tack improves bond; it is not a universal cure for moving joints.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>A concrete slab can suffer load-related cracking, restrained thermal or shrinkage movement, loss of support, joint damage or material deterioration. <strong>Slab failure</strong> belongs to rigid-pavement behaviour in the bank's conventional distinction; an ordinary asphalt wheel-path rut is not concrete slab flexural failure. But water movement, frost-related damage and some shrinkage mechanisms are not exclusive to one pavement family.</p><table><thead><tr><th scope='col'>Concrete observation</th><th scope='col'>Meaning and investigation</th></tr></thead><tbody><tr><th scope='row'>Crazing / fine surface network</th><td>Shallow fine cracking, often related to surface shrinkage or finishing and curing conditions. Not every single hairline crack is crazing, and shallow crazing is not automatically a through-slab leak or strength failure.</td></tr><tr><th scope='row'>Corner or slab break</th><td>A discrete structural break; examine wheel loading, support, load transfer and existing deterioration.</td></tr><tr><th scope='row'>Joint spalling</th><td>Local breaking at a joint edge; investigate incompressible material, joint movement, bar restraint and weak edge concrete.</td></tr><tr><th scope='row'>Faulting</th><td>A difference in elevation across a joint or crack; support erosion, settlement and poor load transfer can be involved.</td></tr></tbody></table><p><strong>Pumping requires a water and support investigation.</strong> Repeated loading can drive water and erodible fines through openings, leaving voids and reducing support. It is well known at concrete joints, but <strong>it also occurs beneath asphalt</strong>. FHWA's <strong>LTPP Distress Identification Manual, Fifth Revised Edition, May 2014, Chapter 1, distress 15</strong>, explicitly lists water bleeding and pumping for asphalt-concrete surfaces, including fines ejected from support layers through cracks. Chapter 2 separately lists it for jointed concrete.</p>",
                    moreHtml: "<p>Restore a functioning drainage route, investigate erodible or contaminated support, and assess load transfer or structural repairs as appropriate. Joint sealing may reduce ingress but cannot by itself fill an existing support void or restore broken concrete. Grinding can improve a faulted surface's ride without necessarily arresting the underlying process. Diagnose shallow surface defects separately from defects requiring partial-depth, full-depth or slab replacement work.</p>",
                    sources: [
            ...
            cautions: [
                {
                    "id": "check-tran808-00272",
                    "status": "review",
                    "prompt": "After how long can the flexible pavement be opened to the public after its construction?",
                ...
                {
                    "id": "check-tran808-00359",
                    "status": "review",
                    "prompt": "Bleeding in bituminous mix refers to appearance of excess bitumen due to",
                ...
                {
                    "id": "check-tran808-00021",
                    "status": "review",
                    "prompt": "The thin hairline crack is also known as",
                ...
                {
                    "id": "check-tran808-00036",
                    "status": "review",
                    "prompt": "In mass haul diagram, if end is negative what does it mean?",
                ...
                {
                    "id": "check-tran808-00053",
                    "status": "review",
                    "prompt": "Longitudinal ridging due to the channelization of traffic is called as ______",
                ...
                {
                    "id": "check-tran808-00065",
                    "status": "review",
                    "prompt": "One of the probable causes of rutting on flexible pavements is",
                    "html": "<p><strong>Inadequate compaction is one possible rutting cause.</strong> Mix instability, stripping, unsuitable aggregate and weak support can also contribute. A correct possible-cause answer does not justify excluding all other mechanisms.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00065",
                            "set": 7,
                ...
                {
                    "id": "check-tran808-00072",
                    "status": "review",
                    "prompt": "In the penetration macadam construction, the bitumen is.",
                    "html": "<p><strong>Bank check: penetration-macadam key conflict is resolved by §1304.</strong> </p><p>TRAN808-00072 stores <strong>C, binder before aggregates</strong>, while its own explanation describes the opposite. §1304(6) applies binder to rolled coarse aggregate, so its <strong>A</strong> describes the supported sequence. </p><p>Stored questions and keys remain untouched.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00072",
                            "set": 8,
                ...
                {
                    "id": "check-tran808-00073",
                    "status": "review",
                    "prompt": "For sandy soils the most common method of stabilization is",
                ...
                {
                    "id": "check-tran808-00075",
                    "status": "review",
                    "prompt": "Pot hole maintenance in case of bituminous road is",
                ...
                {
                    "id": "check-tran808-00078",
                    "status": "review",
                    "prompt": "Which of the following roller is used to compact the coarse grained soil?",
                    "html": "<p><strong>Vibration is a principal method for suitable granular soils.</strong> Its effectiveness depends on grading, moisture, lift thickness and equipment. That common application does not exclude other suitable compaction methods or all nonplastic silts.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00078",
                            "set": 9,
                ...
                {
                    "id": "check-tran808-00081",
                    "status": "review",
                    "prompt": "The Macadam method of laying roads had cross slope 1 in 36 with well compacted pavement thickness of",
                    "html": "<p>TRAN808-00081's ten-inch explanation converts to 254 mm, approximately 250 mm; 1:36 is about 2.78%. </p><p>Historical authority for the prescription is not established here. </p><p>Neither claim is adopted as a modern size limit, and no guessed replacement answer is supplied.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00081",
                            "set": 9,
                ...
                {
                    "id": "check-tran808-00106",
                    "status": "review",
                    "prompt": "The broken stones that were used in the construction of roads in macadam’s construction road is",
                    "html": "<p><strong>Bank check: historical numbers are not construction specifications.</strong> </p><p>Historical authority for the prescription is not established here. </p><p>TRAN808-00106's 70/100 mm key cannot be reconciled with its less-than-75 mm explanation. </p><p>Neither claim is adopted as a modern size limit, and no guessed replacement answer is supplied.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00106",
                            "set": 11,
                ...
                {
                    "id": "check-tran808-00167",
                    "status": "review",
                    "prompt": "Rutting may be avoided by ______",
                    "html": "<p><strong>Bank check: compaction does not exclude other rutting mechanisms.</strong> </p><p>TRAN808-00167's good-compaction answer reduces densification risk, not all shear, mix-instability or support-related rutting.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00167",
                            "set": 16,
                ...
                {
                    "id": "check-soil136-00344",
                    "status": "review",
                    "prompt": "Method of stabilization can be grouped under ______ main types.",
                    "html": "<p><strong>Bank check: classification and admixture ambiguity.</strong> </p><p>SOIL136-00344's three groups require a named taxonomy, not a universal count. </p><p>The unspecified additive does not uniquely identify the mechanism.</p>",
                    "sources": [
                        {
                            "id": "SOIL136-00344",
                            "set": 27,
                ...
                {
                    "id": "check-soil136-00345",
                    "status": "review",
                    "prompt": "Example of modification of soil property with the help of admixtures is ______",
                    "html": "<p><strong>Bank check: classification and admixture ambiguity.</strong> </p><p>SOIL136-00345's mechanical-stabilization key is defensible for physical soil/aggregate blending, but admixtures can also mean cement, lime or other treatments. </p><p>The unspecified additive does not uniquely identify the mechanism.</p>",
                    "sources": [
                        {
                            "id": "SOIL136-00345",
                            "set": 27,
                ...
                {
                    "id": "check-soil136-00348",
                    "status": "review",
                    "prompt": "For mechanical stabilized bases, liquid limit should not exceed ______",
                ...
                {
                    "id": "check-soil136-00352",
                    "status": "review",
                    "prompt": "The important factor affecting soil cement is ______",
                    "html": "<p>For comparable solids, finer grains have greater specific surface area. </p><p>SOIL136-00352's admixture ranking is also too absolute: soil compatibility, water, dosage, mixing, compaction delay, density and curing jointly control the result. </p><p>No stored key is changed.</p>",
                    "sources": [
                        {
                            "id": "SOIL136-00352",
                            "set": 27,
                ...
                {
                    "id": "check-soil136-00353",
                    "status": "review",
                    "prompt": "The binding action of individual particles through cement is possible only in ______ type of soil.",
                    "html": "<p><strong>Bank check: cement is not restricted to coarse soil.</strong> </p><p>SOIL136-00353's only-coarse-grained wording is false and conflicts with its own acknowledgement of fine-soil treatment. </p><p>For comparable solids, finer grains have greater specific surface area. </p><p>No stored key is changed.</p>",
                    "sources": [
                        {
                            "id": "SOIL136-00353",
                            "set": 27,
                ...
                {
                    "id": "check-tran808-00322",
                    "status": "review",
                    "prompt": "The basic causes of sub-grade failure are",
                ...
                {
                    "id": "check-tran808-00325",
                    "status": "review",
                    "prompt": "Map cracking is",
                    "html": "<p><strong>Map pattern is not a unique fatigue diagnosis.</strong> Alligator fatigue in asphalt, asphalt block cracking and map cracking in concrete have different mechanisms. Use material, location and loading evidence before equating the names.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00325",
                            "set": 30,
                ...
                {
                    "id": "check-tran808-00326",
                    "status": "review",
                    "prompt": "Which of the following is not a type of rigid pavement failure",
                    "html": "<p><strong>Bank check: pumping is explicitly recorded on asphalt surfaces.</strong> </p><p>TRAN808-00326's conventional ruts-versus-slab-distress distinction does not make its explanation's pumping/shrinkage exclusivity correct. </p><p>Investigate water, erosion and support in either pavement system.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00326",
                            "set": 30,
                ...
                {
                    "id": "check-tran808-00329",
                    "status": "review",
                    "prompt": "Bituminous surfacing done on already existing impervious pavement is known as",
                    "html": "<p><strong>Bank check: a tack coat is defined by interlayer bonding.</strong> </p><p>TRAN808-00329's impervious-surface wording alone is too broad to uniquely identify tack. </p><p>Tack is not itself the complete new surfacing.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00329",
                            "set": 30,
                ...
                {
                    "id": "check-tran808-00334",
                    "status": "review",
                    "prompt": "Benkelman Beam is used for",
                ...
                {
                    "id": "check-tran808-00341",
                    "status": "review",
                    "prompt": "Most suitable excavator for dredging purposes is",
                    "html": "<p><strong>Bank check: equipment preferences retain operating conditions.</strong> </p><p>TRAN808-00341's dragline suits appropriate soft/wet below-track excavation among the given choices, not every dredging task. </p>",
                    "sources": [
                        {
                            "id": "TRAN808-00341",
                            "set": 32,
                ...
                {
                    "id": "check-tran808-00342",
                    "status": "review",
                    "prompt": "Downtime of an equipment is",
                ...
                {
                    "id": "check-tran808-00343",
                    "status": "review",
                    "prompt": "Vibrating compactor is ideally suited for",
                    "html": "<p><strong>Vibration is a principal method for suitable granular soils.</strong> Its effectiveness depends on grading, moisture, lift thickness and equipment. That common application does not exclude other suitable compaction methods or all nonplastic silts.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00343",
                ...
                {
                    "id": "check-tran808-00344",
                    "status": "review",
                    "prompt": "A process of transporting material over a stationary structure is",
                ...
                {
                    "id": "check-tran808-00345",
                    "status": "review",
                    "prompt": "Which crusher is primarily used for shaping aggregates?",
                    "html": "<p><strong>Bank check: equipment preferences retain operating conditions.</strong> </p><p>TRAN808-00345 correctly associates VSI with shaping but does not prove jaw/cone products must be flaky. </p>",
                    "sources": [
                        {
                            "id": "TRAN808-00345",
                            "set": 32,
                ...
                {
                    "id": "check-tran808-00346",
                    "status": "review",
                    "prompt": "Highest coefficient of friction for crawler track tractors is on",
                    "html": "<p><strong>Bank check: equipment preferences retain operating conditions.</strong> </p><p>TRAN808-00346's earth-traction answer depends on ground and track conditions; large area reduces ground pressure rather than by itself defining a higher friction coefficient.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00346",
                            "set": 32,
                ...
                {
                    "id": "check-tran808-00348",
                    "status": "review",
                    "prompt": "Alligator cracking in bituminous pavement is mainly due to",
                    "html": "<p><strong>Bank check: map cracking, alligator fatigue and initiation depth.</strong> </p><p>TRAN808-00348's repeated-load fatigue concept is sound, but bottom-up initiation is not the only possible mechanism, and weak subgrade must be distinguished from insufficient pavement thickness.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00348",
                            "set": 32,
                ...
                {
                    "id": "check-tran808-00349",
                    "status": "review",
                    "prompt": "Which is not a cause of alligator cracking?",
                ...
                {
                    "id": "check-tran808-00350",
                    "status": "review",
                    "prompt": "Alligator or map cracking is common failure in",
                    "html": "<p><strong>Map pattern is not a unique fatigue diagnosis.</strong> Alligator fatigue in asphalt, asphalt block cracking and map cracking in concrete have different mechanisms. Use material, location and loading evidence before equating the names.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00350",
                ...
                {
                    "id": "check-tran808-00351",
                    "status": "review",
                    "prompt": "Reflection cracking is observed in",
                    "html": "<p>TRAN808-00351's asphalt-over-concrete example is valid, but other cracked substrates can reflect and a season-or-two timing is not established. </p>",
                    "sources": [
                        {
                            "id": "TRAN808-00351",
                            "set": 32,
                ...
                {
                    "id": "check-tran808-00352",
                    "status": "review",
                    "prompt": "Failure from relative movement of pavement layer",
                    "html": "<p><strong>Bank check: reflection is not every relative layer movement.</strong> </p><p>TRAN808-00352 needs the movement to be at an underlying crack or joint to support reflection; interlayer sliding may instead produce shear/slippage failure.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00352",
                            "set": 33,
                ...
                {
                    "id": "check-tran808-00353",
                    "status": "review",
                    "prompt": "Causes of raveling in bituminous pavement",
                    "html": "<p><strong>Bank check: ravelling and pothole depth.</strong> </p><p>TRAN808-00353's low-binder cause is credible, but correctly designed open grading does not by itself mean failure. </p><p>Potholes can be shallow or deep, and repair depth follows the actual sound-material boundary.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00353",
                            "set": 33,
                ...
                {
                    "id": "check-tran808-00354",
                    "status": "review",
                    "prompt": "Treatment for surfacing on existing black top or concrete road",
                    "html": "<p><strong>Bank check: a tack coat is defined by interlayer bonding.</strong> </p><p>TRAN808-00354 is interpreted as preparation before an overlay, and its spray-of-emulsion option overlaps a possible tack application. </p><p>Tack is not itself the complete new surfacing.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00354",
                            "set": 33,
                ...
                {
                    "id": "check-tran808-00356",
                    "status": "review",
                    "prompt": "Which is not a distress in flexible pavements?",
                    "html": "<p><strong>Bank check: pumping is explicitly recorded on asphalt surfaces.</strong> </p><p>TRAN808-00356's categorical exclusion conflicts with <strong>FHWA-HRT-13-092, Fifth Revised Edition, May 2014, Chapter 1, distress 15</strong>: water and fines can be pumped from support layers through asphalt cracks. </p><p>Investigate water, erosion and support in either pavement system.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00356",
                            "set": 33,
                ...
                {
                    "id": "check-tran808-00357",
                    "status": "review",
                    "prompt": "Stripping of asphalt pavement is primarily due to",
                ...
                {
                    "id": "check-tran808-00358",
                    "status": "review",
                    "prompt": "Defect indicating disintegration by loss of aggregates",
                    "html": "<p><strong>Bank check: ravelling and pothole depth.</strong> </p><p>TRAN808-00358 correctly identifies progressive aggregate loss as ravelling; its explanation wrongly requires a pothole to remove the full layer. </p><p>Potholes can be shallow or deep, and repair depth follows the actual sound-material boundary.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00358",
                            "set": 33,
                ...
                {
                    "id": "check-tran808-00364",
                    "status": "review",
                    "prompt": "In penetration macadam construction, bitumen is",
                    "html": "<p><strong>Bank check: penetration-macadam key conflict is resolved by §1304.</strong> </p><p>TRAN808-00364's <strong>A, after aggregate compaction</strong>, is consistent. </p><p>Follow with key aggregate and its rolling, then the specified seal; do not omit that intermediate operation. </p><p>Stored questions and keys remain untouched.</p>",
                    "sources": [
                        {
                            "id": "TRAN808-00364",
                            "set": 33,
