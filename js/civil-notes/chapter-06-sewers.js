        ...
        ACiE0604: {
            ...
            blocks: [
                ...
                },
                {
                    ...
                    html: "<p>For contributing population P, per-capita water use q<sub>w</sub> in L/(person·day), and dimensionless sewer return fraction r, average domestic wastewater is <strong>Q<sub>d</sub> = Pq<sub>w</sub>r</strong> in L/day. Divide by 1000 for m<sup>3</sup>/day or by 86,400 for L/s. Litres per capita per day describe a generation rate, not the total flow in a trunk sewer.</p><p>The return fraction accounts for water not reaching the sewer, such as some outdoor consumption or evaporation. The bank's 80% is an assumption frequently used in elementary estimates, not a universal measured fraction. Water supplied from private wells may enter sewers without appearing in utility consumption records.</p><p><strong>Hypothetical example:</strong> P = 10,000 people, q<sub>w</sub> = 120 L/(person·day) and r = 0.80 give <strong>960,000 L/day = 960 m<sup>3</sup>/day = 11.1111 L/s</strong> domestic wastewater. These inputs are not a prescribed Nepal design demand.</p>",
                    moreHtml: "<p>Add institutional, commercial or industrial discharges only where they are not already included in the population-based estimate. Infiltration and direct inflow require separate assessment. Population served, connection uptake, daily use and industrial schedules can all change over time. An unauthorised connection is a potential flow source and a management issue, not a fixed percentage that can be inserted without investigation.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Infiltration</strong> is groundwater entering through defects such as cracked pipes, faulty joints or leaking structures. <strong>Inflow</strong> is more direct entry through connections or openings, including inappropriate roof drains, surface drains and flooded covers. Together they are often abbreviated I&amp;I, but their timing and remedies differ.</p><p>Rain can cause rapid inflow and delayed infiltration as groundwater rises. A sanitary sewer can therefore have wet-weather excess flow without being an intentionally combined sewer. Groundwater infiltration may also persist in dry weather, so dry-weather flow is not necessarily pure domestic sewage.</p><p><strong>Exfiltration</strong> is leakage out of the sewer when the hydraulic conditions drive wastewater towards the surrounding ground. Leakage direction can change with external groundwater and internal water levels. A joint that admits groundwater in one season may release sewage under a different pressure condition.</p>",
                    moreHtml: "<p>Investigate flow records alongside rainfall, groundwater and connection surveys. Remote inspection and approved testing can help distinguish structural defects from inappropriate connections. Repairs should target the cause, while checking whether groundwater entry simply shifts to another defect. I&amp;I increases conveyance and treatment loads, but dilution does not remove the underlying pollutant mass or make an overflow acceptable. No universal infiltration allowance can be inferred from a definition question.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension; the entire dataset is hypothetical.</strong> The bank does not provide a complete measured domestic profile, industrial schedule or I&amp;I record. Assume domestic average flow 11.1111 L/s, corresponding to 10,000 people using 120 L/(person·day) with an 80% return. Add steady industrial flow of 3 L/s and groundwater infiltration of 2 L/s.</p><p>For this illustration only, assume the domestic peak is 2.5 times its average and the domestic minimum is 0.25 times its average. Assume an additional 10 L/s wet-weather inflow coincides with the domestic peak. Keep unrounded domestic flow in the calculations.</p><table><thead><tr><th scope='col'>Condition</th><th scope='col'>Flow, L/s</th></tr></thead><tbody><tr><th scope='row'>Average dry weather</th><td>11.1111 + 3 + 2 = 16.1111</td></tr><tr><th scope='row'>Peak dry weather</th><td>2.5 × 11.1111 + 3 + 2 = 32.7778</td></tr><tr><th scope='row'>Minimum dry weather</th><td>0.25 × 11.1111 + 3 + 2 = 7.7778</td></tr><tr><th scope='row'>Coincident wet-weather peak</th><td>32.7778 + 10 = 42.7778</td></tr></tbody></table><p>The wet peak is 0.0427778 m<sup>3</sup>/s. Applying the 2.5 multiplier to every contribution would incorrectly peak the assumed steady flows. Adding wet-weather inflow to the minimum dry-weather case would describe a different condition.</p>",
                    moreHtml: "<p>These values demonstrate component accounting, not a prescribed flow allowance. Actual minimum industrial flow, infiltration and peak coincidence may differ; measurements and development scenarios determine which combinations govern capacity and deposition checks.</p>",
                    sources: []
                },
                {
                    id: "sewer-separate-combined-and-partial-systems",
                    title: "Classify systems by the intended flow paths, not by population size",
                    html: "<p>A <strong>separate system</strong> provides distinct sanitary and stormwater conveyance paths. A <strong>combined system</strong> intentionally carries sanitary wastewater and storm runoff in one network. Sanitary wastewater can include domestic, commercial and industrial contributions; domestic and industrial sewage alone do not define a combined storm-sanitary system.</p><p>Partially separate or partially combined terminology describes arrangements in which selected runoff joins sanitary flow while other drainage remains separate. The actual connected catchments must be drawn and quantified: the label alone does not specify the volume or treatment route.</p><p>Dry-weather flow generally includes sanitary contributions and any persistent extraneous flow. Consequently sewage plus rainwater and dry-weather flow plus rainwater can overlap in meaning under common elementary usage; they are not reliably exclusive answer choices.</p>",
                    moreHtml: "<p>Storm sewers collect runoff from roofs, streets, parking and other connected surfaces. Their outlets still need receiving-water and erosion assessment; stormwater is not automatically clean. Separate sanitary pipes should not intentionally accept unlimited runoff merely because an I&amp;I allowance is included.</p><p>Trace each source through its lateral, main, interceptor and treatment or permitted discharge route. A wet-weather overflow from a sanitary system is a malfunction or exceedance to investigate, not proof that it was correctly designed as combined. Water-carriage sanitation can use different network types and does not mean stormwater alone.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension:</strong> the bank lacks rainfall time series, storage geometry, downstream levels and complete combined-system hydrographs. A peak estimate alone cannot determine storage volume or overflow duration. Continuity gives <strong>dS/dt = Q<sub>in</sub> − Q<sub>out</sub></strong>, with storage S in m<sup>3</sup>, flow in m<sup>3</sup>/s and time in seconds.</p><p>Integrate the flow difference over the event, respecting the starting storage, outlet relation and physical storage bounds. The maximum accumulated excess determines the required active storage for the assumed operation, not peak discharge multiplied by an arbitrary duration.</p><p><strong>Hypothetical simplified pulse:</strong> initially empty storage receives 0.40 m<sup>3</sup>/s for 20 minutes while a controlled outlet passes 0.25 m<sup>3</sup>/s. Accumulation is (0.40 − 0.25) × 1200 = <strong>180 m<sup>3</sup></strong>. This excludes freeboard, sediment space and other allowances and assumes that the stated outlet can actually discharge throughout the pulse.</p>",
                    moreHtml: "<p>Downstream backwater can reduce outlet capacity and cause surcharge or reverse flow. EPA's SWMM capability description supports routing runoff, dry-weather flow and I&amp;I with appropriate hydraulic models, including dynamic-wave representation of such effects. Software still requires verified levels, connections and calibration; a uniform-flow calculation is not a surcharge model. Storage and overflow controls need receiving-water protection and operating plans, not permission for untreated disposal.</p>",
                    sources: []
                },
                {
                    id: "sewer-functional-hierarchy-and-pressure",
                    title: "Laterals, trunks, interceptors and force mains have different functions",
                    html: "<p>House connections discharge into local collecting sewers; branches combine local flows and larger mains or trunks convey accumulated flow onward. Naming conventions vary, so a plan should identify actual connections and contributing areas rather than infer capacity from a name alone.</p><p>An <strong>intercepting sewer</strong> receives flow from existing sewers or outfalls and redirects it towards treatment or another controlled destination. It may be used to intercept former direct discharges along a river. This is a large-scale collection function, not an intercepting trap's gas-seal function at a house drain.</p><p>A <strong>force main</strong> normally carries pumped wastewater under pressure. A gravity sewer ordinarily has a free water surface, although it can surcharge under adverse conditions. A depressed crossing, conventionally called an inverted siphon, also operates full under pressure but is driven by the available upstream-to-downstream head rather than necessarily by a pump.</p>",
                    moreHtml: "<p>At each junction, continuity requires downstream flow to equal the concurrent incoming flows plus local contribution, allowing for any defined storage or diversion. Do not add every tributary's independent peak without checking timing. Profile, energy losses and downstream level determine whether gravity is feasible. Selecting an interceptor or pressure crossing must also address low-flow sediment, maintenance, failure consequences and treatment capacity, not just whether the alignment reaches the receiving point.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>For a given enclosed area, a circle has the smallest enclosing perimeter, giving a favourable full-flow hydraulic radius. Circular pipes are also convenient to manufacture and join and can develop effective ring action under external load. These advantages explain their widespread use in both separate and combined sewerage.</p><p>Combined flow can vary greatly between dry weather and storms. An egg-shaped section with a narrow invert can concentrate low flow while providing a larger upper area for storms. Rectangular or other noncircular conduits can suit particular drainage, structural or space constraints. Their hydraulic elements must be calculated from their actual shape, not circular-pipe ratios.</p><p>Compare area A, wetted perimeter P<sub>w</sub> and hydraulic radius R = A/P<sub>w</sub> at the <strong>operating depth</strong>. Full-section efficiency alone does not establish low-flow sediment transport. A narrow invert can improve one condition while complicating construction, inspection or sediment removal elsewhere.</p>",
                    moreHtml: "<p>The bank offers circular as the most suitable combined-system shape without defining the flow range or alternatives completely. It is a common practical choice, not a universal optimum. Check manufacturability, structural strength, corrosion resistance, flow variability, maintenance and cost. Even within one circular section, velocity and discharge do not increase monotonically all the way to full depth.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension:</strong> sewer materials are explicit official scope, but the assigned bank provides no complete material-selection or structural-class dataset. Selection combines hydraulic, chemical, structural, construction and maintenance requirements. A smooth new pipe is not automatically the best pipe for every buried environment.</p><table><thead><tr><th scope='col'>Material family</th><th scope='col'>Issues to assess</th></tr></thead><tbody><tr><th scope='row'>Concrete or reinforced concrete</th><td>Load capacity, joints and protection where sulfide-related acid corrosion or aggressive ground is relevant.</td></tr><tr><th scope='row'>Vitrified clay</th><td>Chemical resistance alongside brittle handling behaviour, bedding and joint integrity.</td></tr><tr><th scope='row'>PVC or polyethylene</th><td>Pipe-soil interaction, deformation, stiffness, temperature and appropriate jointing; pressure duty needs a suitable product.</td></tr><tr><th scope='row'>Ductile iron, steel or composites</th><td>Pressure or special-crossing needs, corrosion protection, joints and product-specific structural behaviour.</td></tr></tbody></table><p>Material standards must be matched to the product and application. No claim that ISO 4437 specifies sewer-water velocity or that IS 2430 is a sewer-design standard is used here. Product certification, local requirements and project-specific acceptance criteria remain necessary rather than invented from an unrelated standard number.</p>",
                    moreHtml: "<p>Assess wastewater composition, groundwater, traffic loads, burial, construction access, abrasion and expected service conditions. Distinguish nominal diameter from the actual internal diameter used in hydraulic calculations, and distinguish pressure rating from buried external-load performance.</p>",
                    sources: []
                },
                {
                    id: "sewer-buried-pipe-and-joints",
                    title: "Buried pipe-soil behaviour and watertight joints — Syllabus extension",
                    html: "<p><strong>Syllabus extension:</strong> the bank lacks cover, soil stiffness, trench geometry, external loads and structural pipe properties for a buried-pipe design. Rigid and flexible pipes interact differently with their surroundings. Flexible pipes mobilise side support as they deform; rigid pipes depend strongly on bedding support and their structural resistance.</p><p>Check earth and traffic loads, bedding and haunch support, joint movement, allowable deformation and local ground settlement. Groundwater can add external pressure or buoyancy, especially when a pipe is empty. Adequate hydraulic capacity does not prove resistance to crushing, buckling, flotation or excessive deformation.</p><p>Joints must maintain alignment and watertightness while accommodating the movements for which they were designed. Poor joints allow groundwater infiltration, sewage exfiltration, soil migration or root entry. A connection to a rigid manhole may need different movement accommodation from a straight pipe-to-pipe joint.</p>",
                    moreHtml: "<p>Specify compatible pipes, seals, fittings and installation tolerances, then verify their condition during construction and acceptance. Roughness n in a hydraulic formula is not structural stiffness, and a pressure class is not a substitute for a buried-load calculation. Seismic movement, differential settlement and aggressive ground can govern even where the nominal pipe size and slope appear adequate. The missing data prevent a defensible numerical cover or pipe-class prescription.</p>",
                    sources: []
                },
                {
                ...
                },
                {
                    ...
                    html: "<p><strong>Syllabus extension:</strong> the assigned questions do not provide a complete Manning design dataset. For the conventional SI relation, <strong>v = (1/n)R<sup>2/3</sup>S<sub>f</sub><sup>1/2</sup></strong> and <strong>Q = Av</strong>. A is flowing area in m<sup>2</sup>, R = A/P<sub>w</sub> is hydraulic radius in metres, P<sub>w</sub> is wetted perimeter in metres, and S<sub>f</sub> is friction slope in m/m.</p><p>Velocity is m/s and discharge m<sup>3</sup>/s. In dimensional SI form, n has units s/m<sup>1/3</sup>; its numerical value depends on the unit convention. Do not insert the US-customary coefficient into the SI formula or use diameter in millimetres while retaining metre-based parameters.</p>",
                    moreHtml: "<p>Equating friction slope to the bed slope assumes steady uniform flow in the reach. Backwater, junction losses, rapidly changing discharge and pressurisation require additional hydraulic analysis. A pipe's geometric fall alone does not determine its actual energy gradient under surcharge.</p><p>Roughness reflects the relevant surface and operating condition, including joints, ageing, deposits and biofilm. Use a justified value or sensitivity range, not an unexplained constant copied from a material name. The formula is empirical; it is not derived solely from dimensional analysis. Continuity and correct section geometry allow its consistent application, but neither equation proves self-cleansing, structural adequacy or acceptable overflow risk.</p>",
                    sources: []
                },
                {
                ...
                },
                {
                    ...
                    html: "<p>Let n<sub>p</sub> and n<sub>f</sub> be Manning roughness for partial flow and the full reference. For the same friction slope, <strong>v/v<sub>f</sub> = (n<sub>f</sub>/n<sub>p</sub>)[(θ − sin θ)/θ]<sup>2/3</sup></strong>. Multiplying by area ratio gives the complete expression:</p><p><strong>q/Q<sub>f</sub> = (n<sub>f</sub>/n<sub>p</sub>) [(θ − sin θ)/(2π)] [(θ − sin θ)/θ]<sup>2/3</sup></strong>. If friction slopes differ, also multiply by √(S<sub>p</sub>/S<sub>f</sub>). A bare θ − sin θ omits normalisation and the hydraulic-radius contribution and is not a discharge ratio.</p><table><thead><tr><th scope='col'>y/D</th><th scope='col'>a/A<sub>f</sub></th><th scope='col'>v/v<sub>f</sub></th><th scope='col'>q/Q<sub>f</sub></th></tr></thead><tbody><tr><th scope='row'>0.25</th><td>0.195501</td><td>0.700670</td><td>0.136982</td></tr><tr><th scope='row'>0.50</th><td>0.500000</td><td>1.000000</td><td>0.500000</td></tr><tr><th scope='row'>0.75</th><td>0.804499</td><td>1.133473</td><td>0.911878</td></tr></tbody></table>",
                    moreHtml: "<p>The table is a mathematical comparison assuming <strong>constant equal n and equal slope</strong>, not measured sewer performance. At half depth, velocity equals the full-reference velocity only with those assumptions. A variable-roughness chart incorporates an additional empirical assumption and must not be mixed silently with this constant-n table. Calculate θ in radians and retain precision until the final result; a plausible-looking area fraction cannot repair the bank's incomplete formula.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>With constant n and friction slope, velocity increases with hydraulic radius, not with area alone. Differentiating <strong>r/R<sub>f</sub> = 1 − sin θ/θ</strong> gives a stationary point where <strong>sin θ − θ cos θ = 0</strong>. The relevant interior root is θ ≈ 4.49341 rad, giving <strong>y/D ≈ 0.81280</strong> and <strong>v/v<sub>f</sub> ≈ 1.14003</strong>.</p><p>Discharge additionally includes increasing area. Differentiating the complete constant-n discharge expression gives <strong>5θ(1 − cos θ) = 2(θ − sin θ)</strong>. Its relevant root gives <strong>y/D ≈ 0.93818</strong> and <strong>q/Q<sub>f</sub> ≈ 1.07571</strong>. Thus maximum velocity and maximum discharge occur at different depths.</p><p>At 0.90D, discharge is about 1.0658 times full-flow discharge; at full depth the ratio is 1.0. Discharge therefore does not rise throughout the entire depth range. <strong>Wetted perimeter does increase continuously</strong>; the revised Model 6 Q97 now asks for that quantity and keys option A.</p>",
                    moreHtml: "<p>These maxima belong to the stated idealised Manning model. Variable roughness shifts them, and a pressurised sewer is governed by available head rather than this free-surface depth curve. Values between full-reference capacity and the partial-flow maximum can correspond to two normal-depth branches; solving an equation requires identifying the physical regime and boundary conditions, not selecting an arbitrary root.</p>",
                ...
                },
                {
                    ...
                    html: "<p>The <strong>invert</strong> is the lowest internal level of a sewer. A gravity profile must connect the required upstream and downstream inverts while providing the selected fall and accommodating junctions, crossings and structures. Surface slope and pipe slope are not necessarily equal.</p><p>A dumpy or automatic level can transfer elevations from a reliable benchmark; modern survey instruments may also be used with appropriate control. Independent checks of benchmarks, instrument setup, chainage and closing error matter more than the instrument name alone. Construction lasers or sighting devices do not replace the underlying level survey.</p><p><strong>Hypothetical profile:</strong> upstream invert RL 100.500 m, horizontal reach length 80 m and downward gradient 1 in 250 give a fall of 80/250 = <strong>0.320 m</strong> and downstream invert RL <strong>100.180 m</strong>. An accidental sign reversal would create a rise instead of the intended fall.</p>",
                    moreHtml: "<p>Ground cover is measured to the relevant <strong>outside crown</strong>, not automatically to invert plus nominal diameter; wall thickness and actual bore must be considered. Check cover, utility separation and ground support along the whole reach, not just at its ends. Changes in direction or gradient normally require a defined inspection and maintenance arrangement. Record actual installed levels and deviations because an unrecorded sag can retain solids despite the correct average end-to-end gradient.</p>",
                    sources: [
                ...
                },
                {
                    ...
                    html: "<p>An inverted siphon is a depressed sewer crossing beneath an obstruction such as a river, road or utility. It normally runs full under pressure. Despite the name, it is not a true siphon lifted above the upstream water surface. Available head must cover friction, entrance, exit and other local losses.</p><p>For a constant circular bore, <strong>v = 4Q/(πD<sup>2</sup>)</strong> and a simplified Darcy–Weisbach loss is <strong>h<sub>L</sub> = [f<sub>D</sub>L/D + ΣK]v<sup>2</sup>/(2g)</strong>. Use D and L in metres, Q in m<sup>3</sup>/s, dimensionless Darcy factor f<sub>D</sub> and appropriately referenced local coefficients K.</p><p><strong>Hypothetical example:</strong> Q = 0.030 m<sup>3</sup>/s, D = 0.200 m, L = 60 m, f<sub>D</sub> = 0.025 and ΣK = 3 give v ≈ <strong>0.95493 m/s</strong> and h<sub>L</sub> ≈ <strong>0.48802 m</strong>. The example assumes the stated loss model and does not establish actual upstream or downstream levels.</p>",
                    moreHtml: "<p>Several barrels may allow different flows to be conveyed while preserving useful velocities, but multiple barrels are not an automatic guarantee against deposition. A suitably designed barrel can provide cleansing at its operating flow; the claim that every inverted siphon cannot self-clean is too absolute. Check low flow, sediment, access, blockage, redundancy, buoyancy, structural protection and receiving levels before adopting the crossing.</p>",
                ...
                },
                {
                    ...
                    moreHtml: "<p>A trap retains a water seal between the occupied space and foul drainage air. Siphonage or positive pressure can disturb that seal; evaporation can also remove it. An anti-siphonage or vent connection helps control pressure at the protected trap arrangement. The bank's top-of-P-trap wording is a simplified description, not a complete connection detail or a reason to connect indiscriminately to any point.</p><p>An intercepting trap is a traditional trap at the house-drain/public-sewer interface. It is not an intercepting sewer. Whether it is required or appropriate depends on the governing building-drainage design; additional trapping can introduce headloss and maintenance demands and should not be assumed universally beneficial.</p><p>Ventilation helps protect seals and manage foul air, but it does not make a sewer chamber safe to enter. Coordinate fixture loading, pipe slopes, clean-outs, vent routes and permitted connection details using the applicable plumbing requirements. Neither a trap nor a vent replaces watertight construction, routine maintenance or protection against surcharge backing into the building.</p>",
                    sources: [
            ...
            gaps: [
                "All 57 assigned root-question records are cited in related substantive blocks, including the four BASI-prefixed building-drainage records.",
            ...
            cautions: [
                {
                    "id": "check-wate813-00186",
                    "status": "review",
                    "prompt": "Minimum size of public sewer should not be less than ...",
                    "html": "<p><strong>150 mm is not a universal minimum for every sewer or house drain.</strong> </p><p>It is the bank's public-sewer teaching value without a verified applicable edition here. </p><p>Appropriate 100 mm house-drain applications exist subject to plumbing requirements and loading. </p><p>Do not extend a public-network convention to every connection or pressure system.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00186",
                            "set": 1,
                ...
                {
                    "id": "check-wate813-00202",
                    "status": "review",
                    "prompt": "...is additional flow through sewers available during rainy season?",
                    "html": "<p>Groundwater entry through defects is infiltration, and it may persist in dry weather. </p><p>Direct surface-water entry is inflow. </p><p>Wet-weather excess in a sanitary sewer does not make it an intentionally combined system.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00202",
                            "set": 1,
                ...
                {
                    "id": "check-wate813-00222",
                    "status": "review",
                    "prompt": "A combined sewage system collectively carries",
                    "html": "<p><strong>The combined-system choices overlap.</strong> </p><p>Domestic and industrial wastewater alone do not define storm-sanitary combination. </p><p>Preserve the intended system distinction without treating synonymous options as independent facts.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00222",
                            "set": 1,
                ...
                {
                    "id": "check-wate813-00047",
                    "status": "corrected",
                    "prompt": "For a circular sewer, which quantity increases continuously as water depth rises from empty to full?",
                    "html": "<p><strong>Corrected: wetted perimeter, option A.</strong> Perimeter increases throughout the depth range. Velocity and discharge can peak before the pipe is full, so the former unconditional discharge key was incorrect.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00047",
                            "set": 6,
                ...
                {
                    "id": "check-wate813-00048",
                    "status": "review",
                    "prompt": "Inverted siphon is provided when",
                ...
                {
                    "id": "check-wate813-00049",
                    "status": "review",
                    "prompt": "Why is air gap left at the top of sewers?",
                ...
                {
                    "id": "check-wate813-00052",
                    "status": "review",
                    "prompt": "The legal entity that is responsible for the wastewater collection system is called ______",
                    "html": "<p><strong>Sewer system agency is a descriptive term, not a verified universal statutory name.</strong> </p><p>Ownership, maintenance, treatment interfaces and regulatory duties depend on the applicable local arrangements. </p><p>These definition questions do not identify a particular Nepal legal entity.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00052",
                            "set": 7,
                ...
                {
                    "id": "check-wate813-00053",
                    "status": "review",
                    "prompt": "The minimum size of sewer is",
                    "html": "<p><strong>150 mm is not a universal minimum for every sewer or house drain.</strong> </p><p>Appropriate 100 mm house-drain applications exist subject to plumbing requirements and loading. </p>",
                    "sources": [
                        {
                            "id": "WATE813-00053",
                            "set": 7,
                ...
                {
                    "id": "check-wate813-00054",
                    "status": "review",
                    "prompt": "A manhole is classified as shallow if its depth is between",
                    "html": "<p><strong>Shallow depth does not imply a light cover or safe atmosphere.</strong> </p>",
                    "sources": [
                        {
                            "id": "WATE813-00054",
                            "set": 7,
                ...
                {
                    "id": "check-wate813-00180",
                    "status": "review",
                    "prompt": "The water carried sewerage system removes",
                ...
                {
                    "id": "check-wate813-00182",
                    "status": "review",
                    "prompt": "Factor affecting sanitary sewage are",
                    "html": "<p><strong>Count the actual contributing flows.</strong> Population, per-capita water use and return fraction affect domestic sewage; industrial/private supplies and infiltration or inflow may need separate additions. Avoid counting a contribution twice.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00182",
                            "set": 19,
                ...
                {
                    "id": "check-wate813-00183",
                    "status": "review",
                    "prompt": "Sanitary sewage produced is generally expressed as:",
                    "html": "<p><strong>A per-capita rate is not total discharge.</strong> A value in L/(person day) needs the contributing population to become L/day. Non-domestic flows require their own compatible basis.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00183",
                            "set": 19,
                ...
                {
                    "id": "check-wate813-00185",
                    "status": "review",
                    "prompt": "Minimum velocity in sewer depends upon",
                    "html": "<p><strong>Velocity ranges need a named application and design basis.</strong> </p><p>Approximately 0.6–0.9 m/s minimum and 2.5–3.0 m/s maximum are legacy teaching ranges, not universal limits for every material and deposit. </p><p>The asserted 0.6 present/0.9 ultimate requirement is not independently established here. </p><p>Check actual low-flow depth, sediment behaviour and abrasion separately.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00185",
                            "set": 19,
                ...
                {
                    "id": "check-wate813-00187",
                    "status": "review",
                    "prompt": "Testing of sewer is done by which of the following methods",
                ...
                {
                    "id": "check-wate813-00188",
                    "status": "review",
                    "prompt": "Which of the following test of the sewer is done by placing a mirror at one end?",
                ...
                {
                    "id": "check-wate813-00190",
                    "status": "review",
                    "prompt": "For large sewers, the maximum distance between manholes should be",
                    "html": "<p>Changes of alignment, gradient, size and junctions commonly require access, but the source's 30 m building-drain interval and 300 m large-sewer spacings are not established as universal requirements here. </p>",
                    "sources": [
                        {
                            "id": "WATE813-00190",
                            "set": 20,
                ...
                {
                    "id": "check-wate813-00191",
                    "status": "review",
                    "prompt": "The lower portion of manhole is known as",
                    "html": "<p>The 0.7–0.9 m classification is an unverified convention here; cover loading depends on actual traffic and imposed loads. </p><p>Working chamber describes a part of the structure, not automatic authorisation for workers to stand inside it.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00191",
                            "set": 20,
                ...
                {
                    "id": "check-wate813-00192",
                    "status": "review",
                    "prompt": "The minimum diameter of a manhole covered by the seal is",
                    "html": "<p><strong>A 50 cm opening does not establish safe access with a harness or rescue equipment.</strong> </p><p>The source's minimum is not independently verified. </p><p>Neither dimension nor shape substitutes for a qualified confined-space system.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00192",
                            "set": 20,
                ...
                {
                    "id": "check-wate813-00193",
                    "status": "review",
                    "prompt": "Manholes on sewer lines are provided for a periodic cleaning",
                    "html": "<p><strong>Manholes provide access and hydraulic connections, not guaranteed oxidation treatment.</strong> </p><p>Ventilation and cleaning are distinct functions, and the malformed all-of-these source wording should not imply that routine entry or deliberate exposure to sewer gases is acceptable. </p>",
                    "sources": [
                        {
                            "id": "WATE813-00193",
                            "set": 20,
                ...
                {
                    "id": "check-wate813-00194",
                    "status": "review",
                    "prompt": "A drop manhole is provided if",
                    "html": "<p>The cited questions provide no verified universal height threshold, and a drop arrangement must control energy, air, abrasion and maintenance access.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00194",
                            "set": 20,
                ...
                {
                    "id": "check-wate813-00195",
                    "status": "review",
                    "prompt": "The equipment used for checking the levels of the sewer inverts is",
                ...
                {
                    "id": "check-wate813-00196",
                    "status": "review",
                    "prompt": "Ventilation of house drainage is required if",
                    "html": "<p><strong>Trap and vent identification is not a complete plumbing detail.</strong> </p><p>House-drain ventilation protects pressure conditions but does not certify a safe sewer atmosphere.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00196",
                            "set": 20,
                ...
                {
                    "id": "check-wate813-00199",
                    "status": "review",
                    "prompt": "The internal diameter of the sewer should not be less than",
                    "html": "<p><strong>Minimum diameter depends on the system.</strong> The bank's 150 mm public-sewer convention is not a universal minimum for every house drain or pressure pipe. Adopt the applicable plumbing or sewer standard and verify loading and maintenance access.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00199",
                            "set": 20,
                ...
                {
                    "id": "check-wate813-00201",
                    "status": "review",
                    "prompt": "The quantity of wastewater is assumed to be...% of the quantity of water supply.",
                    "html": "<p><strong>Eighty percent is an assumed return fraction.</strong> Actual wastewater return depends on consumptive uses, private supply and network inflow/infiltration. Do not treat 80% as a measured value for every catchment.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00201",
                            "set": 21,
                ...
                {
                    "id": "check-wate813-00203",
                    "status": "review",
                    "prompt": "...is the process in which ground water infiltrate in to the sewers",
                    "html": "<p><strong>Rain-related excess can be inflow or delayed infiltration.</strong> </p><p>Direct surface-water entry is inflow. </p>",
                    "sources": [
                        {
                            "id": "WATE813-00203",
                            "set": 21,
                ...
                {
                    "id": "check-wate813-00205",
                    "status": "review",
                    "prompt": "Which of the following is an advantage of sewer as sewer?",
                ...
                {
                    "id": "check-wate813-00207",
                    "status": "review",
                    "prompt": "If sizes of the sewers are ... choking problems are less.",
                ...
                {
                    "id": "check-wate813-00208",
                    "status": "review",
                    "prompt": "In which kind of cities are combined systems used?",
                    "html": "<p><strong>Low population does not universally favour a combined system.</strong> </p>",
                    "sources": [
                        {
                            "id": "WATE813-00208",
                            "set": 21,
                ...
                {
                    "id": "check-wate813-00209",
                    "status": "review",
                    "prompt": "The treatment is costly in which of the following systems?",
                    "html": "<p>Runoff, existing assets, topography, treatment, receiving-water protection and whole-life cost determine the choice. </p><p>Combined wet-weather loads can increase treatment cost, but that is not a complete universal cost ranking.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00209",
                            "set": 21,
                ...
                {
                    "id": "check-wate813-00211",
                    "status": "review",
                    "prompt": "A masonry or RCC chamber constructed at suitable intervals along the sewer lines, for providing access into them is called ______.",
                    "html": "<p>Ventilation and cleaning are distinct functions, and the malformed all-of-these source wording should not imply that routine entry or deliberate exposure to sewer gases is acceptable. </p>",
                    "sources": [
                        {
                            "id": "WATE813-00211",
                            "set": 21,
                ...
                {
                    "id": "check-wate813-00212",
                    "status": "review",
                    "prompt": "What is the spacing of manholes for pipe diameter of greater than 2 m?",
                    "html": "<p><strong>Manhole spacing requires an applicable edition and equipment context.</strong> </p><p>Large diameter does not automatically justify wider spacing or personnel entry.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00212",
                            "set": 22,
                ...
                {
                    "id": "check-wate813-00214",
                    "status": "review",
                    "prompt": "Storm water flow or run off is given by",
                ...
                {
                    "id": "check-wate813-00215",
                    "status": "review",
                    "prompt": "Camp Shield formula for self-cleansing velocity is given by which of the following equations?",
                ...
                {
                    "id": "check-wate813-00216",
                    "status": "review",
                    "prompt": "For a circular sewer running partially full, the expression for proportion depth d/D is equal to",
                ...
                {
                    "id": "check-wate813-00217",
                    "status": "review",
                    "prompt": "For a circular sewer running partially full, the expression for proportional discharge q/Q is equal to",
                ...
                {
                    "id": "check-wate813-00219",
                    "status": "review",
                    "prompt": "The means of access for inspection and cleaning of sewer line is known as",
                    "html": "<p>Ventilation and cleaning are distinct functions, and the malformed all-of-these source wording should not imply that routine entry or deliberate exposure to sewer gases is acceptable. </p><p>Prefer remote inspection where practicable.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00219",
                            "set": 22,
                ...
                {
                    "id": "check-wate813-00223",
                    "status": "review",
                    "prompt": "The drop manholes are provided in sewerage system when there is",
                    "html": "<p><strong>A drop addresses an incoming-to-receiving invert difference.</strong> </p><p>It is not required merely because a sewer changes alignment or size. </p>",
                    "sources": [
                        {
                            "id": "WATE813-00223",
                            "set": 23,
                ...
                {
                    "id": "check-wate813-00224",
                    "status": "review",
                    "prompt": "Manhole covers are made circular",
                    "html": "<p><strong>A 50 cm opening does not establish safe access with a harness or rescue equipment.</strong> </p><p>Circular-cover geometry helps only with a correctly sized matching seat; damaged or wrongly fitted covers remain hazardous. </p><p>Neither dimension nor shape substitutes for a qualified confined-space system.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00224",
                            "set": 23,
                ...
                {
                    "id": "check-wate813-00225",
                    "status": "review",
                    "prompt": "The most suitable sewer in combined sewerage system is",
                ...
                {
                    "id": "check-wate813-00226",
                    "status": "review",
                    "prompt": "Sewerage system is usually designed for",
                ...
                {
                    "id": "check-wate813-00227",
                    "status": "review",
                    "prompt": "Which one of the following options is true for combined system of sewerage system?",
                    "html": "<p><strong>The combined-system choices overlap.</strong> </p><p>Sewage plus rainwater and dry-weather flow plus rainwater can describe the same elementary arrangement. </p><p>Preserve the intended system distinction without treating synonymous options as independent facts.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00227",
                            "set": 23,
                ...
                {
                    "id": "check-basi674-00384",
                    "status": "review",
                    "prompt": "The trap which is provided to disconnect the house drain from the street sewer is called:",
                    "html": "<p><strong>Trap and vent identification is not a complete plumbing detail.</strong> </p><p>Intercepting traps are not universally required or interchangeable with intercepting sewers. </p><p>House-drain ventilation protects pressure conditions but does not certify a safe sewer atmosphere.</p>",
                    "sources": [
                        {
                            "id": "BASI674-00384",
                            "set": 30,
                ...
                {
                    "id": "check-basi674-00391",
                    "status": "review",
                    "prompt": "Anti-siphonage pipe is connected to",
                    "html": "<p><strong>Trap and vent identification is not a complete plumbing detail.</strong> </p><p>The top-of-P-trap answer is simplified; actual anti-siphonage connections require the governing layout. </p>",
                    "sources": [
                        {
                            "id": "BASI674-00391",
                            "set": 30,
                ...
                {
                    "id": "check-basi674-00401",
                    "status": "review",
                    "prompt": "The inspection pit or chamber is a manhole provided in a base drainage system",
                    "html": "<p><strong>Manhole spacing requires an applicable edition and equipment context.</strong> </p><p>Changes of alignment, gradient, size and junctions commonly require access, but the source's 30 m building-drain interval and 300 m large-sewer spacings are not established as universal requirements here. </p>",
                    "sources": [
                        {
                            "id": "BASI674-00401",
                            "set": 31,
                ...
                {
                    "id": "check-basi674-00403",
                    "status": "review",
                    "prompt": "The diameter of a domestic sewer pipe laid at gradient 1 in 100 is recommended",
                ...
                {
                    "id": "check-wate813-00331",
                    "status": "review",
                    "prompt": "What is the recommended maximum velocity in an untreated (raw) sewer to prevent erosion of the material?",
                    "html": "<p><strong>Velocity ranges need a named application and design basis.</strong> </p><p>Approximately 0.6–0.9 m/s minimum and 2.5–3.0 m/s maximum are legacy teaching ranges, not universal limits for every material and deposit. </p><p>The asserted 0.6 present/0.9 ultimate requirement is not independently established here. </p><p>Check actual low-flow depth, sediment behaviour and abrasion separately.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00331",
                ...
                {
                    "id": "check-wate813-00336",
                    "status": "review",
                    "prompt": "What is the recommended 'Minimum Velocity' (self-cleansing velocity) in a sewer to prevent the deposition of solids?",
                    "html": "<p><strong>Self-cleansing needs a stated design basis.</strong> Legacy minimum velocities around 0.6-0.9 m/s are teaching ranges. Actual low-flow depth, sediment characteristics and boundary shear determine deposition risk.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00336",
                            "set": 33,
                ...
                {
                    "id": "check-wate813-00341",
                    "status": "review",
                    "prompt": "What is the recommended minimum velocity (self-cleansing velocity) in a sewer to prevent the settlement of solid particles?",
                    "html": "<p><strong>Self-cleansing needs a stated design basis.</strong> Legacy minimum velocities around 0.6-0.9 m/s are teaching ranges. Actual low-flow depth, sediment characteristics and boundary shear determine deposition risk.</p>",
                    "sources": [
                        {
                            "id": "WATE813-00341",
