    ...
    ACiE0306: {
      ...
      blocks: [
        ...
        },
        {
          ...
          moreHtml: "<p>Comparable compact fan-shaped basins can synchronise tributary arrivals; elongated fern-shaped basins tend to spread them. Shape alone cannot rank <em>total stream length</em>. Urbanisation commonly increases runoff volume/peak and shortens lag and time base; detention, drainage layout and storm pattern can alter that tendency.</p>",
          sources: [
        ...
        },
        {
          ...
          moreHtml: "<p>Dew requires cooling to saturation at a surface above freezing. An above-zero dew point alone does not produce dew. Frost involves vapour deposition on a suitably cold, subfreezing surface; dew is surface condensation, not falling rain.</p>",
          sources: [
        ...
        },
        {
          ...
          html: "<p>A monthly normal is the mean for that calendar month over a specified 30-year reference period; 60 mm above normal means normal plus 60 mm. </p><p>The bank quotes Nepal's annual rainfall as 1890 mm and names WECS/DHM 1990 for regional flow estimation. Check local records, observation period and regional applicability; neither supplies design limits or guaranteed accuracy.</p>",
          moreHtml: "<p>A <strong>double-mass curve</strong> compares cumulative station rainfall against cumulative reference-station averages. A slope break prompts investigation of exposure, relocation and regional consistency, not automatic correction.</p>",
          sources: [
        ...
        },
        {
          ...
          html: "<p>Arithmetic averaging suits representative, reasonably uniform gauge coverage. <strong>Thiessen polygons</strong> use perpendicular bisectors and basin-clipped nearest-gauge areas: P̄ = Σ(A<sub>i</sub>P<sub>i</sub>)/A, with ΣA<sub>i</sub> = A.</p><p><strong>Isohyets</strong> join equal rainfall depths for the same interval. Weight each inter-isohyet band by its area: P̄ = Σ[A<sub>j</sub>(P<sub>j</sub> + P<sub>j+1</sub>)/2]/A. </p>",
          moreHtml: "<p>Terrain-informed contours can improve hilly-basin estimates, but sparse or poor observations defeat any claim of automatic accuracy.</p><p><strong>DAD curves</strong> describe maximum areal storm depths through upper envelopes, not mean best-fit lines. Depth generally decreases with increasing area and increases with duration.</p>",
          sources: [
        ...
        },
        {
          ...
          html: "<p>Capacity f<sub>c</sub> is the potential infiltration rate; actual f = min(i, f<sub>c</sub>) when rainfall is the only supply and no ponded reserve exists. </p><p><strong>Supplementary Horton model:</strong> f<sub>c</sub>(t) = f<sub>∞</sub> + (f<sub>0</sub> − f<sub>∞</sub>)exp(−kt), with k in inverse time. A fitted <strong>φ-index</strong> instead satisfies P<sub>e</sub> = Σmax(0, i<sub>j</sub> − φ)Δt; it is an aggregate loss index.</p><p><strong>Bank example:</strong> interpreting runoff as 1.2 × 10<sup>8</sup> m<sup>3</sup> over 1200 km<sup>2</sup> gives 10 cm excess. From 16 cm in six hours, φ = (16 − 10)/6 = <strong>1 cm/h</strong> only if intensity stays above φ throughout; totals alone do not prove that.</p>",
          moreHtml: "<p>Wetting reduces suction; surface sealing can reduce capacity. Ponding itself supplies head rather than necessarily reducing infiltration.</p>",
          sources: [
        ...
        },
        {
          ...
          html: "<p><strong>Q = Σa<sub>i</sub>v̄<sub>i</sub></strong> combines subsection areas and mean velocities. Current meters or acoustic instruments measure velocity. The two-point vertical estimate averages readings at 0.2h and 0.8h <em>below the surface</em>; one vertical is not the entire section.</p><p><strong>Bank example:</strong> h = 10 m, velocities 0.7 and 0.3 m/s give v̄ = 0.5 m/s. Discharge per unit width q = hv̄ = <strong>5 m<sup>2</sup>/s</strong>.</p>",
          moreHtml: "<p>Dilution gauging uses tracer conservation with complete mixing, negligible tracer loss and steady discharge: small turbulent streams suit it. The <strong>slope–area</strong> method indirectly reconstructs floods using high-water marks, surveyed geometry, roughness and a resistance equation.</p>",
          sources: [
        ...
        },
        {
          ...
          html: "<p>A hydrograph plots discharge against time: rising limb, crest and recession. After input ceases, basin storage and drainage dominate recession, but antecedent wetness and event history prevent absolute storm independence. </p><p>The <strong>flow mass curve V(t) = ∫Q(t)dt</strong> preserves chronology; its slope is discharge. A flow-duration curve instead orders flows by exceedance frequency and discards chronology.</p>",
          moreHtml: "<p>Maximum storage requires inflow to equal outflow while changing from filling to draining, not merely a graphical inflection.</p>",
          sources: [
        ...
        },
        {
          ...
          html: "<p>A <strong>D-hour unit hydrograph</strong> represents one specified depth, conventionally 1 cm, of effective rainfall uniformly distributed over the basin at constant intensity for D hours. First subtract baseflow: Q<sub>d</sub> = Q − Q<sub>base</sub>. </p><p><strong>Bank checks:</strong> six centimetres from three-hour excess requires division by six, retaining three-hour duration. A four-hour flood peak of 240 minus 40 m<sup>3</sup>/s baseflow, divided by 80 mm = 8 cm, gives <strong>25 m<sup>3</sup>/s</strong>.</p><table><thead><tr><th scope='col'>Triangular bank hydrograph</th><th scope='col'>Volume/depth calculation</th></tr></thead><tbody><tr><th scope='row'>80 h base, 50 m<sup>3</sup>/s peak</th><td>V = ½ × 80 × 3600 × 50 = 7.2 million m<sup>3</sup>; over 144 km<sup>2</sup>, excess = 5 cm.</td></tr><tr><th scope='row'>144 h base, 23 m<sup>3</sup>/s peak</th><td>V = 5,961,600 m<sup>3</sup>; for 1 cm, A = V/(0.01 m) = 596.16 km<sup>2</sup>.</td></tr></tbody></table><p>The second hydrograph's 12-hour rainfall duration is not its 144-hour runoff time base.</p>",
          moreHtml: "<p>Integrate for direct-runoff volume, divide by basin area for excess depth, then divide ordinates by that depth expressed in unit-depth multiples.</p>",
          sources: [
        ...
        },
        {
          ...
          html: "<p>UH convolution assumes <strong>linearity</strong> (scaled, additive responses) and <strong>time invariance</strong> (unchanged response after a time shift), with spatially uniform effective input, constant within each D-hour pulse. For pulse depths e<sub>j</sub>, <strong>Q<sub>d</sub>(t) = Σ[e<sub>j</sub>/(1 cm)]U<sub>D</sub>(t − jD)</strong>.</p><p><strong>Bank correction:</strong> adding two 2-hour UHs staggered by two hours represents 2 cm across <strong>four hours</strong>. Divide the sum by two to obtain a 4-hour UH. The undivided sum is not a unit hydrograph.</p>",
          moreHtml: "<p>An <strong>instantaneous UH</strong> idealises unit excess depth over the entire basin as rainfall duration tends to zero, not as basin area tends to zero.</p>",
          sources: [
        ...
        },
        {
          ...
          html: "<p>For maxima, define z = (x − μ)/β with location μ and positive scale β, both in x's units; μ is not the mean.</p><p><strong>CDF:</strong> F(x) = exp[−exp(−z)]. <strong>Density:</strong> f(x) = exp[−z − exp(−z)]/β. Density is not cumulative probability; AEP = 1 − F(x).</p><p>Setting F(x<sub>T</sub>) = 1 − 1/T gives <strong>x<sub>T</sub> = μ − β ln[−ln(1 − 1/T)]</strong>, T &gt; 1.</p><p>For the stated Gumbel distribution, mu = 0, beta = 1 and x = 2 give <strong>F(2) = exp[-exp(-2)] = 0.873423</strong>. Both source questions now offer this corrected value; their former 0.864 choices were not correct rounding.</p>",
          sources: [
      ...
      cautions: [
          {
              "id": "check-wate701-00132",
              "status": "review",
              "prompt": "Which of the following is adopted as standard recouping rain gauge?",
              "html": "<p><strong>“Recouping” is not an established gauge category.</strong> Recording and non-recording gauges differ in the time information retained. Clarify the damaged term before inferring an instrument function.</p>",
              "sources": [
                  {
                      "id": "WATE701-00132",
                      "set": 1,
          ...
          {
              "id": "check-wate701-00013",
              "status": "review",
              "prompt": "The dew point is above 0°C, then.",
              "html": "<p><strong>Cooling to saturation is required.</strong> An above-freezing dew point alone does not produce dew. A surface must cool sufficiently for condensation while remaining above freezing.</p>",
              "sources": [
                  {
                      "id": "WATE701-00013",
                      "set": 3,
          ...
          {
              "id": "check-wate701-00069",
              "status": "review",
              "prompt": "Which of the following statement is correct about stream length of fan shaped and fern shaped catchment?",
              "html": "<p><strong>Catchment ambiguities:</strong> shape cannot fix total stream length. </p>",
              "sources": [
                  {
                      "id": "WATE701-00069",
                      "set": 7,
          ...
          {
              "id": "check-wate701-00075",
              "status": "review",
              "prompt": "Rational method is applicable for",
          ...
          {
              "id": "check-wate701-00077",
              "status": "corrected",
              "prompt": "Given a Gumbel's distribution with μ = 0 and β = 1, find the probability that X is less than or equal to 2.",
              "html": "<p><strong>Corrected: 0.873423, option C.</strong> Substitution in F(x) = exp[−exp(−x)] gives 0.8734230185; 0.864 was not correct rounding.</p>",
              "sources": [
                  {
                      "id": "WATE701-00077",
                      "set": 8,
          ...
          {
              "id": "check-wate701-00080",
              "status": "review",
              "prompt": "What do you mean by cold frontal precipitation?",
          ...
          {
              "id": "check-wate701-00112",
              "status": "corrected",
              "prompt": "Given a Gumbel’s distribution with μ = 0 and β = 1, find the probability that X is less than or equal to 2.",
              "html": "<p><strong>Corrected: 0.873423, option A.</strong> The stated Gumbel CDF gives 0.8734230185, not 0.864.</p>",
              "sources": [
                  {
                      "id": "WATE701-00112",
                      "set": 11,
          ...
          {
              "id": "check-wate701-00133",
              "status": "review",
              "prompt": "Which of the following recording rain gauge does not produce the mass curve of precipitation as record?",
              "html": "<p>Contrary to the explanation, natural siphon records; Symons does not.</p>",
              "sources": [
                  {
                      "id": "WATE701-00133",
                      "set": 12,
          ...
          {
              "id": "check-wate701-00141",
              "status": "review",
              "prompt": "Depth area duration curves of precipitation at a station would normally be",
          ...
          {
              "id": "check-wate701-00146",
              "status": "review",
              "prompt": "The infiltration capacity during rain storm is considerably reduced due to",
              "html": "<p><strong>Loss assumptions:</strong> ponding need not reduce capacity; φ = 1 cm/h needs the unstated full-duration intensity assumption. </p><p>Otherwise φ is underdetermined.</p>",
              "sources": [
                  {
                      "id": "WATE701-00146",
                      "set": 13,
          ...
          {
              "id": "check-wate701-00152",
              "status": "review",
              "prompt": "If the velocity of flow of a stream of 10 m depth recorded by a current meter at depths of 2 m and 8 m are 0.7 and 0.3 m/s respectively, the discharge per unit width of the stream in cubic meters, is",
          ...
          {
              "id": "check-soil136-00175",
              "status": "review",
              "prompt": "For unconfined flow, which of the following discharge slot is used?",
              "html": "<p><strong>Formula notation is incomplete.</strong> The corrupted discharge-slot expression leaves variables and grouping undefined. Use a stated unconfined-flow model and defined geometry; do not reconstruct a unique formula from unreadable choices.</p>",
              "sources": [
                  {
                      "id": "SOIL136-00175",
                      "set": 15,
          ...
          {
              "id": "check-soil136-00180",
              "status": "review",
              "prompt": "In discharge equation given by chapmen qp=kba(H-ho)/1+EA, EA refers to ______",
              "html": "<p><strong>Groundwater source limits:</strong> full penetration is an idealisation, not compulsory. </p><p>Corrupted Chapman notation identifies EA as “extra length factor” but leaves grouping/variables undefined. </p><p>Do not reconstruct a discharge formula.</p>",
              "sources": [
                  {
                      "id": "SOIL136-00180",
                      "set": 15,
          ...
          {
              "id": "check-wate701-00298",
              "status": "review",
              "prompt": "The form factor of a drainage basin is obtained by dividing",
              "html": "<p><strong>Equivalent form-factor expressions.</strong> A/L<sup>2</sup> equals mean width divided by length when mean width is defined as A/L. Those expressions are not mutually exclusive choices.</p>",
              "sources": [
                  {
                      "id": "WATE701-00298",
                      "set": 26,
          ...
          {
              "id": "check-wate701-00333",
              "status": "review",
              "prompt": "A direct runoff hydrograph due to a storm was found to be triangular in shape with a peak of 150 m³/s, time from start of effective storm to peak of 24 h and a total time base of 72 h. The duration of storm in such case was",
              "html": "<p><strong>Hydrograph inference:</strong> a 150 m<sup>3</sup>/s peak at 24 h and 72 h triangular base cannot alone establish rainfall duration below 24 h. </p>",
              "sources": [
                  {
                      "id": "WATE701-00333",
                      "set": 29,
          ...
          {
              "id": "check-wate701-00334",
              "status": "review",
              "prompt": "The D-hour unit hydrograph of a catchment may be obtained by dividing the ordinates of a single peak direct runoff hydrograph due to a storm of D hour duration by the",
              "html": "<p><strong>UH key conflicts:</strong> normalise by depth, not volume. </p><p>Two staggered 2-hour UHs give four-hour, 2 cm runoff; halve for a unit response.</p>",
              "sources": [
                  {
                      "id": "WATE701-00334",
                      "set": 29,
          ...
          {
              "id": "check-wate701-00339",
              "status": "review",
              "prompt": "Rational formula is applicable only to",
              "html": "<p><strong>Rainfall duration must be sufficient for whole-catchment contribution.</strong> The usual rational-method assumption is duration at least the time of concentration. Equality is the standard design-intensity selection, not the only possible applicability condition.</p>",
              "sources": [
                  {
                      "id": "WATE701-00339",
                      "set": 30,
          ...
          {
              "id": "check-wate701-00345",
              "status": "review",
              "prompt": "If two 2-hour hydrograph are staggered by 2 hours and added graphically, the resulting hydrograph will be",
              "html": "<p>Two staggered 2-hour UHs give four-hour, 2 cm runoff; halve for a unit response.</p>",
              "sources": [
                  {
                      "id": "WATE701-00345",
                      "set": 30,
          ...
          {
              "id": "check-wate701-00349",
              "status": "review",
              "prompt": "A mean annual runoff of 1 m/s from a catchment of area 31.54 km² represents an effective rainfall of",
              "html": "<p><strong>Mean runoff must be a discharge.</strong> Interpreting the printed 1 m/s as 1 m<sup>3</sup>/s gives 31,536,000 m<sup>3</sup> in 365 days, equivalent to about 100 cm over 31.54 km<sup>2</sup>. Literal velocity alone cannot determine rainfall depth.</p>",
              "sources": [
                  {
                      "id": "WATE701-00349",
                      "set": 30,
          ...
          {
              "id": "check-wate701-00356",
              "status": "review",
              "prompt": "The total rainfall in a catchment of an area 1200 km² during 6-hr storm is 16 cm while the surface runoff due to the storm is 1.2 * 108 m². The φ-index is",
              "html": "<p><strong>Repair the runoff-volume unit and state the loss assumption.</strong> Interpreting 1.2 × 10<sup>8</sup> as m<sup>3</sup> over 1200 km<sup>2</sup> gives 10 cm runoff. A phi-index of (16 - 10)/6 = 1 cm/h additionally requires rainfall intensity above that loss rate throughout the six hours.</p>",
              "sources": [
                  {
                      "id": "WATE701-00356",
                      "set": 31,
          ...
          {
              "id": "check-wate701-00358",
              "status": "review",
              "prompt": "If a gauging section is having shifting control due to backwater effects, then",
          ...
          {
              "id": "check-wate701-00368",
              "status": "review",
              "prompt": "Point of inflection in hydrograph represents the condition of",
              "html": "<p>Recession inflection likewise does not generally prove maximum storage.</p>",
              "sources": [
                  {
                      "id": "WATE701-00368",
                      "set": 32,
